...
declare namespace ARROWS_DATA {
    namespace DEFAULT_ARROW {
        export { DefaultArrow as SvgComp };
        export const width: number;
        export const height: number;
    }
    namespace ARROW_2 {
        export { Arrow2 as SvgComp };
...
//# sourceMappingURL=arrowsIconsData.d.ts.map
...
function getItemsInViewportOrMarginByActiveGroup({ groups, options, virtualizationSettings, galleryWidth, galleryHeight, activeIndex, }) {
    ...
    const isHorizontal = options[pro_gallery_lib_1.optionsMap.layoutParams.structure.scrollDirection] ===
    ...
    const isScrollable = !isHorizontal ||
        options[pro_gallery_lib_1.optionsMap.behaviourParams.gallery.horizontal.slideAnimation] ===
            pro_gallery_lib_1.GALLERY_CONSTS[pro_gallery_lib_1.optionsMap.behaviourParams.gallery.horizontal.slideAnimation].SCROLL;
    if (!enabled) {
...
function getItemsInViewportOrMarginByScrollLocation({ items, options, virtualizationSettings, galleryWidth, galleryHeight, scrollPosition, }) {

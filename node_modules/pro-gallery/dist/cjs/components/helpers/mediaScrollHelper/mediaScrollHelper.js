...
class VideoScrollHelper {
    constructor(setPlayingItem, isItemSupported, getPlayTrigger) {
        this.setPlayingItem = setPlayingItem;
        this.isItemSupported = isItemSupported;
        this.getPlayTrigger = getPlayTrigger;
        this.scrollBase = 0;
        this.items = [];
        ...
        //--------------------------updates----------------------------------//
        this.updateGalleryStructure = ({ galleryStructure, galleryWidth, scrollBase, options, }) => {
        ...
        this.shouldTriggerAction = (idx, action = 'HOVER') => {
            return this.findItem(idx) && this.shouldTrigger(action);
        };
        this.itemHovered = (idx) => {
        ...
        //-------------------------------controls------------------------------------//
        this.autoPlayNextItemByRating = ({ top, left }) => {
        ...
        this.stop = (idx = this.currentPlayingIdx) => {
        ...
        //-----------------------------Utils--------------------------------------------//
        this.isCurrentItemStillVisible = ({ top, left }) => {
        ...
        this.isVisible = (item, { top, left }) => {
            ...
            const visibleVertically = (0, utils_js_1.isWithinPaddingVertically)({
                target,
            ...
            if (this.scrollDirection === pro_gallery_lib_1.GALLERY_CONSTS[pro_gallery_lib_1.optionsMap.layoutParams.structure.scrollDirection].VERTICAL) {
                visibleHorizontally = true;
            }
            else {
                visibleHorizontally = (0, utils_js_1.isWithinPaddingHorizontally)({
                    target,
...
//# sourceMappingURL=mediaScrollHelper.js.map
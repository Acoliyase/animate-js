...
class TextItem extends react_1.default.Component {
    constructor(props) {
        super(props);
    ...
    getTextDimensions() {
        ...
        const textWidth = (!isVerticalItem ? style.width / style.maxWidth : style.height / style.maxHeight) * style.maxWidth;
        const translate = options[pro_gallery_lib_1.optionsMap.layoutParams.crop.method] === pro_gallery_lib_1.GALLERY_CONSTS[pro_gallery_lib_1.optionsMap.layoutParams.crop.method].FIT
            ? '0, 0'
    ...
    render() {
        ...
        const changeBgColor = {
            style: Object.assign(dimensions, options[pro_gallery_lib_1.optionsMap.layoutParams.crop.method] === pro_gallery_lib_1.GALLERY_CONSTS[pro_gallery_lib_1.optionsMap.layoutParams.crop.method].FIT
                ? { backgroundColor: style.bgColor }
                : {}),
        };
        const attributes = Object.assign(Object.assign({}, htmlParam), changeBgColor);
        const itemContentStyle = {
            height: imageDimensions && !this.props.isPrerenderMode ? imageDimensions.height : 'inherit',
            backgroundColor: options[pro_gallery_lib_1.optionsMap.layoutParams.crop.method] !== pro_gallery_lib_1.GALLERY_CONSTS[pro_gallery_lib_1.optionsMap.layoutParams.crop.method].FIT
                ? style.bgColor
                : 'inherit',
        };
        ...
        return (react_1.default.createElement("div", { className: containerClasses.join(' '), style: itemContentStyle },
            react_1.default.createElement("div", Object.assign({ className: 'gallery-item-visible gallery-item gallery-item-loaded text-item', key: 'item-text-' + id, onTouchStart: actions.handleItemMouseDown, onTouchEnd: actions.handleItemMouseUp, "data-hook": "text-item" }, attributes))));
    }
}

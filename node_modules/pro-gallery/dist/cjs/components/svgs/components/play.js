...
const play = (_a) => {
    var { size } = _a, props = tslib_1.__rest(_a, ["size"]);
    return (react_1.default.createElement("svg", Object.assign({ viewBox: "0 0 11 14", fill: "currentColor", width: size || "11", height: size || "14" }, props),

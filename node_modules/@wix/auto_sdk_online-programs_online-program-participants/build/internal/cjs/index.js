...
__export(index_exports, {
  ChoiceRightness: () => ChoiceRightness,
  DescriptionFieldSet: () => DescriptionFieldSet,
  DurationUnit: () => DurationUnit,
  ParticipantStepState: () => ParticipantStepState,
  ParticipationState: () => ParticipationState,
  PaymentType: () => PaymentType,
  QueryParticipantsRequestJoinPath: () => QueryParticipantsRequestJoinPath,
  QueryParticipantsRequestSortingCriterion: () => QueryParticipantsRequestSortingCriterion,
  QueryParticipantsRequestSortingOrder: () => QueryParticipantsRequestSortingOrder,
  QuizType: () => QuizType,
  ...
  addAllParticipant: () => addAllParticipant4,
  addParticipant: () => addParticipant4,
  addParticipants: () => addParticipants4,
  applyCouponToOrder: () => applyCouponToOrder4,
  createJoinRequest: () => createJoinRequest4,
  createPaymentOrder: () => createPaymentOrder4,
  deleteParticipant: () => deleteParticipant4,
  getCertificate: () => getCertificate4,
  getMediaUploadInfo: () => getMediaUploadInfo4,
  getParticipant: () => getParticipant4,
  getSection: () => getSection4,
  getStep: () => getStep4,
  inviteAllParticipants: () => inviteAllParticipants4,
  inviteParticipants: () => inviteParticipants4,
  issueCertificate: () => issueCertificate4,
  issueParticipantCertificate: () => issueParticipantCertificate4,
  joinParticipant: () => joinParticipant4,
  listParticipants: () => listParticipants4,
  listSections: () => listSections4,
  listSteps: () => listSteps4,
  myProgram: () => myProgram4,
  myProgramSection: () => myProgramSection4,
  myProgramStep: () => myProgramStep4,
  onParticipantDeleted: () => onParticipantDeleted2,
  onParticipantJoined: () => onParticipantJoined2,
  onParticipantStepResolved: () => onParticipantStepResolved2,
  queryParticipants: () => queryParticipants4,
  removeCouponFromOrder: () => removeCouponFromOrder4,
  resetParticipantProgress: () => resetParticipantProgress4,
  resolveStep: () => resolveStep4,
  reviveParticipant: () => reviveParticipant4,
  updateParticipant: () => updateParticipant4,
  updateStepFeedback: () => updateStepFeedback4
});
module.exports = __toCommonJS(index_exports);

// src/challenges-v1-participant-online-program-participants.public.ts
...
// src/challenges-v1-participant-online-program-participants.universal.ts
...
var PACKAGE_NAME = "@wix/auto_sdk_online-programs_online-program-participants";
...
function listParticipants(payload) {
  function __listParticipants({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "GET",
...
function joinParticipant(payload) {
  function __joinParticipant({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function createJoinRequest(payload) {
  function __createJoinRequest({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function inviteParticipants(payload) {
  function __inviteParticipants({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function inviteAllParticipants(payload) {
  function __inviteAllParticipants({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function reviveParticipant(payload) {
  function __reviveParticipant({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "PATCH",
...
function resetParticipantProgress(payload) {
  function __resetParticipantProgress({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "PATCH",
...
function issueParticipantCertificate(payload) {
  function __issueParticipantCertificate({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function getCertificate(payload) {
  function __getCertificate({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "GET",
...
function createPaymentOrder(payload) {
  function __createPaymentOrder({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function applyCouponToOrder(payload) {
  function __applyCouponToOrder({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "POST",
...
function removeCouponFromOrder(payload) {
  function __removeCouponFromOrder({ host }) {
    const metadata = {
      entityFqdn: "wix.challenges.v1.participant",
      method: "DELETE",
...
async function queryParticipants2(challengeId, options) {
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          ...
          paths: [{ path: "participants.challenge.media.image" }]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [{ path: "participants.challenge.media.video" }]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [{ path: "participants.challenge.media.document" }]
        }
      ])
    );
  } catch (err) {
...
async function listParticipants2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    paging: options?.paging,
    ...
    sortingCriterion: options?.sortingCriterion,
    memberName: options?.memberName,
    sorting: options?.sorting
  });
  const reqOpts = listParticipants(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        ...
        explicitPathsToArguments: {
          ...
          sortingCriterion: "$[1].sortingCriterion",
...
async function joinParticipant2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    memberId: options?.memberId,
  ...
  const reqOpts = joinParticipant(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          transformFn: import_image2.transformRESTImageToSDKImage,
          paths: [{ path: "participant.challenge.media.image" }]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [{ path: "participant.challenge.media.video" }]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [{ path: "participant.challenge.media.document" }]
        }
      ])
    );
  } catch (err) {
...
async function addParticipant2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    memberId: options?.memberId,
  ...
  const reqOpts = addParticipant(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function addParticipants2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    memberIds: options?.memberIds,
  ...
  const reqOpts = addParticipants(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function addAllParticipant2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    excludeIds: options?.excludeIds
  });
  const reqOpts = addAllParticipant(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function createJoinRequest2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    memberId: options?.memberId,
  ...
  const reqOpts = createJoinRequest(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function inviteParticipants2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    memberIds: options?.memberIds,
  ...
  const reqOpts = inviteParticipants(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function inviteAllParticipants2(challengeId, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId,
    excludeIds: options?.excludeIds
  });
  const reqOpts = inviteAllParticipants(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function getParticipant2(identifiers) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
...
async function updateParticipant2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = updateParticipant(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function deleteParticipant2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
...
async function reviveParticipant2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = reviveParticipant(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function resetParticipantProgress2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = resetParticipantProgress(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function issueParticipantCertificate2(identifiers) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId
  });
  const reqOpts = issueParticipantCertificate(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function issueCertificate2(identifiers) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId
...
async function getCertificate2(identifiers) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId
  });
  const reqOpts = getCertificate(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function createPaymentOrder2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = createPaymentOrder(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function applyCouponToOrder2(identifiers, couponCode, options) {
  ...
  const reqOpts = applyCouponToOrder(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    ...
    const transformedError = (0, import_transform_error.transformError)(
      ...
      ["identifiers", "couponCode", "options"]
    );
    sideEffects?.onError?.(err);
    throw transformedError;
  }
}
async function removeCouponFromOrder2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = removeCouponFromOrder(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function listSteps2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = listSteps(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          ...
          paths: [
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "steps.source.settings.general.video.coverImage" },
            { path: "steps.source.settings.general.description.media.image" },
            { path: "steps.feedback.items.media.mediaItems.image" },
            { path: "steps.feedback.quiz.media.mediaItems.image" }
          ]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            { path: "steps.source.settings.general.description.media.video" },
            { path: "steps.feedback.items.media.mediaItems.video" },
            { path: "steps.feedback.quiz.media.mediaItems.video" }
          ]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "steps.source.settings.general.description.media.document"
            },
            { path: "steps.feedback.items.media.mediaItems.document" },
            { path: "steps.feedback.quiz.media.mediaItems.document" }
          ]
        },
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [{ path: "steps.source.settings.general.video.video" }]
        }
      ])
    );
  } catch (err) {
...
async function getStep2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          ...
          paths: [
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "step.source.settings.general.video.coverImage" },
            { path: "step.source.settings.general.description.media.image" },
            { path: "step.feedback.items.media.mediaItems.image" },
            { path: "step.feedback.quiz.media.mediaItems.image" },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "subSteps.source.settings.general.video.coverImage" },
            {
              path: "subSteps.source.settings.general.description.media.image"
            },
            { path: "subSteps.feedback.items.media.mediaItems.image" },
            { path: "subSteps.feedback.quiz.media.mediaItems.image" }
          ]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            { path: "step.source.settings.general.description.media.video" },
            { path: "step.feedback.items.media.mediaItems.video" },
            { path: "step.feedback.quiz.media.mediaItems.video" },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "subSteps.source.settings.general.description.media.video"
            },
            { path: "subSteps.feedback.items.media.mediaItems.video" },
            { path: "subSteps.feedback.quiz.media.mediaItems.video" }
          ]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "step.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "step.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            { path: "step.source.settings.general.description.media.document" },
            { path: "step.feedback.items.media.mediaItems.document" },
            { path: "step.feedback.quiz.media.mediaItems.document" },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "subSteps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "subSteps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "subSteps.source.settings.general.description.media.document"
            },
            { path: "subSteps.feedback.items.media.mediaItems.document" },
            { path: "subSteps.feedback.quiz.media.mediaItems.document" }
          ]
        },
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [
            { path: "step.source.settings.general.video.video" },
            { path: "subSteps.source.settings.general.video.video" }
          ]
        }
      ])
    );
...
async function resolveStep2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_transform_paths2.transformPaths)(
    (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
      ...
      actionId: options?.actionId,
      quizSubmissionId: options?.quizSubmissionId
    }),
    [
      {
        transformFn: import_image.transformSDKImageToRESTImage,
        paths: [
          { path: "feedback.items.media.mediaItems.image" },
          { path: "feedback.quiz.media.mediaItems.image" }
        ]
      },
      {
        transformFn: import_video.transformSDKVideoToRESTVideo,
        paths: [
          { path: "feedback.items.media.mediaItems.video" },
          { path: "feedback.quiz.media.mediaItems.video" }
        ]
      },
      {
        transformFn: import_document.transformSDKDocumentToRESTDocument,
        paths: [
          { path: "feedback.items.media.mediaItems.document" },
          { path: "feedback.quiz.media.mediaItems.document" }
        ]
      }
    ]
  );
  const reqOpts = resolveStep(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(
      (0, import_transform_paths2.transformPaths)(result.data, [
        ...
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [{ path: "step.source.settings.general.video.video" }]
        }
      ])
    );
  } catch (err) {
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        ...
        explicitPathsToArguments: {
          ...
          feedback: "$[1].feedback",
          actionId: "$[1].actionId",
          quizSubmissionId: "$[1].quizSubmissionId"
        },
        singleArgumentUnchanged: false
      },
      ["identifiers", "options"]
...
async function updateStepFeedback2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_transform_paths2.transformPaths)(
    (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
      challengeId: identifiers?.challengeId,
  ...
  const reqOpts = updateStepFeedback(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function getMediaUploadInfo2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
  ...
  const reqOpts = getMediaUploadInfo(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function listSections2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          transformFn: import_image2.transformRESTImageToSDKImage,
          paths: [
            { path: "sections.source.settings.description.media.image" },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "sections.source.steps.settings.general.video.coverImage" },
            {
              path: "sections.source.steps.settings.general.description.media.image"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "sections.steps.source.settings.general.video.coverImage" },
            {
              path: "sections.steps.source.settings.general.description.media.image"
            },
            { path: "sections.steps.feedback.items.media.mediaItems.image" },
            { path: "sections.steps.feedback.quiz.media.mediaItems.image" }
          ]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [
            { path: "sections.source.settings.description.media.video" },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "sections.source.steps.settings.general.description.media.video"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "sections.steps.source.settings.general.description.media.video"
            },
            { path: "sections.steps.feedback.items.media.mediaItems.video" },
            { path: "sections.steps.feedback.quiz.media.mediaItems.video" }
          ]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [
            { path: "sections.source.settings.description.media.document" },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "sections.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "sections.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "sections.source.steps.settings.general.description.media.document"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "sections.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "sections.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "sections.steps.source.settings.general.description.media.document"
            },
            { path: "sections.steps.feedback.items.media.mediaItems.document" },
            { path: "sections.steps.feedback.quiz.media.mediaItems.document" }
          ]
        },
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [
            { path: "sections.source.steps.settings.general.video.video" },
            { path: "sections.steps.source.settings.general.video.video" }
          ]
        }
      ])
    );
...
async function getSection2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    challengeId: identifiers?.challengeId,
    participantId: identifiers?.participantId,
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          transformFn: import_image2.transformRESTImageToSDKImage,
          paths: [
            { path: "section.source.settings.description.media.image" },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "section.source.steps.settings.general.video.coverImage" },
            {
              path: "section.source.steps.settings.general.description.media.image"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            { path: "section.steps.source.settings.general.video.coverImage" },
            {
              path: "section.steps.source.settings.general.description.media.image"
            },
            { path: "section.steps.feedback.items.media.mediaItems.image" },
            { path: "section.steps.feedback.quiz.media.mediaItems.image" }
          ]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [
            { path: "section.source.settings.description.media.video" },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "section.source.steps.settings.general.description.media.video"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "section.steps.source.settings.general.description.media.video"
            },
            { path: "section.steps.feedback.items.media.mediaItems.video" },
            { path: "section.steps.feedback.quiz.media.mediaItems.video" }
          ]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [
            { path: "section.source.settings.description.media.document" },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "section.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "section.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "section.source.steps.settings.general.description.media.document"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "section.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "section.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "section.steps.source.settings.general.description.media.document"
            },
            { path: "section.steps.feedback.items.media.mediaItems.document" },
            { path: "section.steps.feedback.quiz.media.mediaItems.document" }
          ]
        },
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [
            { path: "section.source.steps.settings.general.video.video" },
            { path: "section.steps.source.settings.general.video.video" }
          ]
        }
      ])
    );
...
async function myProgram2(programId) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    programId
  });
  const reqOpts = myProgram(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function myProgramStep2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    programId: identifiers?.programId,
    programStepId: identifiers?.programStepId,
    descriptionFieldSet: options?.descriptionFieldSet
  });
  const reqOpts = myProgramStep(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          ...
          paths: [
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantStep.source.settings.general.video.coverImage"
            },
            {
              path: "participantStep.source.settings.general.description.media.image"
            },
            { path: "participantStep.feedback.items.media.mediaItems.image" },
            { path: "participantStep.feedback.quiz.media.mediaItems.image" }
          ]
        },
        {
          transformFn: import_video2.transformRESTVideoToSDKVideo,
          paths: [
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantStep.source.settings.general.description.media.video"
            },
            { path: "participantStep.feedback.items.media.mediaItems.video" },
            { path: "participantStep.feedback.quiz.media.mediaItems.video" }
          ]
        },
        {
          transformFn: import_document2.transformRESTDocumentToSDKDocument,
          paths: [
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantStep.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantStep.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantStep.source.settings.general.description.media.document"
            },
            {
              path: "participantStep.feedback.items.media.mediaItems.document"
            },
            { path: "participantStep.feedback.quiz.media.mediaItems.document" }
          ]
        },
        {
          transformFn: import_video_v2.transformRESTVideoV2ToSDKVideoV2,
          paths: [
            { path: "participantStep.source.settings.general.video.video" }
          ]
        }
      ])
    );
...
async function myProgramSection2(identifiers, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({
    programId: identifiers?.programId,
    programSectionId: identifiers?.programSectionId,
    descriptionFieldSet: options?.descriptionFieldSet
  });
  const reqOpts = myProgramSection(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          ...
          paths: [
            {
              path: "participantSection.source.settings.description.media.image"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantSection.source.steps.settings.general.video.coverImage"
            },
            {
              path: "participantSection.source.steps.settings.general.description.media.image"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.image"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.image"
            },
            {
              path: "participantSection.steps.source.settings.general.video.coverImage"
            },
            {
              path: "participantSection.steps.source.settings.general.description.media.image"
            },
            {
              path: "participantSection.steps.feedback.items.media.mediaItems.image"
            },
            {
              path: "participantSection.steps.feedback.quiz.media.mediaItems.image"
            }
          ]
        },
        {
          ...
          paths: [
            {
              path: "participantSection.source.settings.description.media.video"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantSection.source.steps.settings.general.description.media.video"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.video"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.video"
            },
            {
              path: "participantSection.steps.source.settings.general.description.media.video"
            },
            {
              path: "participantSection.steps.feedback.items.media.mediaItems.video"
            },
            {
              path: "participantSection.steps.feedback.quiz.media.mediaItems.video"
            }
          ]
        },
        {
          ...
          paths: [
            {
              path: "participantSection.source.settings.description.media.document"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantSection.source.steps.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantSection.source.steps.settings.general.description.media.document"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.feedbackSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multipleChoice.choices.description.media.document"
            },
            {
              path: "participantSection.steps.source.settings.general.individual.quizSettings.type.multiSelect.choices.description.media.document"
            },
            {
              path: "participantSection.steps.source.settings.general.description.media.document"
            },
            {
              path: "participantSection.steps.feedback.items.media.mediaItems.document"
            },
            {
              path: "participantSection.steps.feedback.quiz.media.mediaItems.document"
            }
          ]
        },
        {
          ...
          paths: [
            {
              path: "participantSection.source.steps.settings.general.video.video"
            },
            {
              path: "participantSection.steps.source.settings.general.video.video"
            }
          ]
        }
      ])
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        ...
        explicitPathsToArguments: {
          programId: "$[0].programId",
          programSectionId: "$[0].programSectionId",
          descriptionFieldSet: "$[1].descriptionFieldSet"
        },
        singleArgumentUnchanged: false
      },
...
function queryParticipants3(httpClient) {
  return (challengeId, options) => queryParticipants2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function listParticipants3(httpClient) {
  return (challengeId, options) => listParticipants2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function joinParticipant3(httpClient) {
  return (challengeId, options) => joinParticipant2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function addParticipant3(httpClient) {
  return (challengeId, options) => addParticipant2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function addParticipants3(httpClient) {
  return (challengeId, options) => addParticipants2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function addAllParticipant3(httpClient) {
  return (challengeId, options) => addAllParticipant2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function createJoinRequest3(httpClient) {
  return (challengeId, options) => createJoinRequest2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function inviteParticipants3(httpClient) {
  return (challengeId, options) => inviteParticipants2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function inviteAllParticipants3(httpClient) {
  return (challengeId, options) => inviteAllParticipants2(
    challengeId,
    options,
    // @ts-ignore
    { httpClient }
...
function getParticipant3(httpClient) {
  return (identifiers) => getParticipant2(
    identifiers,
    // @ts-ignore
    { httpClient }
  );
...
function updateParticipant3(httpClient) {
  return (identifiers, options) => updateParticipant2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function deleteParticipant3(httpClient) {
  return (identifiers, options) => deleteParticipant2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function reviveParticipant3(httpClient) {
  return (identifiers, options) => reviveParticipant2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function resetParticipantProgress3(httpClient) {
  return (identifiers, options) => resetParticipantProgress2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function issueParticipantCertificate3(httpClient) {
  return (identifiers) => issueParticipantCertificate2(
    identifiers,
    // @ts-ignore
    { httpClient }
  );
...
function issueCertificate3(httpClient) {
  return (identifiers) => issueCertificate2(
    identifiers,
    // @ts-ignore
    { httpClient }
  );
}
function getCertificate3(httpClient) {
  return (identifiers) => getCertificate2(
    identifiers,
    // @ts-ignore
    { httpClient }
  );
}
function createPaymentOrder3(httpClient) {
  return (identifiers, options) => createPaymentOrder2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function applyCouponToOrder3(httpClient) {
  return (identifiers, couponCode, options) => applyCouponToOrder2(
    identifiers,
    couponCode,
    options,
    // @ts-ignore
...
function removeCouponFromOrder3(httpClient) {
  return (identifiers, options) => removeCouponFromOrder2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function listSteps3(httpClient) {
  return (identifiers, options) => listSteps2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function getStep3(httpClient) {
  return (identifiers, options) => getStep2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function resolveStep3(httpClient) {
  return (identifiers, options) => resolveStep2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function updateStepFeedback3(httpClient) {
  return (identifiers, options) => updateStepFeedback2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function getMediaUploadInfo3(httpClient) {
  return (identifiers, options) => getMediaUploadInfo2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function listSections3(httpClient) {
  return (identifiers, options) => listSections2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function getSection3(httpClient) {
  return (identifiers, options) => getSection2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function myProgram3(httpClient) {
  return (programId) => myProgram2(
    programId,
    // @ts-ignore
    { httpClient }
  );
}
function myProgramStep3(httpClient) {
  return (identifiers, options) => myProgramStep2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
function myProgramSection3(httpClient) {
  return (identifiers, options) => myProgramSection2(
    identifiers,
    options,
    // @ts-ignore
    { httpClient }
...
var onParticipantDeleted = (0, import_sdk_types.EventDefinition)(
  "wix.challenges.v1.participant_deleted",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
        transformFn: import_float3.transformRESTFloatToSDKFloat,
        paths: [{ path: "undefined.performance" }]
      },
      {
        transformFn: import_image3.transformRESTImageToSDKImage,
        paths: [{ path: "undefined.challenge.media.image" }]
      },
      {
        transformFn: import_video3.transformRESTVideoToSDKVideo,
        paths: [{ path: "undefined.challenge.media.video" }]
      },
      {
        transformFn: import_document3.transformRESTDocumentToSDKDocument,
        paths: [{ path: "undefined.challenge.media.document" }]
      },
      {
        transformFn: import_timestamp3.transformRESTTimestampToSDKTimestamp,
        paths: [
          { path: "undefined.timeFrame.start" },
          { path: "undefined.timeFrame.finish" },
          { path: "undefined.stepsSummary.lastEvent.transition.occurredAt" },
          { path: "undefined.transitions.occurredAt" },
          { path: "undefined.certificate.issuedDate" },
...
var onParticipantJoined = (0, import_sdk_types.EventDefinition)(
  "wix.challenges.v1.participant_participant_joined",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
        transformFn: import_float3.transformRESTFloatToSDKFloat,
        paths: [{ path: "data.participant.performance" }]
      },
      {
        transformFn: import_image3.transformRESTImageToSDKImage,
        paths: [{ path: "data.participant.challenge.media.image" }]
      },
      {
        transformFn: import_video3.transformRESTVideoToSDKVideo,
        paths: [{ path: "data.participant.challenge.media.video" }]
      },
      {
        transformFn: import_document3.transformRESTDocumentToSDKDocument,
        paths: [{ path: "data.participant.challenge.media.document" }]
      },
      {
        transformFn: import_timestamp3.transformRESTTimestampToSDKTimestamp,
        paths: [
          { path: "data.participant.timeFrame.start" },
          { path: "data.participant.timeFrame.finish" },
          {
            path: "data.participant.stepsSummary.lastEvent.transition.occurredAt"
          },
          { path: "data.participant.transitions.occurredAt" },
...
var onParticipantStepResolved = (0, import_sdk_types.EventDefinition)(
  "wix.challenges.v1.participant_step_resolved",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
        transformFn: import_timestamp3.transformRESTTimestampToSDKTimestamp,
        paths: [
          { path: "data.feedback.createdAt" },
          { path: "data.feedback.updatedAt" },
          { path: "metadata.eventTime" }
        ]
      },
      {
        transformFn: import_image3.transformRESTImageToSDKImage,
        paths: [
          { path: "data.feedback.items.media.mediaItems.image" },
          { path: "data.feedback.quiz.media.mediaItems.image" }
        ]
      },
      {
        transformFn: import_video3.transformRESTVideoToSDKVideo,
        paths: [
          { path: "data.feedback.items.media.mediaItems.video" },
          { path: "data.feedback.quiz.media.mediaItems.video" }
        ]
      },
      {
        transformFn: import_document3.transformRESTDocumentToSDKDocument,
        paths: [
          { path: "data.feedback.items.media.mediaItems.document" },
          { path: "data.feedback.quiz.media.mediaItems.document" }
        ]
      },
      {
        transformFn: import_float3.transformRESTFloatToSDKFloat,
        paths: [
          { path: "data.feedback.items.quantity.amount" },
          { path: "data.feedback.quiz.quantity.amount" }
        ]
      }
    ])
  )
...
// src/challenges-v1-participant-online-program-participants.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var import_event_definition_modules = require("@wix/sdk-runtime/event-definition-modules");
var queryParticipants4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(queryParticipants3);
var listParticipants4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listParticipants3);
var joinParticipant4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(joinParticipant3);
var addParticipant4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(addParticipant3);
var addParticipants4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(addParticipants3);
var addAllParticipant4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(addAllParticipant3);
var createJoinRequest4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(createJoinRequest3);
var inviteParticipants4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(inviteParticipants3);
var inviteAllParticipants4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(inviteAllParticipants3);
...
var reviveParticipant4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(reviveParticipant3);
var resetParticipantProgress4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(resetParticipantProgress3);
var issueParticipantCertificate4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(issueParticipantCertificate3);
var issueCertificate4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(issueCertificate3);
var getCertificate4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getCertificate3);
var createPaymentOrder4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(createPaymentOrder3);
var applyCouponToOrder4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(applyCouponToOrder3);
var removeCouponFromOrder4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(removeCouponFromOrder3);
var listSteps4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listSteps3);
var getStep4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getStep3);
var resolveStep4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(resolveStep3);
var updateStepFeedback4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updateStepFeedback3);
var getMediaUploadInfo4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getMediaUploadInfo3);
...
var myProgram4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(myProgram3);
var myProgramStep4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(myProgramStep3);
var myProgramSection4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(myProgramSection3);
...
var onParticipantStepResolved2 = (0, import_event_definition_modules.createEventModule)(
  onParticipantStepResolved
);

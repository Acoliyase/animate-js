...
function listParticipants2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = listParticipants(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function joinParticipant2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = joinParticipant(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addParticipant2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = addParticipant(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addParticipants2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = addParticipants(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function addAllParticipant2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = addAllParticipant(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createJoinRequest2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = createJoinRequest(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function inviteParticipants2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = inviteParticipants(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function inviteAllParticipants2() {
  const payload = { challengeId: ":challengeId" };
  const getRequestOptions = inviteAllParticipants(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateParticipant2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId"
  };
  const getRequestOptions = updateParticipant(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function reviveParticipant2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId"
  };
  const getRequestOptions = reviveParticipant(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function resetParticipantProgress2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId"
  };
  const getRequestOptions = resetParticipantProgress(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function issueParticipantCertificate2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId"
  };
  const getRequestOptions = issueParticipantCertificate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getCertificate2() {
  ...
  const getRequestOptions = getCertificate(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createPaymentOrder2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId"
  };
  const getRequestOptions = createPaymentOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function applyCouponToOrder2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId",
    orderId: ":orderId"
  };
  const getRequestOptions = applyCouponToOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function removeCouponFromOrder2() {
  const payload = {
    challengeId: ":challengeId",
    participantId: ":participantId",
    orderId: ":orderId",
  ...
  const getRequestOptions = removeCouponFromOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

...
interface ListTicketDefinitionsSignature {
     ...
     * @deprecated
     */
    (options?: ListTicketDefinitionsOptions): Promise<NonNullablePaths<ListTicketDefinitionsResponse, `metaData.count` | `metaData.offset` | `metaData.total` | `definitions` | `definitions.${number}._id` | `definitions.${number}.price.amount` | `definitions.${number}.price.currency` | `definitions.${number}.free` | `definitions.${number}.name` | `definitions.${number}.description` | `definitions.${number}.limitPerCheckout` | `definitions.${number}.orderIndex` | `definitions.${number}.policy` | `definitions.${number}.dashboard.hidden` | `definitions.${number}.dashboard.sold` | `definitions.${number}.dashboard.limited` | `definitions.${number}.dashboard.ticketsSold` | `definitions.${number}.dashboard.ticketsReserved` | `definitions.${number}.eventId` | `definitions.${number}.wixFeeConfig.type` | `definitions.${number}.salePeriod.hideNotOnSale` | `definitions.${number}.saleStatus` | `definitions.${number}.pricing.pricingType`, 5>>;
}
...
interface GetTicketDefinitionSignature {
     ...
     * @deprecated
     */
    (definitionId: string, options?: GetTicketDefinitionOptions): Promise<NonNullablePaths<TicketDefinition, `_id` | `price.amount` | `price.currency` | `free` | `name` | `description` | `limitPerCheckout` | `orderIndex` | `policy` | `dashboard.hidden` | `dashboard.sold` | `dashboard.limited` | `dashboard.ticketsSold` | `dashboard.ticketsReserved` | `eventId` | `wixFeeConfig.type` | `salePeriod.hideNotOnSale` | `saleStatus` | `state` | `pricing.pricingOptions.options` | `pricing.pricingType`, 4>>;
}
...
interface CreateTicketDefinitionSignature {
     ...
     * @deprecated
     */
    (eventId: string, options: NonNullablePaths<CreateTicketDefinitionOptions, `definition` | `definition.name`, 3>): Promise<NonNullablePaths<CreateTicketDefinitionResponse, `definition._id` | `definition.price.amount` | `definition.price.currency` | `definition.free` | `definition.name` | `definition.description` | `definition.limitPerCheckout` | `definition.orderIndex` | `definition.policy` | `definition.dashboard.hidden` | `definition.dashboard.sold` | `definition.dashboard.limited` | `definition.dashboard.ticketsSold` | `definition.dashboard.ticketsReserved` | `definition.eventId` | `definition.wixFeeConfig.type` | `definition.salePeriod.hideNotOnSale` | `definition.saleStatus` | `definition.state` | `definition.pricing.pricingOptions.options` | `definition.pricing.pricingType`, 5>>;
}
...
interface UpdateTicketDefinitionSignature {
     ...
     * @deprecated
     */
    (definitionId: string, eventId: string, options?: UpdateTicketDefinitionOptions): Promise<NonNullablePaths<UpdateTicketDefinitionResponse, `definition._id` | `definition.price.amount` | `definition.price.currency` | `definition.free` | `definition.name` | `definition.description` | `definition.limitPerCheckout` | `definition.orderIndex` | `definition.policy` | `definition.dashboard.hidden` | `definition.dashboard.sold` | `definition.dashboard.limited` | `definition.dashboard.ticketsSold` | `definition.dashboard.ticketsReserved` | `definition.eventId` | `definition.wixFeeConfig.type` | `definition.salePeriod.hideNotOnSale` | `definition.saleStatus` | `definition.state` | `definition.pricing.pricingOptions.options` | `definition.pricing.pricingType`, 5>>;
}
...
interface ChangeCurrencySignature {
     ...
     * @deprecated
     */
    (options?: NonNullablePaths<ChangeCurrencyOptions, `currency`, 2>): Promise<void>;
}
declare const onTicketDefinitionCreated$1: EventDefinition<TicketDefinitionCreatedEnvelope, "wix.events.ticketing.events.TicketDefinitionCreated">;
declare const onTicketDefinitionDeleted$1: EventDefinition<TicketDefinitionDeletedEnvelope, "wix.events.ticketing.events.TicketDefinitionDeleted">;
declare const onTicketDefinitionUpdated$1: EventDefinition<TicketDefinitionUpdatedEnvelope, "wix.events.ticketing.events.TicketDefinitionUpdated">;
...
declare const listTicketDefinitions: MaybeContext<BuildRESTFunction<typeof listTicketDefinitions$1> & typeof listTicketDefinitions$1>;

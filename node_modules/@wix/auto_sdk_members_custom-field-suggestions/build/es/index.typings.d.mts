 ...
 */
declare function listCustomFieldSuggestions(options?: ListCustomFieldSuggestionsOptions): Promise<NonNullablePaths<ListCustomFieldSuggestionsResponse, `suggestions` | `suggestions.${number}.defaultPrivacy` | `suggestions.${number}.fieldType` | `suggestions.${number}.socialType` | `suggestions.${number}.fieldOrigin`, 4>>;
...
export { type CustomFieldSuggestion, type ListCustomFieldSuggestionsOptions, type ListCustomFieldSuggestionsRequest, type ListCustomFieldSuggestionsResponse, Origin, type OriginWithLiterals, type Paging, type PagingMetadata, Privacy, type PrivacyWithLiterals, type Query, type QueryCustomFieldSuggestionsRequest, type QueryCustomFieldSuggestionsResponse, SocialTypeType, type SocialTypeTypeWithLiterals, SortOrder, type SortOrderWithLiterals, type Sorting, type SuggestionsQueryBuilder, type SuggestionsQueryResult, Type, type TypeWithLiterals, listCustomFieldSuggestions, queryCustomFieldSuggestions };

...
import { ListCustomFieldSuggestionsOptions, ListCustomFieldSuggestionsResponse, SuggestionsQueryBuilder } from './index.typings.mjs';
export { CustomFieldSuggestion, ListCustomFieldSuggestionsRequest, Origin, OriginWithLiterals, Paging, PagingMetadata, Privacy, PrivacyWithLiterals, Query, QueryCustomFieldSuggestionsRequest, QueryCustomFieldSuggestionsResponse, SocialTypeType, SocialTypeTypeWithLiterals, SortOrder, SortOrderWithLiterals, Sorting, SuggestionsQueryResult, Type, TypeWithLiterals } from './index.typings.mjs';
...
interface ListCustomFieldSuggestionsSignature {
     ...
     */
    (options?: ListCustomFieldSuggestionsOptions): Promise<NonNullablePaths<ListCustomFieldSuggestionsResponse, `suggestions` | `suggestions.${number}.defaultPrivacy` | `suggestions.${number}.fieldType` | `suggestions.${number}.socialType` | `suggestions.${number}.fieldOrigin`, 4>>;
}

...
interface UpdateRefundTransactionSignature {
     ...
     * @param - Payment ID.
     */
    (orderId: string, refundId: string, options?: UpdateRefundTransactionOptions): Promise<void & {

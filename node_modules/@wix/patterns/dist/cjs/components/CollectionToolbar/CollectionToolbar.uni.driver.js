...
exports.CollectionToolbarUniDriver = void 0;
...
var _MultiLevelSortingCTAButtonUni = require("../MultiLevelSorting/MultiLevelSortingCTAButton.uni.driver");
var _ToolbarSecondaryActionsUni = require("./ToolbarSecondaryActions.uni.driver");
var _MoreActionsUni = require("../MoreActions/MoreActions.uni.driver");
const CollectionToolbarUniDriver = (base, body) => {
  ...
  const getMoreActions = (dataHook = 'toolbar-more-actions') => (0, _MoreActionsUni.MoreActionsUniDriver)(base, body).getMoreActions(dataHook);
  const getSecondaryActions = (index, dataHook) => (0, _ToolbarSecondaryActionsUni.ToolbarSecondaryActionsUniDriver)(base, body).getSecondaryActions(dataHook, index);
  const searchDriver = (0, _unidriver2.SearchUniDriver)(base.$('[data-hook="collection-search"]'), body);
  const filtersPanel = (0, _FiltersPanelUni.FiltersPanelUniDriver)(body.$(`[data-hook="cairo-modals-container"]`), body);
  const getSwitchButton = () => (0, _TableGridSwitchButtonUni.TableGridSwitchButtonUniDriver)(base.$('[data-hook="table-grid-switch-toggle-button"]'), body);
  const getSwitchButtonDivider = () => base.$('[data-hook="collection-table--grid-switch--divider"]');
  const getPrimaryActionButton = () => (0, _unidriver2.ButtonUniDriver)(base.$('[data-hook="toolbar-primary-action-button"]'), body);
  const getInputWithOptionsDriver = filterName => {
    ...
    const inputWithOptionsDriver = (0, _unidriver2.InputWithOptionsUniDriver)(inputWithOptionsBase, body);
    return (0, _CollectionDropdownFilterUni.CollectionDropdownFilterUniDriver)(inputWithOptionsDriver, dataHook, inputWithOptionsBase, body);
  };
  const isFiltersPanelOpen = () => filtersPanel.isOpen();
  const getMoreFiltersPanelButton = () => (0, _unidriver2.ButtonUniDriver)(base.$('[data-hook="more-filters-button"]'), body);
  ...
  const getToolbarFilterTitleAt = async index => {
    return base.$(`[data-hook="toolbar-item-filter-${index}"] [data-hook="table-toolbar-label"]`).text();
  };
  const getMultiLevelSortingButton = () => (0, _MultiLevelSortingCTAButtonUni.MultiLevelSortingCTAButtonUniDriver)(base, body, {
  ...
  const customColumnsPopover = () => (0, _CustomColumnsPanelUni.CustomColumnsPanelUniDriver)(modalsContainerBase(), body);
  const getMultiLevelSortingPanel = () => (0, _MultiLevelSortingPanelUni.MultiLevelSortingPanelUniDriver)(modalsContainerBase(), body);
  return {
    ...toolbar,
    ...
    getMoreFiltersButtonCounterValue: () => (0, _unidriver2.CounterBadgeUniDriver)(base.$('[data-hook="more-filters-button-counter"]'), body).getContentText(),
    ...
    waitSidePanelFullyOpened: () => {
      return (0, _unidriver.waitFor)(async () => (await slidingModalBase().attr('data-transition-status')) === 'entered');
    },
    waitSidePanelFullyClosed: () => {
      return (0, _unidriver.waitFor)(async () => (await slidingModalBase().attr('data-transition-status')) === 'exited');
    },
    /**
    ...
    getCustomColumnsButtonCounterValue: () => (0, _unidriver2.CounterBadgeUniDriver)(base.$('[data-hook="custom-columns-button-counter"]'), body).getContentText(),
    /**
     ...
     * Get tabs driver
     */
    getTabs: () => (0, _TabsFilterUni.default)(base.$('[data-hook="collection-tabs-filter"]'), body),
    /**
    ...
    getMultiLevelSortingButtonCounterValue: () => (0, _unidriver2.CounterBadgeUniDriver)(base.$('[data-hook="multi-level-sorting-button-counter"]'), body).getContentText(),
    /**
     ...
     */
    getShowTotal: () => (0, _unidriver2.CounterBadgeUniDriver)(base.$('[data-hook="toolbar-counter"]'), body).getContentText(),
    /**
     ...
     */
    getSubtitleLearnMoreButton: () => (0, _unidriver2.TextButtonUniDriver)(base.$('[data-hook="toolbar-subtitle-learn-more-cta"]'), body),
...
exports.CollectionToolbarUniDriver = CollectionToolbarUniDriver;

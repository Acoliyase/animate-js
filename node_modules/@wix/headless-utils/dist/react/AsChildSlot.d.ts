...
export interface AsChildSlot {
    ...
    /** Custom render function when using asChild */
    customElement?: React.ReactNode | React.ForwardRefRenderFunction<HTMLElement, any>;
...
export declare const AsChildSlot: React.ForwardRefExoticComponent<Omit<AsChildSlot, "ref"> & React.RefAttributes<HTMLElement>>;

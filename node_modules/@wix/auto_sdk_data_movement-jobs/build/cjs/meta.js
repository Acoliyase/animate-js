...
// src/hub-v1-job-movement-jobs.types.ts
...
// src/hub-v1-job-movement-jobs.meta.ts
function submitJob2() {
  const payload = {};
  const getRequestOptions = submitJob(payload);
...
function createFileUploadUrl2() {
  const payload = {};
  const getRequestOptions = createFileUploadUrl(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getJob2() {
  ...
  const getRequestOptions = getJob(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listJobs2() {
  const payload = {};
  const getRequestOptions = listJobs(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryJobs2() {
  const payload = {};
  const getRequestOptions = queryJobs(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function terminateJob2() {
  const payload = { jobId: ":jobId" };
  const getRequestOptions = terminateJob(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listMovementLogs2() {
  const payload = { jobId: ":jobId" };
  const getRequestOptions = listMovementLogs(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

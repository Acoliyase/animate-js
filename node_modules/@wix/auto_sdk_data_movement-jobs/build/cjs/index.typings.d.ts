...
interface JobsQueryBuilder {
     ...
     * @documentationMaturity preview
     */
    eq: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ne: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    ge: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    gt: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    le: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    lt: (propertyName: '_id' | 'startedAt' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `string`.
     * @param string - String to compare against. Case-insensitive.
     * @documentationMaturity preview
     */
    startsWith: (propertyName: '_id' | 'name' | 'scheduleId', value: string) => JobsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `values`.
     * @param values - List of values to compare against.
     * @documentationMaturity preview
     */
    hasSome: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId', value: any[]) => JobsQueryBuilder;
    /** @documentationMaturity preview */
    in: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId', value: any) => JobsQueryBuilder;
    /** @documentationMaturity preview */
    exists: (propertyName: '_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId', value: boolean) => JobsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    ascending: (...propertyNames: Array<'_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId'>) => JobsQueryBuilder;
    /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
     * @documentationMaturity preview
     */
    descending: (...propertyNames: Array<'_id' | 'startedAt' | 'status' | 'name' | 'finishedAt' | 'scheduleId'>) => JobsQueryBuilder;
 ...
 * @requiredField query
 */
declare function typedQueryJobs(query: CursorQuery): Promise<NonNullablePaths<QueryJobsResponse, `jobs` | `jobs.${number}.partiallySuccessfulOptions.cause` | `jobs.${number}._id` | `jobs.${number}.status` | `jobs.${number}.source.wixDataCollection.collectionId` | `jobs.${number}.source.file.format` | `jobs.${number}.source.file.fileId` | `jobs.${number}.source.file.url` | `jobs.${number}.destination.wixDataCollection.collectionId` | `jobs.${number}.destination.wixDataCollection.writePolicy` | `jobs.${number}.destination.file.format` | `jobs.${number}.destination.file.url` | `jobs.${number}.name` | `jobs.${number}.progress.current` | `jobs.${number}.progress.itemsRejected` | `jobs.${number}.progress.itemsSuccessful` | `jobs.${number}.error.code` | `jobs.${number}.error.description` | `jobs.${number}.sourceSiteId` | `jobs.${number}.destinationSiteId` | `jobs.${number}.logsRecorded`, 6>>;
/**

  ...
  createSpan(spanOptions, sentryOptionsOrPromise) {
    ...
    const maybePromise = runWithMaybePromise(
      ...
      ({ sentrySDK, scope }, isPromise2) => {
        ...
        promise == null ? void 0 : promise.catch((e) => {
          if ((e == null ? void 0 : e.message) !== (error == null ? void 0 : error.message)) {
            throw e;
          }
        });
      }
    ...
    const span = {
        ...
        endSpan(() => resolveSpan == null ? void 0 : resolveSpan());
      },
      fail: (_error) => {
        error = error != null ? error : _error;
        endSpan(() => rejectSpan == null ? void 0 : rejectSpan(_error));
      }
    };

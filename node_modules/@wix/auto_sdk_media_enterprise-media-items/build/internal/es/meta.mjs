...
// src/media-enterprise-public-media-v1-enterprise-item-enterprise-media-items.meta.ts
function itemUploadCallback2() {
  const payload = {};
  const getRequestOptions = itemUploadCallback(
    payload
  );
...
function generateFileUploadUrl2() {
  const payload = {};
  const getRequestOptions = generateFileUploadUrl(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function importFile2() {
  const payload = {};
  const getRequestOptions = importFile(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkImportFiles2() {
  const payload = {};
  const getRequestOptions = bulkImportFiles(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function searchItems2() {
  const payload = {};
  const getRequestOptions = searchItems(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function queryItems2() {
  const payload = {};
  const getRequestOptions = queryItems(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkUpdateItem2() {
  const payload = {};
  const getRequestOptions = bulkUpdateItem(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function linkItemToCategories2() {
  const payload = { itemId: ":itemId" };
  const getRequestOptions = linkItemToCategories(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function unlinkItemFromCategories2() {
  const payload = { itemId: ":itemId" };
  const getRequestOptions = unlinkItemFromCategories(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function overwriteItemCategories2() {
  const payload = { itemId: ":itemId" };
  const getRequestOptions = overwriteItemCategories(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
export {
  ...
  bulkUpdateItem2 as bulkUpdateItem,
  generateFileUploadUrl2 as generateFileUploadUrl,
  getItem2 as getItem,
  importFile2 as importFile,
  itemUploadCallback2 as itemUploadCallback,
  linkItemToCategories2 as linkItemToCategories,
  overwriteItemCategories2 as overwriteItemCategories,
  queryItems2 as queryItems,
  searchItems2 as searchItems,
  unlinkItemFromCategories2 as unlinkItemFromCategories,

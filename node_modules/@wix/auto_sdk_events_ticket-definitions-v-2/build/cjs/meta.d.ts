...
/** @enumType */
type PricingTypeEnumTypeWithLiterals = PricingTypeEnumType | 'UNKNOWN_PRICING_TYPE' | 'STANDARD' | 'DONATION';
...
/** @enumType */
type FeeTypeEnumTypeWithLiterals = FeeTypeEnumType | 'UNKNOWN_FEE_TYPE' | 'FEE_INCLUDED' | 'FEE_ADDED_AT_CHECKOUT' | 'NO_FEE';
...
interface SeatingDetails {
    ...
    seats?: AvailableSeat[];
    /**
     * List of available seated areas.
     * @maxSize 1000
     */
    areas?: AvailableArea[];
}
...
declare function createTicketDefinition(): __PublicMethodMetaInfo<'POST', {}, CreateTicketDefinitionRequest$1, CreateTicketDefinitionRequest, CreateTicketDefinitionResponse$1, CreateTicketDefinitionResponse>;
declare function updateTicketDefinition(): __PublicMethodMetaInfo<'PATCH', {
    ticketDefinitionId: string;
}, UpdateTicketDefinitionRequest$1, UpdateTicketDefinitionRequest, UpdateTicketDefinitionResponse$1, UpdateTicketDefinitionResponse>;
declare function getTicketDefinition(): __PublicMethodMetaInfo<'GET', {
    ticketDefinitionId: string;
}, GetTicketDefinitionRequest$1, GetTicketDefinitionRequest, GetTicketDefinitionResponse$1, GetTicketDefinitionResponse>;
declare function deleteTicketDefinition(): __PublicMethodMetaInfo<'DELETE', {
    ticketDefinitionId: string;
}, DeleteTicketDefinitionRequest$1, DeleteTicketDefinitionRequest, DeleteTicketDefinitionResponse$1, DeleteTicketDefinitionResponse>;
...
declare function queryAvailableTicketDefinitions(): __PublicMethodMetaInfo<'POST', {}, QueryAvailableTicketDefinitionsRequest$1, QueryAvailableTicketDefinitionsRequest, QueryAvailableTicketDefinitionsResponse$1, QueryAvailableTicketDefinitionsResponse>;
declare function countTicketDefinitions(): __PublicMethodMetaInfo<'POST', {}, CountTicketDefinitionsRequest$1, CountTicketDefinitionsRequest, CountTicketDefinitionsResponse$1, CountTicketDefinitionsResponse>;
declare function countAvailableTicketDefinitions(): __PublicMethodMetaInfo<'POST', {}, CountAvailableTicketDefinitionsRequest$1, CountAvailableTicketDefinitionsRequest, CountAvailableTicketDefinitionsResponse$1, CountAvailableTicketDefinitionsResponse>;

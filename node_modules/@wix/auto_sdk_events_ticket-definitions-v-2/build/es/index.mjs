...
var onTicketDefinitionDeleted2 = createEventModule(
  onTicketDefinitionDeleted
);
var onTicketDefinitionSaleEnded2 = createEventModule(
  onTicketDefinitionSaleEnded
);
var onTicketDefinitionSalePeriodUpdated2 = createEventModule(
  onTicketDefinitionSalePeriodUpdated
);
var onTicketDefinitionSaleStarted2 = createEventModule(
  onTicketDefinitionSaleStarted
);
var onTicketDefinitionUpdated2 = createEventModule(

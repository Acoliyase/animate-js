 ...
 */
declare function reorderTicketDefinitions(eventId: string, options?: NonNullablePaths<ReorderTicketDefinitionsOptions, `ticketDefinitionId`, 2>): Promise<void & {
...
interface TicketDefinitionsQueryBuilder {
     ...
     * @param value - Value to compare against.
     */
    ge: (propertyName: '_id' | 'eventId' | 'revision' | '_createdDate' | '_updatedDate' | 'name' | 'description' | 'initialLimit' | 'pricingMethod.fixedPrice.value' | 'pricingMethod.fixedPrice.currency', value: any) => TicketDefinitionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    gt: (propertyName: '_id' | 'eventId' | 'revision' | '_createdDate' | '_updatedDate' | 'name' | 'description' | 'initialLimit' | 'pricingMethod.fixedPrice.value' | 'pricingMethod.fixedPrice.currency', value: any) => TicketDefinitionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    le: (propertyName: '_id' | 'eventId' | 'revision' | '_createdDate' | '_updatedDate' | 'name' | 'description' | 'initialLimit' | 'pricingMethod.fixedPrice.value' | 'pricingMethod.fixedPrice.currency', value: any) => TicketDefinitionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     */
    lt: (propertyName: '_id' | 'eventId' | 'revision' | '_createdDate' | '_updatedDate' | 'name' | 'description' | 'initialLimit' | 'pricingMethod.fixedPrice.value' | 'pricingMethod.fixedPrice.currency', value: any) => TicketDefinitionsQueryBuilder;
 ...
 */
declare function changeCurrency(eventId: string, options: NonNullablePaths<ChangeCurrencyOptions, `currency`, 2>): Promise<void & {

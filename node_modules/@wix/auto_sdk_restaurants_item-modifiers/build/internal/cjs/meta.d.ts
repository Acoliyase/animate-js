...
declare function createModifier(): __PublicMethodMetaInfo<'POST', {}, CreateModifierRequest$1, CreateModifierRequest, CreateModifierResponse$1, CreateModifierResponse>;
declare function getModifier(): __PublicMethodMetaInfo<'GET', {
    modifierId: string;
}, GetModifierRequest$1, GetModifierRequest, GetModifierResponse$1, GetModifierResponse>;
declare function listModifiers(): __PublicMethodMetaInfo<'GET', {}, ListModifiersRequest$1, ListModifiersRequest, ListModifiersResponse$1, ListModifiersResponse>;
declare function updateModifier(): __PublicMethodMetaInfo<'PATCH', {
    modifierId: string;
}, UpdateModifierRequest$1, UpdateModifierRequest, UpdateModifierResponse$1, UpdateModifierResponse>;
declare function bulkCreateModifiers(): __PublicMethodMetaInfo<'POST', {}, BulkCreateModifiersRequest$1, BulkCreateModifiersRequest, BulkCreateModifiersResponse$1, BulkCreateModifiersResponse>;
declare function bulkUpdateModifiers(): __PublicMethodMetaInfo<'POST', {}, BulkUpdateModifiersRequest$1, BulkUpdateModifiersRequest, BulkUpdateModifiersResponse$1, BulkUpdateModifiersResponse>;
declare function deleteModifier(): __PublicMethodMetaInfo<'DELETE', {
    modifierId: string;
}, DeleteModifierRequest$1, DeleteModifierRequest, DeleteModifierResponse$1, DeleteModifierResponse>;
declare function queryModifiers(): __PublicMethodMetaInfo<'POST', {}, QueryModifiersRequest$1, QueryModifiersRequest, QueryModifiersResponse$1, QueryModifiersResponse>;

...
interface CountModifiersSignature {
     ...
     */
    (options?: CountModifiersOptions): Promise<NonNullablePaths<CountModifiersResponse, `count`, 2> & {
...
interface BulkDeleteModifiersSignature {
     ...
     */
    (ids: string[]): Promise<NonNullablePaths<BulkDeleteModifiersResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}
declare const onItemModifierCreated$1: EventDefinition<ItemModifierCreatedEnvelope, "wix.restaurants.menus.v1.item_modifier_created">;
...
declare const updateModifier: MaybeContext<BuildRESTFunction<typeof updateModifier$1> & typeof updateModifier$1>;
...
/** */
declare const onItemModifierDeleted: BuildEventDefinition<typeof onItemModifierDeleted$1> & typeof onItemModifierDeleted$1;
/** */

import { CreateRefundRequest as CreateRefundRequest$1, CreateRefundResponse as CreateRefundResponse$1, GetRefundRequest as GetRefundRequest$1, GetRefundResponse as GetRefundResponse$1, QueryRefundsRequest as QueryRefundsRequest$1, QueryRefundsResponse as QueryRefundsResponse$1 } from './index.typings.mjs';
...
/** @enumType */
type StatusWithLiterals = Status | 'UNKNOWN_STATUS' | 'PENDING' | 'SUCCEEDED' | 'FAILED' | 'REVERSED';
...
declare function createRefund(): __PublicMethodMetaInfo<'POST', {}, CreateRefundRequest$1, CreateRefundRequest, CreateRefundResponse$1, CreateRefundResponse>;
declare function getRefund(): __PublicMethodMetaInfo<'GET', {
    refundId: string;
}, GetRefundRequest$1, GetRefundRequest, GetRefundResponse$1, GetRefundResponse>;
declare function queryRefunds(): __PublicMethodMetaInfo<'POST', {}, QueryRefundsRequest$1, QueryRefundsRequest, QueryRefundsResponse$1, QueryRefundsResponse>;

export { type __PublicMethodMetaInfo, createRefund, getRefund, queryRefunds };

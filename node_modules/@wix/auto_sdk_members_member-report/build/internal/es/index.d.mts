...
import { MemberReport, ReportMemberResponse, ReportMemberApplicationErrors, MemberReportsQueryBuilder, ListReportedMembersOptions, ListReportedMembersResponse, QueryReportedMembersOptions, QueryReportedMembersResponse, DeleteMemberReportsApplicationErrors, MemberReportCreatedEnvelope, MemberReportDeletedEnvelope, MemberReportReportedMemberCreatedEnvelope, MemberReportReportedMemberDeletedEnvelope } from './index.typings.mjs';
export { ActionEvent, BaseEventMetadata, CannotReportBlockedMemberError, Category, CategoryWithLiterals, CursorPaging, Cursors, DeleteMemberReportsRequest, DeleteMemberReportsResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, IdentificationData, IdentificationDataIdOneOf, ListReportedMembersOptionsPagingMethodOneOf, ListReportedMembersRequest, ListReportedMembersRequestPagingMethodOneOf, MarkMemberReportsAsReviewedRequest, MarkMemberReportsAsReviewedResponse, MemberReportsQueryResult, MessageEnvelope, Paging, PagingMetadataV2, QueryMemberReportsRequest, QueryMemberReportsResponse, QueryReportedMembersRequest, QueryV2, Reason, ReportMemberRequest, ReportedMember, ReportedMemberCreated, ReportedMemberDeleted, RestoreInfo, SelfReportingForbiddenError, SortOrder, SortOrderWithLiterals, Sorting, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface ReportMemberSignature {
     ...
     */
    (memberReport: NonNullablePaths<MemberReport, `reason` | `reportedMemberId`, 2>): Promise<NonNullablePaths<ReportMemberResponse, `memberReport.reportedMemberId` | `memberReport.reason.category`, 4> & {

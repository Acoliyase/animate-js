...
interface GetMemberPrivacySettingsSignature {
     ...
     */
    (): Promise<NonNullablePaths<GetMemberPrivacySettingsResponse, `memberPrivacySettings.publicMemberVisibility` | `memberPrivacySettings.publicMemberCandidates`, 3>>;
}
...
interface SetMemberPrivacySettingsSignature {
     ...
     */
    (memberPrivacySettings: NonNullablePaths<MemberPrivacySettings, `revision`, 2>): Promise<NonNullablePaths<SetMemberPrivacySettingsResponse, `memberPrivacySettings.publicMemberVisibility` | `memberPrivacySettings.publicMemberCandidates`, 3> & {

...
// src/bookings-availability-v2-time-slot-availability-time-slots.public.ts
function listAvailabilityTimeSlots3(httpClient) {
  return (options) => listAvailabilityTimeSlots2(
    options,
    // @ts-ignore
    { httpClient }
  );
...
var listAvailabilityTimeSlots4 = /* @__PURE__ */ createRESTModule(listAvailabilityTimeSlots3);
var getAvailabilityTimeSlot4 = /* @__PURE__ */ createRESTModule(getAvailabilityTimeSlot3);
export {
  LocationType,
  getAvailabilityTimeSlot4 as getAvailabilityTimeSlot,
  listAvailabilityTimeSlots4 as listAvailabilityTimeSlots
};

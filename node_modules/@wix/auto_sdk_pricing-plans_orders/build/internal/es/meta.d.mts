...
/** @enumType */
type OrderTypeWithLiterals = OrderType | 'UNDEFINED' | 'ONLINE' | 'OFFLINE' | 'EXTERNAL';
...
/** @enumType */
type OrderMethodWithLiterals = OrderMethod | 'UNKNOWN' | 'MOTO' | 'POS';
...
/** @enumType */
type OrderStatusWithLiterals = OrderStatus | 'UNDEFINED' | 'DRAFT' | 'PENDING' | 'ACTIVE' | 'PAUSED' | 'ENDED' | 'CANCELED';
...
/** @enumType */
type CancellationCauseWithLiterals = CancellationCause | 'UNDEFINED' | 'OWNER_ACTION' | 'MEMBER_ACTION' | 'PAYMENT_FAILURE' | 'PAYMENT_SETUP_FAILURE' | 'UNKNOWN';
...
/** @enumType */
type CancellationEffectiveAtWithLiterals = CancellationEffectiveAt | 'UNDEFINED' | 'IMMEDIATELY' | 'NEXT_PAYMENT_DATE';
...
/** @enumType */
type PaymentStatusWithLiterals = PaymentStatus | 'UNDEFINED' | 'PAID' | 'REFUNDED' | 'FAILED' | 'UNPAID' | 'PENDING' | 'NOT_APPLICABLE';
...
declare function managementListOrders(): __PublicMethodMetaInfo<'GET', {}, ListOrdersRequest$1, ListOrdersRequest, ListOrdersResponse$1, ListOrdersResponse>;
declare function postponeEndDate(): __PublicMethodMetaInfo<'PATCH', {
    id: string;
}, PostponeEndDateRequest$1, PostponeEndDateRequest, PostponeEndDateResponse$1, PostponeEndDateResponse>;
...
declare function markAsPaid(): __PublicMethodMetaInfo<'POST', {
    id: string;
}, MarkAsPaidRequest$1, MarkAsPaidRequest, MarkAsPaidResponse$1, MarkAsPaidResponse>;
declare function pauseOrder(): __PublicMethodMetaInfo<'POST', {
    id: string;
}, PauseOrderRequest$1, PauseOrderRequest, PauseOrderResponse$1, PauseOrderResponse>;

...
// src/pricing-plans-v2-order-orders.http.ts
...
async function memberGetOrder2(_id, options) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = renameKeysFromSDKRequestToRESTRequest({
    id: _id,
    fieldSet: options?.fieldSet
  });
  const reqOpts = memberGetOrder(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function memberListOrders2(options) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({
    planIds: options?.planIds,
    autoRenewCanceled: options?.autoRenewCanceled,
  ...
  const reqOpts = memberListOrders(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function requestCancellation2(_id, effectiveAt) {
  const { httpClient, sideEffects } = arguments[2];
  const payload = renameKeysFromSDKRequestToRESTRequest({
    id: _id,
    effectiveAt
  });
  const reqOpts = requestCancellation(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
function managementListOrders3(httpClient) {
  return (options) => managementListOrders2(
    options,
    // @ts-ignore
    { httpClient }
  );
}
function postponeEndDate3(httpClient) {
  return (_id, endDate) => postponeEndDate2(
    _id,
    endDate,
    // @ts-ignore
    { httpClient }
...
function cancelOrder3(httpClient) {
  return (_id, effectiveAt) => cancelOrder2(
    _id,
    effectiveAt,
    // @ts-ignore
    { httpClient }
...
function markAsPaid3(httpClient) {
  return (_id) => markAsPaid2(
    _id,
    // @ts-ignore
    { httpClient }
  );
}
function pauseOrder3(httpClient) {
  return (_id) => pauseOrder2(
    _id,
    // @ts-ignore
    { httpClient }
  );
}
function resumeOrder3(httpClient) {
  return (_id) => resumeOrder2(
    _id,
    // @ts-ignore
    { httpClient }
  );
...
function memberListOrders3(httpClient) {
  return (options) => memberListOrders2(
    options,
    // @ts-ignore
    { httpClient }
  );
}
function requestCancellation3(httpClient) {
  return (_id, effectiveAt) => requestCancellation2(
    _id,
    effectiveAt,
    // @ts-ignore
    { httpClient }
...
var onOrderAutoRenewCanceled = EventDefinition(
...
var onOrderCycleStarted = EventDefinition(
...
var onOrderEndDatePostponed = EventDefinition(
...
var onOrderEnded = EventDefinition(
...
var onOrderMarkedAsPaid = EventDefinition(
...
var onOrderPaused = EventDefinition(
...
var onOrderPurchased = EventDefinition(
...
var onOrderResumed = EventDefinition(
...
var onOrderStarted = EventDefinition(
...
var onOrderStartDateChanged = EventDefinition(
...
var managementGetOrder4 = /* @__PURE__ */ createRESTModule(managementGetOrder3);
var managementListOrders4 = /* @__PURE__ */ createRESTModule(managementListOrders3);
var postponeEndDate4 = /* @__PURE__ */ createRESTModule(postponeEndDate3);
var cancelOrder4 = /* @__PURE__ */ createRESTModule(cancelOrder3);
var markAsPaid4 = /* @__PURE__ */ createRESTModule(markAsPaid3);
var pauseOrder4 = /* @__PURE__ */ createRESTModule(pauseOrder3);
var resumeOrder4 = /* @__PURE__ */ createRESTModule(resumeOrder3);
var memberGetOrder4 = /* @__PURE__ */ createRESTModule(memberGetOrder3);
var memberListOrders4 = /* @__PURE__ */ createRESTModule(memberListOrders3);
var requestCancellation4 = /* @__PURE__ */ createRESTModule(requestCancellation3);
var createOnlineOrder4 = /* @__PURE__ */ createRESTModule(createOnlineOrder3);
var createOfflineOrder4 = /* @__PURE__ */ createRESTModule(createOfflineOrder3);
var getOnlineOrderPreview4 = /* @__PURE__ */ createRESTModule(getOnlineOrderPreview3);
var getOfflineOrderPreview4 = /* @__PURE__ */ createRESTModule(getOfflineOrderPreview3);
var getPricePreview4 = /* @__PURE__ */ createRESTModule(getPricePreview3);
var onOrderAutoRenewCanceled2 = createEventModule(
  onOrderAutoRenewCanceled
);
var onOrderCanceled2 = createEventModule(onOrderCanceled);
var onOrderCycleStarted2 = createEventModule(
  onOrderCycleStarted
);
var onOrderEndDatePostponed2 = createEventModule(
  onOrderEndDatePostponed
);
var onOrderEnded2 = createEventModule(onOrderEnded);
var onOrderMarkedAsPaid2 = createEventModule(
  onOrderMarkedAsPaid
);
var onOrderPaused2 = createEventModule(onOrderPaused);
var onOrderPurchased2 = createEventModule(onOrderPurchased);
var onOrderResumed2 = createEventModule(onOrderResumed);
var onOrderStarted2 = createEventModule(onOrderStarted);
var onOrderUpdated2 = createEventModule(onOrderUpdated);
var onOrderCreated2 = createEventModule(onOrderCreated);
var onOrderStartDateChanged2 = createEventModule(
...
export {
  ...
  createOfflineOrder4 as createOfflineOrder,
  createOnlineOrder4 as createOnlineOrder,
  getOfflineOrderPreview4 as getOfflineOrderPreview,
  getOnlineOrderPreview4 as getOnlineOrderPreview,
  getPricePreview4 as getPricePreview,
  managementGetOrder4 as managementGetOrder,
  managementListOrders4 as managementListOrders,
  markAsPaid4 as markAsPaid,
  memberGetOrder4 as memberGetOrder,
  memberListOrders4 as memberListOrders,
  onOrderAutoRenewCanceled2 as onOrderAutoRenewCanceled,
  onOrderCanceled2 as onOrderCanceled,
  onOrderCreated2 as onOrderCreated,
  onOrderCycleStarted2 as onOrderCycleStarted,
  onOrderEndDatePostponed2 as onOrderEndDatePostponed,
  onOrderEnded2 as onOrderEnded,
  onOrderMarkedAsPaid2 as onOrderMarkedAsPaid,
  onOrderPaused2 as onOrderPaused,
  onOrderPurchased2 as onOrderPurchased,
  onOrderResumed2 as onOrderResumed,
  onOrderStartDateChanged2 as onOrderStartDateChanged,
  onOrderStarted2 as onOrderStarted,
  onOrderUpdated2 as onOrderUpdated,
  pauseOrder4 as pauseOrder,
  postponeEndDate4 as postponeEndDate,
  requestCancellation4 as requestCancellation,
  resumeOrder4 as resumeOrder
};

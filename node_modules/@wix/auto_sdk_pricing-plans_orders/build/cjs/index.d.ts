 ...
 */
declare const onOrderCycleStarted: BuildEventDefinition<typeof onOrderCycleStarted$1> & typeof onOrderCycleStarted$1;
/**
 * Triggered when an order's `endDate` is postponed.
 */
declare const onOrderEndDatePostponed: BuildEventDefinition<typeof onOrderEndDatePostponed$1> & typeof onOrderEndDatePostponed$1;
/**
 ...
 */
declare const onOrderEnded: BuildEventDefinition<typeof onOrderEnded$1> & typeof onOrderEnded$1;
/**
 * Triggered when an offline order is marked as paid.
 */
declare const onOrderMarkedAsPaid: BuildEventDefinition<typeof onOrderMarkedAsPaid$1> & typeof onOrderMarkedAsPaid$1;
/**
 * Triggered when an order is paused.
 */
declare const onOrderPaused: BuildEventDefinition<typeof onOrderPaused$1> & typeof onOrderPaused$1;
/**
 ...
 */
declare const onOrderPurchased: BuildEventDefinition<typeof onOrderPurchased$1> & typeof onOrderPurchased$1;
/**
 * Triggered when a paused order is resumed.
 */
declare const onOrderResumed: BuildEventDefinition<typeof onOrderResumed$1> & typeof onOrderResumed$1;
/**

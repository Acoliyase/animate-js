...
__export(meta_exports, {
  ...
  EventStatusOriginal: () => EventStatus,
  EventTypeOriginal: () => EventType,
  ...
  InputControlTypeOriginal: () => InputControlType,
  ...
  RegistrationStatusOriginal: () => RegistrationStatus,
  ...
  VisitorTypeOriginal: () => VisitorType,
  VoteRoleOriginal: () => VoteRole,
  WebhookIdentityTypeOriginal: () => WebhookIdentityType,
  WidthOriginal: () => Width,
  WidthTypeOriginal: () => WidthType,
  bulkDeleteRsvpsByFilter: () => bulkDeleteRsvpsByFilter2,
  bulkUpdateRsvps: () => bulkUpdateRsvps2,
  cancelRsvpGuestsCheckIn: () => cancelRsvpGuestsCheckIn2,
  checkInRsvpGuests: () => checkInRsvpGuests2,
  countRsvps: () => countRsvps2,
  createRsvp: () => createRsvp2,
  deleteRsvp: () => deleteRsvp2,
  getRsvp: () => getRsvp2,
  listRsvpSummary: () => listRsvpSummary2,
  queryRsvps: () => queryRsvps2,
  searchRsvps: () => searchRsvps2,
  updateRsvp: () => updateRsvp2
});
...
// src/events-v2-rsvp-rsvp-v-2.types.ts
...
// src/events-v2-rsvp-rsvp-v-2.meta.ts
function searchRsvps2() {
  const payload = {};
  const getRequestOptions = searchRsvps(payload);
...
function queryRsvps2() {
  const payload = {};
  const getRequestOptions = queryRsvps(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function countRsvps2() {
  const payload = {};
  const getRequestOptions = countRsvps(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getRsvp2() {
  const payload = { rsvpId: ":rsvpId" };
  const getRequestOptions = getRsvp(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "GET",
    path: "/v2/rsvps/{rsvpId}",
    pathParams: { rsvpId: "rsvpId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
    __originalResponseType: null
...
function createRsvp2() {
  const payload = {};
  const getRequestOptions = createRsvp(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateRsvp2() {
  const payload = { rsvp: { id: ":rsvpId" } };
  const getRequestOptions = updateRsvp(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteRsvp2() {
  const payload = { rsvpId: ":rsvpId" };
  const getRequestOptions = deleteRsvp(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkUpdateRsvps2() {
  const payload = {};
  const getRequestOptions = bulkUpdateRsvps(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkDeleteRsvpsByFilter2() {
  const payload = {};
  const getRequestOptions = bulkDeleteRsvpsByFilter(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/bulk/rsvps/delete-by-filter",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function checkInRsvpGuests2() {
  const payload = { rsvpId: ":rsvpId" };
  const getRequestOptions = checkInRsvpGuests(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function cancelRsvpGuestsCheckIn2() {
  const payload = { rsvpId: ":rsvpId" };
  const getRequestOptions = cancelRsvpGuestsCheckIn(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v2/rsvps/{rsvpId}/cancel-check-in",
    pathParams: { rsvpId: "rsvpId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
function listRsvpSummary2() {
  const payload = {};
  const getRequestOptions = listRsvpSummary(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

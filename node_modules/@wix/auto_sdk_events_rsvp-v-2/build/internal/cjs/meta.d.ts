import { b8 as SearchRsvpsRequest$1, a as SearchRsvpsResponse$1, bT as QueryRsvpsRequest$1, bW as QueryRsvpsResponse$1, bX as CountRsvpsRequest$1, c as CountRsvpsResponse$1, bY as GetRsvpRequest$1, bZ as GetRsvpResponse$1, b_ as CreateRsvpRequest$1, c0 as CreateRsvpResponse$1, c3 as UpdateRsvpRequest$1, c4 as UpdateRsvpResponse$1, c5 as DeleteRsvpRequest$1, c6 as DeleteRsvpResponse$1, c7 as BulkUpdateRsvpsRequest$1, i as BulkUpdateRsvpsResponse$1, cc as BulkDeleteRsvpsByFilterRequest$1, l as BulkDeleteRsvpsByFilterResponse$1, cd as CheckInRsvpGuestsRequest$1, o as CheckInRsvpGuestsResponse$1, ce as CancelRsvpGuestsCheckInRequest$1, r as CancelRsvpGuestsCheckInResponse$1, cf as ListRsvpSummaryRequest$1, L as ListRsvpSummaryResponse$1 } from './events-v2-rsvp-rsvp-v-2.universal-BSHsxbeg.js';
...
/** @enumType */
type RsvpStatusWithLiterals = RsvpStatus | 'UNKNOWN_RSVP_STATUS' | 'YES' | 'NO' | 'WAITLIST';
interface GuestList {
    /**
     * List of guests.
     * @maxSize 11
...
interface LimitedRsvpSpotsReleased {
    /**
     * Event ID.
     * @format GUID
     */
    eventId?: string | null;
    /** Number of spots released. */
    spotsReleased?: number | null;
}
interface RsvpsBalanceUpdated {
    /** Current event rsvp balance */
    rsvpSummary?: V2RsvpSummary;
    /** Balance change that occurred */
    balanceDelta?: RsvpBalanceDelta;
    /** Event RSVP guest limit */
...
interface RsvpBalanceDelta {
    /** YES count change */
    yesDelta?: number;
    /** NO count change */
    noDelta?: number;
    /** Waitlist count change */
    waitlistDelta?: number;
    /** RSVP count change */
    totalRsvpDelta?: number;
}
...
declare enum SortOrder {
    /** Sort is in the ascending order. */
    ASC = "ASC",
...
interface ValueAggregation extends ValueAggregationOptionsOneOf {
     ...
     */
    limit?: number | null;
    /** Whether to include or exclude missing values from the aggregation results. <br><br> Default: `EXCLUDE`. */
...
/** @enumType */
type RequestedFieldsWithLiterals = RequestedFields | 'UNKNOWN_REQUESTED_FIELD' | 'DETAILS' | 'FORM' | 'CONTACT_DETAILS';
...
interface ModificationOptions {
    ...
    /** Whether to ignore the response status. */
...
interface GuestLimitExceededData {
    /** Maximum size of RSVP guest list. */
    maxRsvpSize?: number;
}
...
interface BulkUpdateRsvpsRequest {
    /**
     * RSVPs to update.
     * @minSize 1
     * @maxSize 100
...
interface BulkUpdateRsvpsResponse {
    /**
...
interface BulkDeleteRsvpsByFilterResponse {
    /**
     * Job ID. Call Get Async Job ([SDK](https://dev.wix.com/docs/sdk/backend-modules/async-jobs/get-async-job) | [REST](https://dev.wix.com/docs/rest/business-management/async-job/get-async-job)) with this ID to retrieve the job details and metadata.
     * @format GUID
     */
    jobId?: string;
}
...
interface ListRsvpSummaryRequest {
    /**
     * Event ID to retrieve the RSVP summary for.
     * @format GUID
     * @minSize 1
     * @maxSize 100
     */
...
/** @docsIgnore */
type CreateRsvpApplicationErrors = {
    ...
    code?: 'RSVP_LIMIT_EXCEEDED';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'GUEST_LIMIT_EXCEEDED';
    description?: string;
    data?: GuestLimitExceededData;
} | {
    code?: 'RSVPS_CLOSED';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'RSVPS_NOT_STARTED';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'WAITING_LIST_UNAVAILABLE';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'MEMBER_EMAIL_ALREADY_REGISTERED';
    description?: string;
    data?: Record<string, any>;
} | {
    code?: 'ADDITIONAL_GUESTS_MUST_HAVE_NAMES';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type UpdateRsvpApplicationErrors = {
...
/** @docsIgnore */
type BulkUpdateRsvpsApplicationErrors = {
    code?: 'RSVP_NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
} | {
...
/** @docsIgnore */
type BulkDeleteRsvpsByFilterApplicationErrors = {
    code?: 'EMPTY_FILTER';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type CheckInRsvpGuestsApplicationErrors = {
...
/** @docsIgnore */
type CancelRsvpGuestsCheckInApplicationErrors = {
    code?: 'GUEST_NOT_FOUND';
    description?: string;
    data?: Record<string, any>;
} | {

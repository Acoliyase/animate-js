...
declare function registerCommentsWidget(): __PublicMethodMetaInfo<'POST', {}, RegisterCommentsWidgetRequest$1, RegisterCommentsWidgetRequest, RegisterCommentsWidgetResponse$1, RegisterCommentsWidgetResponse>;
declare function queryCommentsWidgetResources(): __PublicMethodMetaInfo<'POST', {}, QueryCommentsWidgetResourcesRequest$1, QueryCommentsWidgetResourcesRequest, QueryCommentsWidgetResourcesResponse$1, QueryCommentsWidgetResourcesResponse>;
declare function createCommentsWidget(): __PublicMethodMetaInfo<'POST', {}, CreateCommentsWidgetRequest$1, CreateCommentsWidgetRequest, CreateCommentsWidgetResponse$1, CreateCommentsWidgetResponse>;
declare function getCommentsWidget(): __PublicMethodMetaInfo<'GET', {
    commentsWidgetId: string;
}, GetCommentsWidgetRequest$1, GetCommentsWidgetRequest, GetCommentsWidgetResponse$1, GetCommentsWidgetResponse>;
declare function updateCommentsWidget(): __PublicMethodMetaInfo<'PATCH', {
    commentsWidgetId: string;
}, UpdateCommentsWidgetRequest$1, UpdateCommentsWidgetRequest, UpdateCommentsWidgetResponse$1, UpdateCommentsWidgetResponse>;
declare function deleteCommentsWidget(): __PublicMethodMetaInfo<'DELETE', {
    commentsWidgetId: string;
}, DeleteCommentsWidgetRequest$1, DeleteCommentsWidgetRequest, DeleteCommentsWidgetResponse$1, DeleteCommentsWidgetResponse>;

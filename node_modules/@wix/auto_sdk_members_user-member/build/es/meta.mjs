...
// src/members-usermembers-v1-user-member-user-member.types.ts
...
// src/members-usermembers-v1-user-member-user-member.meta.ts
function queryUserMembers2() {
  const payload = {};
  const getRequestOptions = queryUserMembers(payload);
...
export {
  ...
  queryUserMembers2 as queryUserMembers
};

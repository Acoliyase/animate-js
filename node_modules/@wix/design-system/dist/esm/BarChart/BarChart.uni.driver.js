import { baseUniDriverFactory, findByHook, findByHookAtIndex, countByHook, } from '../utils/test-utils/unidriver';
import DataHooks from './dataHooks';
import { tooltipDriverFactory } from '../Tooltip/Tooltip.uni.driver';
import { adaptiveHeadingDriverFactory } from '../common/AdaptiveHeading/AdaptiveHeading.uni.driver';
const barChartDriverFactory = (base, body) => {
    ...
    return {
         ...
         * @return {Promise<string>}
         */
        getValueInShort: async (index) => (await getAdaptiveHeadingDriver(index)).getShortText(),
        /**
         * Gets item description by index
         * @param index Item index
         * @return {Promise<string>}
         */
        getDescription: async (index) => findByHook(await findByHookAtIndex(base, DataHooks.bar, index), DataHooks.description).text(),
        /**

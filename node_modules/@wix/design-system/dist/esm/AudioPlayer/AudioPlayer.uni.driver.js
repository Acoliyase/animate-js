...
export const audioPlayerDriverFactory = (base, body) => {
    const playPauseButtonDriver = iconButtonDriverFactory(findByHook(base, dataHooks.audioPlayerPlayPause));
    const timeIndicatorDriver = headingUniDriverFactory(findByHook(base, dataHooks.audioTimeIndicator));
    return {
...
//# sourceMappingURL=AudioPlayer.uni.driver.js.map
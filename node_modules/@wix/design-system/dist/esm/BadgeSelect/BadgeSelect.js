...
class BadgeSelect extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Popover, { shown: visible, dataHook: dataHook, placement: "bottom", onKeyDown: this._onKeyDown, onClickOutside: this.hideDropdown, ...popoverProps, className: classes.root },
            React.createElement(Popover.Element, null,
                React.createElement(Badge, { ref: badge => (this.badge = badge), type: type, size: size, uppercase: uppercase, suffixIcon: React.createElement(ChevronDownSmall, null), skin: this.state.selectedBadge.skin, onClick: this.toggleDropdown, dataHook: DATA_ATTR.DATA_BADGE }, this.state.selectedBadge.text)),
            React.createElement(Popover.Content, null,
                React.createElement(DropdownLayout, { ref: r => (this.dropdownLayout = r), dataHook: DATA_ATTR.DATA_DROPDOWN, visible: true, selectedId: selectedBadge.id, options: this.options, onSelect: this._handleSelect, onClose: this.hideDropdown, inContainer: true }))));
    }
}

...
export const avatarUniDriverFactory = base => {
    const getIndication = () => iconButtonDriverFactory(findByHook(base, dataHooks.indication));
    const getLoader = () => loaderUniDriverFactory(findByHook(base, dataHooks.loader));
    const getCustomIndication = () => iconButtonDriverFactory(findByHook(base, dataHooks.customIndication));
    return {
         ...
         */
        getTextContent: async () => await findByHook(base, dataHooks.textContainer).text(),
        /**
...
//# sourceMappingURL=Avatar.uni.driver.js.map
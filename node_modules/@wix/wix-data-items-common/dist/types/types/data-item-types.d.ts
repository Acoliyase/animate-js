...
export interface QueryDataItemsRequest extends QueryDataItemsRequestSortModeOptionsOneOf {
...
/** @oneof */
export interface QueryDataItemsRequestSortModeOptionsOneOf {
    /** Additional options for random sorting. */
    randomOptions?: RandomOptions;
}
...
export declare enum SortMode {
    ...
    UNKNOWN_SORT_MODE = "UNKNOWN_SORT_MODE",

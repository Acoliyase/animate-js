...
import { Provider, WixDataAggregateOptions, WixDataBulkResult, WixDataItem, WixDataItemOrId, WixDataOptions, WixDataRemoveOptions, WixDataQueryReferencedOptions, WixDataReadOptions, WixDataReadWithProjectionOptions, WixDataReference, WixDataUpdateOptions, WixDataBulkUpdateOptions, WixDataSaveOptions } from './types';
...
export declare class WixDataApi {
    ...
    save: (collectionName: string, item: Partial<WixDataItem>, options?: WixDataSaveOptions | undefined) => Promise<WixDataItem>;
    update: (collectionName: string, item: WixDataItem, options?: WixDataUpdateOptions | undefined) => Promise<WixDataItem>;
    remove: (collectionName: string, itemId: string, options?: WixDataRemoveOptions | undefined) => Promise<WixDataItem | null>;
    ...
    aggregatePipeline: (collectionName: string, pipeline: apiTypes.AggregationPipeline, options?: WixDataAggregateOptions | undefined) => Promise<apiTypes.AggregatePipelineDataItemsResponse>;
    ...
    bulkUpdate: (collectionName: string, items: WixDataItem[], options?: WixDataBulkUpdateOptions | undefined) => Promise<WixDataBulkResult>;

 ...
 * @requiredField query
 */
declare function typedQueryBrands(query: CursorQuery, options?: QueryBrandsOptions): Promise<NonNullablePaths<QueryBrandsResponse, `brands` | `brands.${number}.name`, 4>>;
/**

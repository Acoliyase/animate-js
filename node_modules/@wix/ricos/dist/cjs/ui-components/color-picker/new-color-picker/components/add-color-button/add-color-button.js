...
var add_color_button_exports = {};
__export(add_color_button_exports, {
  AddColorButton: () => AddColorButton
});
module.exports = __toCommonJS(add_color_button_exports);
...
const AddColorButton = ({ onAddClick, setRef }) => {
  ...
  const zIndexService = (0, import_react.useContext)(import_ricos_context.ZIndexContext);
  return /* @__PURE__ */ import_react.default.createElement("div", { ref: setRef }, /* @__PURE__ */ import_react.default.createElement(
    import_design_system.FillButton,
    {
      iconSize: "medium",
      onClick: onAddClick,
      dataHook: import_data_hooks.ADD_CUSTOM_COLOR_BUTTON,
...
//# sourceMappingURL=add-color-button.js.map

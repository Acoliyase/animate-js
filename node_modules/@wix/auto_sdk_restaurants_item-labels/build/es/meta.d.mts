...
interface ExternalReferenceInfo {
    ...
    /** Last time this item label was synced with the external app. */
...
interface CountLabelsRequest {
    /** Filter for counting labels. */
    filter?: Record<string, any> | null;
}
interface CountLabelsResponse {
    /** Counted labels. */
    count?: number;
}
...
interface BulkDeleteLabelsRequest {
    /**
     * Item Label IDs.
     * @format GUID
     * @maxSize 200
...
interface BulkDeleteLabelsResponse {
    /** Information about the deleted labels. */
    results?: BulkDeleteLabelsResult[];
    /** Metadata for the API call. */
    bulkActionMetadata?: BulkActionMetadata;
}
interface BulkDeleteLabelsResult {
    /** Metadata for labels deletion. */
...
/** @docsIgnore */
type CountLabelsApplicationErrors = {
...
declare function createLabel(): __PublicMethodMetaInfo<'POST', {}, CreateLabelRequest$1, CreateLabelRequest, CreateLabelResponse$1, CreateLabelResponse>;
...
declare function countLabels(): __PublicMethodMetaInfo<'POST', {}, CountLabelsRequest$1, CountLabelsRequest, CountLabelsResponse$1, CountLabelsResponse>;
declare function updateLabel(): __PublicMethodMetaInfo<'PATCH', {
    labelId: string;

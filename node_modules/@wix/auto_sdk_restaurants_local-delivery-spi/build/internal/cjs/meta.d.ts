...
/** @enumType */
type BusinessStatusWithLiterals = BusinessStatus | 'NONE' | 'READY' | 'PENDING' | 'ERROR' | 'NOT_STARTED';
...
/** @docsIgnore */
type EstimateDeliveryApplicationErrors = {
    code?: 'ESTIMATE_DELIVERY_REJECTED';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type CreateDeliveryApplicationErrors = {
...
declare function listAccountIds(): __PublicMethodMetaInfo<'POST', {}, ListAccountIdsRequest$1, ListAccountIdsRequest, ListAccountIdsResponse$1, ListAccountIdsResponse>;
declare function businessStatus(): __PublicMethodMetaInfo<'POST', {}, BusinessStatusRequest$1, BusinessStatusRequest, BusinessStatusResponse$1, BusinessStatusResponse>;
declare function estimateDelivery(): __PublicMethodMetaInfo<'POST', {}, EstimateDeliveryRequest$1, EstimateDeliveryRequest, EstimateDeliveryResponse$1, EstimateDeliveryResponse>;
declare function createDelivery(): __PublicMethodMetaInfo<'POST', {}, CreateDeliveryRequest$1, CreateDeliveryRequest, CreateDeliveryResponse$1, CreateDeliveryResponse>;

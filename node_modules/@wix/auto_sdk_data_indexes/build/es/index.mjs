...
var onIndexCreated = EventDefinition(
...
var onIndexDeleted = EventDefinition(
...
var onIndexUpdated = EventDefinition(
...
var onIndexCreated2 = createEventModule(onIndexCreated);
var onIndexDeleted2 = createEventModule(onIndexDeleted);
var onIndexUpdated2 = createEventModule(onIndexUpdated);
export {
  Environment,
  IndexSource,
  Order,

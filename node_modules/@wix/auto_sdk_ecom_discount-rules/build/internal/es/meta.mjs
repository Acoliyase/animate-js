...
var DiscountType = /* @__PURE__ */ ((DiscountType2) => {
  ...
  DiscountType2["QUANTITY_BASED"] = "QUANTITY_BASED";
...
// src/ecom-discounts-v1-discount-rule-discount-rules.meta.ts
function createDiscountRule2() {
  const payload = {};
  const getRequestOptions = createDiscountRule(payload);
...
function getDiscountRule2() {
  const payload = { discountRuleId: ":discountRuleId" };
  const getRequestOptions = getDiscountRule(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateDiscountRule2() {
  const payload = { discountRule: { id: ":discountRuleId" } };
  const getRequestOptions = updateDiscountRule(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteDiscountRule2() {
  const payload = { discountRuleId: ":discountRuleId" };
  const getRequestOptions = deleteDiscountRule(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryDiscountRules2() {
  const payload = {};
  const getRequestOptions = queryDiscountRules(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

...
export { ActionEvent, BaseEventMetadata, CardBrand, CardBrandWithLiterals, CardInfo, CardSensitiveInfo, CursorPaging, CursorPagingMetadata, Cursors, DeleteSavedPaymentMethodRequest, DeleteSavedPaymentMethodResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, FindSavedCreditCardRequest, FindSavedCreditCardResponse, GetSavedPaymentMethodRequest, GetSavedPaymentMethodResponse, IdentificationData, IdentificationDataIdOneOf, ListSavedPaymentMethodsRequest, MarkSavedPaymentMethodPrimaryRequest, MarkSavedPaymentMethodPrimaryResponse, MessageEnvelope, PaymentMethod, RequestedFields, RequestedFieldsWithLiterals, RestoreInfo, SensitiveInfo, UpdateSavedPaymentMethodRequest, UpdateSavedPaymentMethodResponse, UpsertSavedPaymentMethodRequest, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.js';
...
interface UpsertSavedPaymentMethodSignature {
     ...
     */
    (savedPaymentMethod: NonNullablePaths<SavedPaymentMethod, `paymentMethod` | `paymentMethod.cardInfo.expirationMonth` | `paymentMethod.cardInfo.expirationYear` | `paymentMethod.typeId`, 4>, options: NonNullablePaths<UpsertSavedPaymentMethodOptions, `temporaryCardToken`, 2>): Promise<NonNullablePaths<UpsertSavedPaymentMethodResponse, `savedPaymentMethod.primary` | `savedPaymentMethod.paymentMethod.typeId` | `savedPaymentMethod.paymentMethod.paymentMethodTypeId`, 4>>;
}
...
interface GetSavedPaymentMethodSignature {
     ...
     */
    (savedPaymentMethodId: string, options?: GetSavedPaymentMethodOptions): Promise<NonNullablePaths<SavedPaymentMethod, `primary` | `paymentMethod.typeId` | `paymentMethod.paymentMethodTypeId`, 3>>;
}
...
interface ListSavedPaymentMethodsSignature {
     ...
     */
    (options?: ListSavedPaymentMethodsOptions): Promise<NonNullablePaths<ListSavedPaymentMethodsResponse, `savedPaymentMethods` | `savedPaymentMethods.${number}.primary` | `savedPaymentMethods.${number}.paymentMethod.typeId` | `savedPaymentMethods.${number}.paymentMethod.paymentMethodTypeId`, 5>>;
}
...
interface UpdateSavedPaymentMethodSignature {
     ...
     */
    (_id: string, options?: NonNullablePaths<UpdateSavedPaymentMethodOptions, `savedPaymentMethod.revision`, 3>): Promise<NonNullablePaths<SavedPaymentMethod, `primary` | `paymentMethod.typeId` | `paymentMethod.paymentMethodTypeId`, 3>>;
}
...
/** */
declare const onSavedPaymentMethodCreated: BuildEventDefinition<typeof onSavedPaymentMethodCreated$1>;
/** */
declare const onSavedPaymentMethodDeleted: BuildEventDefinition<typeof onSavedPaymentMethodDeleted$1>;
/** */
declare const onSavedPaymentMethodUpdated: BuildEventDefinition<typeof onSavedPaymentMethodUpdated$1>;

export { GetSavedPaymentMethodOptions, ListSavedPaymentMethodsOptions, ListSavedPaymentMethodsResponse, SavedPaymentMethod, SavedPaymentMethodCreatedEnvelope, SavedPaymentMethodDeletedEnvelope, SavedPaymentMethodUpdatedEnvelope, UpdateSavedPaymentMethodOptions, UpsertSavedPaymentMethodOptions, UpsertSavedPaymentMethodResponse, deleteSavedPaymentMethod, getSavedPaymentMethod, listSavedPaymentMethods, markSavedPaymentMethodPrimary, onSavedPaymentMethodCreated, onSavedPaymentMethodDeleted, onSavedPaymentMethodUpdated, updateSavedPaymentMethod, upsertSavedPaymentMethod };

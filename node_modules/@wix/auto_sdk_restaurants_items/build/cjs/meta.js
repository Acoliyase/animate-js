...
__export(meta_exports, {
  ...
  EntitiesDayOfWeekOriginal: () => EntitiesDayOfWeek,
  EnumOriginal: () => Enum,
  ModeOriginal: () => Mode,
...
// src/restaurants-menus-v1-item-items.http.ts
...
function resolveComWixpressRestaurantsMenusItemV1RestaurantsDuplicateItemRestaurantsDuplicateItemUrl(opts) {
  const domainToMappings = {
    "manage._base_domain_": [
      {
        srcPath: "/_api/restaurants-menus-item",
...
var PACKAGE_NAME = "@wix/auto_sdk_restaurants_items";
function duplicateItem(payload) {
  function __duplicateItem({ host }) {
    const metadata = {
      entityFqdn: "wix.restaurants.menus.v1.item",
      method: "POST",
      methodFqn: "com.wixpress.restaurants.menus_item.v1.restaurants_duplicate_item.RestaurantsDuplicateItem.DuplicateItem",
...
function searchItems(payload) {
  function __searchItems({ host }) {
    ...
    const metadata = {
      entityFqdn: "wix.restaurants.menus.v1.item",
      method: "GET",
      methodFqn: "com.wixpress.restaurants.menus_item.v1.RestaurantsMenusItem.SearchItems",
      packageName: PACKAGE_NAME,
      migrationOptions: {
        optInTransformResponse: true
      },
...
// src/restaurants-menus-v1-item-items.types.ts
...
// src/restaurants-menus-v1-item-items.meta.ts
function duplicateItem2() {
  const payload = { id: ":id" };
  const getRequestOptions = duplicateItem(payload);
...
function createItem2() {
  const payload = {};
  const getRequestOptions = createItem(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkCreateItems2() {
  const payload = {};
  const getRequestOptions = bulkCreateItems(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function searchItems2() {
  const payload = {};
  const getRequestOptions = searchItems(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function countItems2() {
  const payload = {};
  const getRequestOptions = countItems(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkUpdateItem2() {
  const payload = {};
  const getRequestOptions = bulkUpdateItem(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteItem2() {
  const payload = { itemId: ":itemId" };
  const getRequestOptions = deleteItem(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkDeleteItems2() {
  const payload = {};
  const getRequestOptions = bulkDeleteItems(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

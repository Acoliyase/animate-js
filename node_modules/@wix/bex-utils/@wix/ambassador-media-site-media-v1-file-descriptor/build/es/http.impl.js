...
var _bulkAnnotateImageResult = { item: '_fileDescriptor' };
var _bulkAnnotateImagesRequest = {};
var _bulkAnnotateImagesResponse = { results: '_bulkAnnotateImageResult' };
var _bulkDeleteFilesRequest = {};
var _bulkDeleteFilesResponse = {};
var _bulkImportFileRequest = { importFileRequests: '_importFileRequest' };
var _bulkImportFileResponse = { results: '_bulkImportFileResult' };
var _bulkImportFileResult = { item: '_fileDescriptor' };
var _bulkImportFilesRequest = { importFileRequests: '_importFileRequest' };
var _bulkImportFilesResponse = { files: '_fileDescriptor' };
var _bulkPublishDraftFileResult = { item: '_fileDescriptor' };
var _bulkPublishDraftFilesRequest = {};
var _bulkPublishDraftFilesResponse = {
    results: '_bulkPublishDraftFileResult',
};
...
var _fileDescriptor = {
    ...
    lastUsedDate: 'google.protobuf.Timestamp',
    media: '_fileMedia',
};
var _fileMedia = {
    image: '_imageMedia',
...
var _generateWebSocketTokenRequest = {};
var _generateWebSocketTokenResponse = {};
...
var _updateFileRequest = {};
var _updateFileResponse = { file: '_fileDescriptor' };
 ...
 */
export function bulkAnnotateImages(payload) {
    var _a = serializer(_bulkAnnotateImagesRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkAnnotateImagesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _bulkAnnotateImageResult: _bulkAnnotateImageResult,
        _document: _document,
        _faceRecognition: _faceRecognition,
        _fileDescriptor: _fileDescriptor,
        _fileMedia: _fileMedia,
        _focalPoint: _focalPoint,
        _image: _image,
        _imageMedia: _imageMedia,
        _model3D: _model3D,
        _videoResolution: _videoResolution,
        _videoV2: _videoV2,
    }).fromJSON;
    function __bulkAnnotateImages(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
            method: 'POST',
            methodFqn: 'com.wix.media.site_media.v1.FilesService.BulkAnnotateImages',
            url: resolveComWixMediaSiteMediaV1FilesServiceUrl({
                protoPath: '/v1/bulk/files/images/annotate',
                data: serializedData,
                host: host,
            }),
            data: serializedData,
    ...
    __bulkAnnotateImages.fromReq = fromReq;
    __bulkAnnotateImages.__isAmbassador = true;
    return __bulkAnnotateImages;
}
/**
...
export function generateFilesDownloadUrl(payload) {
    var _a = serializer(_generateFilesDownloadUrlRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateFilesDownloadUrlResponse, {}).fromJSON;
    function __generateFilesDownloadUrl(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __generateFilesDownloadUrl.__isAmbassador = true;
...
export function generateFileDownloadUrl(payload) {
    var _a = serializer(_generateFileDownloadUrlRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateFileDownloadUrlResponse, {}).fromJSON;
    function __generateFileDownloadUrl(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __generateFileDownloadUrl.__isAmbassador = true;
...
export function getFileDescriptor(payload) {
    var _a = serializer(_getFileDescriptorRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_getFileDescriptorResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    function __getFileDescriptor(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __getFileDescriptor.__isAmbassador = true;
...
export function getFileDescriptors(payload) {
    var _a = serializer(_getFileDescriptorsRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_getFileDescriptorsResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    function __getFileDescriptors(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __getFileDescriptors.__isAmbassador = true;
...
export function updateFileDescriptor(payload) {
    var _a = serializer(_updateFileDescriptorRequest, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    var fromRes = serializer(_updateFileDescriptorResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    function __updateFileDescriptor(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __updateFileDescriptor.__isAmbassador = true;
...
export function generateFileUploadUrl(payload) {
    var _a = serializer(_generateFileUploadUrlRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateFileUploadUrlResponse, {}).fromJSON;
    function __generateFileUploadUrl(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __generateFileUploadUrl.__isAmbassador = true;
...
export function generateFileResumableUploadUrl(payload) {
    var _a = serializer(_generateFileResumableUploadUrlRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateFileResumableUploadUrlResponse, {}).fromJSON;
    function __generateFileResumableUploadUrl(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __generateFileResumableUploadUrl.__isAmbassador = true;
...
export function importFile(payload) {
    var _a = serializer(_importFileRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_importFileResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    __importFile.__isAmbassador = true;
    return __importFile;
}
/**
...
export function bulkImportFiles(payload) {
    var _a = serializer(_bulkImportFilesRequest, { _importFileRequest: _importFileRequest }), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkImportFilesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    __bulkImportFiles.__isAmbassador = true;
...
export function bulkImportFile(payload) {
    var _a = serializer(_bulkImportFileRequest, { _importFileRequest: _importFileRequest }), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkImportFileResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _bulkImportFileResult: _bulkImportFileResult,
        _document: _document,
        _faceRecognition: _faceRecognition,
        _fileDescriptor: _fileDescriptor,
        _fileMedia: _fileMedia,
    ...
    __bulkImportFile.__isAmbassador = true;
...
export function listFiles(payload) {
    ...
    var fromRes = serializer(_listFilesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
...
export function searchFiles(payload) {
    var _a = serializer(_searchFilesRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_searchFilesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    __searchFiles.__isAmbassador = true;
...
export function generateVideoStreamingUrl(payload) {
    var _a = serializer(_generateVideoStreamingUrlRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateVideoStreamingUrlResponse, {}).fromJSON;
    function __generateVideoStreamingUrl(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __generateVideoStreamingUrl.__isAmbassador = true;
 ...
 */
export function generateWebSocketToken(payload) {
    var _a = serializer(_generateWebSocketTokenRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_generateWebSocketTokenResponse, {}).fromJSON;
    function __generateWebSocketToken(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
            method: 'POST',
            methodFqn: 'com.wix.media.site_media.v1.FilesService.GenerateWebSocketToken',
            url: resolveComWixMediaSiteMediaV1FilesServiceUrl({
                protoPath: '/v1/files/generate-web-socket-token',
                data: serializedData,
                host: host,
            }),
            data: serializedData,
    ...
    __generateWebSocketToken.fromReq = fromReq;
    __generateWebSocketToken.__isAmbassador = true;
    return __generateWebSocketToken;
}
/**
...
export function bulkDeleteFiles(payload) {
    var _a = serializer(_bulkDeleteFilesRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkDeleteFilesResponse, {}).fromJSON;
    function __bulkDeleteFiles(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __bulkDeleteFiles.__isAmbassador = true;
    return __bulkDeleteFiles;
}
/** Restores the specified files from the Media Manager's trash bin, and moves them to their original locations in the Media Manager. */
export function bulkRestoreFilesFromTrashBin(payload) {
    var _a = serializer(_bulkRestoreFilesFromTrashBinRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkRestoreFilesFromTrashBinResponse, {}).fromJSON;
    function __bulkRestoreFilesFromTrashBin(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __bulkRestoreFilesFromTrashBin.__isAmbassador = true;
...
export function listDeletedFiles(payload) {
    var _a = serializer(_listDeletedFilesRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_listDeletedFilesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    function __listDeletedFiles(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
    ...
    __listDeletedFiles.__isAmbassador = true;
    return __listDeletedFiles;
}
export function bulkPublishDraftFiles(payload) {
    var _a = serializer(_bulkPublishDraftFilesRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_bulkPublishDraftFilesResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _bulkPublishDraftFileResult: _bulkPublishDraftFileResult,
        _document: _document,
        _faceRecognition: _faceRecognition,
        _fileDescriptor: _fileDescriptor,
        _fileMedia: _fileMedia,
    ...
    function __bulkPublishDraftFiles(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
            method: 'POST',
            methodFqn: 'com.wix.media.site_media.v1.FilesService.BulkPublishDraftFiles',
            url: resolveComWixMediaSiteMediaV1FilesServiceUrl({
                protoPath: '/v1/bulk/files/publish-drafts',
                data: serializedData,
                host: host,
            }),
            data: serializedData,
    ...
    __bulkPublishDraftFiles.fromReq = fromReq;
    __bulkPublishDraftFiles.__isAmbassador = true;
    return __bulkPublishDraftFiles;
}
/**
 * Updates a file.
 *
 * Specify the `parentFolderId` parameter to move a file from its current folder to a different folder.
 * @deprecated It has been replaced with com.wix.media.site_media.v1.FilesService.UpdateFileDescriptor(), and will be removed on 2023-03-31.
 */
export function updateFile(payload) {
    var _a = serializer(_updateFileRequest, {}), toReq = _a.toJSON, fromReq = _a.fromJSON;
    var fromRes = serializer(_updateFileResponse, {
        _archive: _archive,
        _audio: _audio,
        _audioV2: _audioV2,
        _document: _document,
    ...
    function __updateFile(_a) {
        var host = _a.host;
        var serializedData = toReq(payload);
        var metadata = {
            entityFqdn: 'wix.media.site_media.v1.file_descriptor',
            method: 'PATCH',
            methodFqn: 'com.wix.media.site_media.v1.FilesService.UpdateFile',
            url: resolveComWixMediaSiteMediaV1FilesServiceUrl({
                protoPath: '/v1/files/update-file',
                data: serializedData,
                host: host,
            }),
            data: serializedData,
    ...
    __updateFile.__isAmbassador = true;
    return __updateFile;
}

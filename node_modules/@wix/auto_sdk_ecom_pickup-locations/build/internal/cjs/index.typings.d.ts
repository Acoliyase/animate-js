 ...
 * @requiredField query
 */
declare function typedQueryPickupLocation(query: QueryV2): Promise<NonNullablePaths<QueryPickupLocationResponse, `pickupLocations` | `pickupLocations.${number}.address.streetAddress.number` | `pickupLocations.${number}.address.streetAddress.name`, 6>>;
/**

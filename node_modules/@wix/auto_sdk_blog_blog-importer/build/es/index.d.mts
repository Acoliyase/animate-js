...
import { StartImportOptions, SubmitUrlForImportOptions, ValidateUrlForImportResponse, GetImportStatusResponse, GetNotImportedPostsResponse, StopImportResponse } from './index.typings.mjs';
export { DeleteNotImportedRequest, DeleteNotImportedResponse, GetImportStatusRequest, GetNotImportedPostsRequest, ImportStatus, Post, StartImportRequest, StartImportResponse, Status, StatusWithLiterals, StopImportRequest, SubmitUrlForImportRequest, SubmitUrlForImportResponse, ValidateUrlForImportRequest } from './index.typings.mjs';
...
interface GetImportStatusSignature {
     ...
     */
    (): Promise<NonNullablePaths<GetImportStatusResponse, `importStatus._id` | `importStatus.fileName` | `importStatus.status` | `importStatus.importAmount` | `importStatus.alreadyImportedAmount` | `importStatus.processedAmount` | `importStatus.totalImportAmount`, 3>>;
}
...
interface GetNotImportedPostsSignature {
     ...
     */
    (): Promise<NonNullablePaths<GetNotImportedPostsResponse, `notImportedPosts` | `notImportedPosts.${number}._id` | `notImportedPosts.${number}.title` | `notImportedPosts.${number}.url`, 4>>;
}
declare function stopImport$1(httpClient: HttpClient): StopImportSignature;
interface StopImportSignature {
    /**
     * Stops the import process.
     */
    (): Promise<NonNullablePaths<StopImportResponse, `importStatus._id` | `importStatus.fileName` | `importStatus.status` | `importStatus.importAmount` | `importStatus.alreadyImportedAmount` | `importStatus.processedAmount` | `importStatus.totalImportAmount`, 3>>;
}
...
declare const stopImport: MaybeContext<BuildRESTFunction<typeof stopImport$1> & typeof stopImport$1>;

export { GetImportStatusResponse, GetNotImportedPostsResponse, StartImportOptions, StopImportResponse, SubmitUrlForImportOptions, ValidateUrlForImportResponse, deleteNotImported, getImportStatus, getNotImportedPosts, startImport, stopImport, submitUrlForImport, validateUrlForImport };

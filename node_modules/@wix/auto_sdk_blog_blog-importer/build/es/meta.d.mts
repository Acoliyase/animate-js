...
interface ImportStatus {
    ...
    /** Batch size of entities to be imported. */
    importAmount?: number;
...
interface StopImportRequest {
}
interface StopImportResponse {
    /** Details of the stopped import. */
    importStatus?: ImportStatus;
}
...
declare function stopImport(): __PublicMethodMetaInfo<'POST', {}, StopImportRequest$1, StopImportRequest, StopImportResponse$1, StopImportResponse>;

export { type DeleteNotImportedRequest as DeleteNotImportedRequestOriginal, type DeleteNotImportedResponse as DeleteNotImportedResponseOriginal, type GetImportStatusRequest as GetImportStatusRequestOriginal, type GetImportStatusResponse as GetImportStatusResponseOriginal, type GetNotImportedPostsRequest as GetNotImportedPostsRequestOriginal, type GetNotImportedPostsResponse as GetNotImportedPostsResponseOriginal, type ImportStatus as ImportStatusOriginal, type Post as PostOriginal, type StartImportRequest as StartImportRequestOriginal, type StartImportResponse as StartImportResponseOriginal, Status as StatusOriginal, type StatusWithLiterals as StatusWithLiteralsOriginal, type StopImportRequest as StopImportRequestOriginal, type StopImportResponse as StopImportResponseOriginal, type SubmitUrlForImportRequest as SubmitUrlForImportRequestOriginal, type SubmitUrlForImportResponse as SubmitUrlForImportResponseOriginal, type ValidateUrlForImportRequest as ValidateUrlForImportRequestOriginal, type ValidateUrlForImportResponse as ValidateUrlForImportResponseOriginal, type __PublicMethodMetaInfo, deleteNotImported, getImportStatus, getNotImportedPosts, startImport, stopImport, submitUrlForImport, validateUrlForImport };

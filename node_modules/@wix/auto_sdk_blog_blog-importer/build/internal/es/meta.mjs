...
// src/blog-v1-wordpress-import-blog-importer.types.ts
...
function stopImport2() {
  const payload = {};
  const getRequestOptions = stopImport(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

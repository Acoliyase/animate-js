 ...
 */
declare function getImportStatus(): Promise<NonNullablePaths<GetImportStatusResponse, `importStatus._id` | `importStatus.fileName` | `importStatus.status` | `importStatus.importAmount` | `importStatus.alreadyImportedAmount` | `importStatus.processedAmount` | `importStatus.totalImportAmount`, 3>>;
/**
 ...
 */
declare function getNotImportedPosts(): Promise<NonNullablePaths<GetNotImportedPostsResponse, `notImportedPosts` | `notImportedPosts.${number}._id` | `notImportedPosts.${number}.title` | `notImportedPosts.${number}.url`, 4>>;
/**
 * Stops the import process.
 * @public
 * @permissionId BLOG.IMPORT_FROM_EXTERNAL_SITES
 * @applicableIdentity APP
 * @fqn com.wix.blog.WordpressImportService.StopImport
 */
declare function stopImport(): Promise<NonNullablePaths<StopImportResponse, `importStatus._id` | `importStatus.fileName` | `importStatus.status` | `importStatus.importAmount` | `importStatus.alreadyImportedAmount` | `importStatus.processedAmount` | `importStatus.totalImportAmount`, 3>>;

export { type DeleteNotImportedRequest, type DeleteNotImportedResponse, type GetImportStatusRequest, type GetImportStatusResponse, type GetNotImportedPostsRequest, type GetNotImportedPostsResponse, type ImportStatus, type Post, type StartImportOptions, type StartImportRequest, type StartImportResponse, Status, type StatusWithLiterals, type StopImportRequest, type StopImportResponse, type SubmitUrlForImportOptions, type SubmitUrlForImportRequest, type SubmitUrlForImportResponse, type ValidateUrlForImportRequest, type ValidateUrlForImportResponse, deleteNotImported, getImportStatus, getNotImportedPosts, startImport, stopImport, submitUrlForImport, validateUrlForImport };

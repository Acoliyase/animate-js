...
declare function queryOperation$1(httpClient: HttpClient): QueryOperationSignature;
...
interface CalculateFirstAvailableTimeSlotsForItemSignature {
     ...
     * The response includes time slots with delivery fulfillment types only if you specify a delivery address.
     * Only fulfillment methods capable of delivering to the specified address are considered when calculating time slot availability.
     * @param - Menu ID to get the first available time slots for.
     */
...
declare const queryOperation: MaybeContext<BuildRESTFunction<typeof queryOperation$1> & typeof queryOperation$1>;
declare const listOperations: MaybeContext<BuildRESTFunction<typeof listOperations$1> & typeof listOperations$1>;
declare const listAvailableFulfillmentOptions: MaybeContext<BuildRESTFunction<typeof listAvailableFulfillmentOptions$1> & typeof listAvailableFulfillmentOptions$1>;
declare const listFirstAvailableTimeSlotForFulfillmentTypes: MaybeContext<BuildRESTFunction<typeof listFirstAvailableTimeSlotForFulfillmentTypes$1> & typeof listFirstAvailableTimeSlotForFulfillmentTypes$1>;
declare const calculateFirstAvailableTimeSlotPerFulfillmentType: MaybeContext<BuildRESTFunction<typeof calculateFirstAvailableTimeSlotPerFulfillmentType$1> & typeof calculateFirstAvailableTimeSlotPerFulfillmentType$1>;
declare const listFirstAvailableTimeSlotsForOperations: MaybeContext<BuildRESTFunction<typeof listFirstAvailableTimeSlotsForOperations$1> & typeof listFirstAvailableTimeSlotsForOperations$1>;
declare const calculateFirstAvailableTimeSlotsPerOperation: MaybeContext<BuildRESTFunction<typeof calculateFirstAvailableTimeSlotsPerOperation$1> & typeof calculateFirstAvailableTimeSlotsPerOperation$1>;
declare const listFirstAvailableTimeSlotsForMenus: MaybeContext<BuildRESTFunction<typeof listFirstAvailableTimeSlotsForMenus$1> & typeof listFirstAvailableTimeSlotsForMenus$1>;
declare const calculateFirstAvailableTimeSlotsPerMenu: MaybeContext<BuildRESTFunction<typeof calculateFirstAvailableTimeSlotsPerMenu$1> & typeof calculateFirstAvailableTimeSlotsPerMenu$1>;
declare const calculateFirstAvailableTimeSlotsForItem: MaybeContext<BuildRESTFunction<typeof calculateFirstAvailableTimeSlotsForItem$1> & typeof calculateFirstAvailableTimeSlotsForItem$1>;
declare const listAvailableTimeSlotsForDate: MaybeContext<BuildRESTFunction<typeof listAvailableTimeSlotsForDate$1> & typeof listAvailableTimeSlotsForDate$1>;
declare const calculateAvailableTimeSlotsForDate: MaybeContext<BuildRESTFunction<typeof calculateAvailableTimeSlotsForDate$1> & typeof calculateAvailableTimeSlotsForDate$1>;
declare const listAvailableDatesInRange: MaybeContext<BuildRESTFunction<typeof listAvailableDatesInRange$1> & typeof listAvailableDatesInRange$1>;
declare const calculateAvailableDatesInRange: MaybeContext<BuildRESTFunction<typeof calculateAvailableDatesInRange$1> & typeof calculateAvailableDatesInRange$1>;
declare const validateOperationAddress: MaybeContext<BuildRESTFunction<typeof validateOperationAddress$1> & typeof validateOperationAddress$1>;
 ...
 */
declare const onOperationDeleted: BuildEventDefinition<typeof onOperationDeleted$1> & typeof onOperationDeleted$1;
/**

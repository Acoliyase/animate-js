...
async function typedQueryInventoryItems(query) {
  const { httpClient, sideEffects } = arguments[1];
...
function typedQueryInventoryItems2(httpClient) {
  return (query) => typedQueryInventoryItems(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryInventoryItems(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryInventoryItems3(httpClient)(),
    typedQueryFunction: (query) => typedQueryInventoryItems2(httpClient)(query),
...
var queryInventoryItems4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryInventoryItems);

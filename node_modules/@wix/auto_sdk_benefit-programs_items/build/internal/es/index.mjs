...
// src/benefit-programs-v1-item-items.http.ts
...
async function bulkDeleteItemsByFilter2(namespace, options) {
  ...
  const reqOpts = bulkDeleteItemsByFilter(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
var createItem4 = /* @__PURE__ */ createRESTModule(createItem3);
var bulkCreateItems4 = /* @__PURE__ */ createRESTModule(bulkCreateItems3);
var deleteItem4 = /* @__PURE__ */ createRESTModule(deleteItem3);
var bulkDeleteItems4 = /* @__PURE__ */ createRESTModule(bulkDeleteItems3);
var bulkDeleteItemsByFilter4 = /* @__PURE__ */ createRESTModule(bulkDeleteItemsByFilter3);
var updateItem4 = /* @__PURE__ */ createRESTModule(updateItem3);
var bulkUpdateItems4 = /* @__PURE__ */ createRESTModule(bulkUpdateItems3);
var getItem4 = /* @__PURE__ */ createRESTModule(getItem3);
var listItems4 = /* @__PURE__ */ createRESTModule(listItems3);
var queryItems4 = /* @__PURE__ */ createRESTModule(queryItems3);
var countItems4 = /* @__PURE__ */ createRESTModule(countItems3);
export {
  SortOrder,
  Type,
  WebhookIdentityType,
  bulkCreateItems4 as bulkCreateItems,
  bulkDeleteItems4 as bulkDeleteItems,
  bulkDeleteItemsByFilter4 as bulkDeleteItemsByFilter,
  bulkUpdateItems4 as bulkUpdateItems,
  countItems4 as countItems,
  createItem4 as createItem,
  deleteItem4 as deleteItem,
  getItem4 as getItem,
  listItems4 as listItems,
  queryItems4 as queryItems,
  updateItem4 as updateItem
};

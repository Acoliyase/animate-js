...
export const DefaultDateRangePreset = {
    NONE: 'NONE',
    SEVEN_DAYS: 'SEVEN_DAYS',
    FOURTEEN_DAYS: 'FOURTEEN_DAYS',
    MONTH: 'MONTH',
...
const getDateRangeLabel = (item, { dateFormatters, }) => {
    return [item.from, item.to]
        .filter(Boolean)
        .map((date) => dateFormatters.mediumTime.format(date))
        .join(' - ');
};
export const renderPresetToolbarTag = (container) => (filter) => {
...
export const shouldRenderPresetTag = (preset) => preset &&
...
export const getDatesFromPreset = (preset) => {
...
export const MAP_DATE_PRESET_TO_KEY = {

export const filterPageByPatches = (patches, { itemKey, itemPredicate, }) => (item) => {
    const itemAfterAllPatches = patches.reduce((acc, { selector, patch, patchedItems, actionType }) => {
        if (!selector(item)) {
            return acc;
        }

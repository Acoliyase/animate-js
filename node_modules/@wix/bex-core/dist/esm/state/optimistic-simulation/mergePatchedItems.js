export function mergePatchedItems(toMerge, { page, itemKey, orders, itemPredicate, }) {
    ...
    for (const [key, { item, optimisticPatch }] of Array.from(itemsToMerge.entries())) {
    ...
    for (const [key, { item }] of Array.from(pageWithPatchedItemsMapTmp.entries())) {

...
var _QueryResultState = require("./QueryResultState");
var _BulkSelectState = require("./BulkSelectState");
var _PromisesState = require("./PromisesState");
var _Pagination = require("./Pagination");
var _PaginationMode = require("./PaginationMode");
...
class CollectionState {
  ...
  get optimisticActions() {
    if (this._optimisticActions == null && process.env.NODE_ENV !== 'production') {
  ...
  constructor(params) {
    ...
    (0, _defineProperty2.default)(this, "_paginationModeRef", void 0);
    (0, _defineProperty2.default)(this, "_paginationMode", void 0);
    (0, _defineProperty2.default)(this, "selectionConsistencyMode", void 0);
    (0, _defineProperty2.default)(this, "result", void 0);
    (0, _defineProperty2.default)(this, "fetchesHistory", void 0);
    (0, _defineProperty2.default)(this, "bulkSelect", void 0);
    (0, _defineProperty2.default)(this, "scrollableContent", null);
    ...
    (0, _defineProperty2.default)(this, "queryObserver", void 0);
    (0, _defineProperty2.default)(this, "queryName", void 0);
    (0, _defineProperty2.default)(this, "fqdn", void 0);
    (0, _defineProperty2.default)(this, "fetchErrorMessage", void 0);
    (0, _defineProperty2.default)(this, "itemName", void 0);
    (0, _defineProperty2.default)(this, "itemKey", void 0);
    (0, _defineProperty2.default)(this, "toExtendedFields", void 0);
    (0, _defineProperty2.default)(this, "translate", void 0);
    (0, _defineProperty2.default)(this, "fetchData", void 0);
    (0, _defineProperty2.default)(this, "lodash", void 0);
    (0, _defineProperty2.default)(this, "deferInitialLoading", void 0);
    (0, _defineProperty2.default)(this, "persistQueryToUrl", void 0);
    (0, _defineProperty2.default)(this, "_optimisticActions", void 0);
    (0, _defineProperty2.default)(this, "beforeSetData", void 0);
    ...
    (0, _defineProperty2.default)(this, "initialPromises", new _PromisesState.PromisesState());
    (0, _defineProperty2.default)(this, "refreshPromises", new _PromisesState.PromisesState());
     ...
     */
    (0, _defineProperty2.default)(this, "lifecycleState", 'result');
    (0, _defineProperty2.default)(this, "_queryKey", asComputed => {
      const {
        queryName
      } = this;
      const {
    ...
    (0, _defineProperty2.default)(this, "_queryFn", async computedQuery => {
      const {
        items,
        total,
        available = null,
    ...
    (0, _defineProperty2.default)(this, "scheduleSort", void 0);
    (0, _defineProperty2.default)(this, "scheduleSearch", void 0);
    (0, _defineProperty2.default)(this, "_runSearch", void 0);
    (0, _defineProperty2.default)(this, "_runSort", void 0);
    (0, _defineProperty2.default)(this, "animationFramePromise", () => new Promise(resolve => {
    ...
    (0, _defineProperty2.default)(this, "onError", (0, _mobx.action)(err => {
      if (err == null) {
        return;
      }
      const {
      ...
      if (!(err instanceof _util.OfflineError)) {
        const handled = events.onError == null ? void 0 : events.onError({
          err,
          isOnline
        });
        if (!handled) {
    ...
    (0, _defineProperty2.default)(this, "_currentQueryPromise", void 0);
    (0, _defineProperty2.default)(this, "fetchNextPage", (0, _mobx.action)(async () => {
      const {
        query,
        result,
        events: {
      ...
      const onNewPageAddedListeners = emitter.listeners('newPageStart').map(l => l());
      const maybeOnNewPageAdded = onNewPageStart == null ? void 0 : onNewPageStart({
      ...
      (0, _mobx.runInAction)(() => {
        if (promise === this._currentQueryPromise) {
          ...
          onResultListeners.forEach(l => l == null ? void 0 : l());
          if (updateResultInfo) {
            const {
              newPages
            } = updateResultInfo;
            ...
            onNewPageAdded == null || onNewPageAdded(onNewPageAddedParams);
          }
        }
      });
    }));
    (0, _defineProperty2.default)(this, "_recoverIfError", (0, _mobx.action)(() => {
      const {
        onlineState
      } = this;
      const {
      ...
      if (focusManager.isFocused() && onlineState.isOnline && this.result.status.isError) {
    ...
    (0, _defineProperty2.default)(this, "onOnlineStateChange", isOnline => {
      ...
      if (isOnline) {
        ...
        currentQuery.dispatch({
          type: 'error',
          error: new _util.OfflineError('CollectionState.onOnlineStateChange: offline')
        });
        this.updateStatus();
      }
    });
    ...
    (0, _defineProperty2.default)(this, "_topNotification", new _TransitionState.TransitionState());
    ...
    (0, _mobx.makeObservable)(this, {
      ...
      clearResultAndMoveToStart: _mobx.action.bound,
      refreshAllPages: _mobx.action.bound,
      updateStatus: _mobx.action.bound,
      updateResult: _mobx.action.bound,
      search: _mobx.action,
      sort: _mobx.action,
      fetch: _mobx.action,
      init: _mobx.action,
      setInitialPage: _mobx.action,
      initialFetch: _mobx.action,
      totalPages: _mobx.computed,
      ...
      resetFiltersAndRefresh: _mobx.action.bound,
      lifecycleState: _mobx.observable.ref,
      clearResultBeforeRefresh: _mobx.action,
      scrollableContent: _mobx.observable.ref,
      _commonDynamicBiParams: _mobx.action
    });
    ...
    this.queryObserver = new _core.QueryObserver(this.queryClient, {
      retry: (failureCount, error) => {
        if (failureCount < MAX_RETRIES) {
          var _this$errorHandler;
          (_this$errorHandler = this.errorHandler) == null || _this$errorHandler.reportRetryAttempt == null || _this$errorHandler.reportRetryAttempt(error);
          return true;
        }
        return false;
      },
    ...
    this._runSearch = (0, _mobx.action)(async clearResult => {
      const {
        events: {
          onSearch,
          onSearchResults
      ...
      const searchEndListeners = emitter.listeners('searchStart').map(l => l());
      ...
      return this.moveToFirstPage({
        onResultUpdated: params => {
          ...
          onSearchResults == null || onSearchResults(params);
        }
      });
    });
  ...
  _addToFetchesHistory(newPages) {
    const {
      ...
      cursor,
      offset
    } = this.query.asComputed;
    this.fetchesHistory.push({
      itemsKeys: newPages.flatMap(p => p.items).map(item => this.itemKey(item)),
      queryPageInfo: {
        page,
        cursor,
        offset
  ...
  updateResult(queries) {
    ...
    const newPages = queries.map(reactQuery => reactQuery.state.data).filter(d => d != null);
    this.updateStatus();
    if (newPages.length) {
  ...
  updateStatus() {
    ...
    const {
      ...
      error,
      isFetching
    } = queryObserver.getOptimisticResult(queryObserver.options);
    result.status = {
      ..._model.queryStatus[status],
      isFetching,
      error
    };
  ...
  fetch() {
    ...
    const onResultListeners = fetchListeners.map(l => l({
      isStale
    }));
    if (!onlineState.isOnline) {
      currentQuery.dispatch({
        type: 'error',
        error: new _util.OfflineError('CollectionState.fetch: offline')
      });
    }
    this.updateStatus();
    return {
  ...
  async fetchNextPageIfNeeded() {
    ...
    if (lifecycleState !== 'refresh' && !result.status.isFetching && !fetchedLastPage) {
  ...
  invalidate({
    ...
    queryCache.findAll({
      queryKey: [queryName, queryLookup]
  ...
  async fetchAndReplaceResult({
    ...
    if (promise === this._currentQueryPromise) {
      (0, _mobx.runInAction)(() => {
        ...
        onResultListeners.forEach(l => l == null ? void 0 : l());
        onResultUpdated == null || onResultUpdated({
          query: result.originQuery,
          result: result.asComputed
        });
      });
  ...
  clearSearch() {
    ...
    return this.clearResultAndMoveToStart({
      onResultUpdated: onSearchResults
    });
  }
  get filters() {
  ...
  async refreshAllPages({
    ...
    emitter.emit('refresh', {
      isStale: true
    }); // Because of invalidation above, all queries are now stale
    ...
    for (let page = 1; page <= currentPage; page++) {
      ...
      if (pageQuery.promise) {
        if (paginationMode.id === 'cursor') {
          ...
          (0, _mobx.runInAction)(() => {
            var _pageQuery$state$data;
            return pagination.cursor = ((_pageQuery$state$data = pageQuery.state.data) == null ? void 0 : _pageQuery$state$data.cursor) ?? null;
          });
        }
    ...
    (0, _mobx.runInAction)(() => {
      beforeUpdateResult == null || beforeUpdateResult();
  ...
  async initialFetch() {
    ...
    (0, _mobx.runInAction)(() => {
      ...
      onInitialPageFetched == null || onInitialPageFetched({
        result: {
          total,
  ...
  init({
    ...
    const disposers = [query.init({
      skipFilterListeners
    }), this._registerQueryEvents(), result.init(), bulkSelect.init(),
    ...
    initTask.runOnce(async () => {
      var _this$initDependencie;
      await Promise.all([skipInitialFetch ? null : this.initialFetch(), (_this$initDependencie = this.initDependencies) == null ? void 0 : _this$initDependencie.call(this)]);
    });
  ...
  _registerQueryEvents() {
    ...
    const disposers = [(0, _util.addEventListener)(query.events, 'refresh', opts => {
      if (this.selectionConsistencyMode === 'clear') {
        this.bulkSelect.resetToDefaults();
      }
      ...
      if ((opts == null ? void 0 : opts.clearResult) !== false) {
        this.clearResultBeforeRefresh();
      } else {
        var _this$scrollableConte2;
        (_this$scrollableConte2 = this.scrollableContent) == null || _this$scrollableConte2.scrollTo({
          top: 0,
          behavior: 'smooth'
        });
      }
      this.moveToFirstPage();
    }), (0, _util.addEventListener)(query.events, 'scheduleRefresh', opts => {
      this.scheduleSearch(opts == null ? void 0 : opts.clearResult);
    }), ...(query.refreshOnColumnsChange ? [(0, _mobx.reaction)(() => query.fieldsKeyHash, () => {
      this.clearResultBeforeRefresh();
      this.moveToFirstPage();
    })] : [])];
    return () => {
  ...
  getItem(key) {
    ...
    return keyedItem == null ? void 0 : keyedItem.item;
  }
  getKeyedItem(key) {
  ...
  _commonDynamicBiParams(query = this.result.originQuery) {
    ...
    return {
      ...
      currentSortOrder: (_query$sort = query.sort) != null && _query$sort.length ? JSON.stringify(query.sort) : undefined,
      filteredListSize: result.total,
      initialItems: result.size,
      numSortedColumns: (_query$sort2 = query.sort) == null ? void 0 : _query$sort2.length
    };
  }
  ...
  get showRefreshLoader() {
    ...
    return isLoadingPromises || Boolean(status.isFetching && lifecycleState === 'refresh');
  }
  get showEmptyState() {
    const {
      lifecycleState,
  ...
  get topNotification() {
    ...
    return {
      ...
      get text() {
        return (0, _mobx.runInAction)(() => _topNotification.data);
      },
      get show() {
        return (0, _mobx.runInAction)(() => _topNotification.show);
      }
    };
  }
}

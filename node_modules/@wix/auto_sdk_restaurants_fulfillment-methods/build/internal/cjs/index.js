...
__export(index_exports, {
  ...
  bulkCreateFulfillmentMethods: () => bulkCreateFulfillmentMethods4,
  bulkUpdateFulfillmentMethodTags: () => bulkUpdateFulfillmentMethodTags4,
  bulkUpdateFulfillmentMethodTagsByFilter: () => bulkUpdateFulfillmentMethodTagsByFilter4,
  createFulfillmentMethod: () => createFulfillmentMethod4,
  deleteFulfillmentMethod: () => deleteFulfillmentMethod4,
  getAccumulatedFulfillmentMethodsAvailability: () => getAccumulatedFulfillmentMethodsAvailability4,
  getAggregatedMethodAvailability: () => getAggregatedMethodAvailability4,
  getCombinedMethodAvailability: () => getCombinedMethodAvailability4,
  getFulfillmentMethod: () => getFulfillmentMethod4,
  listAvailableFulfillmentMethodsForAddress: () => listAvailableFulfillmentMethodsForAddress4,
  listFulfillmentMethods: () => listFulfillmentMethods4,
  onFulfillmentMethodCreated: () => onFulfillmentMethodCreated2,
  onFulfillmentMethodDeleted: () => onFulfillmentMethodDeleted2,
  onFulfillmentMethodUpdated: () => onFulfillmentMethodUpdated2,
  queryFulfillmentMethods: () => queryFulfillmentMethods4,
  updateFulfillmentMethod: () => updateFulfillmentMethod4
});
...
// src/restaurants-v1-fulfillment-method-fulfillment-methods.http.ts
...
var PACKAGE_NAME = "@wix/auto_sdk_restaurants_fulfillment-methods";
...
function bulkCreateFulfillmentMethods(payload) {
  function __bulkCreateFulfillmentMethods({ host }) {
    const serializedData = (0, import_transform_paths.transformPaths)(payload, [
      {
        transformFn: import_timestamp.transformSDKTimestampToRESTTimestamp,
        paths: [
    ...
    const metadata = {
      entityFqdn: "wix.restaurants.v1.fulfillment_method",
      method: "POST",
      methodFqn: "wix.restaurants.fulfillment.v1.FulfillmentMethodsService.BulkCreateFulfillmentMethods",
      packageName: PACKAGE_NAME,
      migrationOptions: {
        optInTransformResponse: true
      },
...
function bulkUpdateFulfillmentMethodTags(payload) {
  function __bulkUpdateFulfillmentMethodTags({ host }) {
    const metadata = {
      entityFqdn: "wix.restaurants.v1.fulfillment_method",
      method: "POST",
      methodFqn: "wix.restaurants.fulfillment.v1.FulfillmentMethodsService.BulkUpdateFulfillmentMethodTags",
      packageName: PACKAGE_NAME,
      migrationOptions: {
        optInTransformResponse: true
      },
...
function bulkUpdateFulfillmentMethodTagsByFilter(payload) {
  function __bulkUpdateFulfillmentMethodTagsByFilter({ host }) {
    const metadata = {
      entityFqdn: "wix.restaurants.v1.fulfillment_method",
      method: "POST",
      methodFqn: "wix.restaurants.fulfillment.v1.FulfillmentMethodsService.BulkUpdateFulfillmentMethodTagsByFilter",
      packageName: PACKAGE_NAME,
      migrationOptions: {
        optInTransformResponse: true
      },
...
var FulfillmentMethodType = /* @__PURE__ */ ((FulfillmentMethodType2) => {
  ...
  FulfillmentMethodType2["PICKUP"] = "PICKUP";
  FulfillmentMethodType2["DELIVERY"] = "DELIVERY";
  return FulfillmentMethodType2;
...
var Type = /* @__PURE__ */ ((Type2) => {
  Type2["UNKNOWN_DELIVERY_AREA"] = "UNKNOWN_DELIVERY_AREA";
  Type2["RADIUS"] = "RADIUS";
  Type2["POSTAL_CODE"] = "POSTAL_CODE";
  Type2["CUSTOM"] = "CUSTOM";
  Type2["PROVIDER_DEFINED"] = "PROVIDER_DEFINED";
  return Type2;
})(Type || {});
...
async function createFulfillmentMethod2(fulfillmentMethod) {
  ...
  const reqOpts = createFulfillmentMethod(
    payload
  );
...
async function bulkCreateFulfillmentMethods2(options) {
  ...
  const reqOpts = bulkCreateFulfillmentMethods(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
      ...
      (0, import_transform_paths2.transformPaths)(result.data, [
        {
          transformFn: import_address2.transformRESTAddressToSDKAddress,
          paths: [
            { path: "results.fulfillmentMethod.pickupOptions.address" },
            {
              path: "results.fulfillmentMethod.deliveryOptions.deliveryArea.radiusOptions.centerPointAddress"
            }
          ]
        }
      ])
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        ...
        explicitPathsToArguments: {
          fulfillmentMethods: "$[0].fulfillmentMethods",
...
async function getFulfillmentMethod2(fulfillmentMethodId) {
  ...
  const reqOpts = getFulfillmentMethod(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function updateFulfillmentMethod2(_id, fulfillmentMethod) {
  ...
  const reqOpts = updateFulfillmentMethod(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function deleteFulfillmentMethod2(fulfillmentMethodId) {
  ...
  const reqOpts = deleteFulfillmentMethod(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
function queryFulfillmentMethods2() {
  const { httpClient, sideEffects } = arguments[0];
  return (0, import_query_builder.queryBuilder)({
    func: async (payload) => {
      const reqOpts = queryFulfillmentMethods(
        payload
      );
      sideEffects?.onSiteCall?.();
      try {
...
async function listFulfillmentMethods2(options) {
  ...
  const reqOpts = listFulfillmentMethods(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
...
async function listAvailableFulfillmentMethodsForAddress2(options) {
  ...
  const reqOpts = listAvailableFulfillmentMethodsForAddress(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function getAccumulatedFulfillmentMethodsAvailability2(options) {
  ...
  const reqOpts = getAccumulatedFulfillmentMethodsAvailability(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function getCombinedMethodAvailability2(fulfillmentMethodIds) {
  ...
  const reqOpts = getCombinedMethodAvailability(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function getAggregatedMethodAvailability2(fulfillmentMethodIds) {
  ...
  const reqOpts = getAggregatedMethodAvailability(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
async function bulkUpdateFulfillmentMethodTags2(fulfillmentMethodIds, options) {
  ...
  const reqOpts = bulkUpdateFulfillmentMethodTags(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
    ...
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
        spreadPathsToArguments: {},
        explicitPathsToArguments: {
          fulfillmentMethodIds: "$[0]",
          assignTags: "$[1].assignTags",
          unassignTags: "$[1].unassignTags"
        },
        singleArgumentUnchanged: false
      },
      ["fulfillmentMethodIds", "options"]
    );
    sideEffects?.onError?.(err);
    throw transformedError;
  }
...
async function bulkUpdateFulfillmentMethodTagsByFilter2(filter, options) {
  ...
  const reqOpts = bulkUpdateFulfillmentMethodTagsByFilter(
    payload
  );
  sideEffects?.onSiteCall?.();
  try {
...
function queryFulfillmentMethods3(httpClient) {
  return () => queryFulfillmentMethods2(
    // @ts-ignore
    { httpClient }
  );
}
...
var onFulfillmentMethodCreated = (0, import_sdk_types.EventDefinition)(
  "wix.restaurants.v1.fulfillment_method_created",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      ...
      },
      {
        ...
        paths: [
          { path: "entity.pickupOptions.address" },
          {
            path: "entity.deliveryOptions.deliveryArea.radiusOptions.centerPointAddress"
          }
        ]
      },
      {
        ...
        paths: [
          {
            path: "entity.deliveryOptions.deliveryArea.customOptions.geocodes.latitude"
          },
          {
            path: "entity.deliveryOptions.deliveryArea.customOptions.geocodes.longitude"
          }
        ]
      }
    ])
...
var onFulfillmentMethodDeleted = (0, import_sdk_types.EventDefinition)(
  "wix.restaurants.v1.fulfillment_method_deleted",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
      ...
      },
      {
        transformFn: import_address3.transformRESTAddressToSDKAddress,
        paths: [
          { path: "undefined.pickupOptions.address" },
          {
            path: "undefined.deliveryOptions.deliveryArea.radiusOptions.centerPointAddress"
          }
        ]
      },
      {
        ...
        paths: [
          {
            path: "undefined.deliveryOptions.deliveryArea.customOptions.geocodes.latitude"
          },
          {
            path: "undefined.deliveryOptions.deliveryArea.customOptions.geocodes.longitude"
          }
        ]
      }
    ])
...
var onFulfillmentMethodUpdated = (0, import_sdk_types.EventDefinition)(
  "wix.restaurants.v1.fulfillment_method_updated",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
...
// src/restaurants-v1-fulfillment-method-fulfillment-methods.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var import_event_definition_modules = require("@wix/sdk-runtime/event-definition-modules");
var createFulfillmentMethod4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(createFulfillmentMethod3);
var bulkCreateFulfillmentMethods4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(bulkCreateFulfillmentMethods3);
var getFulfillmentMethod4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getFulfillmentMethod3);
var updateFulfillmentMethod4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updateFulfillmentMethod3);
var deleteFulfillmentMethod4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(deleteFulfillmentMethod3);
var queryFulfillmentMethods4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(queryFulfillmentMethods3);
var listFulfillmentMethods4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(listFulfillmentMethods3);
var listAvailableFulfillmentMethodsForAddress4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(
  listAvailableFulfillmentMethodsForAddress3
);
var getAccumulatedFulfillmentMethodsAvailability4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(
  getAccumulatedFulfillmentMethodsAvailability3
);
var getCombinedMethodAvailability4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getCombinedMethodAvailability3);
var getAggregatedMethodAvailability4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getAggregatedMethodAvailability3);
var bulkUpdateFulfillmentMethodTags4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(bulkUpdateFulfillmentMethodTags3);
var bulkUpdateFulfillmentMethodTagsByFilter4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(
  bulkUpdateFulfillmentMethodTagsByFilter3
);
var onFulfillmentMethodCreated2 = (0, import_event_definition_modules.createEventModule)(
  onFulfillmentMethodCreated
);
var onFulfillmentMethodDeleted2 = (0, import_event_definition_modules.createEventModule)(
  onFulfillmentMethodDeleted
);
var onFulfillmentMethodUpdated2 = (0, import_event_definition_modules.createEventModule)(
  onFulfillmentMethodUpdated
);

...
interface DeleteFulfillmentMethodSignature {
     ...
     * @param - The ID of the fulfillment method to delete.
     */
    (fulfillmentMethodId: string): Promise<void>;
}
declare function queryFulfillmentMethods$1(httpClient: HttpClient): QueryFulfillmentMethodsSignature;
interface QueryFulfillmentMethodsSignature {
    /**
...
declare const queryFulfillmentMethods: MaybeContext<BuildRESTFunction<typeof queryFulfillmentMethods$1> & typeof queryFulfillmentMethods$1>;
...
declare const listAvailableFulfillmentMethodsForAddress: MaybeContext<BuildRESTFunction<typeof listAvailableFulfillmentMethodsForAddress$1> & typeof listAvailableFulfillmentMethodsForAddress$1>;
declare const getAccumulatedFulfillmentMethodsAvailability: MaybeContext<BuildRESTFunction<typeof getAccumulatedFulfillmentMethodsAvailability$1> & typeof getAccumulatedFulfillmentMethodsAvailability$1>;
declare const getCombinedMethodAvailability: MaybeContext<BuildRESTFunction<typeof getCombinedMethodAvailability$1> & typeof getCombinedMethodAvailability$1>;
declare const getAggregatedMethodAvailability: MaybeContext<BuildRESTFunction<typeof getAggregatedMethodAvailability$1> & typeof getAggregatedMethodAvailability$1>;
declare const bulkUpdateFulfillmentMethodTags: MaybeContext<BuildRESTFunction<typeof bulkUpdateFulfillmentMethodTags$1> & typeof bulkUpdateFulfillmentMethodTags$1>;
declare const bulkUpdateFulfillmentMethodTagsByFilter: MaybeContext<BuildRESTFunction<typeof bulkUpdateFulfillmentMethodTagsByFilter$1> & typeof bulkUpdateFulfillmentMethodTagsByFilter$1>;
/** */
declare const onFulfillmentMethodCreated: BuildEventDefinition<typeof onFulfillmentMethodCreated$1> & typeof onFulfillmentMethodCreated$1;
/**
 * Triggered when a fulfillment method is deleted.
 */
declare const onFulfillmentMethodDeleted: BuildEventDefinition<typeof onFulfillmentMethodDeleted$1> & typeof onFulfillmentMethodDeleted$1;
/**
 * Triggered when a fulfillment method is updated.
 */
declare const onFulfillmentMethodUpdated: BuildEventDefinition<typeof onFulfillmentMethodUpdated$1> & typeof onFulfillmentMethodUpdated$1;

...
// src/restaurants-v1-fulfillment-method-fulfillment-methods.types.ts
...
// src/restaurants-v1-fulfillment-method-fulfillment-methods.meta.ts
function createFulfillmentMethod2() {
  const payload = {};
  const getRequestOptions = createFulfillmentMethod(
    payload
  );
...
function bulkCreateFulfillmentMethods2() {
  const payload = {};
  const getRequestOptions = bulkCreateFulfillmentMethods(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getFulfillmentMethod2() {
  const payload = { fulfillmentMethodId: ":fulfillmentMethodId" };
  const getRequestOptions = getFulfillmentMethod(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateFulfillmentMethod2() {
  const payload = { fulfillmentMethod: { id: ":fulfillmentMethodId" } };
  const getRequestOptions = updateFulfillmentMethod(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function deleteFulfillmentMethod2() {
  const payload = { fulfillmentMethodId: ":fulfillmentMethodId" };
  const getRequestOptions = deleteFulfillmentMethod(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function queryFulfillmentMethods2() {
  const payload = {};
  const getRequestOptions = queryFulfillmentMethods(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function listFulfillmentMethods2() {
  const payload = {};
  const getRequestOptions = listFulfillmentMethods(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listAvailableFulfillmentMethodsForAddress2() {
  const payload = {};
  const getRequestOptions = listAvailableFulfillmentMethodsForAddress(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getAccumulatedFulfillmentMethodsAvailability2() {
  const payload = {};
  const getRequestOptions = getAccumulatedFulfillmentMethodsAvailability(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getCombinedMethodAvailability2() {
  const payload = {};
  const getRequestOptions = getCombinedMethodAvailability(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getAggregatedMethodAvailability2() {
  const payload = {};
  const getRequestOptions = getAggregatedMethodAvailability(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function bulkUpdateFulfillmentMethodTags2() {
  const payload = {};
  const getRequestOptions = bulkUpdateFulfillmentMethodTags(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function bulkUpdateFulfillmentMethodTagsByFilter2() {
  const payload = {};
  const getRequestOptions = bulkUpdateFulfillmentMethodTagsByFilter(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
export {
  ...
  bulkCreateFulfillmentMethods2 as bulkCreateFulfillmentMethods,
  bulkUpdateFulfillmentMethodTags2 as bulkUpdateFulfillmentMethodTags,
  bulkUpdateFulfillmentMethodTagsByFilter2 as bulkUpdateFulfillmentMethodTagsByFilter,
  createFulfillmentMethod2 as createFulfillmentMethod,
  deleteFulfillmentMethod2 as deleteFulfillmentMethod,
  getAccumulatedFulfillmentMethodsAvailability2 as getAccumulatedFulfillmentMethodsAvailability,
  getAggregatedMethodAvailability2 as getAggregatedMethodAvailability,
  getCombinedMethodAvailability2 as getCombinedMethodAvailability,
  getFulfillmentMethod2 as getFulfillmentMethod,
  listAvailableFulfillmentMethodsForAddress2 as listAvailableFulfillmentMethodsForAddress,
  listFulfillmentMethods2 as listFulfillmentMethods,
  queryFulfillmentMethods2 as queryFulfillmentMethods,
  updateFulfillmentMethod2 as updateFulfillmentMethod
};

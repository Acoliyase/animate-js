...
/** @enumType */
type FulfillmentMethodTypeWithLiterals = FulfillmentMethodType | 'UNKNOWN_FULFILLMENT_TYPE' | 'PICKUP' | 'DELIVERY';
...
/** @enumType */
type TypeWithLiterals = Type | 'UNKNOWN_DELIVERY_AREA' | 'RADIUS' | 'POSTAL_CODE' | 'CUSTOM' | 'PROVIDER_DEFINED';
interface Radius {
    /**
...
/** @enumType */
type UnitWithLiterals = Unit | 'UNKNOWN_UNIT' | 'MILES' | 'KILOMETERS';
...
interface GetAggregatedMethodAvailabilityRequest {
    /**
...
interface GetAggregatedMethodAvailabilityResponse {
...
interface BulkUpdateFulfillmentMethodTagsRequest {
    /**
...
interface BulkUpdateFulfillmentMethodTagsResponse {
    /**
...
interface BulkUpdateFulfillmentMethodTagsResult {
...
interface BulkUpdateFulfillmentMethodTagsByFilterRequest {
...
interface BulkUpdateFulfillmentMethodTagsByFilterResponse {
    /**
...
/** @docsIgnore */
type BulkUpdateFulfillmentMethodTagsApplicationErrors = {
    code?: 'EMPTY_ASSIGN_AND_UNASSIGN_LISTS';
    description?: string;
    data?: Record<string, any>;
};
/** @docsIgnore */
type BulkUpdateFulfillmentMethodTagsByFilterApplicationErrors = {
    code?: 'EMPTY_ASSIGN_AND_UNASSIGN_LISTS';
    description?: string;
    data?: Record<string, any>;
};

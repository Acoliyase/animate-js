...
interface CustomField {
     ...
     * @readonly
     */
    appliesTo?: AppliesToAppliesToWithLiterals;
    /**
...
/** @enumType */
type AppliesToAppliesToWithLiterals = AppliesToAppliesTo | 'ALL_MEMBERS' | 'SELECTED_MEMBERS';
 ...
 * @param application - Custom field application details.
 * @public
 ...
 * @fqn com.wixpress.members.customfields.applications.CustomFieldApplications.CreateCustomFieldApplication
 */
declare function createCustomFieldApplication(application: NonNullablePaths<CustomFieldApplication, `applications.items.${number}.entityId` | `customFieldId` | `exclusions.items.${number}.entityId`, 5>): Promise<NonNullablePaths<CustomFieldApplication, `applications.items` | `applications.items.${number}.applicationType` | `exclusions.items` | `exclusions.items.${number}.exclusionType`, 5>>;
/**
 * Deletes a custom field application.
 *
 * When you delete the application, the field is automatically applied to all members.
 * @param customFieldId - ID of the custom field with an application to delete.
 * @public
 * @documentationMaturity preview
 * @requiredField customFieldId
 * @permissionId MEMBERS.CUSTOM_FIELDS_DELETE
 * @applicableIdentity APP
 * @fqn com.wixpress.members.customfields.applications.CustomFieldApplications.DeleteCustomFieldApplication
 */
declare function deleteCustomFieldApplication(customFieldId: string): Promise<void>;
/**
 ...
 * @fqn com.wixpress.members.customfields.applications.CustomFieldApplications.UpdateCustomFieldApplication
 */
declare function updateCustomFieldApplication(customFieldId: string, application: NonNullablePaths<UpdateCustomFieldApplication, `applications.items.${number}.entityId` | `exclusions.items.${number}.entityId` | `revision`, 5>): Promise<NonNullablePaths<CustomFieldApplication, `applications.items` | `applications.items.${number}.applicationType` | `exclusions.items` | `exclusions.items.${number}.exclusionType`, 5>>;

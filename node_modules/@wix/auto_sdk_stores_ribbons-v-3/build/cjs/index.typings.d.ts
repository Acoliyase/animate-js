 ...
 * @requiredField query
 */
declare function typedQueryRibbons(query: CursorQuery, options?: QueryRibbonsOptions): Promise<NonNullablePaths<QueryRibbonsResponse, `ribbons` | `ribbons.${number}.name`, 4>>;
/**

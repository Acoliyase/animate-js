...
async function typedQueryBackInStockNotificationRequests(query) {
  const { httpClient, sideEffects } = arguments[1];
...
function typedQueryBackInStockNotificationRequests2(httpClient) {
  return (query) => typedQueryBackInStockNotificationRequests(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryBackInStockNotificationRequests(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryBackInStockNotificationRequests3(httpClient)(),
    typedQueryFunction: (query) => typedQueryBackInStockNotificationRequests2(httpClient)(query),
...
var queryBackInStockNotificationRequests4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryBackInStockNotificationRequests);

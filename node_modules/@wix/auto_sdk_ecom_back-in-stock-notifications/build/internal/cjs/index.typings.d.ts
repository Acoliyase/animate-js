 ...
 * @requiredField query
 */
declare function typedQueryBackInStockNotificationRequests(query: PlatformQuery): Promise<NonNullablePaths<QueryBackInStockNotificationRequestsResponse, `requests` | `requests.${number}.catalogReference.catalogItemId` | `requests.${number}.catalogReference.appId` | `requests.${number}.email` | `requests.${number}.status`, 5>>;
/**

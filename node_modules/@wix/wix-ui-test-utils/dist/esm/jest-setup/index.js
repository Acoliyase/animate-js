...
console.error = (...args) => {
    const shouldIgnoreError = args.some((arg) => typeof arg === 'string' &&
        ignoredErrors.some((ignoredError) => arg.includes(ignoredError)));

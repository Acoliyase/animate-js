...
import { CreateCartOptions, Cart, GetCartApplicationErrors, UpdateCart, RefreshCartResponse, CalculateCartOptions, CalculateCartResponse, GetCheckoutUrlOptions, GetCheckoutURLResponse, PlaceOrderOptions, PlaceOrderResponse, AddLineItemsOptions, AddLineItemsResponse, RemoveLineItemsResponse, UpdateLineItemsOptions, UpdateLineItemsResponse, CouponInput, AddCouponResponse, RemoveCouponResponse, DeliveryMethodInput, SetDeliveryMethodResponse, GiftCardInput, AddGiftCardResponse, RemoveGiftCardResponse, MarkCartAsCompletedOptions, MarkCartAsCompletedResponse, RawHttpResponse } from './index.typings.js';
...
interface PlaceOrderSignature {
     ...
     * @param - Cart ID.
     */
    (cartId: string, options?: PlaceOrderOptions): Promise<NonNullablePaths<PlaceOrderResponse, `orderId` | `completed`, 2>>;
}

...
interface QueryCurrentMemberConnectionsSignature {
     ...
     */
    (connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMyMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 4>>;
}
...
interface QueryMemberConnectionsSignature {
     ...
     */
    (memberId: string, connectedMemberIds: string[]): Promise<NonNullablePaths<QueryMemberConnectionsResponse, `connectedMembers` | `connectedMembers.${number}.connectedMemberId` | `connectedMembers.${number}.followedByMember` | `connectedMembers.${number}.followingMember`, 4>>;
}

...
class UniDriverBase extends UniDriverBaseCommon_1.UniDriverBaseCommon {
    constructor() {
        super(...arguments);
    ...
    $(selector) {
        return this.s(internal_1.unidriverConfig.queryByAttribute(selector));
    }
    $$(selector) {
        return this.ss(internal_1.unidriverConfig.queryByAttribute(selector));
    }
    async attr(attr) {
        return this.runWithinTimeBudget(async () => {
    ...
    async pressKey(key) {
        await this.runWithinTimeBudget(async () => {
            const meta = internal_1.keyMeta[key];
    ...
    async getBaseElement() {
        ...
        if (!base) {
            throw new errors_1.NoElementWithSelectorError({ selector: (await this.ctx.selector) ?? '' });
        }
        return base;
    }
...
exports.UniDriverBase = UniDriverBase;

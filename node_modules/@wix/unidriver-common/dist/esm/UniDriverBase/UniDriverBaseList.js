...
import { NoElementWithSelectorError } from './errors';
export class UniDriverBaseList extends UniDriverBaseCommon {
    constructor() {
        super(...arguments);
            ...
            base: async () => {
                ...
                if (!cont[idx]) {
                    throw new NoElementWithSelectorError({
                        fullPath: await getSelectorsPath(this.ctx),
    ...
    async count() {
        try {
            ...
            if (e instanceof NoElementWithSelectorError &&

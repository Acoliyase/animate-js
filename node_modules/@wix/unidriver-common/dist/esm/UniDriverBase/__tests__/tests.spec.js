...
import { AsyncChildrenApp, TestApp, runAllSuites } from '../../exports-testing';
import { delay } from '../../utils/delay';
import { describe, assertType } from 'vitest';
describe('Common Test Suite', () => {
    runAllSuites({
        setup: (props) => {
            const { container } = render(React.createElement(TestApp, { ...props }));
...
describe('Adapter Specific', () => {
    ...
    describe('constructor params', () => {
        describe('base element', () => {
            ...
            it('should work with base element as a Promise', async () => {
                const { container } = render(React.createElement("div", null,
                    React.createElement("section", null)));
                const driver = testUniDriver(Promise.resolve(container));
                expect(await driver.$('section').exists()).toBe(true);
            });
        });
        describe('should work with {selector, root}', () => {
            it('should work when selector is non Promise', async () => {
                const { container } = render(React.createElement("div", null,
                    React.createElement("section", null, "test")));
                const driver = testUniDriver({
                    selector: 'section',
                    root: container,
                });
        ...
        describe('function', () => {
            ...
            it('should work with base element which is delayed', async () => {
                const { container } = render(React.createElement(AsyncChildrenApp, { timeout: 30 },
        ...
        describe('async function', () => {
            it('should work with base element', async () => {
                const { container } = render(React.createElement("div", null,
                    React.createElement("section", null)));
                const driver = testUniDriver(async () => container);
                expect(await driver.$('section').exists()).toBe(true);
            });
        });
    });
    describe('click', () => {
        ...
        it('should trigger button events when clicked', async () => {
            ...
            const onFocus = vi.fn();
            const { container } = render(React.createElement("button", { onClick: onClick, onFocus: onFocus, onMouseDown: onMouseDown, onMouseUp: onMouseUp }));
            const driver = testUniDriver(container);
        ...
        it(`should trigger double click if {type: 'double'} is passed`, async () => {
            ...
            const { container } = render(React.createElement("input", { onDoubleClick: onDoubleClick, type: "checkbox" }));
            const driver = testUniDriver(container);
        ...
        it('should trigger input events in order', async () => {
            ...
            const { container } = render(React.createElement("input", { onChange: onChange, onClick: onClick, onFocus: onFocus, onInput: onInput, onMouseDown: onMouseDown, onMouseUp: onMouseUp, type: "checkbox" }));
            const driver = testUniDriver(container);
        ...
        it('should trigger focus and blur in order when clicking two buttons', async () => {
            ...
            const { container } = render(React.createElement(React.Fragment, null,
                React.createElement("button", { id: "A", onBlur: onBlurA, onFocus: onFocusA }, "button A"),
        ...
        it('should not call onFocus when given disabled button', async () => {
            const onFocusA = vi.fn();
            const { container } = render(React.createElement("button", { disabled: true, id: "A", onFocus: onFocusA }, "button B"));
            const driver = testUniDriver(container);
    ...
    describe('enterText', () => {
        it('should change input value when entering', async () => {
            const onChange = vi.fn();
            const { container } = render(React.createElement("input", { name: "search", onChange: (event) => {
        ...
        it('should change input value when given uncontrolled input', async () => {
            const { container } = render(React.createElement("input", { name: "search", type: "text" }));
            const driver = testUniDriver(container);

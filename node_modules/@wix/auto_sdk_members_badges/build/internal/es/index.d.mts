...
interface UpdateBadgesDisplayOrderSignature {
     ...
     * @deprecated
     */
    (badgeIds: string[]): Promise<NonNullablePaths<UpdateBadgesDisplayOrderResponse, `badges` | `badges.${number}._id`, 4>>;
}

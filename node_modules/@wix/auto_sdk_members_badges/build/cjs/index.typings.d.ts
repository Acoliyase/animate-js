 ...
 */
declare function createBadge(badge: NonNullablePaths<Badge, `backgroundColor` | `textColor` | `title`, 2>): Promise<NonNullablePaths<Badge, `_id`, 2>>;
/**
 * Updates a badge.
 *
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function updateBadge(_id: string, badge: UpdateBadge): Promise<NonNullablePaths<Badge, `_id`, 2>>;
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function listBadges(options?: ListBadgesOptions): Promise<NonNullablePaths<ListBadgesResponse, `badges` | `badges.${number}._id`, 4>>;
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function getBadge(_id: string): Promise<NonNullablePaths<Badge, `_id`, 2>>;
/**
 * Deletes a badge.
 * @param _id - Badge ID.
 * @public
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function assignBadge(_id: string, memberIds: string[]): Promise<NonNullablePaths<AssignBadgeResponse, `memberIds`, 2>>;
/**
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function listMembersByBadge(_id: string, options?: ListMembersByBadgeOptions): Promise<NonNullablePaths<ListMembersResponse, `memberIds`, 2>>;
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function listBadgesPerMember(memberIds: string[]): Promise<NonNullablePaths<ListMembersBadgeIdsResponse, `memberBadgeIds` | `memberBadgeIds.${number}.memberId`, 4>>;
/**
 ...
 * @targetRemovalDate 2026-03-31
 */
declare function getMemberCountsPerBadge(): Promise<NonNullablePaths<GetMemberCountsPerBadgeResponse, `badgeMemberCounts` | `badgeMemberCounts.${number}.badgeId` | `badgeMemberCounts.${number}.memberCount`, 4>>;
/**

 ...
 * @permissionId WIX_RESTAURANTS.RESTAURANT_LOCATIONS_READ
 * @applicableIdentity APP
 * @fqn com.wixpress.restaurants.restaurantlocations.v3.RestaurantLocationsService.ListRestaurantLocations
 */
declare function listRestaurantLocations(options?: ListRestaurantLocationsOptions): Promise<NonNullablePaths<ListRestaurantLocationsResponse, `restaurantLocations` | `restaurantLocations.${number}.active` | `restaurantLocations.${number}.location.default` | `restaurantLocations.${number}.location.timeZone`, 5>>;
...
export { type Address, type AddressLocation, type AddressStreetOneOf, type Availability, type ContactDetails, DayOfWeek, type DayOfWeekWithLiterals, type GetRestaurantLocationRequest, type GetRestaurantLocationResponse, type ListRestaurantLocationsOptions, type ListRestaurantLocationsRequest, type ListRestaurantLocationsResponse, type Locale, type Location, type RestaurantLocation, type SpecialHourPeriod, type StandardDetails, type StreetAddress, type Subdivision, SubdivisionType, type SubdivisionTypeWithLiterals, type TimePeriod, getRestaurantLocation, listRestaurantLocations };

...
declare enum ApproximateAddresses {
    EMPTY = "EMPTY",
    BLOCK = "BLOCK",
    ALLOW = "ALLOW"
}
/** @enumType */
type ApproximateAddressesWithLiterals = ApproximateAddresses | 'EMPTY' | 'BLOCK' | 'ALLOW';
/** Local regulations may require you to add a policy document to your site. */
interface Policies {
    /** Privacy policy */
...
/** @enumType */
type TypeWithLiterals = Type | 'URL' | 'TEXT';
...
/** @enumType */
type TipsTypeWithLiterals = TipsType | 'AMOUNT' | 'PERCENTAGE';
...
declare enum ChargeRoundingStrategy {
    UNDEFINED = "UNDEFINED",
...
/** @enumType */
type ChargeRoundingStrategyWithLiterals = ChargeRoundingStrategy | 'UNDEFINED' | 'HALF_AWAY_FROM_ZERO' | 'HALF_EVEN';

...
interface Activity extends ActivityContentOneOf {
    ...
    type?: ActivityType;
    /** Activity type. */
    activityType?: OrderActivityTypeEnumActivityType;
}
/** @oneof */
...
interface LineItemModifiersChange {
     ...
     * @maxSize 10
     */
    addedModifierGroups?: V1ModifierGroup[];
    /**
     * Modifier groups that were removed from the line item.
     * @maxSize 10
     */
    removedModifierGroups?: V1ModifierGroup[];
}

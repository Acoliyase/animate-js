...
interface PatchDataCollectionRequest {
    /** Data collection to patch. Only fields specified in the field_mask are updated. */
    dataCollection: DataCollection;
}
interface PatchDataCollectionResponse {
    /** The updated data collection. */
    dataCollection?: DataCollection;
}

// src/payments-psp-v1-provider-platform-event-psp-callbacks.universal.ts
import { transformError as sdkTransformError } from "@wix/sdk-runtime/transform-error";
import { renameKeysFromSDKRequestToRESTRequest } from "@wix/sdk-runtime/rename-all-nested-keys";

// src/payments-psp-v1-provider-platform-event-psp-callbacks.http.ts
...
var PACKAGE_NAME = "@wix/auto_sdk_payments_psp-callbacks";
...
// src/payments-psp-v1-provider-platform-event-psp-callbacks.universal.ts
async function submitEvent2(event) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({ event });
  const reqOpts = submitEvent(payload);
...
// src/payments-psp-v1-provider-platform-event-psp-callbacks.public.ts
function submitEvent3(httpClient) {
  return (event) => submitEvent2(
    event,
    // @ts-ignore
    { httpClient }
  );
...
// src/payments-psp-v1-provider-platform-event-psp-callbacks.context.ts
import { createRESTModule } from "@wix/sdk-runtime/rest-modules";
var submitEvent4 = /* @__PURE__ */ createRESTModule(submitEvent3);
export {
  submitEvent4 as submitEvent
};

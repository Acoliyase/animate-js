...
/** @enumType */
type DisputeStageWithLiterals = DisputeStage | 'UNKNOWN_DISPUTE_STAGE' | 'RFI' | 'CHARGEBACK';
 ...
 */
declare function getDisputeHistoryRecord(disputeHistoryRecordId: string): Promise<NonNullablePaths<DisputeHistoryRecord, `disputeId` | `stage` | `status` | `chargeId` | `channel` | `tags.tags.tagIds`, 4>>;
/**

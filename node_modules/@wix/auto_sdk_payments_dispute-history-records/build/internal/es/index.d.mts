...
interface GetDisputeHistoryRecordSignature {
     ...
     */
    (disputeHistoryRecordId: string): Promise<NonNullablePaths<DisputeHistoryRecord, `disputeId` | `stage` | `status` | `chargeId` | `channel` | `tags.tags.tagIds`, 4>>;
}
/** @internal */

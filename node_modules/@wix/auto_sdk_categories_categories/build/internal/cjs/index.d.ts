...
/** @internal */
declare function setItemCategories$1(httpClient: HttpClient): SetItemCategoriesSignature;
interface SetItemCategoriesSignature {
    /**
     ...
     */
    (item: NonNullablePaths<ItemReference, `appId` | `catalogItemId`, 2>, options: NonNullablePaths<SetItemCategoriesOptions, `categoryIds` | `treeReference` | `treeReference.appNamespace`, 3>): Promise<void & {
        __applicationErrorsType?: SetItemCategoriesApplicationErrors;
    }>;
}
...
/** @internal */
declare const setItemCategories: MaybeContext<BuildRESTFunction<typeof setItemCategories$1> & typeof setItemCategories$1>;
/**
 * Triggered when a category is moved.
 */
declare const onCategoryMoved: BuildEventDefinition<typeof onCategoryMoved$1>;
/** */

...
function setItemCategories2() {
  const payload = {};
  const getRequestOptions = setItemCategories(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v1/categories/set-item-categories",
    pathParams: {},
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,
...
export {
  ...
  setItemCategories2 as setItemCategories,

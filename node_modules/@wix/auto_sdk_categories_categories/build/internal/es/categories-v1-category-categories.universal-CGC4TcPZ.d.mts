 ...
 * @fqn com.wix.categories.api.v1.CategoriesService.SetItemCategories
 */
declare function setItemCategories(item: NonNullablePaths<ItemReference, `appId` | `catalogItemId`, 2>, options: NonNullablePaths<SetItemCategoriesOptions, `categoryIds` | `treeReference` | `treeReference.appNamespace`, 3>): Promise<void & {
...
export { type SetItemCategoriesApplicationErrors as $, type BulkRemoveItemsFromCategoryResponse as A, type BulkUpdateCategoriesOptions as B, type Category as C, type DeleteCategoryApplicationErrors as D, type BulkRemoveItemsFromCategoryApplicationErrors as E, type BulkRemoveItemFromCategoriesOptions as F, type GetCategoryOptions as G, type BulkRemoveItemFromCategoriesResponse as H, type ItemReference as I, type BulkRemoveItemFromCategoriesApplicationErrors as J, type ListItemsInCategoryResponse as K, type ListItemsInCategoryOptions as L, type MoveCategoryOptions as M, type ListCategoriesForItemOptions as N, type ListCategoriesForItemResponse as O, type ListCategoriesForItemsOptions as P, type QueryCategoriesOptions as Q, type ListCategoriesForItemsResponse as R, type SearchCategoriesOptions as S, type TreeReference as T, type UpdateCategory as U, type ListTreesResponse as V, type SetArrangedItemsOptions as W, type SetArrangedItemsResponse as X, type SetArrangedItemsApplicationErrors as Y, type GetArrangedItemsResponse as Z, type SetItemCategoriesOptions as _, type CreateCategoryOptions as a, type Tag as a$, type CategoryMovedEnvelope as a0, type CategoryCreatedEnvelope as a1, type CategoryDeletedEnvelope as a2, type CategoryItemAddedToCategoryEnvelope as a3, type CategoryItemRemovedFromCategoryEnvelope as a4, type CategoryItemsArrangedInCategoryEnvelope as a5, type CategoryUpdatedEnvelope as a6, NodeType as a7, WidthType as a8, PluginContainerDataAlignment as a9, Type as aA, Alignment as aB, Layout as aC, AppType as aD, InitialExpandedItems as aE, Direction as aF, VerticalAlignment as aG, NullValue as aH, SingleEntityOpsRequestedFields as aI, SortOrder as aJ, RequestedFields as aK, SortType as aL, SortDirection as aM, MissingValues as aN, ScalarType as aO, NestedAggregationType as aP, Interval as aQ, AggregationType as aR, Mode as aS, Position as aT, MoveItemInCategoryRequestPosition as aU, WebhookIdentityType as aV, type BreadcrumbsInfo as aW, type Breadcrumb as aX, type ParentCategory as aY, type SeoSchema as aZ, type Keyword as a_, ButtonDataType as aa, Target as ab, TextAlignment as ac, LineStyle as ad, Width as ae, DividerDataAlignment as af, ViewMode as ag, LayoutType as ah, Orientation as ai, Crop as aj, ThumbnailsAlignment as ak, GIFType as al, Source as am, StylesPosition as an, MapType as ao, ViewRole as ap, VoteRole as aq, PollLayoutType as ar, PollLayoutDirection as as, BackgroundType as at, DecorationType as au, FontType as av, ImageStylesPosition as aw, AspectRatio as ax, Resizing as ay, Placement as az, type CreateCategoryApplicationErrors as b, type DecorationDataOneOf as b$, type Settings as b0, type RichContent as b1, type Node as b2, type NodeDataOneOf as b3, type NodeStyle as b4, type ButtonData as b5, type Border as b6, type Colors as b7, type PluginContainerData as b8, type PluginContainerDataWidth as b9, type HeadingData as bA, type HTMLData as bB, type HTMLDataDataOneOf as bC, type ImageData as bD, type StylesBorder as bE, type ImageDataStyles as bF, type LinkPreviewData as bG, type LinkPreviewDataStyles as bH, type MapData as bI, type MapSettings as bJ, type ParagraphData as bK, type PollData as bL, type Permissions as bM, type Option as bN, type PollSettings as bO, type PollLayout as bP, type OptionLayout as bQ, type Gradient as bR, type Background as bS, type BackgroundBackgroundOneOf as bT, type PollDesign as bU, type OptionDesign as bV, type Poll as bW, type PollDataLayout as bX, type Design as bY, type TextData as bZ, type Decoration as b_, type PluginContainerDataWidthDataOneOf as ba, type Spoiler as bb, type Height as bc, type Styles as bd, type Link as be, type LinkDataOneOf as bf, type Rel as bg, type CodeBlockData as bh, type TextStyle as bi, type DividerData as bj, type FileData as bk, type FileSource as bl, type FileSourceDataOneOf as bm, type PDFSettings as bn, type GalleryData as bo, type Media as bp, type Image as bq, type Video as br, type Item as bs, type ItemDataOneOf as bt, type GalleryOptions as bu, type GalleryOptionsLayout as bv, type ItemStyle as bw, type Thumbnails as bx, type GIFData as by, type GIF as bz, type UpdateCategoryOptions as c, type CursorPagingMetadata as c$, type AnchorData as c0, type ColorData as c1, type LinkData as c2, type MentionData as c3, type FontSizeData as c4, type SpoilerData as c5, type AppEmbedData as c6, type AppEmbedDataAppDataOneOf as c7, type BookingData as c8, type EventData as c9, type InvalidateCache as cA, type InvalidateCacheGetByOneOf as cB, type App as cC, type Page as cD, type URI as cE, type File as cF, type CustomTag as cG, type CategoryMoved as cH, type ItemAddedToCategory as cI, type ItemsAddedToCategory as cJ, type ItemRemovedFromCategory as cK, type ItemsRemovedFromCategory as cL, type ItemsArrangedInCategory as cM, type CreateCategoryRequest as cN, type CreateCategoryResponse as cO, type GetCategoryRequest as cP, type GetCategoryResponse as cQ, type UpdateCategoryRequest as cR, type UpdateCategoryResponse as cS, type DeleteCategoryRequest as cT, type DeleteCategoryResponse as cU, type QueryCategoriesRequest as cV, type CursorQuery as cW, type CursorQueryPagingMethodOneOf as cX, type Sorting as cY, type CursorPaging as cZ, type QueryCategoriesResponse as c_, type ButtonStyles as ca, type ImageStyles as cb, type RibbonStyles as cc, type CardStyles as cd, type PricingData as ce, type VideoData as cf, type PlaybackOptions as cg, type EmbedData as ch, type Oembed as ci, type CollapsibleListData as cj, type TableData as ck, type Dimensions as cl, type TableCellData as cm, type CellStyle as cn, type BorderColors as co, type ListValue as cp, type AudioData as cq, type OrderedListData as cr, type BulletedListData as cs, type BlockquoteData as ct, type CaptionData as cu, type LayoutCellData as cv, type Metadata as cw, type DocumentStyle as cx, type TextNodeStyle as cy, type ExtendedFields as cz, type UpdateCategoryApplicationErrors as d, type BulkAddItemToCategoriesRequest as d$, type Cursors as d0, type ListCompactCategoriesByIdsRequest as d1, type ListCompactCategoriesByIdsResponse as d2, type CompactCategory as d3, type SearchCategoriesRequest as d4, type CursorSearch as d5, type CursorSearchPagingMethodOneOf as d6, type Aggregation as d7, type AggregationKindOneOf as d8, type RangeBucket as d9, type DateHistogramResult as dA, type GroupByValueResults as dB, type DateHistogramResults as dC, type NestedResults as dD, type AggregationResults as dE, type AggregationResultsResultOneOf as dF, type DeprecatedSearchCategoriesWithOffsetRequest as dG, type OffsetSearch as dH, type OffsetSearchPagingMethodOneOf as dI, type Paging as dJ, type DeprecatedSearchCategoriesWithOffsetResponse as dK, type PagingMetadata as dL, type CountCategoriesRequest as dM, type MoveCategoryRequest as dN, type BulkUpdateCategoriesRequest as dO, type BulkCategoriesResult as dP, type ItemMetadata as dQ, type ApplicationError as dR, type BulkActionMetadata as dS, type UpdateCategoryVisibilityRequest as dT, type BulkShowCategoriesRequest as dU, type BulkDeleteCategoriesRequest as dV, type BulkDeleteCategoriesResponse as dW, type BulkDeleteCategoriesResponseBulkCategoriesResult as dX, type BulkAddItemsToCategoryRequest as dY, type BulkItemsToCategoryResult as dZ, type ItemReferenceMetadata as d_, type IncludeMissingValuesOptions as da, type ValueAggregation as db, type ValueAggregationOptionsOneOf as dc, type RangeAggregation as dd, type ScalarAggregation as de, type DateHistogramAggregation as df, type NestedAggregationItem as dg, type NestedAggregationItemKindOneOf as dh, type NestedAggregation as di, type SearchDetails as dj, type AggregationData as dk, type ValueAggregationResult as dl, type RangeAggregationResult as dm, type NestedAggregationResults as dn, type NestedAggregationResultsResultOneOf as dp, type ValueResults as dq, type RangeResults as dr, type AggregationResultsScalarResult as ds, type NestedValueAggregationResult as dt, type ValueResult as du, type RangeResult as dv, type ScalarResult as dw, type NestedResultValue as dx, type NestedResultValueResultOneOf as dy, type Results as dz, type CategoriesQueryBuilder as e, type PlacementWithLiterals as e$, type BulkItemToCategoriesResult as e0, type BulkRemoveItemsFromCategoryRequest as e1, type BulkRemoveItemFromCategoriesRequest as e2, type ListItemsInCategoryRequest as e3, type ListItemsInCategoryRequestPagingMethodOneOf as e4, type PagingMetadataV2 as e5, type ListCategoriesForItemRequest as e6, type ListCategoriesForItemsRequest as e7, type MapItemToCategories as e8, type ListTreesRequest as e9, type WidthTypeWithLiterals as eA, type PluginContainerDataAlignmentWithLiterals as eB, type ButtonDataTypeWithLiterals as eC, type TargetWithLiterals as eD, type TextAlignmentWithLiterals as eE, type LineStyleWithLiterals as eF, type WidthWithLiterals as eG, type DividerDataAlignmentWithLiterals as eH, type ViewModeWithLiterals as eI, type LayoutTypeWithLiterals as eJ, type OrientationWithLiterals as eK, type CropWithLiterals as eL, type ThumbnailsAlignmentWithLiterals as eM, type GIFTypeWithLiterals as eN, type SourceWithLiterals as eO, type StylesPositionWithLiterals as eP, type MapTypeWithLiterals as eQ, type ViewRoleWithLiterals as eR, type VoteRoleWithLiterals as eS, type PollLayoutTypeWithLiterals as eT, type PollLayoutDirectionWithLiterals as eU, type BackgroundTypeWithLiterals as eV, type DecorationTypeWithLiterals as eW, type FontTypeWithLiterals as eX, type ImageStylesPositionWithLiterals as eY, type AspectRatioWithLiterals as eZ, type ResizingWithLiterals as e_, type MoveItemInCategoryRequest as ea, type MoveItemInCategoryResponse as eb, type SetArrangedItemsRequest as ec, type GetArrangedItemsRequest as ed, type SetItemCategoriesRequest as ee, type SetItemCategoriesResponse as ef, type GetCategoriesTreeRequest as eg, type GetCategoriesTreeResponse as eh, type CategoryTreeNode as ei, type DomainEvent as ej, type DomainEventBodyOneOf as ek, type EntityCreatedEvent as el, type RestoreInfo as em, type EntityUpdatedEvent as en, type EntityDeletedEvent as eo, type ActionEvent as ep, type Empty as eq, type MessageEnvelope as er, type IdentificationData as es, type IdentificationDataIdOneOf as et, type BaseEventMetadata as eu, type EventMetadata as ev, type CategoriesQueryResult as ew, type CategorySearchSpec as ex, type ListItemsInCategoryOptionsPagingMethodOneOf as ey, type NodeTypeWithLiterals as ez, type CategorySearch as f, type TypeWithLiterals as f0, type AlignmentWithLiterals as f1, type LayoutWithLiterals as f2, type AppTypeWithLiterals as f3, type InitialExpandedItemsWithLiterals as f4, type DirectionWithLiterals as f5, type VerticalAlignmentWithLiterals as f6, type NullValueWithLiterals as f7, type SingleEntityOpsRequestedFieldsWithLiterals as f8, type SortOrderWithLiterals as f9, moveCategory as fA, bulkUpdateCategories as fB, updateCategoryVisibility as fC, bulkShowCategories as fD, bulkAddItemsToCategory as fE, bulkAddItemToCategories as fF, bulkRemoveItemsFromCategory as fG, bulkRemoveItemFromCategories as fH, listItemsInCategory as fI, listCategoriesForItem as fJ, listCategoriesForItems as fK, listTrees as fL, setArrangedItems as fM, getArrangedItems as fN, setItemCategories as fO, type RequestedFieldsWithLiterals as fa, type SortTypeWithLiterals as fb, type SortDirectionWithLiterals as fc, type MissingValuesWithLiterals as fd, type ScalarTypeWithLiterals as fe, type NestedAggregationTypeWithLiterals as ff, type IntervalWithLiterals as fg, type AggregationTypeWithLiterals as fh, type ModeWithLiterals as fi, type PositionWithLiterals as fj, type MoveItemInCategoryRequestPositionWithLiterals as fk, type WebhookIdentityTypeWithLiterals as fl, type CommonSearchWithEntityContext as fm, onCategoryMoved as fn, onCategoryCreated as fo, onCategoryDeleted as fp, onCategoryItemAddedToCategory as fq, onCategoryItemRemovedFromCategory as fr, onCategoryItemsArrangedInCategory as fs, onCategoryUpdated as ft, createCategory as fu, getCategory as fv, updateCategory as fw, deleteCategory as fx, queryCategories as fy, countCategories as fz, type SearchCategoriesResponse as g, type CountCategoriesOptions as h, type CountCategoriesResponse as i, type MoveCategoryResponse as j, type MoveCategoryApplicationErrors as k, type MaskedCategory as l, type BulkUpdateCategoriesResponse as m, type BulkUpdateCategoriesApplicationErrors as n, type UpdateCategoryVisibilityOptions as o, type UpdateCategoryVisibilityResponse as p, type UpdateCategoryVisibilityApplicationErrors as q, type BulkShowCategoriesOptions as r, type BulkShowCategoriesResponse as s, type BulkAddItemsToCategoryOptions as t, type BulkAddItemsToCategoryResponse as u, type BulkAddItemsToCategoryApplicationErrors as v, type BulkAddItemToCategoriesOptions as w, type BulkAddItemToCategoriesResponse as x, type BulkAddItemToCategoriesApplicationErrors as y, type BulkRemoveItemsFromCategoryOptions as z };

...
function getDeliveryProfileByDeliveryRegionId2() {
  const payload = { deliveryRegionId: ":deliveryRegionId" };
  const getRequestOptions = getDeliveryProfileByDeliveryRegionId(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function getDeliveryDestinationProperties2() {
  const payload = {};
  const getRequestOptions = getDeliveryDestinationProperties(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);

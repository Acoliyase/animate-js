...
__export(index_exports, {
  ...
  getDeliveryDestinationProperties: () => getDeliveryDestinationProperties4,
...
function typedQueryDeliveryProfiles2(httpClient) {
  return (query) => typedQueryDeliveryProfiles(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function getDeliveryDestinationProperties3(httpClient) {
  return () => getDeliveryDestinationProperties2(
    // @ts-ignore
    { httpClient }
  );
}
...
function customQueryDeliveryProfiles(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryDeliveryProfiles3(httpClient)(),
    typedQueryFunction: (query) => typedQueryDeliveryProfiles2(httpClient)(query),
...
var getDeliveryDestinationProperties4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getDeliveryDestinationProperties3);
...
var queryDeliveryProfiles4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryDeliveryProfiles);

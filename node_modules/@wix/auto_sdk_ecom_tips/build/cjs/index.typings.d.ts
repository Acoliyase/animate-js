 ...
 * @param draftOrderId - ID of the [draft order](https://dev.wix.com/docs/api-reference/business-solutions/e-commerce/orders/draft-orders/introduction) to retrieve the tip for.
 * @public
 ...
 * @requiredField query
 */
declare function typedQueryTipDistributions(query: CursorQuery): Promise<NonNullablePaths<QueryTipDistributionsResponse, `tipDistributions` | `tipDistributions.${number}.staff.identificationData.anonymousVisitorId` | `tipDistributions.${number}.staff.identificationData.memberId` | `tipDistributions.${number}.staff.identificationData.wixUserId` | `tipDistributions.${number}.staff.identificationData.appId` | `tipDistributions.${number}.source`, 6>>;
/**

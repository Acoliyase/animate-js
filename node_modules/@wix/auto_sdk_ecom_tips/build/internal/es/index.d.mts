...
interface GetTipByDraftOrderIdSignature {
     ...
     * @param - ID of the [draft order](https://dev.wix.com/docs/api-reference/business-solutions/e-commerce/orders/draft-orders/introduction) to retrieve the tip for.
     */
...
declare function customQueryTipDistributions(httpClient: HttpClient): {
    (): TipDistributionsQueryBuilder;
    (query: CursorQuery): ReturnType<typeof typedQueryTipDistributions>;
};

...
function typedQueryTipDistributions2(httpClient) {
  return (query) => typedQueryTipDistributions(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryTipDistributions(httpClient) {
  const router = createQueryOverloadRouter({
    builderQueryFunction: () => queryTipDistributions3(httpClient)(),
    typedQueryFunction: (query) => typedQueryTipDistributions2(httpClient)(query),
...
var queryTipDistributions4 = /* @__PURE__ */ createRESTModule(customQueryTipDistributions);
export {
  IdentityType,
  QueryBy,
  SortOrder,

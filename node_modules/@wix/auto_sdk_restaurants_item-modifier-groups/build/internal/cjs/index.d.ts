...
interface CreateModifierGroupSignature {
     ...
     */
    (modifierGroup: NonNullablePaths<ModifierGroup, `name`, 2>): Promise<NonNullablePaths<ModifierGroup, `modifiers` | `modifiers.${number}._id` | `businessLocationIds`, 4>>;
}
...
interface GetModifierGroupSignature {
     ...
     * @returns Modifier group.
     */
    (modifierGroupId: string): Promise<NonNullablePaths<ModifierGroup, `modifiers` | `modifiers.${number}._id` | `businessLocationIds`, 4>>;
}
...
interface CountModifierGroupsSignature {
     ...
     */
    (options?: CountModifierGroupsOptions): Promise<NonNullablePaths<CountModifierGroupsResponse, `count`, 2> & {
...
interface UpdateModifierGroupSignature {
     ...
     */
    (_id: string, modifierGroup: NonNullablePaths<UpdateModifierGroup, `revision`, 2>): Promise<NonNullablePaths<ModifierGroup, `modifiers` | `modifiers.${number}._id` | `businessLocationIds`, 4>>;
}
...
declare function bulkCreateModifierGroups$1(httpClient: HttpClient): BulkCreateModifierGroupsSignature;
interface BulkCreateModifierGroupsSignature {
     ...
     */
    (modifierGroups: ModifierGroup[], options?: BulkCreateModifierGroupsOptions): Promise<NonNullablePaths<BulkCreateModifierGroupsResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}
...
interface BulkUpdateModifierGroupsSignature {
     ...
     */
    (modifierGroups: NonNullablePaths<MaskedModifierGroup, `modifierGroup._id` | `modifierGroup.revision`, 3>[], options?: BulkUpdateModifierGroupsOptions): Promise<NonNullablePaths<BulkUpdateModifierGroupsResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}

 ...
 * ```
 */
export function getCurrentConsentPolicy() {
 ...
 * ```
 */
export function resetConsentPolicy() {
    const consentPolicyObject = getConsentPolicyObject();
 ...
 * ```
 */
export function onConsentPolicyChanged(handler) {
    const consentPolicyObject = getConsentPolicyObject();
    ...
    try {
        document.addEventListener(EVENTS.CONSENT_POLICY_CHANGED, ((event) => {
 ...
 * ```
 */
export async function setConsentPolicy(policy, successCallback, errorCallback) {
    const consentPolicyObject = getConsentPolicyObject();

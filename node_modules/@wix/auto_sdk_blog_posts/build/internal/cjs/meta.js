...
__export(meta_exports, {
  ...
  PostFieldFieldOriginal: () => PostFieldField,
  QueryPublicationsCountStatsRequestOrderOriginal: () => QueryPublicationsCountStatsRequestOrder,
...
// src/blog-v3-post-posts.types.ts
...
// src/blog-v3-post-posts.meta.ts
function queryPostCountStats2() {
  const payload = {};
  const getRequestOptions = queryPostCountStats(payload);
...
function getTotalPosts2() {
  const payload = {};
  const getRequestOptions = getTotalPosts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getPost2() {
  ...
  const getRequestOptions = getPost(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getPostBySlug2() {
  const payload = { slug: ":slug" };
  const getRequestOptions = getPostBySlug(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listPosts2() {
  const payload = {};
  const getRequestOptions = listPosts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryPosts2() {
  const payload = {};
  const getRequestOptions = queryPosts(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getPostMetrics2() {
  const payload = { postId: ":postId" };
  const getRequestOptions = getPostMetrics(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  ...
  PositionOriginal,
  PostFieldFieldOriginal,
  QueryPublicationsCountStatsRequestOrderOriginal,
  ResizingOriginal,
  SortOrderOriginal,
  SourceOriginal,
  StatusOriginal,

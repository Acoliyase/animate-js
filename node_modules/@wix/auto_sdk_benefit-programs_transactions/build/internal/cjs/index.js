...
__export(index_exports, {
  ...
  getTransaction: () => getTransaction4,
  queryTransactions: () => queryTransactions4
});
...
// src/benefit-programs-v1-transaction-transactions.http.ts
...
var PACKAGE_NAME = "@wix/auto_sdk_benefit-programs_transactions";
...
async function getTransaction2(transactionId) {
  ...
  const reqOpts = getTransaction(payload);
  sideEffects?.onSiteCall?.();
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(result.data)?.transaction;
  } catch (err) {
...
// src/benefit-programs-v1-transaction-transactions.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var getTransaction4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getTransaction3);
var queryTransactions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(queryTransactions3);

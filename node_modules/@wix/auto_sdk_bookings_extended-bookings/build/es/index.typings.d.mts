 ...
 */
declare function queryExtendedBookings(query: CommonQueryV2, options?: QueryExtendedBookingsOptions): Promise<NonNullablePaths<QueryExtendedBookingsResponse, `extendedBookings` | `extendedBookings.${number}.booking.totalParticipants` | `extendedBookings.${number}.booking.status` | `extendedBookings.${number}.booking.paymentStatus` | `extendedBookings.${number}.booking.selectedPaymentOption` | `extendedBookings.${number}.booking.createdBy.anonymousVisitorId` | `extendedBookings.${number}.booking.createdBy.memberId` | `extendedBookings.${number}.booking.createdBy.wixUserId` | `extendedBookings.${number}.booking.createdBy.appId` | `extendedBookings.${number}.allowedActions.cancel` | `extendedBookings.${number}.allowedActions.reschedule` | `extendedBookings.${number}.attendance.status` | `extendedBookings.${number}.attendance.numberOfAttendees` | `extendedBookings.${number}.bookingFeeDetails.cancellationFeeStatus` | `extendedBookings.${number}.order.number` | `extendedBookings.${number}.order.status` | `extendedBookings.${number}.order.paymentStatus` | `extendedBookings.${number}.waiver.status` | `extendedBookings.${number}.invoices.orderId` | `extendedBookings.${number}.transactions.orderId`, 6>>;
 ...
 */
declare function countExtendedBookings(options?: CountExtendedBookingsOptions): Promise<NonNullablePaths<CountExtendedBookingsResponse, `count`, 2>>;
...
export { ActionType, type ActionTypeWithLiterals, Actor, type ActorWithLiterals, type AdditionalFeeRefund, type Address, type AddressLocation, type AddressStreetOneOf, type AggregatedRefundSummary, type AllowedActions, type Attendance, AttendanceStatus, type AttendanceStatusWithLiterals, type AuthorizationActionFailureDetails, type AuthorizationCapture, AuthorizationCaptureStatus, type AuthorizationCaptureStatusWithLiterals, type AuthorizationDetails, type AuthorizationVoid, AuthorizationVoidStatus, type AuthorizationVoidStatusWithLiterals, type Balance, type BalanceSummary, type BookedAddOn, type BookedEntity, type BookedEntityItemOneOf, type BookedResource, type BookedSchedule, type BookedSlot, type Booking, type BookingFeeDetails, BookingFeeStatus, type BookingFeeStatusWithLiterals, type BookingParticipantsInfoOneOf, BookingPaymentStatus, type BookingPaymentStatusWithLiterals, type BookingPolicySettings, type BookingSource, BookingStatus, type BookingStatusWithLiterals, type CatalogReference, type Chargeback, ChargebackStatus, type ChargebackStatusWithLiterals, type CommonPaging, type CommonQueryV2, type CommonQueryV2PagingMethodOneOf, type ConferencingDetails, type ContactDetails, type CountExtendedBookingsOptions, type CountExtendedBookingsRequest, type CountExtendedBookingsResponse, type CreditCardPaymentMethodDetails, type CursorPaging, type Cursors, type CustomFormField, type Duration, type ExtendedBooking, type ExtendedFields, type ExternalReceiptInfo, type FlowControlSettings, type FormSubmission, type GiftCardPaymentDetails, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type IdentityTypeWithLiterals, type Invoice, type LineItemRefund, type LineItemRefundSummary, type Location, LocationType, type LocationTypeWithLiterals, type MembershipName, type MembershipPaymentDetails, MembershipPaymentStatus, type MembershipPaymentStatusWithLiterals, type MultiServiceBookingInfo, MultiServiceBookingType, type MultiServiceBookingTypeWithLiterals, type Order, type OrderInvoices, type OrderLineItem, OrderStatus, type OrderStatusWithLiterals, type OrderTransactions, type Paging, type PagingMetadataV2, type ParticipantChoices, type ParticipantNotification, type Payment, PaymentOptionType, type PaymentOptionTypeWithLiterals, type PaymentPaymentDetailsOneOf, type PaymentReceiptInfoOneOf, PaymentStatus, type PaymentStatusWithLiterals, Platform, type PlatformWithLiterals, type Price, type PriceDescription, type PriceSummary, type QueryExtendedBookingRequest, type QueryExtendedBookingResponse, type QueryExtendedBookingsOptions, type QueryExtendedBookingsRequest, type QueryExtendedBookingsResponse, type QueryOptions, type QueryV2, type QueryV2PagingMethodOneOf, Reason, type ReasonWithLiterals, type Refund, type RefundDetails, type RefundItem, type RefundItemsBreakdown, RefundStatus, type RefundStatusInfo, type RefundStatusWithLiterals, type RefundTransaction, type RegularPaymentDetails, type RegularPaymentDetailsPaymentMethodDetailsOneOf, type ResourceSelection, type ScheduledAction, SelectedPaymentOption, type SelectedPaymentOptionWithLiterals, SelectionMethod, type SelectionMethodWithLiterals, type ServiceChoice, type ServiceChoiceChoiceOneOf, type ServiceChoices, type ShippingRefund, SortOrder, type SortOrderWithLiterals, type Sorting, Status, type StatusWithLiterals, type StreetAddress, type Subdivision, TransactionStatus, type TransactionStatusWithLiterals, ValueType, type ValueTypeWithLiterals, type Waiver, type WixReceiptInfo, countExtendedBookings, query, queryExtendedBookings };

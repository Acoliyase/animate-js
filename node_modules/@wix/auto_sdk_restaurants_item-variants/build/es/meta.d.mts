...
interface ExternalReferenceInfo {
    ...
    /** Last time this item variant was synced with the external app. */
...
interface BulkUpdateBusinessLocationIdsResponse {
    /**
     * Information about the updated variants.
     * @minSize 1
     * @maxSize 100
     */
...
interface BulkUpdateBusinessLocationIdsPerEntityRequest {
     ...
     * @maxSize 100
     */
    variantIdLocationIds?: VariantIdLocationIds[];
}
interface VariantIdLocationIds {
    /**
     * variant ID
     * @format GUID
     */
...
interface BulkUpdateAttachedToOrphanItemRequest {
     ...
     * @maxSize 100
     */
    variantIdAttachedToOrphanItem?: VariantIdAttachedToOrphanItem[];
}
interface VariantIdAttachedToOrphanItem {
    /**
     * variant ID
     * @format GUID
     */
...
/** @docsIgnore */
type CountVariantsApplicationErrors = {
...
declare function createVariant(): __PublicMethodMetaInfo<'POST', {}, CreateVariantRequest$1, CreateVariantRequest, CreateVariantResponse$1, CreateVariantResponse>;
declare function getVariant(): __PublicMethodMetaInfo<'GET', {
    variantId: string;
}, GetVariantRequest$1, GetVariantRequest, GetVariantResponse$1, GetVariantResponse>;
declare function listVariants(): __PublicMethodMetaInfo<'GET', {}, ListVariantsRequest$1, ListVariantsRequest, ListVariantsResponse$1, ListVariantsResponse>;
declare function updateVariant(): __PublicMethodMetaInfo<'PATCH', {
    variantId: string;
}, UpdateVariantRequest$1, UpdateVariantRequest, UpdateVariantResponse$1, UpdateVariantResponse>;
declare function bulkCreateVariants(): __PublicMethodMetaInfo<'POST', {}, BulkCreateVariantsRequest$1, BulkCreateVariantsRequest, BulkCreateVariantsResponse$1, BulkCreateVariantsResponse>;
declare function bulkUpdateVariants(): __PublicMethodMetaInfo<'POST', {}, BulkUpdateVariantsRequest$1, BulkUpdateVariantsRequest, BulkUpdateVariantsResponse$1, BulkUpdateVariantsResponse>;
declare function deleteVariant(): __PublicMethodMetaInfo<'DELETE', {
    variantId: string;
}, DeleteVariantRequest$1, DeleteVariantRequest, DeleteVariantResponse$1, DeleteVariantResponse>;

...
__export(index_exports, {
  ...
  getPricingPlansSettings: () => getPricingPlansSettings4,
  updatePricingPlansSettings: () => updatePricingPlansSettings4
});
...
// src/pricing-plans-settings-v1-pricing-plans-settings-pricing-plans-settings.public.ts
function getPricingPlansSettings3(httpClient) {
  return () => getPricingPlansSettings2(
    // @ts-ignore
    { httpClient }
  );
}
function updatePricingPlansSettings3(httpClient) {
  return (pricingPlansSettings) => updatePricingPlansSettings2(
    pricingPlansSettings,
    // @ts-ignore
    { httpClient }
  );
...
// src/pricing-plans-settings-v1-pricing-plans-settings-pricing-plans-settings.context.ts
var import_rest_modules3 = require("@wix/sdk-runtime/rest-modules");
var getPricingPlansSettings4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getPricingPlansSettings3);
var updatePricingPlansSettings4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(updatePricingPlansSettings3);

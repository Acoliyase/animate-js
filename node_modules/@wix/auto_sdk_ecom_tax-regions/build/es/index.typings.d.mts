 ...
 */
declare function createTaxRegion(taxRegion: NonNullablePaths<TaxRegion, `appId` | `country`, 2>): Promise<NonNullablePaths<TaxRegion, `country` | `subdivision` | `appId` | `taxIncludedInPrice`, 2> & {
 ...
 */
declare function getTaxRegion(taxRegionId: string): Promise<NonNullablePaths<TaxRegion, `country` | `subdivision` | `appId` | `taxIncludedInPrice`, 2>>;
/**
 ...
 */
declare function updateTaxRegion(_id: string, taxRegion: NonNullablePaths<UpdateTaxRegion, `revision`, 2>): Promise<NonNullablePaths<TaxRegion, `country` | `subdivision` | `appId` | `taxIncludedInPrice`, 2> & {
...
interface TaxRegionsQueryBuilder {
     ...
     * @documentationMaturity preview
     */
    ge: (propertyName: '_id' | 'country' | 'subdivision' | 'appId' | '_createdDate' | '_updatedDate', value: any) => TaxRegionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    gt: (propertyName: '_id' | 'country' | 'subdivision' | 'appId' | '_createdDate' | '_updatedDate', value: any) => TaxRegionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    le: (propertyName: '_id' | 'country' | 'subdivision' | 'appId' | '_createdDate' | '_updatedDate', value: any) => TaxRegionsQueryBuilder;
    /** @param propertyName - Property whose value is compared with `value`.
     * @param value - Value to compare against.
     * @documentationMaturity preview
     */
    lt: (propertyName: '_id' | 'country' | 'subdivision' | 'appId' | '_createdDate' | '_updatedDate', value: any) => TaxRegionsQueryBuilder;

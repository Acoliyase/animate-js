...
import { TaxRegion, CreateTaxRegionApplicationErrors, UpdateTaxRegion, UpdateTaxRegionApplicationErrors, TaxRegionCreatedEnvelope, TaxRegionDeletedEnvelope, TaxRegionUpdatedEnvelope, TaxRegionsQueryBuilder, CursorQuery, typedQueryTaxRegions } from './index.typings.mjs';
...
interface CreateTaxRegionSignature {
     ...
     */
    (taxRegion: NonNullablePaths<TaxRegion, `appId` | `country`, 2>): Promise<NonNullablePaths<TaxRegion, `country` | `subdivision` | `appId` | `taxIncludedInPrice`, 2> & {

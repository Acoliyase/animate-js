...
@property st-global(--wds-vertical-tabs-item-fill-light-premium-premium);
...
.root {
  ...
  --wds-announcement-modal-border-radius: 4px;
  ...
  --wds-button-border-dark-secondary-active: #e2e3ea;
  --wds-button-border-dark-secondary-disabled: rgba(19, 23, 32, .1);
  --wds-button-border-dark-secondary-hover: #42454c;
  --wds-button-border-destructive-secondary: #e2e3ea;
  --wds-button-border-destructive-secondary-active: #ee4437;
  --wds-button-border-destructive-secondary-disabled: #e2e3ea;
  --wds-button-border-destructive-secondary-hover: #e2e3ea;
  --wds-button-border-premium-secondary: #e2e3ea;
  --wds-button-border-premium-secondary-active: #9a27d5;
  --wds-button-border-premium-secondary-disabled: rgba(19, 23, 32, .1);
  --wds-button-border-premium-secondary-hover: #e2e3ea;
  ...
  --wds-button-border-standard-secondary: #e2e3ea;
  --wds-button-border-standard-secondary-active: #116dff;
  --wds-button-border-standard-secondary-disabled: rgba(19, 23, 32, .1);
  --wds-button-border-standard-secondary-hover: #e2e3ea;
  --wds-button-fill-dark-primary-disabled: #bebebe;
  --wds-button-fill-dark-secondary: #ffffff;
  --wds-button-fill-dark-secondary-active: #42454c;
  --wds-button-fill-dark-secondary-disabled: #ffffff;
  --wds-button-fill-dark-secondary-hover: #42454c;
  ...
  --wds-button-fill-destructive-secondary-hover: #f7f8f8;
  ...
  --wds-button-fill-premium-secondary-hover: #f7f8f8;
  ...
  --wds-button-label-fill-dark-secondary: #131720;
  --wds-button-label-fill-dark-secondary-active: #ffffff;
  --wds-button-label-fill-dark-secondary-disabled: #bebebe;
  ...
  --wds-button-label-fill-destructive-secondary-disabled: #ffffff;
  --wds-button-label-fill-destructive-secondary-hover: #ee4437;
  ...
  --wds-button-label-fill-premium-secondary-disabled: #bebebe;
  --wds-button-label-fill-premium-secondary-hover: #9a27d5;
  ...
  --wds-button-label-fill-standard-secondary-disabled: #bebebe;
  --wds-button-label-fill-standard-secondary-hover: #116dff;
  ...
  --wds-carousel-controls-shadow: 0 12px 20px rgba(19, 23, 32, .1);
  ...
  --wds-clickable-card-filled-fill-active: #dce9ff;
  --wds-clickable-card-filled-fill-disabled: rgba(255, 255, 255, .3);
  --wds-clickable-card-filled-fill-hover: #ebf2ff;
  --wds-clickable-card-outline-border-color: #c3daff;
  --wds-clickable-card-outline-border-color-active: #116dff;
  --wds-clickable-card-outline-border-color-disabled: rgba(19, 23, 32, .1);
  --wds-clickable-card-outline-border-color-hover: #418aff;
  ...
  --wds-field-set-label-fill: #131720;
  ...
  --wds-form-field-label-fill: #131720;
  ...
  --wds-form-field-label-line-height-tiny: 16px;
  ...
  --wds-icon-button-color-border-dark-secondary-disabled: rgba(19, 23, 32, .1);
  ...
  --wds-icon-button-color-border-premium-secondary-disabled: rgba(19, 23, 32, .1);
  --wds-icon-button-color-border-standard-secondary: #e2e3ea;
  --wds-icon-button-color-border-standard-secondary-active: #116dff;
  --wds-icon-button-color-border-standard-secondary-disabled: rgba(19, 23, 32, .1);
  --wds-icon-button-color-border-standard-secondary-hover: #868aa5;
  --wds-icon-button-color-fill-dark-primary: #131720;
  --wds-icon-button-color-fill-dark-primary-active: #42454c;
  --wds-icon-button-color-fill-dark-primary-disabled: #bebebe;
  --wds-icon-button-color-fill-dark-primary-hover: #42454c;
  --wds-icon-button-color-fill-dark-secondary: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-dark-secondary-active: #116dff;
  --wds-icon-button-color-fill-dark-secondary-disabled: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-dark-secondary-hover: #42454c;
  ...
  --wds-icon-button-color-fill-dark-tertiary-hover: #edeef2;
  --wds-icon-button-color-fill-light-primary: #ffffff;
  --wds-icon-button-color-fill-light-primary-active: #dce9ff;
  --wds-icon-button-color-fill-light-primary-disabled: rgba(255, 255, 255, .3);
  --wds-icon-button-color-fill-light-primary-hover: #ebf2ff;
  --wds-icon-button-color-fill-light-secondary: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-light-secondary-active: #dce9ff;
  --wds-icon-button-color-fill-light-secondary-disabled: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-light-secondary-hover: #ebf2ff;
  --wds-icon-button-color-fill-light-tertiary: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-light-tertiary-active: #dce9ff;
  --wds-icon-button-color-fill-light-tertiary-disabled: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-light-tertiary-hover: #ebf2ff;
  ...
  --wds-icon-button-color-fill-standard-tertiary-active: #dce9ff;
  --wds-icon-button-color-fill-standard-tertiary-disabled: rgba(255, 255, 255, 0);
  --wds-icon-button-color-fill-standard-tertiary-hover: #ebf2ff;
  ...
  --wds-icon-button-color-text-dark-secondary: #131720;
  --wds-icon-button-color-text-dark-secondary-active: #ffffff;
  --wds-icon-button-color-text-dark-secondary-disabled: #bebebe;
  --wds-icon-button-color-text-dark-secondary-hover: #ffffff;
  --wds-icon-button-color-text-dark-tertiary: #131720;
  --wds-icon-button-color-text-dark-tertiary-active: #131720;
  --wds-icon-button-color-text-dark-tertiary-disabled: #bebebe;
  --wds-icon-button-color-text-dark-tertiary-hover: #131720;
  --wds-icon-button-color-text-light-primary: #116dff;
  --wds-icon-button-color-text-light-primary-active: #116dff;
  --wds-icon-button-color-text-light-primary-disabled: #bebebe;
  ...
  --wds-icon-button-color-text-light-secondary-disabled: #bebebe;
  ...
  --wds-icon-button-color-text-premium-secondary-disabled: #bebebe;
  ...
  --wds-list-item-gap-columns: 12px;
  ...
  --wds-number-input-icon-fill: #42454c;
  ...
  --wds-section-helper-title-font-size: 12px;
  ...
  --wds-segmented-toggle-border-color: #e2e3ea;
  --wds-segmented-toggle-border-color-disabled: rgba(19, 23, 32, .1);
  --wds-segmented-toggle-border-color-hover: #c3daff;
  ...
  --wds-segmented-toggle-value-fill: #131720;
  --wds-segmented-toggle-value-fill-default: #131720;
  --wds-segmented-toggle-value-fill-disabled: #bebebe;
  ...
  --wds-skeleton-fill-light: rgba(19, 23, 32, .1);
  ...
  --wds-swatches-fill-border-disabled: rgba(19, 23, 32, 0);
  --wds-swatches-fill-border-no-value: #e2e3ea;
  ...
  --wds-toggle-button-border-color-inverted-disabled: rgba(19, 23, 32, .1);
  --wds-toggle-button-border-color-inverted-hover: #dce9ff;
  --wds-toggle-button-border-color-standard: #ffffff;
  --wds-toggle-button-border-color-standard-disabled: #e5e5e5;
  --wds-toggle-button-border-color-standard-hover: #e2e3ea;
  --wds-toggle-button-border-radius-square-large: 4px;
  --wds-toggle-button-border-radius-square-medium: 4px;
  ...
  --wds-toggle-button-fill-dark-hover: #f7f8f8;
  --wds-toggle-button-fill-dark-selected: #131720;
  --wds-toggle-button-fill-dark-selected-disabled: #bebebe;
  --wds-toggle-button-fill-dark-selected-hover: #42454c;
  ...
  --wds-toggle-button-label-fill-inverted-default: #131720;
  --wds-toggle-button-label-fill-inverted-disabled: #bebebe;
  --wds-toggle-button-label-fill-inverted-hover: #131720;
  ...
  --wds-toggle-button-padding-medium-round: 16px;
  ...
  --wds-toggle-switch-fill-standard: #131720;
  ...
  --wds-toggle-switch-fill-standard-hover: #42454c;
  ...
  --wds-vertical-tabs-item-fill-light-active: #dce9ff;
  --wds-vertical-tabs-item-fill-light-disabled: #ffffff;
  --wds-vertical-tabs-item-fill-light-hover: #f7f8f8;
  ...
  --wds-vertical-tabs-item-fill-light-premium-premium: #ffffff;
  --wds-vertical-tabs-item-fill-neutral: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-active: #dce9ff;
  --wds-vertical-tabs-item-fill-neutral-disabled: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-hover: #f7f8f8;
  ...
  --wds-vertical-tabs-item-fill-standard-active: #dce9ff;
  --wds-vertical-tabs-item-fill-standard-disabled: rgba(255, 255, 255, .3);
  --wds-vertical-tabs-item-fill-standard-hover: #f7f8f8;
  --wds-vertical-tabs-item-fill-standard-premium: #f7f8f8;
  ...
  --wds-vertical-tabs-item-label-disabled: #bebebe;
  --wds-vertical-tabs-item-label-font-weight: 400;
  --wds-vertical-tabs-item-label-font-weight-active: 400;
  --wds-vertical-tabs-item-label-text: #131720;
  --wds-vertical-tabs-item-label-text-active: #116dff;

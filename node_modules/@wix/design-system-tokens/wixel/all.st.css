...
@property st-global(--wds-color-white-transparent-60);
...
.root {
  ...
  --wds-add-item-title-font-line-height-medium: 20px;
  --wds-add-item-title-font-line-height-tiny: 16px;
  --wds-add-item-title-font-size-medium: 14px;
  --wds-add-item-title-font-size-small: 12px;
  --wds-announcement-modal-actions-padding: 28px;
  --wds-announcement-modal-border-radius: 12px;
  --wds-announcement-modal-content-gap: 8px;
  --wds-announcement-modal-padding-horizontal: 52px;
  --wds-announcement-modal-padding-vertical: 32px;
  --wds-announcement-modal-text-font-line-height: 20px;
  --wds-announcement-modal-text-font-size: 14px;
  --wds-announcement-modal-title-font-line-height: 32px;
  ...
  --wds-button-border-destructive-secondary-active: #ee4437;
  --wds-button-border-destructive-secondary-disabled: rgba(38, 37, 36, 0.1000);
  --wds-button-border-destructive-secondary-hover: #ee4437;
  --wds-button-border-premium-secondary: #e2e3ea;
  --wds-button-border-premium-secondary-active: #9a27d5;
  --wds-button-border-premium-secondary-disabled: rgba(38, 37, 36, 0.1000);
  --wds-button-border-premium-secondary-hover: #9a27d5;
  --wds-button-border-radius-large: 8px;
  ...
  --wds-button-label-fill-destructive-primary-disabled: rgba(255, 255, 255, 0.7000);
  --wds-button-label-fill-destructive-secondary: #ee4437;
  --wds-button-label-fill-destructive-secondary-active: #ffffff;
  --wds-button-label-fill-destructive-secondary-disabled: rgba(38, 37, 36, 0.3000);
  --wds-button-label-fill-destructive-secondary-hover: #ffffff;
  --wds-button-label-fill-premium-primary-disabled: rgba(255, 255, 255, 0.7000);
  --wds-button-label-fill-premium-secondary: #9a27d5;
  --wds-button-label-fill-premium-secondary-active: #ffffff;
  --wds-button-label-fill-premium-secondary-disabled: rgba(38, 37, 36, 0.3000);
  --wds-button-label-fill-premium-secondary-hover: #ffffff;
  --wds-button-label-fill-standard-primary-disabled: rgba(255, 255, 255, 0.7000);
  --wds-button-label-fill-standard-secondary: #4a57ff;
  --wds-button-label-fill-standard-secondary-active: #ffffff;
  --wds-button-label-fill-standard-secondary-disabled: rgba(38, 37, 36, 0.3000);
  ...
  --wds-card-gallery-item-border-radius-0: 12px;
  --wds-card-gallery-item-border-radius-100: 12px;
  --wds-card-gallery-item-buttons-gap: 4px;
  ...
  --wds-carousel-controls-shadow: 0 2px 18px rgba(38, 37, 36, 0.1000), 0 6px 6px rgba(38, 37, 36, 0.0000);
  ...
  --wds-color-border-light-primary-disabled: rgba(255, 255, 255, 0.3000);
  ...
  --wds-color-fill-warning-tertiary-hover: #f7f8f8;
  ...
  --wds-custom-modal-footnote-padding-vertical: 8px;
  --wds-custom-modal-footnote-text-font-line-height: 16px;
  --wds-custom-modal-footnote-text-font-size: 12px;
  ...
  --wds-custom-modal-header-subtitle-font-line-height: 20px;
  ...
  --wds-form-field-label-line-height-tiny: 14px;
  ...
  --wds-icon-button-color-border-dark-secondary-hover: #2b2e36;
  --wds-icon-button-color-border-light-secondary: rgba(255, 255, 255, 0.5000);
  --wds-icon-button-color-border-light-secondary-active: #ffffff;
  --wds-icon-button-color-border-light-secondary-disabled: rgba(255, 255, 255, 0.3000);
  --wds-icon-button-color-border-light-secondary-hover: rgba(255, 255, 255, 0.7000);
  ...
  --wds-icon-button-color-fill-premium-primary-active: #9a27d5;
  --wds-icon-button-color-fill-premium-primary-disabled: #bebebe;
  --wds-icon-button-color-fill-premium-primary-hover: #7927a3;
  --wds-icon-button-color-fill-premium-secondary: #ffffff;
  --wds-icon-button-color-fill-premium-secondary-active: #9a27d5;
  --wds-icon-button-color-fill-premium-secondary-disabled: #ffffff;
  --wds-icon-button-color-fill-premium-secondary-hover: #7927a3;
  --wds-icon-button-color-fill-premium-tertiary: rgba(255, 255, 255, 0.0000);
  ...
  --wds-icon-button-color-text-premium-secondary-disabled: rgba(38, 37, 36, 0.3000);
  ...
  --wds-icon-button-color-text-premium-tertiary-disabled: rgba(38, 37, 36, 0.3000);
  ...
  --wds-input-area-padding-left-small: 14px;
  --wds-input-area-padding-right-medium: 12px;
  ...
  --wds-input-background-fill-readonly: #edeef2;
  ...
  --wds-input-border-radius-default-tiny: 8px;
  ...
  --wds-input-padding-vertical-medium: 12px;
  ...
  --wds-input-size-large: 44px;
  --wds-input-size-medium: 42px;
  --wds-input-size-small: 36px;
  --wds-input-size-tiny: 28px;
  ...
  --wds-internal-color-picker-padding-horizontal: 16px;
  ...
  --wds-message-modal-content-gap: 8px;
  --wds-message-modal-padding-horizontal: 24px;
  --wds-message-modal-padding-vertical: 20px;
  --wds-message-modal-text-font-line-height: 20px;
  --wds-message-modal-text-font-size: 14px;
  ...
  --wds-section-header-padding-vertical-medium: 8px;
  --wds-section-header-padding-vertical-small: 8px;
  --wds-section-helper-action-padding-medium: 8px;
  ...
  --wds-section-helper-vertical-padding-small: 8px;
  ...
  --wds-shadow-fill-input: rgba(38, 37, 36, 0.0000);
  --wds-shadow-fill-primary-modal: rgba(38, 37, 36, 0.2000);
  --wds-shadow-fill-primary-overlay: rgba(38, 37, 36, 0.1000);
  --wds-shadow-fill-primary-overlay-dark: rgba(38, 37, 36, 0.1500);
  --wds-shadow-fill-primary-raised: rgba(38, 37, 36, 0.3000);
  --wds-shadow-fill-primary-slider: rgba(38, 37, 36, 0.0000);
  --wds-shadow-fill-primary-toggle: rgba(38, 37, 36, 0.0000);
  --wds-shadow-fill-quaternary-raised: rgba(38, 37, 36, 0.0500);
  --wds-shadow-fill-secondary-modal: rgba(38, 37, 36, 0.0000);
  --wds-shadow-fill-secondary-overlay: rgba(38, 37, 36, 0.0000);
  --wds-shadow-fill-secondary-overlay-dark: rgba(38, 37, 36, 0.0000);
  ...
  --wds-shadow-inner-300-bottom: 0 -22px 18px -18px rgba(38, 37, 36, 0.1000) inset, 0 -8px 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-300-horizontal: 22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, 8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset, -22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, -8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-300-left: 22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, 8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-300-right: -22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, -8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-300-top: 0 22px 18px -18px rgba(38, 37, 36, 0.1000) inset, 0 -8px 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-300-vertical: 0 22px 18px -18px rgba(38, 37, 36, 0.1000) inset, 0 -8px 6px -6px rgba(38, 37, 36, 0.0500) inset, 0 -22px 18px -18px rgba(38, 37, 36, 0.1000) inset, 0 -8px 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-400: 0 0 24px rgba(38, 37, 36, 0.2000) inset, 0 0 6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-400-bottom: 0 -32px 24px -24px rgba(38, 37, 36, 0.2000) inset, 0 -8px 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-400-horizontal: 22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, 8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset, -22px 0 18px -18px rgba(38, 37, 36, 0.1000) inset, -8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset;
  --wds-shadow-inner-400-left: 32px 0 24px -24px rgba(38, 37, 36, 0.2000) inset, 8px 0 6px -6px rgba(38, 37, 36, 0.0500) inset;
  ...
  --wds-shadow-y-primary-modal: 10px;
  --wds-shadow-y-primary-overlay: 10px;
  ...
  --wds-skeleton-fill-light: rgba(38, 37, 36, 0.1000);
  ...
  --wds-swatches-fill-border-disabled: rgba(38, 37, 36, 0.0000);
  --wds-swatches-fill-border-no-value: #dce2ff;
  --wds-swatches-fill-border-no-value-dash: #ee4437;
  --wds-swatches-fill-border-selected: #4a57ff;
  --wds-swatches-fill-disabled: #e5e5e5;
  ...
  --wds-swatches-swatch-active-border-radius-small: 1000px;
  --wds-swatches-swatch-border-radius-medium: 1000px;
  --wds-swatches-swatch-border-radius-small: 1000px;
  --wds-swatches-swatch-size-extra-tiny: 18px;
  --wds-swatches-swatch-size-large: 48px;
  ...
  --wds-tag-label-font-line-height-small: 16px;
  ...
  --wds-vertical-tabs-item-active-title-text-disabled: rgba(38, 37, 36, 0.3000);
  --wds-vertical-tabs-item-fill-light: #ffffff;
  --wds-vertical-tabs-item-fill-light-active: #eef0ff;
  --wds-vertical-tabs-item-fill-light-disabled: #ffffff;
  --wds-vertical-tabs-item-fill-light-hover: #f4f6ff;
  ...
  --wds-vertical-tabs-item-fill-light-premium-hover: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-active: #eef0ff;
  --wds-vertical-tabs-item-fill-neutral-disabled: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-hover: #e2e3ea;
  --wds-vertical-tabs-item-fill-neutral-premium: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-premium-active: #e3c3f4;
  --wds-vertical-tabs-item-fill-neutral-premium-disabled: #f7f8f8;
  --wds-vertical-tabs-item-fill-neutral-premium-hover: #f1e0f9;
  --wds-vertical-tabs-item-fill-standard: #ffffff;
  --wds-vertical-tabs-item-fill-standard-active: #eef0ff;
  --wds-vertical-tabs-item-fill-standard-disabled: #f4f6ff;
  --wds-vertical-tabs-item-fill-standard-hover: #f4f6ff;
  --wds-vertical-tabs-item-fill-standard-premium: #ffffff;
  --wds-vertical-tabs-item-fill-standard-premium-active: #eef0ff;
  ...
  --wds-vertical-tabs-item-round-fill-hover: #f4f6ff;
  ...
  --wds-vertical-tabs-section-text-font-weight-small: 700;

...
/** @enumType */
type ReportReasonWithLiterals = ReportReason | 'UNKNOWN_REASON' | 'EMAIL_QUOTA_REACHED' | 'IP_BLOCKLISTED' | 'EMAIL_BLOCKLISTED' | 'AI_REPORTED' | 'MANUALLY_REPORTED' | 'MODERATION_SPI';
 ...
 */
declare function checkForSpam(submission: NonNullablePaths<FormSubmission, `formId`, 2>): Promise<NonNullablePaths<CheckForSpamResponse, `spam` | `spamReport.reportReason`, 3>>;
/**
 ...
 */
declare function createFormSpamSubmissionReport(formSpamSubmissionReport: NonNullablePaths<FormSpamSubmissionReport, `formId` | `reportReason` | `submissions` | `submitter`, 2>): Promise<NonNullablePaths<FormSpamSubmissionReport, `formId` | `namespace` | `reportReason` | `submissionStatusAtReport` | `orderDetails.checkoutId`, 3> & {
 ...
 */
declare function getFormSpamSubmissionReport(formSpamSubmissionReportId: string): Promise<NonNullablePaths<FormSpamSubmissionReport, `formId` | `namespace` | `reportReason` | `submissionStatusAtReport` | `orderDetails.checkoutId`, 3>>;
/**
 ...
 */
declare function deleteFormSpamSubmissionReport(formSpamSubmissionReportId: string): Promise<void>;
/**
 ...
 */
declare function bulkDeleteFormSpamSubmissionReportByFilter(filter: Record<string, any>): Promise<NonNullablePaths<BulkDeleteFormSpamSubmissionReportByFilterResponse, `jobId`, 2>>;
/**
 ...
 */
declare function reportNotSpamSubmission(formSpamSubmissionReportId: string): Promise<NonNullablePaths<ReportNotSpamSubmissionResponse, `submission.formId` | `submission.namespace` | `submission.status` | `submission.seen` | `submission.orderDetails.itemSubtotal` | `submission.orderDetails.checkoutId` | `submission.tags.tags.tagIds`, 5>>;
/**
 ...
 */
declare function queryFormSpamSubmissionReportsByNamespace(): FormSpamSubmissionReportsQueryBuilder;
 ...
 */
declare function countFormSpamSubmissionReports(formIds: string[], namespace: string): Promise<NonNullablePaths<CountFormSpamSubmissionReportsResponse, `formsSpamSubmissionReportsCount` | `formsSpamSubmissionReportsCount.${number}.formId` | `formsSpamSubmissionReportsCount.${number}.totalCount`, 4>>;

export { type ActionEvent, type ApplicationError, type BulkActionMetadata, type BulkDeleteFormSpamSubmissionReportByFilterRequest, type BulkDeleteFormSpamSubmissionReportByFilterResponse, type BulkDeleteFormSpamSubmissionReportOptions, type BulkDeleteFormSpamSubmissionReportRequest, type BulkDeleteFormSpamSubmissionReportResponse, type BulkDeleteFormSpamSubmissionReportResult, type BulkReportNotSpamSubmissionOptions, type BulkReportNotSpamSubmissionRequest, type BulkReportNotSpamSubmissionResponse, type BulkReportNotSpamSubmissionResult, type BulkReportSpamSubmissionOptions, type BulkReportSpamSubmissionRequest, type BulkReportSpamSubmissionResponse, type BulkReportSpamSubmissionResult, type CheckForSpamRequest, type CheckForSpamResponse, type CountFormSpamSubmissionReportsRequest, type CountFormSpamSubmissionReportsResponse, type CreateFormSpamSubmissionReportRequest, type CreateFormSpamSubmissionReportResponse, type CreateFormSpamSubmissionReportValidationErrors, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DeleteFormSpamSubmissionReportRequest, type DeleteFormSpamSubmissionReportResponse, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, ErrorType, type ErrorTypeWithLiterals, type ExtendedFields, type FormSpamSubmissionReport, type FormSpamSubmissionReportValidationErrorsDetails, type FormSpamSubmissionReportsCount, type FormSpamSubmissionReportsQueryBuilder, type FormSpamSubmissionReportsQueryResult, type FormSubmission, type FormSubmissionOrderDetails, type GetFormSpamSubmissionReportRequest, type GetFormSpamSubmissionReportResponse, type IdentificationData, type IdentificationDataIdOneOf, type ItemMetadata, type MessageEnvelope, type OrderDetails, type PublicTags, type QueryFormSpamSubmissionReportsByNamespaceRequest, type QueryFormSpamSubmissionReportsByNamespaceResponse, type ReportNotSpamSubmissionRequest, type ReportNotSpamSubmissionResponse, ReportReason, type ReportReasonWithLiterals, type ReportSpamSubmissionOptions, type ReportSpamSubmissionRequest, type ReportSpamSubmissionResponse, type RestoreInfo, SortOrder, type SortOrderWithLiterals, type Sorting, type SpamReport, SubmissionStatus, type SubmissionStatusWithLiterals, type Submitter, type SubmitterSubmitterOneOf, type TagList, type ValidationError, WebhookIdentityType, type WebhookIdentityTypeWithLiterals, bulkDeleteFormSpamSubmissionReport, bulkDeleteFormSpamSubmissionReportByFilter, bulkReportNotSpamSubmission, bulkReportSpamSubmission, checkForSpam, countFormSpamSubmissionReports, createFormSpamSubmissionReport, deleteFormSpamSubmissionReport, getFormSpamSubmissionReport, queryFormSpamSubmissionReportsByNamespace, reportNotSpamSubmission, reportSpamSubmission };

...
/** @enumType */
type ReservationStatusWithLiterals = ReservationStatus | 'PENDING' | 'CONFIRMED' | 'CANCELED' | 'CANCELED_MANUALLY' | 'EXPIRED';
...
interface SeatInfo {
    /**
     * Section or sector identifier within the venue.
     * @readonly
     * @maxLength 20
     */
    sectionLabel?: string | null;
    /**
     * Sub-area within a section.
     * @readonly
     * @maxLength 50
     */
    areaLabel?: string | null;
    /**
     * Table identifier for events with table seating.
     * @readonly
     * @maxLength 50
     */
    ...
    /**
     * Venue configuration identifier.
     * @readonly
     * @format GUID
     */
...
interface EventSettingsSnapshot {
}
...
/** @enumType */
type FeeTypeWithLiterals = FeeType | 'FEE_INCLUDED' | 'FEE_ADDED_AT_CHECKOUT';
...
interface AdditionalReservationSettings {
    /**
...
interface TicketReservationBalanceUpdated {
    /** Current event ticket reservation balance */
    balance?: TicketReservationBalance;
}
interface TicketReservationBalance {
    /**
 ...
 */
interface TicketDefinitionBalance {
    /**
...
interface CreateTicketReservationRequest {
    /**
...
interface CreateTicketReservationResponse {
...
/** @enumType */
type PromotionTypeWithLiterals = PromotionType | 'UNKNOWN_PROMOTION_TYPE' | 'OTHER' | 'COUPON_CODE' | 'PAID_PLAN_BENEFIT' | 'GIFT_CARD';
interface Error {
    /** Promotion type. */
...
interface GetTicketReservationRequest {
    /**
...
interface GetTicketReservationResponse {
    /** The requested ticket reservation. */
    ticketReservation?: TicketReservation;
    /** Promotion-related errors associated with this reservation. */
    promotionErrors?: PromotionErrors;
}
interface GetCurrentTicketReservationRequest {
}
interface GetCurrentTicketReservationResponse {
    /** The current visitor's TicketReservation. */
    ticketReservation?: TicketReservation;
    /** Promotions errors */
    promotionErrors?: PromotionErrors;
}
interface UpdateTicketReservationRequest {
    /** TicketReservation to be updated, may be partial. */
    ticketReservation?: TicketReservation;
    /** Updates reservation but does not save changes. */
    previewReservation?: boolean;
}
interface UpdateTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
    /** Promotions errors */
    promotionErrors?: PromotionErrors;
}
interface UpdateCurrentTicketReservationRequest {
    /** TicketReservation to be updated, may be partial. */
    ticketReservation?: TicketReservation;
    /** Updates reservation but does not save changes. */
    previewReservation?: boolean;
}
interface UpdateCurrentTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
    /** Promotions errors. */
    promotionErrors?: PromotionErrors;
}
interface AddTicketsToCurrentTicketReservationRequest {
    /**
     * @minSize 1
     * @maxSize 50
     */
...
interface AddTicketsToCurrentTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
}
interface AddTicketsToTicketReservationRequest {
    /**
...
interface AddTicketsToTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
}
...
interface RemoveTicketsFromCurrentTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
}
interface RemoveTicketsFromTicketReservationRequest {
    /**
     * ID of the ticket reservation to add tickets to.
     * @format GUID
     */
...
interface RemoveTicketsFromTicketReservationResponse {
    /** Updated TicketReservation. */
    ticketReservation?: TicketReservation;
}
interface DeleteTicketReservationRequest {
    /**
...
interface DeleteTicketReservationResponse {
    /** Deleted ticket reservation. */
    ticketReservation?: TicketReservation;
}
interface DeleteCurrentTicketReservationRequest {
}
interface DeleteCurrentTicketReservationResponse {
...
interface BulkUpdateTicketReservationTagsResponse {
    /**
...
interface BulkUpdateTicketReservationTagsResult {
...
interface BulkUpdateTicketReservationTagsByFilterRequest {
...
interface BulkUpdateTicketReservationTagsByFilterResponse {
    /**
...
interface ConfirmTicketReservationRequest {
    /**
...
interface ConfirmTicketReservationResponse {
    /** The confirmed TicketReservation. */
    ticketReservation?: TicketReservation;
}
interface CancelTicketReservationRequest {
    /**
...
interface CancelTicketReservationResponse {
    /** The canceled ticket reservation. */
    ticketReservation?: TicketReservation;
}
interface CancelTicketReservationOnGracePeriodEndRequest {
    /**
...
interface CancelTicketReservationOnGracePeriodEndResponse {
}
interface ExpireTicketReservationRequest {
    /**
...
interface ExpireTicketReservationResponse {
    /** The expired TicketReservation. */
    ticketReservation?: TicketReservation;
}
interface UpdateTicketReservationCancelableRequest {
    /**
...
interface UpdateTicketReservationCancelableResponse {
}
interface Empty {
}
/** Triggered when an order is archived. */
interface OrderArchived {
    /**
...
interface OrderTicketsCanceled {
    /**
     * Event ID to which the order belongs.
     * @format GUID
     */
...
interface FixArchivedTicketReservationRequest {
    /**
...
interface FixArchivedTicketReservationResponse {

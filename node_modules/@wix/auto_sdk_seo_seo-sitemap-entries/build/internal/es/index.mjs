...
function listSitemapPages(payload) {
  function __listSitemapPages({ host }) {
    const metadata = {
      entityFqdn: "wix.promote.seo.v1.headless_sitemap_entry",
      method: "GET",
      methodFqn: "wix.promote.seo.headless.sitemap.service.v1.SeoHeadlessSitemapService.ListSitemapPages",
...
async function listSitemapPages2(options) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = renameKeysFromSDKRequestToRESTRequest({
    itemType: options?.itemType,
    paging: options?.paging
  });
  const reqOpts = listSitemapPages(payload);
...
function listSitemapPages3(httpClient) {
  return (options) => listSitemapPages2(
    options,
    // @ts-ignore
    { httpClient }
  );
...
var listSitemapPages4 = /* @__PURE__ */ createRESTModule(listSitemapPages3);
export {
  ItemType,
  listSitemapPages4 as listSitemapPages
};

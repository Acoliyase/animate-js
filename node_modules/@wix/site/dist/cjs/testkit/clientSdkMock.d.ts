import type { ClientSDK, WixNamespace } from '../types.js';
...
export declare const clientSdkMockBuilder: () => ClientSdkMockBuilder;
export declare const setClientSdkGlobal: (clientSdk: ClientSDK) => void;
export {};
//# sourceMappingURL=clientSdkMock.d.ts.map
import { CreateQuestionEntryRequest as CreateQuestionEntryRequest$1, CreateQuestionEntryResponse as CreateQuestionEntryResponse$1, GetQuestionEntryRequest as GetQuestionEntryRequest$1, GetQuestionEntryResponse as GetQuestionEntryResponse$1, UpdateQuestionEntryRequest as UpdateQuestionEntryRequest$1, UpdateQuestionEntryResponse as UpdateQuestionEntryResponse$1, DeleteQuestionEntryRequest as DeleteQuestionEntryRequest$1, DeleteQuestionEntryResponse as DeleteQuestionEntryResponse$1, ListQuestionEntriesRequest as ListQuestionEntriesRequest$1, ListQuestionEntriesResponse as ListQuestionEntriesResponse$1, QueryQuestionEntriesRequest as QueryQuestionEntriesRequest$1, QueryQuestionEntriesResponse as QueryQuestionEntriesResponse$1, BulkDeleteQuestionEntriesRequest as BulkDeleteQuestionEntriesRequest$1, BulkDeleteQuestionEntriesResponse as BulkDeleteQuestionEntriesResponse$1, UpdateExtendedFieldsRequest as UpdateExtendedFieldsRequest$1, UpdateExtendedFieldsResponse as UpdateExtendedFieldsResponse$1, SetQuestionEntryLabelsRequest as SetQuestionEntryLabelsRequest$1, SetQuestionEntryLabelsResponse as SetQuestionEntryLabelsResponse$1, BulkUpdateQuestionEntryRequest as BulkUpdateQuestionEntryRequest$1, BulkUpdateQuestionEntryResponse as BulkUpdateQuestionEntryResponse$1 } from './index.typings.js';
import '@wix/sdk-types';

interface QuestionEntry extends QuestionEntryAnswerOneOf {
    /**
...
/** @oneof */
interface QuestionEntryAnswerOneOf {
    /**
     * Answer in [Draft.js](https://draftjs.org/) format.
     * @minLength 1
     * @maxLength 100000
...
/** Additional groupings for question entries, for integration with other systems like chatbots. */
interface Label {
    /**
     * Label name.
     * @minLength 1
...
interface CreateQuestionEntryRequest {
    /** Question entry to create. */
    questionEntry: QuestionEntry;
}
interface CreateQuestionEntryResponse {
    /** Created question entry. */
    questionEntry?: QuestionEntry;
}
interface GetQuestionEntryRequest {
    /**
...
interface GetQuestionEntryResponse {
    /** Retrieved question entry. */
    questionEntry?: QuestionEntry;
}
interface UpdateQuestionEntryRequest {
    /** Question entry to update. Include only the fields you want to modify. */
    questionEntry: QuestionEntry;
}
interface UpdateQuestionEntryResponse {
    /** Updated question entry. */
    questionEntry?: QuestionEntry;
}
interface DeleteQuestionEntryRequest {
    /**
...
interface DeleteQuestionEntryResponse {
}
interface ListQuestionEntriesRequest {
    /**
...
interface QueryQuestionEntriesRequest {
...
interface SetQuestionEntryLabelsRequest {
    /**
...
interface SetQuestionEntryLabelsResponse {
    /** Question entry with updated labels. */
    questionEntry?: QuestionEntry;
}
interface BulkUpdateQuestionEntryRequest {
    /**
...
interface MaskedQuestionEntry {
    /** Question entry to update. */
    questionEntry?: QuestionEntry;
}
interface BulkUpdateQuestionEntryResponse {
    /**
...
interface BulkUpdateQuestionEntryResult {
...
declare function createQuestionEntry(): __PublicMethodMetaInfo<'POST', {}, CreateQuestionEntryRequest$1, CreateQuestionEntryRequest, CreateQuestionEntryResponse$1, CreateQuestionEntryResponse>;
declare function getQuestionEntry(): __PublicMethodMetaInfo<'GET', {
    questionEntryId: string;
}, GetQuestionEntryRequest$1, GetQuestionEntryRequest, GetQuestionEntryResponse$1, GetQuestionEntryResponse>;
declare function updateQuestionEntry(): __PublicMethodMetaInfo<'PATCH', {
    questionEntryId: string;
}, UpdateQuestionEntryRequest$1, UpdateQuestionEntryRequest, UpdateQuestionEntryResponse$1, UpdateQuestionEntryResponse>;
declare function deleteQuestionEntry(): __PublicMethodMetaInfo<'DELETE', {
    questionEntryId: string;
}, DeleteQuestionEntryRequest$1, DeleteQuestionEntryRequest, DeleteQuestionEntryResponse$1, DeleteQuestionEntryResponse>;
declare function listQuestionEntries(): __PublicMethodMetaInfo<'GET', {}, ListQuestionEntriesRequest$1, ListQuestionEntriesRequest, ListQuestionEntriesResponse$1, ListQuestionEntriesResponse>;
declare function queryQuestionEntries(): __PublicMethodMetaInfo<'POST', {}, QueryQuestionEntriesRequest$1, QueryQuestionEntriesRequest, QueryQuestionEntriesResponse$1, QueryQuestionEntriesResponse>;
declare function bulkDeleteQuestionEntries(): __PublicMethodMetaInfo<'POST', {}, BulkDeleteQuestionEntriesRequest$1, BulkDeleteQuestionEntriesRequest, BulkDeleteQuestionEntriesResponse$1, BulkDeleteQuestionEntriesResponse>;
...
declare function setQuestionEntryLabels(): __PublicMethodMetaInfo<'PATCH', {
    questionEntryId: string;

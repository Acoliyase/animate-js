...
interface CreateQuestionEntrySignature {
     ...
     */
    (questionEntry: NonNullablePaths<QuestionEntry, `question`, 2>): Promise<NonNullablePaths<QuestionEntry, `draftjs` | `plainText` | `labels` | `labels.${number}.title`, 4>>;
}
...
interface GetQuestionEntrySignature {
     ...
     */
    (questionEntryId: string): Promise<NonNullablePaths<QuestionEntry, `draftjs` | `plainText` | `labels` | `labels.${number}.title`, 4>>;
}
...
interface UpdateQuestionEntrySignature {
     ...
     */
    (_id: string, questionEntry: NonNullablePaths<UpdateQuestionEntry, `revision`, 2>): Promise<NonNullablePaths<QuestionEntry, `draftjs` | `plainText` | `labels` | `labels.${number}.title`, 4>>;
}
...
interface UpdateExtendedFieldsSignature {
     ...
     */
    (_id: string, namespace: string, options: NonNullablePaths<UpdateExtendedFieldsOptions, `namespaceData`, 2>): Promise<NonNullablePaths<UpdateExtendedFieldsResponse, `questionEntry.draftjs` | `questionEntry.plainText` | `questionEntry.labels` | `questionEntry.labels.${number}.title`, 5>>;
}
...
interface SetQuestionEntryLabelsSignature {
     ...
     */
    (questionEntryId: string, options?: SetQuestionEntryLabelsOptions): Promise<NonNullablePaths<SetQuestionEntryLabelsResponse, `questionEntry.draftjs` | `questionEntry.plainText` | `questionEntry.labels` | `questionEntry.labels.${number}.title`, 5>>;
}
...
interface BulkUpdateQuestionEntrySignature {
     ...
     */
    (options?: NonNullablePaths<BulkUpdateQuestionEntryOptions, `questionEntries.${number}.questionEntry` | `questionEntries.${number}.questionEntry._id` | `questionEntries.${number}.questionEntry.revision`, 5>): Promise<NonNullablePaths<BulkUpdateQuestionEntryResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `results.${number}.questionEntry.draftjs` | `results.${number}.questionEntry.plainText` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}

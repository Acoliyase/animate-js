...
interface CreateOperationGroupSignature {
     ...
     */
    (operationGroup: NonNullablePaths<OperationGroup, `name`, 2>): Promise<NonNullablePaths<OperationGroup, `tags.privateTags.tagIds`, 4>>;
}
...
interface GetOperationGroupSignature {
     ...
     */
    (operationGroupId: string): Promise<NonNullablePaths<OperationGroup, `tags.privateTags.tagIds`, 4>>;
}
...
interface UpdateOperationGroupSignature {
     ...
     */
    (_id: string, operationGroup: NonNullablePaths<UpdateOperationGroup, `revision`, 2>): Promise<NonNullablePaths<OperationGroup, `tags.privateTags.tagIds`, 4>>;
}
...
declare function queryOperationGroups$1(httpClient: HttpClient): QueryOperationGroupsSignature;
...
declare function bulkCreateOperationGroups$1(httpClient: HttpClient): BulkCreateOperationGroupsSignature;
interface BulkCreateOperationGroupsSignature {
     ...
     */
    (operationGroups: NonNullablePaths<OperationGroup, `name`, 2>[], options?: BulkCreateOperationGroupsOptions): Promise<NonNullablePaths<BulkCreateOperationGroupsResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}
...
interface BulkUpdateOperationGroupsSignature {
     ...
     */
    (operationGroups: NonNullablePaths<MaskedOperationGroup, `operationGroup.revision`, 3>[], options?: BulkUpdateOperationGroupsOptions): Promise<NonNullablePaths<BulkUpdateOperationGroupsResponse, `results` | `results.${number}.itemMetadata.originalIndex` | `results.${number}.itemMetadata.success` | `results.${number}.itemMetadata.error.code` | `results.${number}.itemMetadata.error.description` | `bulkActionMetadata.totalSuccesses` | `bulkActionMetadata.totalFailures` | `bulkActionMetadata.undetailedFailures`, 6>>;
}
...
interface BulkUpdateOperationGroupTagsByFilterSignature {
     ...
     */
    (filter: Record<string, any>, options?: BulkUpdateOperationGroupTagsByFilterOptions): Promise<NonNullablePaths<BulkUpdateOperationGroupTagsByFilterResponse, `jobId`, 2> & {
...
declare const onOperationGroupUpdated$1: EventDefinition<OperationGroupUpdatedEnvelope, "wix.restaurants.v1.operation_group_updated">;

declare const createOperationGroup: MaybeContext<BuildRESTFunction<typeof createOperationGroup$1> & typeof createOperationGroup$1>;
declare const getOperationGroup: MaybeContext<BuildRESTFunction<typeof getOperationGroup$1> & typeof getOperationGroup$1>;
declare const updateOperationGroup: MaybeContext<BuildRESTFunction<typeof updateOperationGroup$1> & typeof updateOperationGroup$1>;
declare const deleteOperationGroup: MaybeContext<BuildRESTFunction<typeof deleteOperationGroup$1> & typeof deleteOperationGroup$1>;
declare const queryOperationGroups: MaybeContext<BuildRESTFunction<typeof queryOperationGroups$1> & typeof queryOperationGroups$1>;
declare const bulkCreateOperationGroups: MaybeContext<BuildRESTFunction<typeof bulkCreateOperationGroups$1> & typeof bulkCreateOperationGroups$1>;
declare const bulkUpdateOperationGroups: MaybeContext<BuildRESTFunction<typeof bulkUpdateOperationGroups$1> & typeof bulkUpdateOperationGroups$1>;
declare const bulkDeleteOperationGroups: MaybeContext<BuildRESTFunction<typeof bulkDeleteOperationGroups$1> & typeof bulkDeleteOperationGroups$1>;
declare const bulkUpdateOperationGroupTags: MaybeContext<BuildRESTFunction<typeof bulkUpdateOperationGroupTags$1> & typeof bulkUpdateOperationGroupTags$1>;
declare const bulkUpdateOperationGroupTagsByFilter: MaybeContext<BuildRESTFunction<typeof bulkUpdateOperationGroupTagsByFilter$1> & typeof bulkUpdateOperationGroupTagsByFilter$1>;
/** */
declare const onOperationGroupCreated: BuildEventDefinition<typeof onOperationGroupCreated$1> & typeof onOperationGroupCreated$1;
/** */
declare const onOperationGroupDeleted: BuildEventDefinition<typeof onOperationGroupDeleted$1> & typeof onOperationGroupDeleted$1;
/** */
declare const onOperationGroupUpdated: BuildEventDefinition<typeof onOperationGroupUpdated$1> & typeof onOperationGroupUpdated$1;

export { BulkCreateOperationGroupsOptions, BulkCreateOperationGroupsResponse, BulkDeleteOperationGroupsResponse, BulkUpdateOperationGroupTagsApplicationErrors, BulkUpdateOperationGroupTagsByFilterApplicationErrors, BulkUpdateOperationGroupTagsByFilterOptions, BulkUpdateOperationGroupTagsByFilterResponse, BulkUpdateOperationGroupTagsOptions, BulkUpdateOperationGroupTagsResponse, BulkUpdateOperationGroupsOptions, BulkUpdateOperationGroupsResponse, MaskedOperationGroup, OperationGroup, OperationGroupCreatedEnvelope, OperationGroupDeletedEnvelope, OperationGroupUpdatedEnvelope, OperationGroupsQueryBuilder, UpdateOperationGroup, bulkCreateOperationGroups, bulkDeleteOperationGroups, bulkUpdateOperationGroupTags, bulkUpdateOperationGroupTagsByFilter, bulkUpdateOperationGroups, createOperationGroup, deleteOperationGroup, getOperationGroup, onOperationGroupCreated, onOperationGroupDeleted, onOperationGroupUpdated, queryOperationGroups, updateOperationGroup };

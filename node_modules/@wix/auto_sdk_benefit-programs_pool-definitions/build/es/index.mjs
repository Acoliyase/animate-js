...
async function createPoolDefinition2(poolDefinition, options) {
  ...
  try {
    ...
    return renameKeysFromRESTResponseToSDKResponse(result.data)?.poolDefinition;
  } catch (err) {
...
var bulkUpdatePoolDefinitions4 = /* @__PURE__ */ createRESTModule(bulkUpdatePoolDefinitions3);
...
export {
  ...
  WebhookIdentityType,
  WeekDay,
  addPoolDefinitionToProgramDefinition4 as addPoolDefinitionToProgramDefinition,
  bulkCreatePoolDefinitions4 as bulkCreatePoolDefinitions,
  bulkDeletePoolDefinitions4 as bulkDeletePoolDefinitions,
  bulkUpdatePoolDefinitions4 as bulkUpdatePoolDefinitions,
  createPoolDefinition4 as createPoolDefinition,
  deletePoolDefinition4 as deletePoolDefinition,
  findPoolDefinitionsByProgramDefinition4 as findPoolDefinitionsByProgramDefinition,
  getPoolDefinition4 as getPoolDefinition,
  queryPoolDefinitions4 as queryPoolDefinitions,
  removePoolDefinitionFromProgramDefinition4 as removePoolDefinitionFromProgramDefinition,
  updatePoolDefinition4 as updatePoolDefinition
};

...
declare function createPoolDefinition(): __PublicMethodMetaInfo<'POST', {}, CreatePoolDefinitionRequest$1, CreatePoolDefinitionRequest, CreatePoolDefinitionResponse$1, CreatePoolDefinitionResponse>;
declare function bulkCreatePoolDefinitions(): __PublicMethodMetaInfo<'POST', {}, BulkCreatePoolDefinitionsRequest$1, BulkCreatePoolDefinitionsRequest, BulkCreatePoolDefinitionsResponse$1, BulkCreatePoolDefinitionsResponse>;
declare function updatePoolDefinition(): __PublicMethodMetaInfo<'PATCH', {
    poolDefinitionId: string;
}, UpdatePoolDefinitionRequest$1, UpdatePoolDefinitionRequest, UpdatePoolDefinitionResponse$1, UpdatePoolDefinitionResponse>;
declare function bulkUpdatePoolDefinitions(): __PublicMethodMetaInfo<'POST', {}, BulkUpdatePoolDefinitionsRequest$1, BulkUpdatePoolDefinitionsRequest, BulkUpdatePoolDefinitionsResponse$1, BulkUpdatePoolDefinitionsResponse>;
declare function deletePoolDefinition(): __PublicMethodMetaInfo<'DELETE', {
    poolDefinitionId: string;
}, DeletePoolDefinitionRequest$1, DeletePoolDefinitionRequest, DeletePoolDefinitionResponse$1, DeletePoolDefinitionResponse>;
declare function bulkDeletePoolDefinitions(): __PublicMethodMetaInfo<'POST', {}, BulkDeletePoolDefinitionsRequest$1, BulkDeletePoolDefinitionsRequest, BulkDeletePoolDefinitionsResponse$1, BulkDeletePoolDefinitionsResponse>;
declare function getPoolDefinition(): __PublicMethodMetaInfo<'GET', {
    poolDefinitionId: string;
}, GetPoolDefinitionRequest$1, GetPoolDefinitionRequest, GetPoolDefinitionResponse$1, GetPoolDefinitionResponse>;
declare function queryPoolDefinitions(): __PublicMethodMetaInfo<'POST', {}, QueryPoolDefinitionsRequest$1, QueryPoolDefinitionsRequest, QueryPoolDefinitionsResponse$1, QueryPoolDefinitionsResponse>;
declare function addPoolDefinitionToProgramDefinition(): __PublicMethodMetaInfo<'POST', {}, AddPoolDefinitionToProgramDefinitionRequest$1, AddPoolDefinitionToProgramDefinitionRequest, AddPoolDefinitionToProgramDefinitionResponse$1, AddPoolDefinitionToProgramDefinitionResponse>;

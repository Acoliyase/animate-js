...
import { Root as CoreCheckoutRoot } from './core/Checkout.js';
...
export interface RootProps {
    ...
    checkoutServiceConfig?: Parameters<typeof CoreCheckoutRoot>[0]['checkoutServiceConfig'];
...
export declare const Root: {
    ({ checkoutServiceConfig, children }: RootProps): import("react/jsx-runtime").JSX.Element;
    displayName: string;
};
/**
 ...
 * ```
 */
export declare const CheckoutTrigger: React.ForwardRefExoticComponent<CheckoutTriggerProps & React.RefAttributes<HTMLDivElement>>;
/**
...
export declare const Actions: {
    ...
    readonly Checkout: React.ForwardRefExoticComponent<ActionCheckoutProps & React.RefAttributes<HTMLButtonElement>>;
    /** Add to Cart button for adding items to the current cart */
    readonly AddToCart: React.ForwardRefExoticComponent<ActionBuyNowRenderProps & React.RefAttributes<HTMLButtonElement>>;
    /** Buy Now button for immediate purchase flow bypassing the cart */
    readonly BuyNow: React.ForwardRefExoticComponent<ActionBuyNowRenderProps & React.RefAttributes<HTMLButtonElement>>;
};

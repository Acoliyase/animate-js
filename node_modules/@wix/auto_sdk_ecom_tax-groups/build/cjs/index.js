...
async function typedQueryTaxGroups(query) {
  const { httpClient, sideEffects } = arguments[1];
...
function typedQueryTaxGroups2(httpClient) {
  return (query) => typedQueryTaxGroups(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryTaxGroups(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryTaxGroups3(httpClient)(),
    typedQueryFunction: (query) => typedQueryTaxGroups2(httpClient)(query),
...
var queryTaxGroups4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryTaxGroups);

 ...
 * @requiredField query
 */
declare function typedQueryTaxGroups(query: QueryV2): Promise<NonNullablePaths<QueryTaxGroupsResponse, `taxGroups` | `taxGroups.${number}.name`, 4>>;
/**

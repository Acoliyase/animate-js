...
import { TaxGroup, UpdateTaxGroup, UpdateTaxGroupApplicationErrors, ListDefaultTaxGroupsResponse, ListDefaultTaxGroupsByAppIdsResponse, TaxGroupCreatedEnvelope, TaxGroupDeletedEnvelope, TaxGroupUpdatedEnvelope, TaxGroupsQueryBuilder, QueryV2, typedQueryTaxGroups } from './index.typings.js';
export { ActionEvent, ApplicationError, BaseEventMetadata, BulkActionMetadata, CreateTaxGroupRequest, CreateTaxGroupResponse, CursorPaging, CursorPagingMetadata, Cursors, DeleteTaxGroupRequest, DeleteTaxGroupResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, GetTaxGroupRequest, GetTaxGroupResponse, IdentificationData, IdentificationDataIdOneOf, ItemMetadata, ListDefaultTaxGroupsByAppIdsRequest, ListDefaultTaxGroupsByAppIdsResult, ListDefaultTaxGroupsRequest, MessageEnvelope, Paging, QueryTaxGroupsRequest, QueryTaxGroupsResponse, QueryV2PagingMethodOneOf, RestoreInfo, SortOrder, SortOrderWithLiterals, Sorting, TaxGroupsQueryResult, UpdateTaxGroupRequest, UpdateTaxGroupResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.js';
...
declare function customQueryTaxGroups(httpClient: HttpClient): {
    (): TaxGroupsQueryBuilder;
    (query: QueryV2): ReturnType<typeof typedQueryTaxGroups>;
};
...
declare const queryTaxGroups: MaybeContext<BuildRESTFunction<typeof customQueryTaxGroups> & typeof customQueryTaxGroups>;
/**

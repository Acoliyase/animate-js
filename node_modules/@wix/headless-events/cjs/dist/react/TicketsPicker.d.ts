 ...
 * ```
 */
export declare const Root: (props: RootProps) => import("react/jsx-runtime").JSX.Element;
/**
 ...
 * ```
 */
export declare const TicketDefinitions: React.ForwardRefExoticComponent<TicketDefinitionsProps & React.RefAttributes<HTMLElement>>;
/**
 ...
 * ```
 */
export declare const TicketDefinitionRepeater: (props: TicketDefinitionRepeaterProps) => React.ReactNode;
/**
 ...
 * ```
 */
export declare const CheckoutError: React.ForwardRefExoticComponent<CheckoutErrorProps & React.RefAttributes<HTMLElement>>;
/**
 ...
 * ```
 */
export declare const CheckoutTrigger: React.ForwardRefExoticComponent<CheckoutTriggerProps & React.RefAttributes<HTMLElement>>;

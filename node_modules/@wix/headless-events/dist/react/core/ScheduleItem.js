...
import { ScheduleItemService, ScheduleItemServiceDefinition, } from '../../services/schedule-item-service.js';
...
export function Root(props) {
    ...
    const scheduleItemServiceConfig = {
        item,
    };
    return (_jsx(WixServices, { servicesMap: createServicesMap().addService(ScheduleItemServiceDefinition, ScheduleItemService, scheduleItemServiceConfig), children: children }));
}
/**
...
export function TimeSlot(props) {
    ...
    const formattedTimeRange = formatTimeRange(startTime, endTime, timeZoneId, props.locale);

 ...
 */
declare function createCustomField(field: NonNullablePaths<CustomField, `name`, 2>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 2> & {
 ...
 */
declare function getCustomField(_id: string): Promise<NonNullablePaths<GetCustomFieldResponse, `field.defaultPrivacy` | `field.fieldType` | `field.socialType` | `field.fieldOrigin` | `field.appliesTo` | `field.section`, 3>>;
/**
 ...
 */
declare function listCustomFields(options?: ListCustomFieldsOptions): Promise<NonNullablePaths<ListCustomFieldsResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section`, 4>>;
 ...
 */
declare function updateCustomField(_id: string, field: NonNullablePaths<UpdateCustomField, `revision`, 2>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 2> & {

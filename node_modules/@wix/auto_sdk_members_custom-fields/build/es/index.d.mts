...
import { CustomField, CreateCustomFieldApplicationErrors, GetCustomFieldResponse, ListCustomFieldsOptions, ListCustomFieldsResponse, UpdateCustomField, UpdateCustomFieldApplicationErrors, UpdateCustomFieldsOrderOptions, UpdateCustomFieldsOrderResponse } from './index.typings.mjs';
export { ActionEvent, AppliesTo, AppliesToWithLiterals, Asset, CreateCustomFieldRequest, CreateCustomFieldResponse, DefaultPrivacyChanged, DeleteContext, DeleteCustomFieldRequest, DeleteCustomFieldResponse, DeleteStatus, DeleteStatusWithLiterals, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, GetCustomFieldRequest, HideCustomFieldRequest, HideCustomFieldResponse, IdentificationData, IdentificationDataIdOneOf, IncorrectFieldTypeData, IncorrectPrivacyData, InvalidSocialTypeData, ListCustomFieldsRequest, MessageEnvelope, MetaSiteSpecialEvent, MetaSiteSpecialEventPayloadOneOf, Namespace, NamespaceChanged, NamespaceWithLiterals, OdeditorAssigned, OdeditorUnassigned, Origin, OriginWithLiterals, Paging, PagingMetadata, PicassoAssigned, PicassoUnassigned, Privacy, PrivacyWithLiterals, ReservedFieldNameNonEditable, RestoreInfo, Section, SectionWithLiterals, ServiceProvisioned, ServiceRemoved, SiteCreated, SiteCreatedContext, SiteCreatedContextWithLiterals, SiteDeleted, SiteHardDeleted, SiteMarkedAsTemplate, SiteMarkedAsWixSite, SitePublished, SitePurgedExternally, SiteRenamed, SiteTransferred, SiteUndeleted, SiteUnpublished, SiteUrlChanged, SocialTypeType, SocialTypeTypeWithLiterals, State, StateWithLiterals, StudioAssigned, StudioUnassigned, Type, TypeWithLiterals, UpdateCustomFieldRequest, UpdateCustomFieldResponse, UpdateCustomFieldsOrderRequest, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreateCustomFieldSignature {
     ...
     */
    (field: NonNullablePaths<CustomField, `name`, 2>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 2> & {
...
interface GetCustomFieldSignature {
     ...
     */
    (_id: string): Promise<NonNullablePaths<GetCustomFieldResponse, `field.defaultPrivacy` | `field.fieldType` | `field.socialType` | `field.fieldOrigin` | `field.appliesTo` | `field.section`, 3>>;
}
...
interface ListCustomFieldsSignature {
     ...
     */
    (options?: ListCustomFieldsOptions): Promise<NonNullablePaths<ListCustomFieldsResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section`, 4>>;
}
...
interface UpdateCustomFieldSignature {
     ...
     */
    (_id: string, field: NonNullablePaths<UpdateCustomField, `revision`, 2>): Promise<NonNullablePaths<CustomField, `defaultPrivacy` | `fieldType` | `socialType` | `fieldOrigin` | `appliesTo` | `section`, 2> & {
...
interface UpdateCustomFieldsOrderSignature {
     ...
     */
    (fieldIds: string[], options?: UpdateCustomFieldsOrderOptions): Promise<NonNullablePaths<UpdateCustomFieldsOrderResponse, `fields` | `fields.${number}.defaultPrivacy` | `fields.${number}.fieldType` | `fields.${number}.socialType` | `fields.${number}.fieldOrigin` | `fields.${number}.appliesTo` | `fields.${number}.section` | `section`, 4>>;
}

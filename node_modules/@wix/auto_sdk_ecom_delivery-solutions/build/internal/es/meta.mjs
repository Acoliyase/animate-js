...
// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.types.ts
...
// src/gateways-ecom-v1-delivery-rates-gateway-delivery-solutions.meta.ts
function getDeliverySolutions2() {
  const payload = {};
  const getRequestOptions = getDeliverySolutions(
    payload
  );

 ...
 * @constant
 */
export declare const ProgramListServiceDefinition: string & {
    __api: {
    ...
    __config: ProgramListServiceConfig;
 ...
 * ```
 */
export declare const ProgramListService: import("@wix/services-definitions").ServiceFactory<string & {
    __api: {
        /** Reactive signal containing the list of programs */
        programs: Signal<programs.Program[]>;
        /** Reactive signal indicating if programs are currently being loaded */
 ...
 * ```
 */
export declare function loadProgramListServiceConfig(): Promise<ProgramListServiceConfig>;

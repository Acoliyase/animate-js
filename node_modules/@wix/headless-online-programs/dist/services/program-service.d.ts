 ...
 * @constant
 */
export declare const ProgramServiceDefinition: string & {
    __api: ProgramServiceAPI;
    __config: {};
 ...
 * ```
 */
export declare const ProgramService: import("@wix/services-definitions").ServiceFactory<string & {
    __api: ProgramServiceAPI;
    __config: {};
    isServiceDefinition?: boolean;
} & ProgramServiceAPI, ProgramServiceConfig>;
/**
 ...
 * ```
 */
export declare function loadProgramServiceConfig(programId: string): Promise<SuccessProgramServiceConfigResult | NotFoundProgramServiceConfigResult>;

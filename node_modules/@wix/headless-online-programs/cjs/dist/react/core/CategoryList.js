...
import { CategoryListService, CategoryListServiceDefinition, } from '../../services/category-list-service.js';
/**
...
export function Root(props) {
    return (_jsx(WixServices, { servicesMap: createServicesMap().addService(CategoryListServiceDefinition, CategoryListService, props.categoryListConfig), children: props.children }));
}

 ...
 * @constant
 */
export const CategoryListServiceDefinition = defineService('program-category-list');
/**
 ...
 * ```
 */
export const CategoryListService = implementService.withConfig()(CategoryListServiceDefinition, ({ getService, config }) => {
 ...
 * ```
 */
export async function loadCategoryListServiceConfig() {
    try {

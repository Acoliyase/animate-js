 ...
 * @requiredField query
 */
declare function typedQueryInfoSections(query: CursorQuery, options?: QueryInfoSectionsOptions): Promise<NonNullablePaths<QueryInfoSectionsResponse, `infoSections` | `infoSections.${number}.uniqueName` | `infoSections.${number}.title`, 4>>;
/**

...
function typedQueryInfoSections2(httpClient) {
  return (query, options) => typedQueryInfoSections(
    query,
    options,
    // @ts-ignore
    { httpClient }
...
function customQueryInfoSections(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: (options) => queryInfoSections3(httpClient)(options),
    typedQueryFunction: (query, options) => typedQueryInfoSections2(httpClient)(query, options),
...
var queryInfoSections4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryInfoSections);

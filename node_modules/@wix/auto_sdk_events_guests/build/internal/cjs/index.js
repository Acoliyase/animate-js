...
__export(index_exports, {
  ...
  onGuestCheckedIn: () => onGuestCheckedIn2,
  onGuestCreated: () => onGuestCreated2,
  onGuestDeleted: () => onGuestDeleted2,
  onGuestEventCanceled: () => onGuestEventCanceled2,
  onGuestEventStarts: () => onGuestEventStarts2,
  onGuestOrderCanceled: () => onGuestOrderCanceled2,
  onGuestUpdated: () => onGuestUpdated2,
  queryGuests: () => queryGuests3
});
...
// src/events-guests-v1-guest-guests.public.ts
function queryGuests2(httpClient) {
  return (options) => queryGuests(
    options,
    // @ts-ignore
    { httpClient }
  );
}
var onGuestCreated = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_created",
  true,
...
var onGuestDeleted = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_deleted",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
...
var onGuestCheckedIn = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_guest_checked_in",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
        transformFn: import_timestamp2.transformRESTTimestampToSDKTimestamp,
        paths: [
          { path: "data.guest.createdDate" },
          { path: "data.guest.updatedDate" },
          { path: "data.guest.attendanceStatusUpdatedDate" },
          {
            path: "data.guest.guestDetails.formResponse.inputValues.dateTime"
          },
          { path: "data.eventDetails.dateAndTimeSettings.startDate" },
          { path: "data.eventDetails.dateAndTimeSettings.endDate" },
          {
            path: "data.eventDetails.dateAndTimeSettings.recurringEvents.individualEventDates.startDate"
          },
          {
            path: "data.eventDetails.dateAndTimeSettings.recurringEvents.individualEventDates.endDate"
          },
          { path: "metadata.eventTime" }
        ]
      },
      {
        transformFn: import_float2.transformRESTFloatToSDKFloat,
        paths: [
          { path: "data.guest.guestDetails.formResponse.inputValues.number" }
        ]
      },
      {
        transformFn: import_address2.transformRESTAddressToSDKAddress,
        paths: [
          {
            path: "data.guest.guestDetails.formResponse.inputValues.address.address"
          },
          { path: "data.eventDetails.location.address" }
        ]
      },
      {
        transformFn: import_page_url.transformRESTPageURLToSDKPageURL,
        paths: [{ path: "data.eventDetails.eventPageUrl" }]
      }
    ])
  )
)();
var onGuestEventCanceled = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_guest_event_canceled",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
        ...
        paths: [
          ...
          { path: "data.event.dateAndTimeSettings.startDate" },
          { path: "data.event.dateAndTimeSettings.endDate" },
          {
            path: "data.event.dateAndTimeSettings.recurringEvents.individualEventDates.startDate"
          },
          {
            path: "data.event.dateAndTimeSettings.recurringEvents.individualEventDates.endDate"
          },
          { path: "metadata.eventTime" }
        ]
      },
      ...
      },
      {
        ...
        paths: [
          ...
          { path: "data.event.location.address" }
        ]
      },
      {
        transformFn: import_page_url.transformRESTPageURLToSDKPageURL,
        paths: [{ path: "data.event.eventPageUrl" }]
      }
    ])
  )
)();
var onGuestEventStarts = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_guest_event_starts",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
...
var onGuestOrderCanceled = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_guest_order_canceled",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
...
var onGuestUpdated = (0, import_sdk_types.EventDefinition)(
  "wix.events.guests.v1.guest_updated",
  true,
  (event) => (0, import_rename_all_nested_keys2.renameKeysFromRESTResponseToSDKResponse)(
    (0, import_transform_paths3.transformPaths)(event, [
      {
...
// src/events-guests-v1-guest-guests.context.ts
var import_rest_modules2 = require("@wix/sdk-runtime/rest-modules");
var import_event_definition_modules = require("@wix/sdk-runtime/event-definition-modules");
var queryGuests3 = /* @__PURE__ */ (0, import_rest_modules2.createRESTModule)(queryGuests2);
var onGuestCreated2 = (0, import_event_definition_modules.createEventModule)(onGuestCreated);
var onGuestDeleted2 = (0, import_event_definition_modules.createEventModule)(onGuestDeleted);
var onGuestCheckedIn2 = (0, import_event_definition_modules.createEventModule)(onGuestCheckedIn);
var onGuestEventCanceled2 = (0, import_event_definition_modules.createEventModule)(
  onGuestEventCanceled
);
var onGuestEventStarts2 = (0, import_event_definition_modules.createEventModule)(onGuestEventStarts);
var onGuestOrderCanceled2 = (0, import_event_definition_modules.createEventModule)(
  onGuestOrderCanceled
);
var onGuestUpdated2 = (0, import_event_definition_modules.createEventModule)(onGuestUpdated);

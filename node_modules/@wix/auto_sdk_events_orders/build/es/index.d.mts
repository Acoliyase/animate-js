...
declare const confirmOrder: MaybeContext<BuildRESTFunction<typeof confirmOrder$1> & typeof confirmOrder$1>;
declare const getSummary: MaybeContext<BuildRESTFunction<typeof getSummary$1> & typeof getSummary$1>;
declare const captureAuthorizedPayment: MaybeContext<BuildRESTFunction<typeof captureAuthorizedPayment$1> & typeof captureAuthorizedPayment$1>;
declare const voidAuthorizedPayment: MaybeContext<BuildRESTFunction<typeof voidAuthorizedPayment$1> & typeof voidAuthorizedPayment$1>;
declare const getCheckoutOptions: MaybeContext<BuildRESTFunction<typeof getCheckoutOptions$1> & typeof getCheckoutOptions$1>;
declare const listAvailableTickets: MaybeContext<BuildRESTFunction<typeof listAvailableTickets$1> & typeof listAvailableTickets$1>;
declare const queryAvailableTickets: MaybeContext<BuildRESTFunction<typeof queryAvailableTickets$1> & typeof queryAvailableTickets$1>;
...
declare const getInvoice: MaybeContext<BuildRESTFunction<typeof getInvoice$1> & typeof getInvoice$1>;
declare const checkout: MaybeContext<BuildRESTFunction<typeof checkout$1> & typeof checkout$1>;
 ...
 */
declare const onOrderDeleted: BuildEventDefinition<typeof onOrderDeleted$1> & typeof onOrderDeleted$1;
/** */
declare const onOrderUpdated: BuildEventDefinition<typeof onOrderUpdated$1> & typeof onOrderUpdated$1;
/** */
declare const onOrderConfirmed: BuildEventDefinition<typeof onOrderConfirmed$1> & typeof onOrderConfirmed$1;
/** */
declare const onOrderInitiated: BuildEventDefinition<typeof onOrderInitiated$1> & typeof onOrderInitiated$1;
/** @deprecated */
declare const onOrderReservationCreated: BuildEventDefinition<typeof onOrderReservationCreated$1> & typeof onOrderReservationCreated$1;
/** @deprecated */
declare const onOrderReservationUpdated: BuildEventDefinition<typeof onOrderReservationUpdated$1> & typeof onOrderReservationUpdated$1;

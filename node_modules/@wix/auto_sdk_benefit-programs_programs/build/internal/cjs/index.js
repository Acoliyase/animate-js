...
__export(index_exports, {
  ...
  getProgramByExternalIdAndNamespace: () => getProgramByExternalIdAndNamespace4,
  pauseProgram: () => pauseProgram4,
  provisionProgram: () => provisionProgram4,
  queryPrograms: () => queryPrograms4,
  renewProgram: () => renewProgram4,
  resumeProgram: () => resumeProgram4,
...
async function updateProgram2(_id, program) {
  ...
  try {
    const result = await httpClient.request(reqOpts);
    sideEffects?.onSuccess?.(result);
    return (0, import_rename_all_nested_keys.renameKeysFromRESTResponseToSDKResponse)(result.data)?.program;
  } catch (err) {
    const transformedError = (0, import_transform_error.transformError)(
      err,
      {
...
var provisionProgram4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(provisionProgram3);
var renewProgram4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(renewProgram3);
var pauseProgram4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(pauseProgram3);
var resumeProgram4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(resumeProgram3);
...
var getProgramByExternalIdAndNamespace4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(getProgramByExternalIdAndNamespace3);

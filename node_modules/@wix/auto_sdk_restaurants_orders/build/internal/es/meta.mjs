...
// src/restaurants-v3-order-orders.types.ts
...
// src/restaurants-v3-order-orders.meta.ts
function getOrder2() {
  const payload = { id: ":id" };
...
function acceptOrder2() {
  const payload = { id: ":id" };
  const getRequestOptions = acceptOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function fulfillOrder2() {
  const payload = { id: ":id" };
  const getRequestOptions = fulfillOrder(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };

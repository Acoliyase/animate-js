...
async function typedQueryShippingOptions(query) {
  const { httpClient, sideEffects } = arguments[1];
...
function typedQueryShippingOptions2(httpClient) {
  return (query) => typedQueryShippingOptions(
    query,
    // @ts-ignore
    { httpClient }
  );
...
function customQueryShippingOptions(httpClient) {
  const router = (0, import_query_method_router.createQueryOverloadRouter)({
    builderQueryFunction: () => queryShippingOptions3(httpClient)(),
    typedQueryFunction: (query) => typedQueryShippingOptions2(httpClient)(query),
...
var queryShippingOptions4 = /* @__PURE__ */ (0, import_rest_modules3.createRESTModule)(customQueryShippingOptions);

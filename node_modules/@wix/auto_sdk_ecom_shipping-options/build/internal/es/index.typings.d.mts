 ...
 * @requiredField query
 */
declare function typedQueryShippingOptions(query: CursorQuery): Promise<NonNullablePaths<QueryShippingOptionsResponse, `shippingOptions` | `shippingOptions.${number}.deliveryRegionId`, 4>>;
/**

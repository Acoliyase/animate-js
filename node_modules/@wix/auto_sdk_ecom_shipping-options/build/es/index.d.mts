...
declare function customQueryShippingOptions(httpClient: HttpClient): {
    (): ShippingOptionsQueryBuilder;
    (query: CursorQuery): ReturnType<typeof typedQueryShippingOptions>;
};
...
declare const queryShippingOptions: MaybeContext<BuildRESTFunction<typeof customQueryShippingOptions> & typeof customQueryShippingOptions>;
/**

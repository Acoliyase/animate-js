...
export { type AddressLocation, type Availability, BestDeliveryByCategory, type BestDeliveryByCategoryWithLiterals, type CreateFulfillmentMethodRequest, type CreateFulfillmentMethodResponse, type CurbsideInfo, type CustomDetails, DayOfWeek, type DayOfWeekWithLiterals, type DeleteFulfillmentMethodRequest, type DeleteFulfillmentMethodResponse, type DeliveryInfo, type DeliveryInfoProviderOneOf, type DeliveryRange, type DeliveryRangeValueOneOf, type DineInInfo, type ExternalProvider, type FindBestDeliveryAreaRequest, type FindBestDeliveryAreaResponse, type FulfillmentMethod, type FulfillmentMethodMethodInfoOneOf, FulfillmentMethodType, type FulfillmentMethodTypeWithLiterals, type GetFulfillmentMethodRequest, type GetFulfillmentMethodResponse, type ListFulfillmentMethodsOptions, type ListFulfillmentMethodsRequest, type ListFulfillmentMethodsResponse, type PickupInfo, type PostalCodeDetails, type RadiusDetails, type Restaurant, type SpecialHourPeriod, TimeDisplayUnit, type TimeDisplayUnitWithLiterals, type TimePeriod, Type, type TypeWithLiterals, type UpdateFulfillmentMethod, type UpdateFulfillmentMethodRequest, type UpdateFulfillmentMethodResponse };

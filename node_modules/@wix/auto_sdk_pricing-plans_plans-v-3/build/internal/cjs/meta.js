...
// src/pricing-plans-v3-plan-plans-v-3.types.ts
...
// src/pricing-plans-v3-plan-plans-v-3.meta.ts
function createPlan2() {
  const payload = {};
  const getRequestOptions = createPlan(payload);
...
function getPlan2() {
  ...
  const getRequestOptions = getPlan(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updatePlan2() {
  ...
  const getRequestOptions = updatePlan(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkUpdatePlans2() {
  const payload = {};
  const getRequestOptions = bulkUpdatePlans(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deletePlan2() {
  const payload = { planId: ":planId" };
  const getRequestOptions = deletePlan(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryPlans2() {
  const payload = {};
  const getRequestOptions = queryPlans(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function searchPlans2() {
  const payload = {};
  const getRequestOptions = searchPlans(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function countPlans2() {
  const payload = {};
  const getRequestOptions = countPlans(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function changePrice2() {
  const payload = { planId: ":planId" };
  const getRequestOptions = changePrice(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
  return {
    getUrl,
    httpMethod: "POST",
    path: "/v3/plans/{planId}/change-price",
    pathParams: { planId: "planId" },
    __requestType: null,
    __originalRequestType: null,
    __responseType: null,

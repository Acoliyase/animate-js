...
/** @internal */
declare function changePrice$1(httpClient: HttpClient): ChangePriceSignature;
interface ChangePriceSignature {
    /**
     * Changes the price of a pricing plan and applies it to existing subscriptions if requested
     * @param - ID of the plan to change.
     * @param - ID of the pricing variant to change.
     */
...
/** @internal */
declare const changePrice: MaybeContext<BuildRESTFunction<typeof changePrice$1> & typeof changePrice$1>;
/**
...
export { BulkUpdatePlansOptions, BulkUpdatePlansResponse, BulkUpdatePlansValidationErrors, ChangePriceOptions, ChangePriceResponse, CountPlansOptions, CountPlansResponse, CreatePlanApplicationErrors, CreatePlanOptions, CreatePlanValidationErrors, MaskedPlan, Plan, PlanCreatedEnvelope, PlanDeletedEnvelope, PlanSearch, PlanUpdatedEnvelope, PlansQueryBuilder, SearchPlansResponse, UpdatePlan, UpdatePlanOptions, UpdatePlanValidationErrors, bulkUpdatePlans, changePrice, countPlans, createPlan, deletePlan, getPlan, onPlanCreated, onPlanDeleted, onPlanUpdated, queryPlans, searchPlans, updatePlan };

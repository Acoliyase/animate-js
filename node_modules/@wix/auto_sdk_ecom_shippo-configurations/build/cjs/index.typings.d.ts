 ...
 * @requiredField query
 */
declare function typedQueryShippoConfigurations(query: CursorQuery): Promise<NonNullablePaths<QueryShippoConfigurationsResponse, `shippoConfigurations` | `shippoConfigurations.${number}.packageType` | `shippoConfigurations.${number}.packageDetails.dimensions.length` | `shippoConfigurations.${number}.packageDetails.dimensions.width` | `shippoConfigurations.${number}.packageDetails.dimensions.height` | `shippoConfigurations.${number}.shipFromAddress.streetAddress.number` | `shippoConfigurations.${number}.shipFromAddress.streetAddress.name`, 6>>;
/**

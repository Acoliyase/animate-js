...
export { ActionEvent, ApplicationError, BaseEventMetadata, BulkActionMetadata, BulkCreateTagsRequest, BulkCreateTagsResponse, BulkDeleteTagRequest, BulkDeleteTagResponse, BulkTagResult, CommonCursorPaging, CommonPaging, CreateTagRequest, CursorPaging, Cursors, DeleteTagRequest, DeleteTagResponse, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, Field, FieldWithLiterals, GetOrCreateTagRequest, GetOrCreateTagResponse, GetTagByLabelRequest, GetTagBySlugRequest, GetTagRequest, GetTagResponse, GetTagsCountByLanguageRequest, GetTagsCountByLanguageResponse, IdentificationData, IdentificationDataIdOneOf, InitialTagsCopied, ItemMetadata, Keyword, ListTagsRequest, ListTagsRequestPagingMethodOneOf, ListTagsResponse, MessageEnvelope, MetaData, Paging, PagingMetadataV2, PlatformQuery, PlatformQueryPagingMethodOneOf, QueryTagsRequest, QueryTagsResponse, RestoreInfo, SeoSchema, Settings, SortOrder, SortOrderWithLiterals, Sorting, Tag, TagLanguageCount, TagsQueryResult, UpdateTagRequest, UpdateTagResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreateTagSignature {
     ...
     */
    (label: string, options?: CreateTagOptions): Promise<NonNullablePaths<CreateTagResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;
}
...
interface GetTagByLabelSignature {
     ...
     */
    (label: string, options?: GetTagByLabelOptions): Promise<NonNullablePaths<GetTagByLabelResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;
}
...
interface GetTagSignature {
     ...
     */
    (tagId: string, options?: GetTagOptions): Promise<NonNullablePaths<BlogTag, `_id` | `label` | `slug` | `postCount` | `publishedPostCount`, 2>>;
}
...
interface GetTagBySlugSignature {
     ...
     * @param - Options specifying which additional fields to return.
     */
    (slug: string, options?: GetTagBySlugOptions): Promise<NonNullablePaths<GetTagBySlugResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;
}
 ...
 */
declare const onTagCreated: BuildEventDefinition<typeof onTagCreated$1> & typeof onTagCreated$1;
/**
 * Triggered when a tag is deleted.
 */
declare const onTagDeleted: BuildEventDefinition<typeof onTagDeleted$1> & typeof onTagDeleted$1;
/**
 * Triggered when a tag is updated.
 */
declare const onTagUpdated: BuildEventDefinition<typeof onTagUpdated$1> & typeof onTagUpdated$1;

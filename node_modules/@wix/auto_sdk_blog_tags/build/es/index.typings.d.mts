 ...
 */
declare function createTag(label: string, options?: CreateTagOptions): Promise<NonNullablePaths<CreateTagResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;
 ...
 */
declare function getTagByLabel(label: string, options?: GetTagByLabelOptions): Promise<NonNullablePaths<GetTagByLabelResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;
 ...
 */
declare function getTag(tagId: string, options?: GetTagOptions): Promise<NonNullablePaths<BlogTag, `_id` | `label` | `slug` | `postCount` | `publishedPostCount`, 2>>;
 ...
 */
declare function getTagBySlug(slug: string, options?: GetTagBySlugOptions): Promise<NonNullablePaths<GetTagBySlugResponse, `tag._id` | `tag.label` | `tag.slug` | `tag.postCount` | `tag.publishedPostCount`, 3>>;

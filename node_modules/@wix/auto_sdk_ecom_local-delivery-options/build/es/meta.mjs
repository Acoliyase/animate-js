...
function createLocalDeliveryOption2() {
  const payload = {};
  const getRequestOptions = createLocalDeliveryOption(payload);
...
function getLocalDeliveryOption2() {
  const payload = { localDeliveryOptionId: ":localDeliveryOptionId" };
  const getRequestOptions = getLocalDeliveryOption(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listLocalDeliveryOptions2() {
  const payload = {};
  const getRequestOptions = listLocalDeliveryOptions(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function queryLocalDeliveryOptions2() {
  const payload = {};
  const getRequestOptions = queryLocalDeliveryOptions(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateLocalDeliveryOption2() {
  const payload = {
    localDeliveryOption: { id: ":localDeliveryOptionId" }
  };
  const getRequestOptions = updateLocalDeliveryOption(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteLocalDeliveryOption2() {
  const payload = { localDeliveryOptionId: ":localDeliveryOptionId" };
  const getRequestOptions = deleteLocalDeliveryOption(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkCreateLocalDeliveryOption2() {
  const payload = {};
  const getRequestOptions = bulkCreateLocalDeliveryOption(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function bulkUpdateLocalDeliveryOption2() {
  const payload = {};
  const getRequestOptions = bulkUpdateLocalDeliveryOption(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function bulkDeleteLocalDeliveryOption2() {
  const payload = {};
  const getRequestOptions = bulkDeleteLocalDeliveryOption(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);

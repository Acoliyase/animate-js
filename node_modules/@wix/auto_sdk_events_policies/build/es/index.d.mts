...
import { Policy, CreatePolicyApplicationErrors, UpdatePolicy, PoliciesQueryBuilder, ReorderEventPoliciesOptions, ReorderEventPoliciesResponse, ReorderEventPoliciesApplicationErrors, PolicyCreatedEnvelope, PolicyDeletedEnvelope, PolicyUpdatedEnvelope } from './index.typings.mjs';
export { ActionEvent, Address, AddressLocation, AddressStreetOneOf, BaseEventMetadata, CreatePolicyRequest, CreatePolicyResponse, CursorPaging, Cursors, DeletePolicyRequest, DeletePolicyResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventCopied, EventMetadata, EventStatus, EventStatusWithLiterals, GetPolicyRequest, GetPolicyResponse, IdentificationData, IdentificationDataIdOneOf, Location, LocationType, LocationTypeWithLiterals, MapCoordinates, MessageEnvelope, Occurrence, Paging, PagingMetadataV2, PoliciesQueryResult, QueryPoliciesRequest, QueryPoliciesResponse, QueryV2, QueryV2PagingMethodOneOf, Recurrences, ReorderEventPoliciesOptionsReferencePolicyOneOf, ReorderEventPoliciesRequest, ReorderEventPoliciesRequestReferencePolicyOneOf, RestoreInfo, ScheduleConfig, SortOrder, SortOrderWithLiterals, Sorting, Status, StatusWithLiterals, StreetAddress, Subdivision, SubdivisionType, SubdivisionTypeWithLiterals, UpdatePolicyRequest, UpdatePolicyResponse, UpdatePolicySortIndexRequest, UpdatePolicySortIndexResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreatePolicySignature {
     ...
     */
    (policy: NonNullablePaths<Policy, `body` | `eventId` | `name`, 2>): Promise<NonNullablePaths<Policy, `name` | `body` | `eventId`, 2> & {
...
interface UpdatePolicySignature {
     ...
     */
    (_id: string, policy: NonNullablePaths<UpdatePolicy, `body` | `eventId` | `name` | `revision`, 2>): Promise<NonNullablePaths<Policy, `name` | `body` | `eventId`, 2>>;
}
...
interface ReorderEventPoliciesSignature {
     ...
     */
    (policyId: string, eventId: string, options?: ReorderEventPoliciesOptions): Promise<NonNullablePaths<ReorderEventPoliciesResponse, `policies` | `policies.${number}.name` | `policies.${number}.body` | `policies.${number}.eventId`, 4> & {
...
interface GetPolicySignature {
     ...
     */
    (policyId: string): Promise<NonNullablePaths<Policy, `name` | `body` | `eventId`, 2>>;
}
...
declare const deletePolicy: MaybeContext<BuildRESTFunction<typeof deletePolicy$1> & typeof deletePolicy$1>;
declare const queryPolicies: MaybeContext<BuildRESTFunction<typeof queryPolicies$1> & typeof queryPolicies$1>;
declare const reorderEventPolicies: MaybeContext<BuildRESTFunction<typeof reorderEventPolicies$1> & typeof reorderEventPolicies$1>;
declare const getPolicy: MaybeContext<BuildRESTFunction<typeof getPolicy$1> & typeof getPolicy$1>;
/**
 * Triggered when a policy is created.
 */
declare const onPolicyCreated: BuildEventDefinition<typeof onPolicyCreated$1> & typeof onPolicyCreated$1;
/**
 * Triggered when a policy is deleted.
 */
declare const onPolicyDeleted: BuildEventDefinition<typeof onPolicyDeleted$1> & typeof onPolicyDeleted$1;
/**
 * Triggered when a policy is updated.
 */
declare const onPolicyUpdated: BuildEventDefinition<typeof onPolicyUpdated$1> & typeof onPolicyUpdated$1;

export { CreatePolicyApplicationErrors, PoliciesQueryBuilder, Policy, PolicyCreatedEnvelope, PolicyDeletedEnvelope, PolicyUpdatedEnvelope, ReorderEventPoliciesApplicationErrors, ReorderEventPoliciesOptions, ReorderEventPoliciesResponse, UpdatePolicy, createPolicy, deletePolicy, getPolicy, onPolicyCreated, onPolicyDeleted, onPolicyUpdated, queryPolicies, reorderEventPolicies, updatePolicy };

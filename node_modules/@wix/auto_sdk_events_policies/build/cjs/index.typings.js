...
__export(index_typings_exports, {
  ...
  createPolicy: () => createPolicy2,
  deletePolicy: () => deletePolicy2,
  getPolicy: () => getPolicy2,
  queryPolicies: () => queryPolicies2,
  reorderEventPolicies: () => reorderEventPolicies2,
...
async function deletePolicy2(policyId) {
  const { httpClient, sideEffects } = arguments[1];
  const payload = (0, import_rename_all_nested_keys.renameKeysFromSDKRequestToRESTRequest)({ policyId });

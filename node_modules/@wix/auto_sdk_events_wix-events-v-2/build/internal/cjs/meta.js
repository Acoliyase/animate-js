...
__export(meta_exports, {
  ...
  BadgeTypeTypeOriginal: () => BadgeTypeType,
  ...
  ConferenceTypeTypeOriginal: () => ConferenceTypeType,
  CropOriginal: () => Crop,
  ...
  GuestTypeTypeOriginal: () => GuestTypeType,
  ImagePositionOriginal: () => ImagePosition,
  InitialExpandedItemsOriginal: () => InitialExpandedItems,
  InitialRegistrationTypeTypeOriginal: () => InitialRegistrationTypeType,
  ...
  RecurrenceStatusStatusOriginal: () => RecurrenceStatusStatus,
  RegistrationStatusStatusOriginal: () => RegistrationStatusStatus,
  RegistrationTypeTypeOriginal: () => RegistrationTypeType,
  RelationOriginal: () => Relation,
  RequestedFieldsOriginal: () => RequestedFields,
  ResizingOriginal: () => Resizing,
  ResponseTypeOriginal: () => ResponseType,
...
function cloneEvent2() {
  const payload = { eventId: ":eventId" };
  const getRequestOptions = cloneEvent(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function publishDraftEvent2() {
  const payload = { eventId: ":eventId" };
  const getRequestOptions = publishDraftEvent(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkCancelEventsByFilter2() {
  const payload = {};
  const getRequestOptions = bulkCancelEventsByFilter(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteEvent2() {
  const payload = { eventId: ":eventId" };
  const getRequestOptions = deleteEvent(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function bulkDeleteEventsByFilter2() {
  const payload = {};
  const getRequestOptions = bulkDeleteEventsByFilter(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function countEventsByStatus2() {
  const payload = {};
  const getRequestOptions = countEventsByStatus(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function getEventBySlug2() {
  const payload = { slug: ":slug" };
  const getRequestOptions = getEventBySlug(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
0 && (module.exports = {
  ...
  FontTypeOriginal,
  GIFTypeOriginal,
  GuestTypeTypeOriginal,
  ImagePositionOriginal,
  InitialExpandedItemsOriginal,
  InitialRegistrationTypeTypeOriginal,
  ...
  PositionOriginal,
  RecurrenceStatusStatusOriginal,
  RegistrationStatusStatusOriginal,
  RegistrationTypeTypeOriginal,
  RelationOriginal,
  RequestedFieldsOriginal,
  ResizingOriginal,
  ResponseTypeOriginal,

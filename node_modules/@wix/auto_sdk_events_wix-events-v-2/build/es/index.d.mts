...
interface BulkCancelEventsByFilterSignature {
     ...
     * @param - Optional fields.
     */
    (options?: NonNullablePaths<BulkCancelEventsByFilterOptions, `filter.filter`, 3>): Promise<void>;
}
...
interface DeleteEventSignature {
     ...
     * @param - Event ID.
     */
    (eventId: string): Promise<NonNullablePaths<DeleteEventResponse, `eventId`, 2>>;
}

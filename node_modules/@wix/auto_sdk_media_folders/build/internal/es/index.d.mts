...
import { CreateFolderOptions, CreateFolderResponse, Folder, ListFoldersOptions, ListFoldersResponse, SearchFoldersOptions, SearchFoldersResponse, UpdateFolder, UpdateFolderValidationErrors, GenerateFolderDownloadUrlResponse, BulkDeleteFoldersOptions, ListDeletedFoldersOptions, ListDeletedFoldersResponse, FolderCreatedEnvelope, FolderDeletedEnvelope, FolderUpdatedEnvelope } from './index.typings.mjs';
export { ActionEvent, BaseEventMetadata, BulkDeleteFoldersRequest, BulkDeleteFoldersResponse, BulkRestoreFoldersFromTrashBinRequest, BulkRestoreFoldersFromTrashBinResponse, CreateFolderRequest, CursorPaging, Cursors, DomainEvent, DomainEventBodyOneOf, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, GenerateFolderDownloadUrlRequest, GetFolderRequest, GetFolderResponse, IdentificationData, IdentificationDataIdOneOf, ListDeletedFoldersRequest, ListFoldersRequest, MessageEnvelope, Namespace, NamespaceWithLiterals, PagingMetadataV2, RestoreInfo, RootFolder, RootFolderWithLiterals, SearchFoldersRequest, SortOrder, SortOrderWithLiterals, Sorting, State, StateWithLiterals, UnsupportedRequestValueError, UpdateFolderRequest, UpdateFolderResponse, WebhookIdentityType, WebhookIdentityTypeWithLiterals } from './index.typings.mjs';
...
interface CreateFolderSignature {
     ...
     */
    (displayName: string, options?: CreateFolderOptions): Promise<NonNullablePaths<CreateFolderResponse, `folder._id` | `folder.displayName` | `folder.parentFolderId` | `folder.state`, 3>>;
}
...
interface GetFolderSignature {
     ...
     */
    (folderId: string): Promise<NonNullablePaths<Folder, `_id` | `displayName` | `parentFolderId` | `state`, 2>>;
}
...
interface ListFoldersSignature {
     ...
     */
    (options?: ListFoldersOptions): Promise<NonNullablePaths<ListFoldersResponse, `folders` | `folders.${number}._id` | `folders.${number}.displayName` | `folders.${number}.parentFolderId` | `folders.${number}.state`, 4>>;
}
...
interface SearchFoldersSignature {
     ...
     */
    (options?: SearchFoldersOptions): Promise<NonNullablePaths<SearchFoldersResponse, `folders` | `folders.${number}._id` | `folders.${number}.displayName` | `folders.${number}.parentFolderId` | `folders.${number}.state`, 4>>;
}
...
interface UpdateFolderSignature {
     ...
     */
    (_id: string, folder: UpdateFolder): Promise<NonNullablePaths<Folder, `_id` | `displayName` | `parentFolderId` | `state`, 2> & {
...
interface GenerateFolderDownloadUrlSignature {
     ...
     * @param - Folder ID.
     */
    (folderId: string): Promise<NonNullablePaths<GenerateFolderDownloadUrlResponse, `downloadUrl`, 2>>;
}
...
interface BulkDeleteFoldersSignature {
     ...
     */
    (folderIds: string[], options?: BulkDeleteFoldersOptions): Promise<void>;
}
...
interface ListDeletedFoldersSignature {
     ...
     */
    (options?: ListDeletedFoldersOptions): Promise<NonNullablePaths<ListDeletedFoldersResponse, `folders` | `folders.${number}._id` | `folders.${number}.displayName` | `folders.${number}.parentFolderId` | `folders.${number}.state`, 4>>;
}
 ...
 */
declare const onFolderCreated: BuildEventDefinition<typeof onFolderCreated$1> & typeof onFolderCreated$1;
/**
 ...
 */
declare const onFolderDeleted: BuildEventDefinition<typeof onFolderDeleted$1> & typeof onFolderDeleted$1;
/**
 * Triggered when a folder is updated, including when a folder is moved to a different parent folder.
 */
declare const onFolderUpdated: BuildEventDefinition<typeof onFolderUpdated$1> & typeof onFolderUpdated$1;

export { BulkDeleteFoldersOptions, CreateFolderOptions, CreateFolderResponse, Folder, FolderCreatedEnvelope, FolderDeletedEnvelope, FolderUpdatedEnvelope, GenerateFolderDownloadUrlResponse, ListDeletedFoldersOptions, ListDeletedFoldersResponse, ListFoldersOptions, ListFoldersResponse, SearchFoldersOptions, SearchFoldersResponse, UpdateFolder, UpdateFolderValidationErrors, bulkDeleteFolders, bulkRestoreFoldersFromTrashBin, createFolder, generateFolderDownloadUrl, getFolder, listDeletedFolders, listFolders, onFolderCreated, onFolderDeleted, onFolderUpdated, searchFolders, updateFolder };

...
var onSubmissionDeleted2 = createEventModule(
  onSubmissionDeleted
);
var onSubmissionRemovedSubmissionFromTrash2 = createEventModule(
  onSubmissionRemovedSubmissionFromTrash
);
var onSubmissionStatusUpdated2 = createEventModule(
  onSubmissionStatusUpdated
);
var onSubmissionContactMapped2 = createEventModule(
  onSubmissionContactMapped
);
var onSubmissionContactMappingSkipped2 = createEventModule(
  onSubmissionContactMappingSkipped
);
var onSubmissionUpdated2 = createEventModule(
  onSubmissionUpdated
);
export {
  AddressInfoTag,

import { GetEventsSettingsRequest as GetEventsSettingsRequest$1, GetEventsSettingsResponse as GetEventsSettingsResponse$1, UpdateEventsSettingsRequest as UpdateEventsSettingsRequest$1, UpdateEventsSettingsResponse as UpdateEventsSettingsResponse$1 } from './index.typings.mjs';
...
interface EventPages {
     ...
     * @readonly
     */
    eventPageUrl?: PageUrlV2;
    /**
     * URL for the Events schedule page showing upcoming events in calendar format. Use this for calendar-based event navigation.
     * @readonly
     */
    schedulePageUrl?: PageUrlV2;
}
interface PageUrlV2 {
    /**
     * The relative path for the page within the site. For example, `/product-page/a-product`.
     * Relative path within the site. For example, `/product-page/a-product`.
     * @maxLength 128
     */
    relativePath?: string;
    /**
     * Complete URL including domain and path. For example, `https://mysite.com/product-page/a-product`.
     * @maxLength 128
     */
    url?: string | null;
}
...
declare function getEventsSettings(): __PublicMethodMetaInfo<'GET', {}, GetEventsSettingsRequest$1, GetEventsSettingsRequest, GetEventsSettingsResponse$1, GetEventsSettingsResponse>;
declare function updateEventsSettings(): __PublicMethodMetaInfo<'PATCH', {
    eventsSettingsId: string;
}, UpdateEventsSettingsRequest$1, UpdateEventsSettingsRequest, UpdateEventsSettingsResponse$1, UpdateEventsSettingsResponse>;

export { type ActionEvent as ActionEventOriginal, Action as ActionOriginal, type ActionTargetOfOneOf as ActionTargetOfOneOfOriginal, type ActionTarget as ActionTargetOriginal, type ActionWithLiterals as ActionWithLiteralsOriginal, type AddressHint as AddressHintOriginal, type Address as AddressOriginal, type AgreeToServiceFeeRequest as AgreeToServiceFeeRequestOriginal, type AgreeToServiceFeeResponse as AgreeToServiceFeeResponseOriginal, type AppState as AppStateOriginal, AppStateState as AppStateStateOriginal, type AppStateStateWithLiterals as AppStateStateWithLiteralsOriginal, type Asset as AssetOriginal, type AssignedFromFloatingReason as AssignedFromFloatingReasonOriginal, type BackofficeActionTarget as BackofficeActionTargetOriginal, type BooleanFeature as BooleanFeatureOriginal, type BusinessSchedule as BusinessScheduleOriginal, type CancelRequestedReason as CancelRequestedReasonOriginal, type Categories as CategoriesOriginal, CheckoutType as CheckoutTypeOriginal, type CheckoutTypeWithLiterals as CheckoutTypeWithLiteralsOriginal, type ConsentPolicy as ConsentPolicyOriginal, type Contact as ContactOriginal, type ContractSwitchedReason as ContractSwitchedReasonOriginal, type DashboardPageActionTarget as DashboardPageActionTargetOriginal, DayOfWeek as DayOfWeekOriginal, type DayOfWeekWithLiterals as DayOfWeekWithLiteralsOriginal, type DelayedPaymentCaptureSettings as DelayedPaymentCaptureSettingsOriginal, type DeleteContext as DeleteContextOriginal, DeleteStatus as DeleteStatusOriginal, type DeleteStatusWithLiterals as DeleteStatusWithLiteralsOriginal, type DomainEventBodyOneOf as DomainEventBodyOneOfOriginal, type DomainEvent as DomainEventOriginal, type Empty as EmptyOriginal, type EntityCreatedEvent as EntityCreatedEventOriginal, type EntityDeletedEvent as EntityDeletedEventOriginal, type EntityUpdatedEvent as EntityUpdatedEventOriginal, type EventBadgesSettings as EventBadgesSettingsOriginal, type EventPages as EventPagesOriginal, type EventsInfo as EventsInfoOriginal, type EventsSettings as EventsSettingsOriginal, type FeatureCancelled as FeatureCancelledOriginal, type FeatureCancelledReasonOneOf as FeatureCancelledReasonOneOfOriginal, type FeatureContext as FeatureContextOriginal, type FeatureDisabled as FeatureDisabledOriginal, type FeatureDisabledReasonOneOf as FeatureDisabledReasonOneOfOriginal, type FeatureEnabled as FeatureEnabledOriginal, type FeatureEnabledReasonOneOf as FeatureEnabledReasonOneOfOriginal, type FeatureEventEventOneOf as FeatureEventEventOneOfOriginal, type FeatureEvent as FeatureEventOriginal, type Feature as FeatureOriginal, FeaturePeriod as FeaturePeriodOriginal, type FeaturePeriodWithLiterals as FeaturePeriodWithLiteralsOriginal, type FeatureQuantityInfoOneOf as FeatureQuantityInfoOneOfOriginal, type FeatureUpdated as FeatureUpdatedOriginal, type FeatureUpdatedPreviousQuantityInfoOneOf as FeatureUpdatedPreviousQuantityInfoOneOfOriginal, type FeatureUpdatedReasonOneOf as FeatureUpdatedReasonOneOfOriginal, type GeoCoordinates as GeoCoordinatesOriginal, type GetEventsSettingsRequest as GetEventsSettingsRequestOriginal, type GetEventsSettingsResponse as GetEventsSettingsResponseOriginal, type IdentificationDataIdOneOf as IdentificationDataIdOneOfOriginal, type IdentificationData as IdentificationDataOriginal, type IncognitoDetails as IncognitoDetailsOriginal, type LiveSiteActionTarget as LiveSiteActionTargetOriginal, type Locale as LocaleOriginal, type ManualFeatureCreationReason as ManualFeatureCreationReasonOriginal, type MessageEnvelope as MessageEnvelopeOriginal, type MetaSiteSpecialEvent as MetaSiteSpecialEventOriginal, type MetaSiteSpecialEventPayloadOneOf as MetaSiteSpecialEventPayloadOneOfOriginal, type MigratedFromLegacyReason as MigratedFromLegacyReasonOriginal, type Multilingual as MultilingualOriginal, type NamespaceChanged as NamespaceChangedOriginal, Namespace as NamespaceOriginal, type NamespaceWithLiterals as NamespaceWithLiteralsOriginal, type NewFeatureReason as NewFeatureReasonOriginal, type NewNotificationMessage as NewNotificationMessageOriginal, type NotificationInfo as NotificationInfoOriginal, type NotificationInitiatorInitiatorOneOf as NotificationInitiatorInitiatorOneOfOriginal, type NotificationInitiator as NotificationInitiatorOriginal, type NotificationRecipient as NotificationRecipientOriginal, type NotificationRecipientRecipientTypeOneOf as NotificationRecipientRecipientTypeOneOfOriginal, type NotificationsSpout as NotificationsSpoutOriginal, type NotificationsSpoutSpoutTypeOneOf as NotificationsSpoutSpoutTypeOneOfOriginal, type OdeditorAssigned as OdeditorAssignedOriginal, type OdeditorUnassigned as OdeditorUnassignedOriginal, type PageUrlV2 as PageUrlV2Original, PatchField as PatchFieldOriginal, type PatchFieldWithLiterals as PatchFieldWithLiteralsOriginal, type PaymentMethod as PaymentMethodOriginal, type PaymentSettings as PaymentSettingsOriginal, type PicassoAssigned as PicassoAssignedOriginal, type PicassoUnassigned as PicassoUnassignedOriginal, PlacementType as PlacementTypeOriginal, type PlacementTypeWithLiterals as PlacementTypeWithLiteralsOriginal, PremiumFeature as PremiumFeatureOriginal, type PremiumFeatureWithLiterals as PremiumFeatureWithLiteralsOriginal, type Properties as PropertiesOriginal, type QuotaFeature as QuotaFeatureOriginal, type QuotaInfoEntry as QuotaInfoEntryOriginal, type QuotaInfo as QuotaInfoOriginal, type ReassignedFromSiteReason as ReassignedFromSiteReasonOriginal, type ReassignedToAnotherSiteReason as ReassignedToAnotherSiteReasonOriginal, type RefreshTicketsFlagsRequest as RefreshTicketsFlagsRequestOriginal, type RefreshTicketsFlagsResponse as RefreshTicketsFlagsResponseOriginal, type ReplacedByAnotherSubscriptionReason as ReplacedByAnotherSubscriptionReasonOriginal, RequestedFields as RequestedFieldsOriginal, type RequestedFieldsWithLiterals as RequestedFieldsWithLiteralsOriginal, ResolutionMethod as ResolutionMethodOriginal, type ResolutionMethodWithLiterals as ResolutionMethodWithLiteralsOriginal, type RestoreInfo as RestoreInfoOriginal, type ServiceFeeSettings as ServiceFeeSettingsOriginal, type ServiceProvisioned as ServiceProvisionedOriginal, type ServiceRemoved as ServiceRemovedOriginal, SiteCreatedContext as SiteCreatedContextOriginal, type SiteCreatedContextWithLiterals as SiteCreatedContextWithLiteralsOriginal, type SiteCreated as SiteCreatedOriginal, type SiteDeleted as SiteDeletedOriginal, type SiteHardDeleted as SiteHardDeletedOriginal, type SiteInfo as SiteInfoOriginal, type SiteMarkedAsTemplate as SiteMarkedAsTemplateOriginal, type SiteMarkedAsWixSite as SiteMarkedAsWixSiteOriginal, type SiteMember as SiteMemberOriginal, type SitePropertiesEvent as SitePropertiesEventOriginal, type SitePropertiesUpdated as SitePropertiesUpdatedOriginal, type SitePublished as SitePublishedOriginal, type SitePurgedExternally as SitePurgedExternallyOriginal, type SiteRenamed as SiteRenamedOriginal, type SiteSettings as SiteSettingsOriginal, type SiteTransferred as SiteTransferredOriginal, type SiteUndeleted as SiteUndeletedOriginal, type SiteUnpublished as SiteUnpublishedOriginal, type SiteUrlChanged as SiteUrlChangedOriginal, type SpecialHourPeriod as SpecialHourPeriodOriginal, State as StateOriginal, type StateWithLiterals as StateWithLiteralsOriginal, type StudioAssigned as StudioAssignedOriginal, type StudioTwoAssigned as StudioTwoAssignedOriginal, type StudioTwoUnassigned as StudioTwoUnassignedOriginal, type StudioUnassigned as StudioUnassignedOriginal, type SupportedLanguage as SupportedLanguageOriginal, type TimePeriod as TimePeriodOriginal, type TransferredFromAnotherAccountReason as TransferredFromAnotherAccountReasonOriginal, type TransferredToAnotherAccountReason as TransferredToAnotherAccountReasonOriginal, Type as TypeOriginal, type TypeWithLiterals as TypeWithLiteralsOriginal, type UnAssingedToFloatingReason as UnAssingedToFloatingReasonOriginal, type UpdateEventsFeeSettingsRequest as UpdateEventsFeeSettingsRequestOriginal, type UpdateEventsFeeSettingsResponse as UpdateEventsFeeSettingsResponseOriginal, type UpdateEventsSettingsRequest as UpdateEventsSettingsRequestOriginal, type UpdateEventsSettingsResponse as UpdateEventsSettingsResponseOriginal, WebhookIdentityType as WebhookIdentityTypeOriginal, type WebhookIdentityTypeWithLiterals as WebhookIdentityTypeWithLiteralsOriginal, type WixelAssigned as WixelAssignedOriginal, type WixelUnassigned as WixelUnassignedOriginal, type __PublicMethodMetaInfo, getEventsSettings, updateEventsSettings };

...
var stringifySafe = (value) => {
  try {
    ...
    return "Failed to stringify log value: ".concat(error == null ? void 0 : error.toString());
  }
};
...
var buildTelemetryPayload = (options, params) => {
  ...
  const { __sourceLocation, ...restOfContext } = contexts != null ? contexts : {};
  let siteUrl = "";
  if (req) {
    try {
      if (req.headers.get("referer")) {
        siteUrl = new URL((_a = req.headers.get("referer")) != null ? _a : "").origin;
      } else {
  ...
  const sourceLocation = __sourceLocation != null ? __sourceLocation : getCallLocation();
  return {
    insertId: generateId(),
    ...
    operation: {
      id: requestId != null ? requestId : generateId(),
      producer
    },
...
var BatchQueue = class {
  ...
  flush() {
    ...
    this.options.flushHandler(events).then(() => {
      var _a;
      (_a = this.resolveBatchQueuePromise) == null ? void 0 : _a.call(this);
      this.resolveBatchQueuePromise = null;
    });
    this.batchQueuePromise = null;
  }
  enqueue(payload) {
    ...
    if (!this.batchQueuePromise) {
      ...
      (_b = (_a = this.options).onBatchQueueCreated) == null ? void 0 : _b.call(_a, this.batchQueuePromise);
    }
...
var isPromise = (value) => typeof (value == null ? void 0 : value.then) === "function";
  ...
  constructor(options) {
    ...
    this.reportError = (captureContext = {}, e) => {
      ...
      const messagePayload = buildTelemetryPayload(this.options, {
        message: (_a = e == null ? void 0 : e.toString()) != null ? _a : "Unknown error",
        level: "error",
        tags,
        contexts: {
          __sourceLocation: getCallLocation2(e == null ? void 0 : e.stack),
          ...contexts
        }
      });

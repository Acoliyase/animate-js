...
interface VeloClientOptions {
    getAuthToken: () => Promise<string | undefined>;
    namespace: string;
    producer: string;
    onBatchQueueCreated?: (batchQueuePromise: Promise<void>) => void;
    fetch?: typeof fetch;
    req?: Request;
    requestId?: string;
}
...
declare const createVeloMonitoringClient: (options: VeloClientOptions) => MonitoringClient;

export { type MessagePayload, type VeloClientOptions, createVeloMonitoringClient };

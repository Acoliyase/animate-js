...
exports.FaqCategoriesService = exports.FaqCategoriesServiceDefinition = void 0;
exports.loadFaqCategoriesServiceConfig = loadFaqCategoriesServiceConfig;
 ...
 * @constant
 */
exports.FaqCategoriesServiceDefinition = (0, services_definitions_1.defineService)('faq-categories');
/**
 ...
 * ```
 */
exports.FaqCategoriesService = services_definitions_1.implementService.withConfig()(exports.FaqCategoriesServiceDefinition, ({ getService, config }) => {
    ...
    const hasCategoriesSignal = signalsService.signal(config.categories.length > 0);
    return {
 ...
 * ```
 */
async function loadFaqCategoriesServiceConfig() {
    try {
        // Use query-based approach like the reference
        let categoryQuery = faq_1.category.queryCategories();
        ...
        const transformedCategories = categoriesRaw
            .map((cat) => ({
            _id: cat._id,
            title: cat.title,
...
//# sourceMappingURL=faq-categories-service.js.map
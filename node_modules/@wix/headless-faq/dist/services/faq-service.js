 ...
 * @constant
 */
export const FaqServiceDefinition = defineService('faq');
/**
 ...
 * ```
 */
export const FaqService = implementService.withConfig()(FaqServiceDefinition, ({ getService, config }) => {
 ...
 * ```
 */
export async function loadFaqServiceConfig(categoryId) {
    try {
        // Use query-based approach like the reference
        let questionQuery = questionEntry.queryQuestionEntries({
            contentFormat: questionEntry.QueryQuestionEntriesRequestContentFormat.PLAIN_TEXT,
        });
 ...
 * ```
 */
export async function loadAllFaqsByCategory() {
    try {

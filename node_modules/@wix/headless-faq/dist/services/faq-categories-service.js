 ...
 * @constant
 */
export const FaqCategoriesServiceDefinition = defineService('faq-categories');
/**
 ...
 * ```
 */
export const FaqCategoriesService = implementService.withConfig()(FaqCategoriesServiceDefinition, ({ getService, config }) => {
 ...
 * ```
 */
export async function loadFaqCategoriesServiceConfig() {
    try {

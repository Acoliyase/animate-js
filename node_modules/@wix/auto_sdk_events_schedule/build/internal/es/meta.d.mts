...
/** @enumType */
type ScheduleStatusWithLiterals = ScheduleStatus | 'SCHEDULED' | 'CANCELED';
...
/** @enumType */
type StateFilterWithLiterals = StateFilter | 'PUBLISHED' | 'DRAFT' | 'VISIBLE' | 'HIDDEN';
interface Paging {
    /**
...
/** @docsIgnore */
type QueryScheduleItemsApplicationErrors = {

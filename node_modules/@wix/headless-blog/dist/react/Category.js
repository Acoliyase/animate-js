...
export const Label = React.forwardRef((props, ref) => {
    ...
    const attributes = {
        'data-testid': "blog-category-label" /* TestIds.blogCategoryLabel */,
        'data-has-image': !!category.imageUrl,
    };
    return (_jsx(AsChildSlot, { ref: ref, asChild: asChild, className: className, ...attributes, customElement: children, customElementProps: { label }, content: label, children: _jsx("span", { children: label }) }));
});
...
export const Description = React.forwardRef((props, ref) => {
    ...
    const attributes = {
        'data-testid': "blog-category-description" /* TestIds.blogCategoryDescription */,
        'data-has-image': !!imageUrl,
    };
    return (_jsx(AsChildSlot, { ref: ref, asChild: asChild, className: className, ...attributes, customElement: children, customElementProps: { description }, content: description, children: _jsx("p", { children: description }) }));
});
...
export const Link = React.forwardRef((props, ref) => {
    ...
    const attributes = {
        'data-testid': "blog-category-link" /* TestIds.blogCategoryLink */,
        'data-href': href,
        'data-active': isActive,
        'aria-current': isActive ? 'page' : undefined,
        'data-has-image': !!imageUrl,
    };
    return (_jsx(AsChildSlot, { ref: ref, asChild: asChild, className: className, ...attributes, customElement: children, customElementProps: { href, isActive }, content: href, children: _jsx("a", { href: href, children: category.label }) }));
});
...
export const Image = React.forwardRef((props, ref) => {
    ...
    if (!imageUrl)
        return null;
    const attributes = {
        'data-testid': "blog-category-image-url" /* TestIds.blogCategoryImageUrl */,
        'data-has-image': !!imageUrl,
    };
    return (_jsx(AsChildSlot, { ref: ref, asChild: asChild, className: className, ...attributes, customElement: children, customElementProps: { imageUrl }, content: imageUrl, children: _jsx("img", { src: imageUrl, alt: category.label }) }));
});

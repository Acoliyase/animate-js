...
var isSentryConfig = (monitoringConfig) => (monitoringConfig == null ? void 0 : monitoringConfig.type) === "SENTRY";
var isPanoramaConfig = (monitoringConfig) => (monitoringConfig == null ? void 0 : monitoringConfig.type) === "PANORAMA";
var getMonitoringClientFunction = ({
  ...
  if (isSentryConfig(monitoringConfig)) {
    ...
    return () => createSentryBrowserClient({
      dsn: sentryOptions == null ? void 0 : sentryOptions.dsn,
      hostContext,
      sentrySDK,

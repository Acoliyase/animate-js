 ...
 * @since 2.0.0
 */
const ap = (fa) => (fab) => () => Promise.all([Promise.resolve().then(fab), Promise.resolve().then(fa)]).then(([f, a]) => f(a));
exports.ap = ap;
/**
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, (ma, f) => () => Promise.resolve()
    .then(ma)
    .then((a) => f(a)()));
/**
 * @category sequencing
 ...
 * @deprecated
 */
exports.fromTask = function_js_1.identity;
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndexSeq = (f) => (as) => () => _.tail(as).reduce((acc, a, i) => acc.then((bs) => Promise.resolve()
    .then(f(i + 1, a))
    .then((b) => {
    bs.push(b);
    return bs;
 ...
 * @deprecated
 */
exports.getSemigroup = (0, Apply_js_1.getApplySemigroup)(exports.ApplySeq);
/**
 ...
 * @deprecated
 */
exports.getMonoid = (0, Applicative_js_1.getApplicativeMonoid)(exports.ApplicativeSeq);

...
import { Applicative3, Applicative3C } from './Applicative.js'
import { Apply1, Apply3 } from './Apply.js'
import { Bifunctor3 } from './Bifunctor.js'
import * as chainable from './Chain.js'
import { Compactable3C } from './Compactable.js'
import * as E from './Either.js'
import { Filterable3C } from './Filterable.js'
import { FromEither3 } from './FromEither.js'
import { FromIO3 } from './FromIO.js'
import { FromReader3 } from './FromReader.js'
import { FromTask3 } from './FromTask.js'
import { LazyArg } from './function.js'
import { Functor3 } from './Functor.js'
...
export declare const flap: <A>(
  ...
  fab: import('./HKT.js').Kind3<'ReaderTaskEither', R, E, (a: A) => B>
) => import('./HKT.js').Kind3<'ReaderTaskEither', R, E, B>
/**
 * @category instances
 * @since 2.10.0
 */
...
export declare const apFirst: <R, E, B>(
  ...
  first: import('./HKT.js').Kind3<'ReaderTaskEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderTaskEither', R, E, A>
/**
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind3<'ReaderTaskEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderTaskEither', R, E, { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => <R, E>(
  fa: import('./HKT.js').Kind3<'ReaderTaskEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderTaskEither', R, E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, R, E, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind3<'ReaderTaskEither', R, E, B>
) => (ma: import('./HKT.js').Kind3<'ReaderTaskEither', R, E, A>) => import('./HKT.js').Kind3<
  'ReaderTaskEither',
  R,
  E,
  {

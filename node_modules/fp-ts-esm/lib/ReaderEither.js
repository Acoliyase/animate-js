 ...
 * @since 2.15.0
 */
exports.tapError = (0, function_js_1.dual)(2, ET.tapError(R.Monad));
/**
 * @category error handling
 * @since 2.11.0
 */
 ...
 * @since 2.16.0
 */
exports.mapBoth = (0, function_js_1.dual)(3, ET.mapBoth(R.Functor));
/**
 * Alias of `mapBoth`.
 *
 * @category legacy
 ...
 * @since 2.16.0
 */
exports.mapError = (0, function_js_1.dual)(2, ET.mapError(R.Functor));
/**
 * Alias of `mapError`.
 *
 * @category legacy
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, ET.flatMap(R.Monad));
/**
...
const getCompactable = (M) => {
    ...
    return {
        URI: exports.URI,
        _E: undefined,
        compact: (0, Compactable_js_1.compact)(R.Functor, C),
        separate: (0, Compactable_js_1.separate)(R.Functor, C, E.Functor)
    };
};
...
function getFilterable(M) {
    ...
    const filter = (0, Filterable_js_1.filter)(R.Functor, F);
    const filterMap = (0, Filterable_js_1.filterMap)(R.Functor, F);
    const partition = (0, Filterable_js_1.partition)(R.Functor, F);
    const partitionMap = (0, Filterable_js_1.partitionMap)(R.Functor, F);
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
...
function getApplicativeReaderValidation(S) {
    const ap = (0, Apply_js_1.ap)(R.Apply, E.getApplicativeValidation(S));
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(E.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));
...
/*#__PURE__*/ (0, Apply_js_1.getApplySemigroup)(exports.Apply);
/**
...
/*#__PURE__*/ (0, Applicative_js_1.getApplicativeMonoid)(exports.Applicative);
/**
 * Use [`getApplySemigroup`](./Apply.ts.html#getapplysemigroup) instead.
 *
 * @category zone of death
 ...
 * @deprecated
 */
const getSemigroup = (S) => (0, Apply_js_1.getApplySemigroup)(R.Apply)(E.getSemigroup(S));

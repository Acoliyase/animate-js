 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, RT.flatMap(I.Monad));
/**
 ...
 * @since 2.13.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(I.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));

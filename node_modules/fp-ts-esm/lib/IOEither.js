...
const I = __importStar(require("./IO.js"));
// -------------------------------------------------------------------------------------
// constructors
// -------------------------------------------------------------------------------------
/**
 ...
 * @since 2.0.0
 */
const tryCatch = (f, onThrow) => () => E.tryCatch(f, onThrow);
 ...
 * @since 2.10.0
 */
const tryCatchK = (f, onThrow) => (...a) => (0, exports.tryCatch)(() => f(...a), onThrow);
 ...
 * @since 2.15.0
 */
exports.tapError = (0, function_js_1.dual)(2, ET.tapError(I.Monad));
/**
 * @category error handling
 * @since 2.12.0
 */
const orElseFirstIOK = (onLeft) => (0, exports.tapError)((0, exports.fromIOK)(onLeft));
 ...
 * @since 2.16.0
 */
exports.mapBoth = (0, function_js_1.dual)(3, ET.mapBoth(I.Functor));
/**
 * Alias of `mapBoth`.
 *
 * @category legacy
 ...
 * @since 2.16.0
 */
exports.mapError = (0, function_js_1.dual)(2, ET.mapError(I.Functor));
/**
 * Alias of `mapError`.
 *
 * @category legacy
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, ET.flatMap(I.Monad));
/**
 ...
 */
exports.flattenW = 
/*#__PURE__*/ (0, exports.flatMap)(function_js_1.identity);
/**
 * @category sequencing
 * @since 2.0.0
 */
...
function getApplicativeIOValidation(S) {
    const ap = (0, Apply_js_1.ap)(I.Apply, E.getApplicativeValidation(S));
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
...
const getCompactable = (M) => {
    ...
    return {
        URI: exports.URI,
        _E: undefined,
        compact: (0, Compactable_js_1.compact)(I.Functor, C),
        separate: (0, Compactable_js_1.separate)(I.Functor, C, E.Functor)
    };
};
...
function getFilterable(M) {
    ...
    const filter = (0, Filterable_js_1.filter)(I.Functor, F);
    const filterMap = (0, Filterable_js_1.filterMap)(I.Functor, F);
    const partition = (0, Filterable_js_1.partition)(I.Functor, F);
    const partitionMap = (0, Filterable_js_1.partitionMap)(I.Functor, F);
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
 ...
 */
exports.fromOptionK = 
/*#__PURE__*/ (0, FromEither_js_1.fromOptionK)(exports.FromEither);
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.10.0
 */
exports.chainOptionK = (0, FromEither_js_1.chainOptionK)(exports.FromEither, exports.Chain);
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 ...
 * @since 2.0.0
 */
const bracket = (acquire, use, release) => (0, exports.bracketW)(acquire, use, release);
 ...
 * @since 2.12.0
 */
const bracketW = (acquire, use, release) => (0, exports.flatMap)(acquire, (a) => I.flatMap(use(a), (e) => (0, exports.flatMap)(release(a, e), () => I.of(e))));
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(I.traverseReadonlyNonEmptyArrayWithIndex(f), I.map(E.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));
...
/*#__PURE__*/ (0, exports.traverseSeqArray)(function_js_1.identity);
// -------------------------------------------------------------------------------------
// deprecated
// -------------------------------------------------------------------------------------
/**
...
/*#__PURE__*/ (0, Apply_js_1.getApplySemigroup)(exports.ApplyPar);
/**
...
/*#__PURE__*/ (0, Applicative_js_1.getApplicativeMonoid)(exports.ApplicativePar);
/**
 * Use [`getApplySemigroup`](./Apply.ts.html#getapplysemigroup) instead.
 *
 * @category zone of death
 ...
 * @deprecated
 */
const getSemigroup = (S) => (0, Apply_js_1.getApplySemigroup)(I.Apply)(E.getSemigroup(S));

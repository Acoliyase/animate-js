...
exports.run = run;
const Applicative_js_1 = require("./Applicative.js");
const Apply_js_1 = require("./Apply.js");
const chainable = __importStar(require("./Chain.js"));
const Compactable_js_1 = require("./Compactable.js");
const E = __importStar(require("./Either.js"));
const ET = __importStar(require("./EitherT.js"));
const Filterable_js_1 = require("./Filterable.js");
const FromEither_js_1 = require("./FromEither.js");
const FromIO_js_1 = require("./FromIO.js");
const FromReader_js_1 = require("./FromReader.js");
const FromTask_js_1 = require("./FromTask.js");
const function_js_1 = require("./function.js");
const Functor_js_1 = require("./Functor.js");
const _ = __importStar(require("./internal.js"));
const R = __importStar(require("./Reader.js"));
const RT = __importStar(require("./ReaderTask.js"));
const T = __importStar(require("./Task.js"));
const TE = __importStar(require("./TaskEither.js"));
// -------------------------------------------------------------------------------------
// constructors
// -------------------------------------------------------------------------------------
/**
 ...
 * @since 2.0.0
 */
exports.rightTask = (0, function_js_1.flow)(TE.rightTask, exports.fromTaskEither);
/**
 * @category constructors
 * @since 2.0.0
 */
exports.leftTask = (0, function_js_1.flow)(TE.leftTask, exports.fromTaskEither);
/**
 * @category constructors
 * @since 2.0.0
 */
const rightReader = (ma) => (0, function_js_1.flow)(ma, TE.right);
exports.rightReader = rightReader;
/**
 * @category constructors
 * @since 2.0.0
 */
const leftReader = (me) => (0, function_js_1.flow)(me, TE.left);
 ...
 * @since 2.0.0
 */
exports.rightIO = (0, function_js_1.flow)(TE.rightIO, exports.fromTaskEither);
/**
 * @category constructors
 * @since 2.0.0
 */
exports.leftIO = (0, function_js_1.flow)(TE.leftIO, exports.fromTaskEither);
/**
 * @category constructors
 * @since 2.13.0
 */
const rightReaderIO = (ma) => (0, function_js_1.flow)(ma, TE.rightIO);
exports.rightReaderIO = rightReaderIO;
/**
 * @category constructors
 * @since 2.13.0
 */
const leftReaderIO = (me) => (0, function_js_1.flow)(me, TE.leftIO);
 ...
 * @since 2.0.0
 */
exports.fromIOEither = (0, function_js_1.flow)(TE.fromIOEither, exports.fromTaskEither);
/**
 * @category conversions
 * @since 2.0.0
 */
const fromReaderEither = (ma) => (0, function_js_1.flow)(ma, TE.fromEither);
 ...
 * @since 2.15.0
 */
exports.tapError = (0, function_js_1.dual)(2, ET.tapError(RT.Monad));
/**
 * @category error handling
 * @since 2.11.0
 */
 ...
 * @since 2.4.0
 */
const fromIOEitherK = (f) => (0, function_js_1.flow)(f, exports.fromIOEither);
exports.fromIOEitherK = fromIOEitherK;
/**
 * @category lifting
 * @since 2.4.0
 */
const fromTaskEitherK = (f) => (0, function_js_1.flow)(f, exports.fromTaskEither);
exports.fromTaskEitherK = fromTaskEitherK;
/**
 * @category lifting
 * @since 2.11.0
 */
const fromReaderEitherK = (f) => (0, function_js_1.flow)(f, exports.fromReaderEither);
exports.fromReaderEitherK = fromReaderEitherK;
const _map = (fa, f) => (0, function_js_1.pipe)(fa, (0, exports.map)(f));
const _apPar = (fab, fa) => (0, function_js_1.pipe)(fab, (0, exports.ap)(fa));
const _apSeq = (fab, fa) => (0, exports.flatMap)(fab, (f) => (0, function_js_1.pipe)(fa, (0, exports.map)(f)));
 ...
 * @since 2.16.0
 */
exports.mapBoth = (0, function_js_1.dual)(3, ET.mapBoth(RT.Functor));
/**
 * Alias of `mapBoth`.
 *
 * @category legacy
 ...
 * @since 2.16.0
 */
exports.mapError = (0, function_js_1.dual)(2, ET.mapError(RT.Functor));
/**
 * Alias of `mapError`.
 *
 * @category legacy
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, ET.flatMap(RT.Monad));
/**
 ...
 * @since 2.11.0
 */
exports.flattenW = (0, exports.flatMap)(function_js_1.identity);
/**
 * @category sequencing
 * @since 2.0.0
 */
...
const getCompactable = (M) => {
    ...
    return {
        URI: exports.URI,
        _E: undefined,
        compact: (0, Compactable_js_1.compact)(RT.Functor, C),
        separate: (0, Compactable_js_1.separate)(RT.Functor, C, E.Functor)
    };
};
...
function getFilterable(M) {
    ...
    const C = (0, exports.getCompactable)(M);
    const filter = (0, Filterable_js_1.filter)(RT.Functor, F);
    const filterMap = (0, Filterable_js_1.filterMap)(RT.Functor, F);
    const partition = (0, Filterable_js_1.partition)(RT.Functor, F);
    const partitionMap = (0, Filterable_js_1.partitionMap)(RT.Functor, F);
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
        compact: C.compact,
        separate: C.separate,
        filter: (fa, predicate) => (0, function_js_1.pipe)(fa, filter(predicate)),
        filterMap: (fa, f) => (0, function_js_1.pipe)(fa, filterMap(f)),
        partition: (fa, predicate) => (0, function_js_1.pipe)(fa, partition(predicate)),
        partitionMap: (fa, f) => (0, function_js_1.pipe)(fa, partitionMap(f))
    };
}
/**
...
function getApplicativeReaderTaskValidation(A, S) {
    const ap = (0, Apply_js_1.ap)(R.Apply, TE.getApplicativeTaskValidation(A, S));
    return {
        URI: exports.URI,
        _E: undefined,
        map: _map,
        ap: (fab, fa) => (0, function_js_1.pipe)(fab, ap(fa)),
        of: exports.of
    };
}
/**
...
function getAltReaderTaskValidation(S) {
    ...
    return {
        ...
        _E: undefined,
        map: _map,
        alt: (fa, that) => (0, function_js_1.pipe)(fa, alt(that))
    };
}
/**
 * @category instances
 ...
 * @since 2.16.0
 */
exports.as = (0, function_js_1.dual)(2, (0, Functor_js_1.as)(exports.Functor));
/**
 ...
 * @since 2.16.0
 */
exports.asUnit = (0, Functor_js_1.asUnit)(exports.Functor);
/**
 * @category mapping
 * @since 2.10.0
 */
 ...
 * @since 2.0.0
 */
exports.apFirst = (0, Apply_js_1.apFirst)(exports.ApplyPar);
/**
 ...
 * @since 2.0.0
 */
exports.apSecond = (0, Apply_js_1.apSecond)(exports.ApplyPar);
/**
 ...
 * @since 2.15.0
 */
exports.tap = (0, function_js_1.dual)(2, chainable.tap(exports.Chain));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapEither = (0, function_js_1.dual)(2, (0, FromEither_js_1.tapEither)(exports.FromEither, exports.Chain));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapIO = (0, function_js_1.dual)(2, (0, FromIO_js_1.tapIO)(exports.FromIO, exports.Chain));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapTask = (0, function_js_1.dual)(2, (0, FromTask_js_1.tapTask)(exports.FromTask, exports.Chain));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapReader = (0, function_js_1.dual)(2, (0, FromReader_js_1.tapReader)(exports.FromReader, exports.Chain));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapReaderEither = (0, function_js_1.dual)(2, (self, f) => (0, exports.tap)(self, (0, exports.fromReaderEitherK)(f)));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapTaskEither = (0, function_js_1.dual)(2, (self, f) => (0, exports.tap)(self, (0, exports.fromTaskEitherK)(f)));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapReaderTask = (0, function_js_1.dual)(2, (self, f) => (0, exports.tap)(self, (0, exports.fromReaderTaskK)(f)));
/**
 * Composes computations in sequence, using the return value of one computation to determine the next computation and
 * keeping only the result of the first.
 *
 ...
 * @since 2.16.0
 */
exports.tapReaderIO = (0, function_js_1.dual)(2, (self, f) => (0, exports.tap)(self, (0, exports.fromReaderIOK)(f)));
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.0.0
 */
exports.ask = (0, FromReader_js_1.ask)(exports.FromReader);
/**
 ...
 * @since 2.0.0
 */
exports.asks = (0, FromReader_js_1.asks)(exports.FromReader);
/**
 * @category lifting
 * @since 2.11.0
 */
exports.fromReaderK = (0, FromReader_js_1.fromReaderK)(exports.FromReader);
/**
 * Alias of `tapReader`.
 *
 * @category legacy
 ...
 * @since 2.11.0
 */
const fromReaderTaskK = (f) => (...a) => (0, exports.rightReaderTask)(f(...a));
 ...
 * @since 2.13.0
 */
const fromReaderIOK = (f) => (...a) => (0, exports.rightReaderIO)(f(...a));
 ...
 */
exports.fromOption = 
/*#__PURE__*/ (0, FromEither_js_1.fromOption)(exports.FromEither);
/**
 * Use `liftOption`.
 *
 * @category legacy
 * @since 2.10.0
 */
exports.fromOptionK = (0, FromEither_js_1.fromOptionK)(exports.FromEither);
/**
 * Use `flatMapOption`.
 *
 * @category legacy
...
/*#__PURE__*/ (0, FromEither_js_1.chainOptionK)(exports.FromEither, exports.Chain);
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 ...
 * @since 2.16.0
 */
exports.flatMapTaskEither = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromTaskEitherK)(f)));
/**
 * @category sequencing
 * @since 2.16.0
 */
exports.flatMapReaderTask = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromReaderTaskK)(f)));
/**
 * @category sequencing
 * @since 2.16.0
 */
 ...
 * @since 2.16.0
 */
exports.flatMapReaderIO = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromReaderIOK)(f)));
/**
 * @category sequencing
 * @since 2.16.0
 */
exports.flatMapIOEither = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromIOEitherK)(f)));
/**
 * @category sequencing
 * @since 2.16.0
 */
exports.flatMapReaderEither = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromReaderEitherK)(f)));
/**
 ...
 * @since 2.0.0
 */
exports.fromPredicate = (0, FromEither_js_1.fromPredicate)(exports.FromEither);
/**
 * @category filtering
 * @since 2.0.0
 */
exports.filterOrElse = (0, FromEither_js_1.filterOrElse)(exports.FromEither, exports.Chain);
/**
 ...
 * @since 2.10.0
 */
exports.fromIOK = (0, FromIO_js_1.fromIOK)(exports.FromIO);
/**
 * Alias of `flatMapIO`.
 *
 * @category legacy
 ...
 * @since 2.10.0
 */
exports.fromTaskK = (0, FromTask_js_1.fromTaskK)(exports.FromTask);
/**
 ...
 * @since 2.8.0
 */
exports.apS = (0, Apply_js_1.apS)(exports.ApplyPar);
/**
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(TE.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));
...
const traverseReadonlyArrayWithIndex = (f) => {
    ...
    return (as) => (_.isNonEmpty(as) ? g(as) : exports.ApT);
};
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndexSeq = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(TE.traverseReadonlyNonEmptyArrayWithIndexSeq(function_js_1.SK)));
...
const traverseReadonlyArrayWithIndexSeq = (f) => {
    const g = (0, exports.traverseReadonlyNonEmptyArrayWithIndexSeq)(f);
    return (as) => (_.isNonEmpty(as) ? g(as) : exports.ApT);
};
 ...
 * @since 2.9.0
 */
exports.sequenceArray = (0, exports.traverseArray)(function_js_1.identity);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(ApplicativeSeq)`.
 *
 * @category traversing
 ...
 * @since 2.9.0
 */
const traverseSeqArray = (f) => (0, exports.traverseReadonlyArrayWithIndexSeq)((_, a) => f(a));
 ...
 * @since 2.9.0
 */
exports.sequenceSeqArray = (0, exports.traverseSeqArray)(function_js_1.identity);
// -------------------------------------------------------------------------------------
// legacy
// -------------------------------------------------------------------------------------
/**
...
/*#__PURE__*/ (0, Apply_js_1.getApplySemigroup)(exports.ApplySeq);
/**
...
/*#__PURE__*/ (0, Applicative_js_1.getApplicativeMonoid)(exports.ApplicativeSeq);
/**
 * Use [`getApplySemigroup`](./Apply.ts.html#getapplysemigroup) instead.
 *
 * @category zone of death
 ...
 * @deprecated
 */
const getSemigroup = (S) => (0, Apply_js_1.getApplySemigroup)(RT.ApplySeq)(E.getSemigroup(S));

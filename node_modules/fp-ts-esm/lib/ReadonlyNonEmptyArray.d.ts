...
export declare const flap: <A>(
  ...
  fab: import('./HKT.js').Kind<'ReadonlyNonEmptyArray', (a: A) => B>
) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', B>
/**
 * @category instances
 * @since 2.10.0
 */
...
export declare const apFirst: <B>(
  ...
  first: import('./HKT.js').Kind<'ReadonlyNonEmptyArray', A>
) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', A>
/**
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind<'ReadonlyNonEmptyArray', A>
) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => (
  fa: import('./HKT.js').Kind<'ReadonlyNonEmptyArray', A>
) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', B>
) => (
  ma: import('./HKT.js').Kind<'ReadonlyNonEmptyArray', A>
) => import('./HKT.js').Kind<'ReadonlyNonEmptyArray', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * @category do notation
 * @since 2.8.0

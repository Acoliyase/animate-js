 ...
 * @since 2.0.0
 */
const ask = () => function_js_1.identity;
exports.ask = ask;
/**
 ...
 * @since 2.0.0
 */
exports.asks = function_js_1.identity;
// -------------------------------------------------------------------------------------
// combinators
// -------------------------------------------------------------------------------------
/**
...
const _compose = (bc, ab) => (0, function_js_1.pipe)(bc, (0, exports.compose)(ab));
const _promap = (fea, f, g) => (0, function_js_1.pipe)(fea, (0, exports.promap)(f, g));
/**
 ...
 * @since 2.0.0
 */
exports.of = function_js_1.constant;
/**
 * @category sequencing
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, (ma, f) => (r) => f(ma(r))(r));
/**
 ...
 * @since 2.0.0
 */
const compose = (ab) => (bc) => (0, function_js_1.flow)(ab, bc);
 ...
 * @since 2.0.0
 */
const id = () => function_js_1.identity;
exports.id = id;
/**
 * @since 2.10.0
 */
const first = (pab) => ([a, c]) => [pab(a), c];
exports.first = first;
/**
 * @since 2.10.0
 */
const second = (pbc) => ([a, b]) => [a, pbc(b)];
exports.second = second;
/**
 * @since 2.10.0
 */
const left = (pab) => E.fold((a) => _.left(pab(a)), E.right);
exports.left = left;
/**
 * @since 2.10.0
 */
const right = (pbc) => E.fold(E.left, (b) => _.right(pbc(b)));
exports.right = right;
/**
 ...
 * @deprecated
 */
exports.getSemigroup = (0, Apply_js_1.getApplySemigroup)(exports.Apply);
/**
 ...
 * @deprecated
 */
exports.getMonoid = (0, Applicative_js_1.getApplicativeMonoid)(exports.Applicative);

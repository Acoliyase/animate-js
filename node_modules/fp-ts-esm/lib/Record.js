 ...
 * @since 2.0.0
 */
exports.toArray = collect(S.Ord)((k, a) => [
    k,
    a
]);
function toUnfoldable(U) {
    return (r) => {
        const sas = (0, exports.toArray)(r);
 ...
 * @since 2.0.0
 */
const updateAt = (k, a) => (0, exports.modifyAt)(k, () => a);
 ...
 * @category conversions
 */
const fromEntries = (fa) => fromFoldable(Se.last(), A.Foldable)(fa);

...
const RT = __importStar(require("./ReaderT.js"));
 ...
 * @since 2.3.0
 */
exports.fromIO = (0, function_js_1.flow)(T.fromIO, exports.fromTask);
/**
 * @category conversions
 * @since 2.13.0
 */
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, RT.flatMap(T.Monad));
/**
 ...
 * @since 2.13.0
 */
const fromReaderIOK = (f) => (...a) => (0, exports.fromReaderIO)(f(...a));
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(T.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndexSeq = (f) => (0, function_js_1.flow)(R.traverseReadonlyNonEmptyArrayWithIndex(f), R.map(T.traverseReadonlyNonEmptyArrayWithIndexSeq(function_js_1.SK)));

...
const OT = __importStar(require("./OptionT.js"));
 ...
 * @since 2.10.0
 */
const fromIO = (ma) => (0, exports.fromTask)(T.fromIO(ma));
 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, OT.flatMap(T.Monad));
/** @internal */
const _FlatMap = {
 ...
 * @since 2.10.0
 */
exports.compact = (0, Compactable_js_1.compact)(T.Functor, O.Compactable);
/**
 * @category filtering
 * @since 2.10.0
 */
exports.separate = (0, Compactable_js_1.separate)(T.Functor, O.Compactable, O.Functor);
/**
 * @category filtering
 * @since 2.10.0
 */
exports.filter = (0, Filterable_js_1.filter)(T.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.10.0
 */
exports.filterMap = 
/*#__PURE__*/ (0, Filterable_js_1.filterMap)(T.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.10.0
 */
exports.partition = (0, Filterable_js_1.partition)(T.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.10.0
 */
exports.partitionMap = (0, Filterable_js_1.partitionMap)(T.Functor, O.Filterable);
// -------------------------------------------------------------------------------------
// instances
// -------------------------------------------------------------------------------------
 ...
 */
exports.fromIOK = 
/*#__PURE__*/ (0, FromIO_js_1.fromIOK)(exports.FromIO);
/**
 * Alias of `flatMapIO`.
 *
 * @category legacy
 ...
 */
exports.fromTaskK = 
/*#__PURE__*/ (0, FromTask_js_1.fromTaskK)(exports.FromTask);
/**
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(T.traverseReadonlyNonEmptyArrayWithIndex(f), T.map(O.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));
 ...
 * @since 2.11.0
 */
const traverseReadonlyNonEmptyArrayWithIndexSeq = (f) => (as) => () => _.tail(as).reduce((acc, a, i) => acc.then((obs) => _.isNone(obs)
    ? acc
    : f(i + 1, a)().then((ob) => {
        if (_.isNone(ob)) {
            return ob;

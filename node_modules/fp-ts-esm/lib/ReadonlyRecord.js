...
const S = __importStar(require("./string.js"));
...
function toUnfoldable(U) {
    return (r) => {
        const sas = (0, exports.toReadonlyArray)(r);
...
function traverse(F) {
    const traverseOF = (0, exports._traverse)(S.Ord)(F);
...
const wither = (F) => {
    ...
    return (f) => (fa) => F.map((0, function_js_1.pipe)(fa, traverseF(f)), exports.compact);
};
...
const wilt = (F) => {
    const traverseF = traverse(F);
    return (f) => (fa) => F.map((0, function_js_1.pipe)(fa, traverseF(f)), exports.separate);
};
exports.wilt = wilt;
...
function fromFoldable(M, F) {
    ...
    return (fka) => fromFoldableMapM(fka, function_js_1.identity);
}
...
/** @internal */
const _map = (fa, f) => (0, function_js_1.pipe)(fa, map(f));
exports._map = _map;
/** @internal */
/* istanbul ignore next */
const _mapWithIndex = (fa, f) => (0, function_js_1.pipe)(fa, mapWithIndex(f));
exports._mapWithIndex = _mapWithIndex;
/** @internal */
/* istanbul ignore next */
const _reduce = (O) => {
    const reduceO = reduce(O);
    return (fa, b, f) => (0, function_js_1.pipe)(fa, reduceO(b, f));
};
...
const _reduceRight = (O) => {
    ...
    return (fa, b, f) => (0, function_js_1.pipe)(fa, reduceRightO(b, f));
};
...
const _reduceWithIndex = (O) => {
    ...
    return (fa, b, f) => (0, function_js_1.pipe)(fa, reduceWithIndexO(b, f));
};
...
const _reduceRightWithIndex = (O) => {
    ...
    return (fa, b, f) => (0, function_js_1.pipe)(fa, reduceRightWithIndexO(b, f));
};
exports._reduceRightWithIndex = _reduceRightWithIndex;
/** @internal */
/* istanbul ignore next */
const _partitionMapWithIndex = (fa, f) => (0, function_js_1.pipe)(fa, partitionMapWithIndex(f));
exports._partitionMapWithIndex = _partitionMapWithIndex;
/** @internal */
/* istanbul ignore next */
const _partitionWithIndex = (fa, predicateWithIndex) => (0, function_js_1.pipe)(fa, partitionWithIndex(predicateWithIndex));
exports._partitionWithIndex = _partitionWithIndex;
/** @internal */
/* istanbul ignore next */
const _filterMapWithIndex = (fa, f) => (0, function_js_1.pipe)(fa, filterMapWithIndex(f));
exports._filterMapWithIndex = _filterMapWithIndex;
/** @internal */
/* istanbul ignore next */
const _filterWithIndex = (fa, predicateWithIndex) => (0, function_js_1.pipe)(fa, filterWithIndex(predicateWithIndex));
...
const _traverse = (O) => {
    ...
    return (F) => {
        ...
        return (ta, f) => traverseWithIndexOF(ta, (0, function_js_1.flow)(function_js_1.SK, f));
    };
};
exports._traverse = _traverse;
/** @internal */
const _sequence = (O) => {
    const traverseO = (0, exports._traverse)(O);
    return (F) => {
        const traverseOF = traverseO(F);
        return (ta) => traverseOF(ta, function_js_1.identity);
    };
};
...
function getEq(E) {
    const isSubrecordE = isSubrecord(E);
    return (0, Eq_js_1.fromEquals)((x, y) => isSubrecordE(x)(y) && isSubrecordE(y)(x));
}
...
const getWitherable = (O) => {
    const T = (0, exports.getTraversable)(O);
    return {
        URI: exports.URI,
        map: exports._map,
        reduce: (0, exports._reduce)(O),
        ...
        partition: exports._partition,
        partitionMap: exports._partitionMap,
        wither: (0, Witherable_js_1.witherDefault)(T, exports.Compactable),
        wilt: (0, Witherable_js_1.wiltDefault)(T, exports.Compactable)
    };
};
...
const getUnionSemigroup = (S) => {
    const unionS = (0, exports.union)(S);
    return {
...
const getIntersectionSemigroup = (S) => {
    const intersectionS = (0, exports.intersection)(S);
    return {
...
const getDifferenceMagma = () => ({
    concat: (first, second) => (0, exports.difference)(second)(first)
});

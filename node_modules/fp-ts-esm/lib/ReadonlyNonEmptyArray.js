...
const Se = __importStar(require("./Semigroup.js"));
// -------------------------------------------------------------------------------------
// internal
// -------------------------------------------------------------------------------------
/**
 ...
 * @internal
 */
const prependW = (head) => (tail) => [head, ...tail];
 ...
 * @internal
 */
const appendW = (end) => (init) => [...init, end];
...
const uniq = (E) => (as) => {
    ...
    const out = [(0, exports.head)(as)];
    const rest = (0, exports.tail)(as);
    for (const a of rest) {
 ...
 */
const union = (E) => {
    const uniqE = (0, exports.uniq)(E);
    return (second) => (first) => uniqE((0, function_js_1.pipe)(first, concat(second)));
};
exports.union = union;
/**
...
const rotate = (n) => (as) => {
    ...
    if (m < 0) {
        const [f, s] = (0, exports.splitAt)(-m)(as);
        return (0, function_js_1.pipe)(s, concat(f));
    }
    else {
 ...
 * @since 2.5.0
 */
const fromReadonlyArray = (as) => (0, exports.isNonEmpty)(as) ? _.some(as) : _.none;
 ...
 * @since 2.11.0
 */
const replicate = (a) => (0, exports.makeBy)(() => a);
 ...
 * @since 2.11.0
 */
const range = (start, end) => start <= end ? (0, exports.makeBy)((i) => start + i)(end - start + 1) : [start];
exports.range = range;
/**
 ...
 * @since 2.9.0
 */
const unprepend = (as) => [(0, exports.head)(as), (0, exports.tail)(as)];
 ...
 * @since 2.9.0
 */
const unappend = (as) => [(0, exports.init)(as), (0, exports.last)(as)];
exports.unappend = unappend;
/**
 * @category conversions
 * @since 2.5.0
 */
const fromArray = (as) => (0, exports.fromReadonlyArray)(as.slice());
 ...
 * @since 2.5.0
 */
const reverse = (as) => as.length === 1 ? as : [(0, exports.last)(as), ...as.slice(0, -1).reverse()];
...
const intersperse = (middle) => (as) => {
    const rest = (0, exports.tail)(as);
    return (0, exports.isNonEmpty)(rest) ? (0, function_js_1.pipe)(rest, (0, exports.prependAll)(middle), (0, exports.prepend)((0, exports.head)(as))) : as;
};
...
const chainWithIndex = (f) => (as) => {
    const out = _.fromReadonlyNonEmptyArray(f(0, (0, exports.head)(as)));
    for (let i = 1; i < as.length; i++) {
        const bs = f(i, as[i]);
...
const splitAt = (n) => (as) => {
    ...
    return m >= as.length ? [as, exports.empty] : [(0, function_js_1.pipe)(as.slice(1, m), (0, exports.prepend)((0, exports.head)(as))), as.slice(m)];
};
 ...
 * @since 2.10.0
 */
const chunksOf = (n) => (0, exports.chop)((0, exports.splitAt)(n));
 ...
 * @since 2.9.0
 */
const altW = (that) => (as) => (0, function_js_1.pipe)(as, concatW(that()));
exports.altW = altW;
/**
 ...
 * @since 2.5.0
 */
const ap = (as) => (0, exports.flatMap)((f) => (0, function_js_1.pipe)(as, (0, exports.map)(f)));
exports.ap = ap;
/**
 * @example
 * import * as RNEA from 'fp-ts/ReadonlyNonEmptyArray'
 ...
 */
exports.duplicate = 
/*#__PURE__*/ (0, exports.extend)(function_js_1.identity);
/**
 * @category sequencing
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
const map = (f) => (0, exports.mapWithIndex)((_, a) => f(a));
exports.map = map;
/**
 * @category mapping
 * @since 2.5.0
...
const mapWithIndex = (f) => (as) => {
    const out = [f(0, (0, exports.head)(as))];
    for (let i = 1; i < as.length; i++) {
        out.push(f(i, as[i]));
    }
    return out;
 ...
 * @since 2.5.0
 */
const reduceRight = (b, f) => (0, exports.reduceRightWithIndex)(b, (_, b, a) => f(b, a));
 ...
 * @since 2.6.3
 */
const sequence = (F) => (0, exports.traverseWithIndex)(F)(function_js_1.SK);
...
const traverseWithIndex = (F) => (f) => (as) => {
    let out = F.map(f(0, (0, exports.head)(as)), exports.of);
    for (let i = 1; i < as.length; i++) {
        out = F.ap(F.map(out, (bs) => (b) => (0, function_js_1.pipe)(bs, (0, exports.append)(b))), f(i, as[i]));
    }
    return out;
};
...
const getUnionSemigroup = (E) => {
    const unionE = (0, exports.union)(E);
    return {
 ...
 * @since 2.5.0
 */
exports.chainFirst = (0, Chain_js_1.chainFirst)(exports.Chain);
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.11.0
 */
const matchLeft = (f) => (as) => f((0, exports.head)(as), (0, exports.tail)(as));
 ...
 * @since 2.11.0
 */
const matchRight = (f) => (as) => f((0, exports.init)(as), (0, exports.last)(as));
 ...
 * @since 2.11.0
 */
const modifyHead = (f) => (as) => [f((0, exports.head)(as)), ...(0, exports.tail)(as)];
 ...
 * @since 2.11.0
 */
const updateHead = (a) => (0, exports.modifyHead)(() => a);
 ...
 * @since 2.11.0
 */
const modifyLast = (f) => (as) => (0, function_js_1.pipe)((0, exports.init)(as), (0, exports.append)(f((0, exports.last)(as))));
 ...
 * @since 2.11.0
 */
const updateLast = (a) => (0, exports.modifyLast)(() => a);
 ...
 */
const intercalate = (S) => {
    const concatAllS = (0, exports.concatAll)(S);
    return (middle) => (0, function_js_1.flow)((0, exports.intersperse)(middle), concatAllS);
};
...
function groupSort(O) {
    const sortO = (0, exports.sort)(O);
    const groupO = group(O);
    return (as) => ((0, exports.isNonEmpty)(as) ? groupO(sortO(as)) : exports.empty);
}
function filter(predicate) {
    return (0, exports.filterWithIndex)((_, a) => predicate(a));
}
/**
 ...
 * @deprecated
 */
const filterWithIndex = (predicate) => (as) => (0, exports.fromReadonlyArray)(as.filter((a, i) => predicate(i, a)));
...
function cons(head, tail) {
    return tail === undefined ? (0, exports.prepend)(head) : (0, function_js_1.pipe)(tail, (0, exports.prepend)(head));
}
/**
 ...
 * @deprecated
 */
const snoc = (init, end) => (0, function_js_1.pipe)(init, concat([end]));
exports.snoc = snoc;
/**
 ...
 * @deprecated
 */
const insertAt = (i, a) => (as) => i < 0 || i > as.length ? _.none : _.some((0, exports.unsafeInsertAt)(i, a, as));

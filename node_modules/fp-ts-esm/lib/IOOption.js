 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_js_1.dual)(2, OT.flatMap(I.Monad));
/**
 * @category sequencing
 * @since 2.12.0
 */
 ...
 * @since 2.12.0
 */
exports.compact = (0, Compactable_js_1.compact)(I.Functor, O.Compactable);
/**
 * @category filtering
 * @since 2.12.0
 */
exports.separate = (0, Compactable_js_1.separate)(I.Functor, O.Compactable, O.Functor);
/**
 * @category filtering
 * @since 2.12.0
 */
exports.filter = (0, Filterable_js_1.filter)(I.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.12.0
 */
exports.filterMap = (0, Filterable_js_1.filterMap)(I.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.12.0
 */
exports.partition = (0, Filterable_js_1.partition)(I.Functor, O.Filterable);
/**
 * @category filtering
 * @since 2.12.0
 */
exports.partitionMap = (0, Filterable_js_1.partitionMap)(I.Functor, O.Filterable);
// -------------------------------------------------------------------------------------
// instances
// -------------------------------------------------------------------------------------
 ...
 * @since 2.16.0
 */
exports.flatMapOption = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromOptionK)(f)));
/**
 * @category sequencing
 * @since 2.16.0
 */
 ...
 * @since 2.16.0
 */
exports.flatMapNullable = (0, function_js_1.dual)(2, (self, f) => (0, exports.flatMap)(self, (0, exports.fromNullableK)(f)));
/**
 * @category lifting
 * @since 2.12.0
 */
 ...
 * @since 2.12.0
 */
const traverseReadonlyNonEmptyArrayWithIndex = (f) => (0, function_js_1.flow)(I.traverseReadonlyNonEmptyArrayWithIndex(f), I.map(O.traverseReadonlyNonEmptyArrayWithIndex(function_js_1.SK)));

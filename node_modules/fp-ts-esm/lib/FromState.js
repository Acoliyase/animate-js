...
const S = __importStar(require("./State.js"));
function get(F) {
...
function modify(F) {
    return (0, function_js_1.flow)(S.modify, F.fromState);
}
function gets(F) {
    return (0, function_js_1.flow)(S.gets, F.fromState);
}
function fromStateK(F) {
    return (f) => (0, function_js_1.flow)(f, F.fromState);
}

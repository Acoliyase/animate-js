...
const NEA = __importStar(require("./NonEmptyArray.js"));
const RA = __importStar(require("./ReadonlyArray.js"));
 ...
 * @since 2.0.0
 */
const makeBy = (n, f) => (n <= 0 ? [] : NEA.makeBy(f)(n));
 ...
 * @since 2.11.0
 */
const fromOption = (ma) => (_.isNone(ma) ? [] : [ma.value]);
 ...
 * @since 2.11.0
 */
const fromEither = (e) => (_.isLeft(e) ? [] : [e.right]);
 ...
 * @since 2.11.0
 */
const matchLeftW = (onEmpty, onNonEmpty) => (as) => (0, exports.isNonEmpty)(as) ? onNonEmpty(NEA.head(as), NEA.tail(as)) : onEmpty();
 ...
 * @since 2.11.0
 */
const matchRightW = (onEmpty, onNonEmpty) => (as) => (0, exports.isNonEmpty)(as) ? onNonEmpty(NEA.init(as), NEA.last(as)) : onEmpty();
 ...
 * @since 2.0.0
 */
const tail = (as) => ((0, exports.isNonEmpty)(as) ? _.some(NEA.tail(as)) : _.none);
exports.tail = tail;
/**
 ...
 * @since 2.0.0
 */
const init = (as) => ((0, exports.isNonEmpty)(as) ? _.some(NEA.init(as)) : _.none);
exports.init = init;
/**
 ...
 * @since 2.0.0
 */
const takeLeft = (n) => (as) => (0, exports.isOutOfBound)(n, as) ? (0, exports.copy)(as) : as.slice(0, n);
 ...
 * @since 2.0.0
 */
const takeRight = (n) => (as) => (0, exports.isOutOfBound)(n, as) ? (0, exports.copy)(as) : n === 0 ? [] : as.slice(-n);
 ...
 * @since 2.0.0
 */
const dropLeft = (n) => (as) => n <= 0 || (0, exports.isEmpty)(as) ? (0, exports.copy)(as) : n >= as.length ? [] : as.slice(n, as.length);
 ...
 * @since 2.0.0
 */
const dropRight = (n) => (as) => n <= 0 || (0, exports.isEmpty)(as) ? (0, exports.copy)(as) : n >= as.length ? [] : as.slice(0, as.length - n);
 ...
 * @since 2.0.0
 */
const reverse = (as) => ((0, exports.isEmpty)(as) ? [] : as.slice().reverse());
 ...
 * @since 2.0.0
 */
const sort = (O) => (as) => as.length <= 1 ? (0, exports.copy)(as) : as.slice().sort(O.compare);
exports.sort = sort;
/**
...
const prependAll = (middle) => {
    ...
    return (as) => ((0, exports.isNonEmpty)(as) ? f(as) : []);
};
...
const intersperse = (middle) => {
    ...
    return (as) => ((0, exports.isNonEmpty)(as) ? f(as) : (0, exports.copy)(as));
};
...
const chop = (f) => {
    const g = NEA.chop(f);
    return (as) => ((0, exports.isNonEmpty)(as) ? g(as) : []);
};
exports.chop = chop;
/**
 ...
 * @since 2.0.0
 */
const splitAt = (n) => (as) => n >= 1 && (0, exports.isNonEmpty)(as) ? NEA.splitAt(n)(as) : (0, exports.isEmpty)(as) ? [(0, exports.copy)(as), []] : [[], (0, exports.copy)(as)];
...
function comprehension(input, f, g = () => true) {
    const go = (scope, input) => (0, exports.isNonEmpty)(input)
        ? (0, exports.flatMap)(NEA.head(input), (a) => go((0, function_js_1.pipe)(scope, (0, exports.append)(a)), NEA.tail(input)))
        : g(...scope)
            ? [f(...scope)]
            : [];
    return go([], input);
 ...
 * @since 2.11.0
 */
const concatW = (second) => (first) => (0, exports.isEmpty)(first) ? (0, exports.copy)(second) : (0, exports.isEmpty)(second) ? (0, exports.copy)(first) : first.concat(second);
 ...
 * @since 2.0.0
 */
const unsafeUpdateAt = (i, a, as) => (0, exports.isNonEmpty)(as) ? NEA.unsafeUpdateAt(i, a, as) : [];

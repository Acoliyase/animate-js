...
export declare const flap: <A>(
  a: A
) => <B>(fab: import('./HKT.js').Kind<'IOOption', (a: A) => B>) => import('./HKT.js').Kind<'IOOption', B>
/**
 * @category instances
 * @since 2.12.0
 */
...
export declare const apFirst: <B>(
  second: IOOption<B>
) => <A>(first: import('./HKT.js').Kind<'IOOption', A>) => import('./HKT.js').Kind<'IOOption', A>
/**
...
export declare const apSecond: <B>(
  second: IOOption<B>
) => <A>(first: import('./HKT.js').Kind<'IOOption', A>) => import('./HKT.js').Kind<'IOOption', B>
/**
 * @category instances
 * @since 2.12.0
 */
 ...
 * @since 2.12.0
 */
export declare const guard: (b: boolean) => import('./HKT.js').Kind<'IOOption', void>
/**
 * @category instances
 * @since 2.12.0
 */
...
export declare const bindTo: <N extends string>(
  name: N
) => <A>(fa: import('./HKT.js').Kind<'IOOption', A>) => import('./HKT.js').Kind<'IOOption', { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => (
  fa: import('./HKT.js').Kind<'IOOption', A>
) => import('./HKT.js').Kind<'IOOption', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind<'IOOption', B>
) => (
  ma: import('./HKT.js').Kind<'IOOption', A>
) => import('./HKT.js').Kind<'IOOption', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * @category do notation
 * @since 2.12.0

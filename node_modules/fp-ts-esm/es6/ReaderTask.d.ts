...
export declare const flap: <A>(
  a: A
) => <E, B>(fab: import('./HKT.js').Kind2<'ReaderTask', E, (a: A) => B>) => import('./HKT.js').Kind2<'ReaderTask', E, B>
/**
 * @category instances
 * @since 2.10.0
 */
...
) => <A>(first: import('./HKT.js').Kind2<'ReaderTask', E, A>) => import('./HKT.js').Kind2<'ReaderTask', E, A>
/**
...
export declare const apSecond: <E, B>(
  second: ReaderTask<E, B>
) => <A>(first: import('./HKT.js').Kind2<'ReaderTask', E, A>) => import('./HKT.js').Kind2<'ReaderTask', E, B>
/**
 * Runs computations in parallel.
 *
 * @category instances
 ...
 * @since 2.3.0
 */
export declare const ask: <R>() => import('./HKT.js').Kind2<'ReaderTask', R, R>
/**
 ...
 * @since 2.3.0
 */
export declare const asks: <R, A>(f: (r: R) => A) => import('./HKT.js').Kind2<'ReaderTask', R, A>
/**
 * @category lifting
 * @since 2.11.0
 */
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind2<'ReaderTask', E, A>
) => import('./HKT.js').Kind2<'ReaderTask', E, { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => <E>(
  fa: import('./HKT.js').Kind2<'ReaderTask', E, A>
) => import('./HKT.js').Kind2<'ReaderTask', E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, E, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind2<'ReaderTask', E, B>
) => (
  ma: import('./HKT.js').Kind2<'ReaderTask', E, A>
) => import('./HKT.js').Kind2<'ReaderTask', E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * The `W` suffix (short for **W**idening) means that the environment types will be merged.
 *

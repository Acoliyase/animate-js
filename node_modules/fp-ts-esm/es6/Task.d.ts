...
export declare const flap: <A>(
  a: A
) => <B>(fab: import('./HKT.js').Kind<'Task', (a: A) => B>) => import('./HKT.js').Kind<'Task', B>
/**
 * @category instances
 * @since 2.10.0
 */
...
export declare const apFirst: <B>(
  second: Task<B>
) => <A>(first: import('./HKT.js').Kind<'Task', A>) => import('./HKT.js').Kind<'Task', A>
/**
...
export declare const apSecond: <B>(
  second: Task<B>
) => <A>(first: import('./HKT.js').Kind<'Task', A>) => import('./HKT.js').Kind<'Task', B>
/**
 * Runs computations in parallel.
 *
 * @category instances
...
export declare const bindTo: <N extends string>(
  name: N
) => <A>(fa: import('./HKT.js').Kind<'Task', A>) => import('./HKT.js').Kind<
  'Task',
  {
    readonly /**
     * Combine two effectful actions, keeping only the result of the first.
...
declare const let_: <N extends string, A, B>(
  ...
  fa: import('./HKT.js').Kind<'Task', A>
) => import('./HKT.js').Kind<'Task', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind<'Task', B>
) => (
  ma: import('./HKT.js').Kind<'Task', A>
) => import('./HKT.js').Kind<'Task', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * @category do notation
 * @since 2.8.0

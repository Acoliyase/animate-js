...
export declare const flap: <A>(
  ...
  fab: import('./HKT.js').Kind3<'ReaderEither', R, E, (a: A) => B>
) => import('./HKT.js').Kind3<'ReaderEither', R, E, B>
/**
 * @category instances
 * @since 2.10.0
 */
...
) => <A>(first: import('./HKT.js').Kind3<'ReaderEither', R, E, A>) => import('./HKT.js').Kind3<'ReaderEither', R, E, A>
/**
...
export declare const apSecond: <R, E, B>(
  second: ReaderEither<R, E, B>
) => <A>(first: import('./HKT.js').Kind3<'ReaderEither', R, E, A>) => import('./HKT.js').Kind3<'ReaderEither', R, E, B>
/**
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind3<'ReaderEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderEither', R, E, { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => <R, E>(
  fa: import('./HKT.js').Kind3<'ReaderEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderEither', R, E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, R, E, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind3<'ReaderEither', R, E, B>
) => (
  ma: import('./HKT.js').Kind3<'ReaderEither', R, E, A>
) => import('./HKT.js').Kind3<'ReaderEither', R, E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * The `W` suffix (short for **W**idening) means that the environment types and the error types will be merged.
 *

...
export declare const flap: <A>(
  a: A
) => <B>(fab: import('./HKT.js').Kind<'IO', (a: A) => B>) => import('./HKT.js').Kind<'IO', B>
/**
 * @category instances
 * @since 2.10.0
 */
...
export declare const apFirst: <B>(
  second: IO<B>
) => <A>(first: import('./HKT.js').Kind<'IO', A>) => import('./HKT.js').Kind<'IO', A>
/**
...
export declare const apSecond: <B>(
  second: IO<B>
) => <A>(first: import('./HKT.js').Kind<'IO', A>) => import('./HKT.js').Kind<'IO', B>
/**
 * @category instances
 * @since 2.7.0
 */
...
export declare const bindTo: <N extends string>(
  name: N
) => <A>(fa: import('./HKT.js').Kind<'IO', A>) => import('./HKT.js').Kind<'IO', { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => (
  fa: import('./HKT.js').Kind<'IO', A>
) => import('./HKT.js').Kind<'IO', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind<'IO', B>
) => (
  ma: import('./HKT.js').Kind<'IO', A>
) => import('./HKT.js').Kind<'IO', { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * @category do notation
 * @since 2.8.0

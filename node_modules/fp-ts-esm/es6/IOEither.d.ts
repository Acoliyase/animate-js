...
export declare const flap: <A>(
  a: A
) => <E, B>(fab: import('./HKT.js').Kind2<'IOEither', E, (a: A) => B>) => import('./HKT.js').Kind2<'IOEither', E, B>
/**
 * @category instances
 * @since 2.10.0
 */
...
export declare const apFirst: <E, B>(
  second: IOEither<E, B>
) => <A>(first: import('./HKT.js').Kind2<'IOEither', E, A>) => import('./HKT.js').Kind2<'IOEither', E, A>
/**
...
export declare const apSecond: <E, B>(
  second: IOEither<E, B>
) => <A>(first: import('./HKT.js').Kind2<'IOEither', E, A>) => import('./HKT.js').Kind2<'IOEither', E, B>
/**
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind2<'IOEither', E, A>
) => import('./HKT.js').Kind2<'IOEither', E, { readonly [K in N]: A }>
declare const let_: <N extends string, A, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => B
) => <E>(
  fa: import('./HKT.js').Kind2<'IOEither', E, A>
) => import('./HKT.js').Kind2<'IOEither', E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
export {
  /**
   * @category do notation
   * @since 2.13.0
...
export declare const bind: <N extends string, A, E, B>(
  name: Exclude<N, keyof A>,
  f: (a: A) => import('./HKT.js').Kind2<'IOEither', E, B>
) => (
  ma: import('./HKT.js').Kind2<'IOEither', E, A>
) => import('./HKT.js').Kind2<'IOEither', E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * The `W` suffix (short for **W**idening) means that the error types will be merged.
 *

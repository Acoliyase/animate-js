...
export declare const flap: <A>(
  a: A
) => <E, B>(fab: import('./HKT.js').Kind2<'ReaderIO', E, (a: A) => B>) => import('./HKT.js').Kind2<'ReaderIO', E, B>
/**
 * @category instances
 * @since 2.13.0
 */
...
export declare const apFirst: <E, B>(
  second: ReaderIO<E, B>
) => <A>(first: import('./HKT.js').Kind2<'ReaderIO', E, A>) => import('./HKT.js').Kind2<'ReaderIO', E, A>
/**
...
export declare const apSecond: <E, B>(
  second: ReaderIO<E, B>
) => <A>(first: import('./HKT.js').Kind2<'ReaderIO', E, A>) => import('./HKT.js').Kind2<'ReaderIO', E, B>
/**
 * @category instances
 * @since 2.13.0
 */
 ...
 * @since 2.13.0
 */
export declare const ask: <R>() => import('./HKT.js').Kind2<'ReaderIO', R, R>
/**
 ...
 * @since 2.13.0
 */
export declare const asks: <R, A>(f: (r: R) => A) => import('./HKT.js').Kind2<'ReaderIO', R, A>
/**
 * @category lifting
 * @since 2.13.0
 */
...
export declare const bindTo: <N extends string>(
  ...
  fa: import('./HKT.js').Kind2<'ReaderIO', E, A>
) => import('./HKT.js').Kind2<'ReaderIO', E, { readonly [K in N]: A }>
/**
 * @category do notation
 * @since 2.13.0
 */
export declare const bind: <N extends string, A, E, B>(
  ...
  f: (a: A) => import('./HKT.js').Kind2<'ReaderIO', E, B>
) => (
  ma: import('./HKT.js').Kind2<'ReaderIO', E, A>
) => import('./HKT.js').Kind2<'ReaderIO', E, { readonly [K in keyof A | N]: K extends keyof A ? A[K] : B }>
/**
 * The `W` suffix (short for **W**idening) means that the environment types will be merged.
 *
 * @category do notation

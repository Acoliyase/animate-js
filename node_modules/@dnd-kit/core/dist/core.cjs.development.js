...
function useAutoScrollInterval() {
  const [setInterval, clearInterval] = utilities.useInterval();
  const [state, setState] = React.useState(initialAutoScrollState);
  const setAutoScrollInterval = React.useCallback((listener, duration, direction) => {
  ...
  const clearAutoScrollInterval = React.useCallback(() => {
    clearInterval();
    setState({
      isScrolling: false,
      direction: {

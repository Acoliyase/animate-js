...
import { useUniqueId, getEventCoordinates, getWindow, isDocument, isHTMLElement, isSVGElement, canUseDOM, isWindow, isNode, getOwnerDocument, add, isKeyboardEvent, subtract, useLazyMemo, usePrevious, useInterval, useLatestValue, useEvent, useIsomorphicLayoutEffect, useNodeRef, findFirstFocusableNode, CSS } from '@dnd-kit/utilities';
...
function useAutoScrollInterval() {
  ...
  const setAutoScrollInterval = useCallback((listener, duration, direction) => {
...
function useAutoScroller(_ref) {
  ...
  useEffect(() => {
    ...
    for (const scrollContainer of sortedScrollableAncestors) {
      ...
      if (threshold.x && speed.x > 0 || threshold.y && speed.y > 0) {
        clearAutoScrollInterval();
...
const DndContext = /*#__PURE__*/memo(function DndContext(_ref) {
  ...
  const autoScrollState = useAutoScroller({ ...autoScrollOptions,
    delta: translate,
  ...
  const overId = autoScrollState.isScrolling && autoScrollOptions.freeze ? overIdRef.current : getFirstCollision(collisions, 'id');
  ...
  const publicContext = useMemo(() => {
    ...
    return context;
  }, [active, activeNode, activeNodeRect, activatorEvent, collisions, containerNodeRect, dragOverlay, draggableNodes, droppableContainers, droppableRects, over, measureDroppableContainers, scrollableAncestors, scrollableAncestorRects, measuringConfiguration, measuringScheduled, windowRect, autoScrollState]);

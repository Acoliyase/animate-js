...
class Item {
    ...
    constructor(config) {
        ...
        if (config.styleParams) {
            ...
            this.cubeType = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.method];
            this.cubeImages = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.enable];
            this._cropRatio = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.ratios];
            this.rotatingCropRatios =
                styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.ratios].length > 1 && styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.ratios];
            this.smartCrop = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.enableSmartCrop];
            this.cropOnlyFill = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.cropOnlyFill];
            this.imageMargin = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.itemSpacing];
            this.gallerySpacing = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.gallerySpacing];
            this.scatter = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.scatter.randomScatter];
            this.rotatingScatter = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.scatter.manualScatter];
            this.smartCrop = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.enableSmartCrop];
            this.useMaxDimensions =
                !styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.enableStreching] && this.itemType !== 'text';
            this.cubeFitPosition = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.alignment];
        }
        this._groupOffset = {
            top: 0,
            left: 0,
    ...
    calcScatter(offset) {
        ...
        if (this.rotatingScatter.length > 0) {
            ...
            let horizontalShift = utils_js_1.utils.hashToRandomInt(this.seed + offset.right + 'x', -spaceLeft, spaceRight);
            ...
            let verticalShift = utils_js_1.utils.hashToRandomInt(this.seed + offset.right + 'y', -spaceUp, spaceDown);
    ...
    get seed() {
        return this.dto.seed || utils_js_1.utils.hashToInt(this.hash);
    }
    get metadata() {
    ...
    get roundedStyle() {
        return Object.assign(Object.assign({}, this.style), { width: Math.round(this.style.width), height: Math.round(this.style.height) });
    }
    get scheme() {
        return {
            id: this.id,

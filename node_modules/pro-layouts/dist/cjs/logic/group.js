...
class Group {
    constructor(config) {
        ...
        if (config.styleParams) {
            ...
            this.scrollDirection = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.scrollDirection];
            ...
            this.layoutOrientation = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.layoutOrientation];
            this.minItemSize = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.targetItemSize.minimum];
            this.collageDensity = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.groups.density];
            this.groupTypes = String(styleParams[pro_gallery_lib_1.optionsMap.layoutParams.groups.allowedGroupTypes]);
            this.repeatingGroupTypes = String(styleParams[pro_gallery_lib_1.optionsMap.layoutParams.groups.repeatingGroupTypes]);
            this.rotatingCropRatios = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.crop.ratios];
            this.chooseBestGroup = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.groups.groupByOrientation];
            ...
            this.groupSize = styleParams[pro_gallery_lib_1.optionsMap.layoutParams.groups.groupSize];
        }
        this.visible = true;
        this.rendered = true;
        this.required = true;
    ...
    safeGetItem(idx) {
        if (this.items[idx]) {
            ...
            const item = new item_js_1.Item(Object.assign({}, this.items[this.items.length - 1].config));
    ...
    setCubedHeight(height) {
        const shouldUseFixedHeight = this.cubeImages &&
            this.groupSize === 1 &&
    ...
    resizeItems() {
        const items = ['3b', '3r'].indexOf(this.type) >= 0

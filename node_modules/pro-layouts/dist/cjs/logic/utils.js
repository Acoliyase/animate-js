...
class Utils {
    ...
    addDefaultStyleParams(styleParams) {
        ...
        const defaultLayouterSP = {
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.gallerySpacing]: 0,
            [pro_gallery_lib_1.optionsMap.layoutParams.groups.repeatingGroupTypes]: [],
            [pro_gallery_lib_1.optionsMap.layoutParams.crop.enable]: false,
            [pro_gallery_lib_1.optionsMap.layoutParams.crop.method]: 'FILL',
            [pro_gallery_lib_1.optionsMap.layoutParams.crop.ratios]: [1],
            [pro_gallery_lib_1.optionsMap.layoutParams.crop.enableSmartCrop]: false,
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.itemSpacing]: 10,
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.scatter.randomScatter]: 0,
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.scatter.manualScatter]: '',
            [pro_gallery_lib_1.optionsMap.layoutParams.groups.groupByOrientation]: true,
            [pro_gallery_lib_1.optionsMap.layoutParams.groups.groupSize]: 3,
            [pro_gallery_lib_1.optionsMap.layoutParams.groups.allowedGroupTypes]: ['1', '2h', '2v', '3h', '3v', '3t', '3b', '3l', '3r'],
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.layoutOrientation]: 'VERTICAL',
            [pro_gallery_lib_1.optionsMap.layoutParams.targetItemSize.minimum]: 120,
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.scrollDirection]: 'VERTICAL',
            targetItemSize: 500,
            [pro_gallery_lib_1.optionsMap.layoutParams.groups.density]: 50,
            fixedColumns: 0,
            [pro_gallery_lib_1.optionsMap.layoutParams.structure.columnRatios]: [],
        };
        return populateWithDefaultOptions(styleParams);
    }
    convertContainer(container, styleParams) {
        const convertedContainer = Object.assign({ bounds: {} }, container);
        ...
        if (container.width >= 0 && !(container.galleryWidth >= 0)) {
            convertedContainer.galleryWidth =
                container.width +
                    ((styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.itemSpacing] / 2 || 0) -
                        (styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.gallerySpacing] || 0)) *
                        2;
        ...
        if (styleParams.externalInfoHeight >= 0 &&
            styleParams[pro_gallery_lib_1.optionsMap.layoutParams.structure.scrollDirection] === 'HORIZONTAL') {

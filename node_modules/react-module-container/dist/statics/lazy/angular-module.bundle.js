(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("reactModuleContainer", [], factory);
	else if(typeof exports === 'object')
		exports["reactModuleContainer"] = factory();
	else
		root["reactModuleContainer"] = factory();
...
MyCompController.$inject = ["props"];
myApp.config(["$routeProvider", "$locationProvider", function ($routeProvider, $locationProvider) {
  $locationProvider.html5Mode({
    enabled: true,
    requireBase: false
  });
  $routeProvider.when('/ng-router-app/a', {
    template: '<div>BAZINGA!</div>'
  }).when('/ng-router-app/b', {
    template: '<div>STAGADISH!</div>'
...
MyCompController2.$inject = ["props"];
myApp2.config(["$stateProvider", "$locationProvider", "$urlRouterProvider", function ($stateProvider, $locationProvider, $urlRouterProvider) {
  $locationProvider.html5Mode({
    enabled: true,
    requireBase: false
  });
...
angular.module('myApp4', []).component('myComp', {
  template: SHARED_TEMPLATE
});
angular.module('myApp5', []).component('myComp', {
  template: SHARED_TEMPLATE
});

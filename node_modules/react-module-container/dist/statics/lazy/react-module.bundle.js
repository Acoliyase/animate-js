(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("reactModuleContainer", ["React"], factory);
	else if(typeof exports === 'object')
		exports["reactModuleContainer"] = factory(require("React"));
	else
		root["reactModuleContainer"] = factory(root["React"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__1024__) {
...
var _assign = __webpack_require__(/*! object-assign */ 4516);
...
var factory = __webpack_require__(/*! ./factory */ 8714);
...
var _LocationUtils = __webpack_require__(/*! ./LocationUtils */ 6440);

var _DOMUtils = __webpack_require__(/*! ./DOMUtils */ 343);

var _DOMStateStorage = __webpack_require__(/*! ./DOMStateStorage */ 304);

var _PathUtils = __webpack_require__(/*! ./PathUtils */ 9989);

var _ExecutionEnvironment = __webpack_require__(/*! ./ExecutionEnvironment */ 4558);
...
var _warning = __webpack_require__(/*! warning */ 395);
...
var _BrowserProtocol = __webpack_require__(/*! ./BrowserProtocol */ 4326);
...
var _invariant = __webpack_require__(/*! invariant */ 6784);
...
var _Actions = __webpack_require__(/*! ./Actions */ 9119);
...
var statesAreEqual = exports.statesAreEqual = function statesAreEqual(a, b) {
  ...
  !(typeofA !== 'function') ?  false ? 0 : (0, _invariant2.default)(false) : void 0;

  // Not the same object, but same type.
  if (typeofA === 'object') {
    !!(isDate(a) && isDate(b)) ?  false ? 0 : (0, _invariant2.default)(false) : void 0;
...
var _RefreshProtocol = __webpack_require__(/*! ./RefreshProtocol */ 6199);

var RefreshProtocol = _interopRequireWildcard(_RefreshProtocol);

var _DOMUtils = __webpack_require__(/*! ./DOMUtils */ 343);

var _createHistory = __webpack_require__(/*! ./createHistory */ 7258);
...
var createBrowserHistory = function createBrowserHistory() {
  ...
  !_ExecutionEnvironment.canUseDOM ?  false ? 0 : (0, _invariant2.default)(false) : void 0;
...
exports.Z = createBrowserHistory;
...
var _HashProtocol = __webpack_require__(/*! ./HashProtocol */ 3289);
...
var _AsyncUtils = __webpack_require__(/*! ./AsyncUtils */ 2615);

var _PathUtils = __webpack_require__(/*! ./PathUtils */ 9989);

var _runTransitionHook = __webpack_require__(/*! ./runTransitionHook */ 6159);
...
var createMemoryHistory = function createMemoryHistory() {
  ...
  if (current == null) {
    ...
    !(current >= 0 && current < entries.length) ?  false ? 0 : (0, _invariant2.default)(false) : void 0;
  }
...
__webpack_unused_export__ = createMemoryHistory;
...
var _queryString = __webpack_require__(/*! query-string */ 2124);
...
var reactIs = __webpack_require__(/*! react-is */ 2594);
...
var hashClear = __webpack_require__(/*! ./_hashClear */ 8145),
    hashDelete = __webpack_require__(/*! ./_hashDelete */ 9096),
    hashGet = __webpack_require__(/*! ./_hashGet */ 5239),
    hashHas = __webpack_require__(/*! ./_hashHas */ 8228),
    hashSet = __webpack_require__(/*! ./_hashSet */ 5920);
...
var listCacheClear = __webpack_require__(/*! ./_listCacheClear */ 7168),
    listCacheDelete = __webpack_require__(/*! ./_listCacheDelete */ 6582),
    listCacheGet = __webpack_require__(/*! ./_listCacheGet */ 3867),
    listCacheHas = __webpack_require__(/*! ./_listCacheHas */ 9557),
    listCacheSet = __webpack_require__(/*! ./_listCacheSet */ 2726);
...
var getNative = __webpack_require__(/*! ./_getNative */ 4457),
    root = __webpack_require__(/*! ./_root */ 441);
...
var mapCacheClear = __webpack_require__(/*! ./_mapCacheClear */ 7076),
    mapCacheDelete = __webpack_require__(/*! ./_mapCacheDelete */ 2530),
    mapCacheGet = __webpack_require__(/*! ./_mapCacheGet */ 4858),
    mapCacheHas = __webpack_require__(/*! ./_mapCacheHas */ 6265),
    mapCacheSet = __webpack_require__(/*! ./_mapCacheSet */ 9909);
...
var root = __webpack_require__(/*! ./_root */ 441);
...
var baseTimes = __webpack_require__(/*! ./_baseTimes */ 5092),
    isArguments = __webpack_require__(/*! ./isArguments */ 6981),
    isArray = __webpack_require__(/*! ./isArray */ 7236),
    isBuffer = __webpack_require__(/*! ./isBuffer */ 8752),
    isIndex = __webpack_require__(/*! ./_isIndex */ 4363),
    isTypedArray = __webpack_require__(/*! ./isTypedArray */ 4812);
...
var baseAssignValue = __webpack_require__(/*! ./_baseAssignValue */ 999),
    eq = __webpack_require__(/*! ./eq */ 6530);
...
var eq = __webpack_require__(/*! ./eq */ 6530);
...
var defineProperty = __webpack_require__(/*! ./_defineProperty */ 9346);
...
var baseForOwn = __webpack_require__(/*! ./_baseForOwn */ 5897),
    createBaseEach = __webpack_require__(/*! ./_createBaseEach */ 4741);
...
var createBaseFor = __webpack_require__(/*! ./_createBaseFor */ 2630);
...
var baseFor = __webpack_require__(/*! ./_baseFor */ 641),
    keys = __webpack_require__(/*! ./keys */ 2635);
...
var castPath = __webpack_require__(/*! ./_castPath */ 8422),
    toKey = __webpack_require__(/*! ./_toKey */ 8780);
...
var Symbol = __webpack_require__(/*! ./_Symbol */ 4690),
    getRawTag = __webpack_require__(/*! ./_getRawTag */ 7077),
    objectToString = __webpack_require__(/*! ./_objectToString */ 1954);
...
var baseGetTag = __webpack_require__(/*! ./_baseGetTag */ 4318),
    isObjectLike = __webpack_require__(/*! ./isObjectLike */ 3387);
...
var isFunction = __webpack_require__(/*! ./isFunction */ 3839),
    isMasked = __webpack_require__(/*! ./_isMasked */ 7275),
    isObject = __webpack_require__(/*! ./isObject */ 5973),
    toSource = __webpack_require__(/*! ./_toSource */ 6822);
...
var baseGetTag = __webpack_require__(/*! ./_baseGetTag */ 4318),
    isLength = __webpack_require__(/*! ./isLength */ 9216),
    isObjectLike = __webpack_require__(/*! ./isObjectLike */ 3387);
...
var isPrototype = __webpack_require__(/*! ./_isPrototype */ 5003),
    nativeKeys = __webpack_require__(/*! ./_nativeKeys */ 1466);
...
var assignValue = __webpack_require__(/*! ./_assignValue */ 7596),
    castPath = __webpack_require__(/*! ./_castPath */ 8422),
    isIndex = __webpack_require__(/*! ./_isIndex */ 4363),
    isObject = __webpack_require__(/*! ./isObject */ 5973),
    toKey = __webpack_require__(/*! ./_toKey */ 8780);
...
var Symbol = __webpack_require__(/*! ./_Symbol */ 4690),
    arrayMap = __webpack_require__(/*! ./_arrayMap */ 6460),
    isArray = __webpack_require__(/*! ./isArray */ 7236),
    isSymbol = __webpack_require__(/*! ./isSymbol */ 2945);
...
var castPath = __webpack_require__(/*! ./_castPath */ 8422),
    last = __webpack_require__(/*! ./last */ 2972),
    parent = __webpack_require__(/*! ./_parent */ 8293),
    toKey = __webpack_require__(/*! ./_toKey */ 8780);
...
var identity = __webpack_require__(/*! ./identity */ 5362);
...
var isArray = __webpack_require__(/*! ./isArray */ 7236),
    isKey = __webpack_require__(/*! ./_isKey */ 3266),
    stringToPath = __webpack_require__(/*! ./_stringToPath */ 3879),
    toString = __webpack_require__(/*! ./toString */ 1119);
...
var isArrayLike = __webpack_require__(/*! ./isArrayLike */ 1580);
...
var isKeyable = __webpack_require__(/*! ./_isKeyable */ 7620);
...
var baseIsNative = __webpack_require__(/*! ./_baseIsNative */ 2987),
    getValue = __webpack_require__(/*! ./_getValue */ 9741);
...
var nativeCreate = __webpack_require__(/*! ./_nativeCreate */ 5148);
...
var coreJsData = __webpack_require__(/*! ./_coreJsData */ 8507);
...
var assocIndexOf = __webpack_require__(/*! ./_assocIndexOf */ 3833);
...
var Hash = __webpack_require__(/*! ./_Hash */ 4613),
    ListCache = __webpack_require__(/*! ./_ListCache */ 131),
    Map = __webpack_require__(/*! ./_Map */ 4438);
...
var getMapData = __webpack_require__(/*! ./_getMapData */ 2907);
...
var memoize = __webpack_require__(/*! ./memoize */ 427);
...
var overArg = __webpack_require__(/*! ./_overArg */ 3717);
...
var freeGlobal = __webpack_require__(/*! ./_freeGlobal */ 4414);
...
var baseGet = __webpack_require__(/*! ./_baseGet */ 166),
    baseSlice = __webpack_require__(/*! ./_baseSlice */ 4293);
...
var memoizeCapped = __webpack_require__(/*! ./_memoizeCapped */ 7085);
...
var isSymbol = __webpack_require__(/*! ./isSymbol */ 2945);
...
var arrayEach = __webpack_require__(/*! ./_arrayEach */ 6758),
    baseEach = __webpack_require__(/*! ./_baseEach */ 6671),
    castFunction = __webpack_require__(/*! ./_castFunction */ 9883),
    isArray = __webpack_require__(/*! ./isArray */ 7236);
...
var baseIsArguments = __webpack_require__(/*! ./_baseIsArguments */ 8520),
    isObjectLike = __webpack_require__(/*! ./isObjectLike */ 3387);
...
/* module decorator */ module = __webpack_require__.nmd(module);
var root = __webpack_require__(/*! ./_root */ 441),
    stubFalse = __webpack_require__(/*! ./stubFalse */ 7149);
...
var baseIsTypedArray = __webpack_require__(/*! ./_baseIsTypedArray */ 3749),
    baseUnary = __webpack_require__(/*! ./_baseUnary */ 6535),
    nodeUtil = __webpack_require__(/*! ./_nodeUtil */ 1782);
...
var arrayLikeKeys = __webpack_require__(/*! ./_arrayLikeKeys */ 6222),
    baseKeys = __webpack_require__(/*! ./_baseKeys */ 8803),
    isArrayLike = __webpack_require__(/*! ./isArrayLike */ 1580);
...
var MapCache = __webpack_require__(/*! ./_MapCache */ 278);
...
var baseSet = __webpack_require__(/*! ./_baseSet */ 8116);
...
var baseToString = __webpack_require__(/*! ./_baseToString */ 454);
...
var toString = __webpack_require__(/*! ./toString */ 1119);
...
var baseUnset = __webpack_require__(/*! ./_baseUnset */ 9386);
...
var ReactPropTypesSecret = __webpack_require__(/*! ./lib/ReactPropTypesSecret */ 5704);
...
if (false) { var throwOnDirectAccess, ReactIs; } else {
  ...
  module.exports = __webpack_require__(/*! ./factoryWithThrowingShims */ 459)();
}
...
var strictUriEncode = __webpack_require__(/*! strict-uri-encode */ 4111);
var objectAssign = __webpack_require__(/*! object-assign */ 4516);
...
if (true) {
  module.exports = __webpack_require__(/*! ./cjs/react-is.production.min.js */ 6697);
} else {}
...
var setPrototypeOf = __webpack_require__(/*! ./setPrototypeOf.js */ 3494);
var isNativeReflectConstruct = __webpack_require__(/*! ./isNativeReflectConstruct.js */ 1543);
...
var getPrototypeOf = __webpack_require__(/*! ./getPrototypeOf.js */ 4692);
var setPrototypeOf = __webpack_require__(/*! ./setPrototypeOf.js */ 3494);
var isNativeFunction = __webpack_require__(/*! ./isNativeFunction.js */ 2298);
var construct = __webpack_require__(/*! ./construct.js */ 3994);
...
"use strict";
/*!*******************************************!*\
  !*** ./lazy/react-module.js + 35 modules ***!
  \*******************************************/
// ESM COMPAT FLAG
...
var browser = __webpack_require__(6784);
var browser_default = /*#__PURE__*/__webpack_require__.n(browser);
// EXTERNAL MODULE: ../../../node_modules/create-react-class/index.js
var create_react_class = __webpack_require__(6842);
...
var warning_browser = __webpack_require__(395);
...
function formatPattern(pattern, params) {
  ...
  for (var i = 0, len = tokens.length; i < len; ++i) {
    ...
    if (token === '*' || token === '**') {
      ...
      !(paramValue != null || parenCount > 0) ?  false ? 0 : browser_default()(false) : void 0;
      ...
      if (paramValue == null) {
        if (parenCount) {
          ...
          !(nextParenIdx > 0) ?  false ? 0 : browser_default()(false) : void 0;
  ...
  !(parenCount <= 0) ?  false ? 0 : browser_default()(false) : void 0;
...
function isValidChild(object) {
  return object == null || external_React_default().isValidElement(object);
}
...
function createRoutesFromReactChildren(children, parentRoute) {
  ...
  external_React_default().Children.forEach(children, function (element) {
    if (external_React_default().isValidElement(element)) {
 ...
 */
function RouteUtils_createRoutes(routes) {
...
function getChildRoutes(route, location, paramNames, paramValues, callback) {
  ...
  var childRoutesReturn = route.getChildRoutes(partialNextState, function (error, childRoutes) {
    childRoutes = !error && RouteUtils_createRoutes(childRoutes);
    if (sync) {
  ...
  if (isPromise(childRoutesReturn)) childRoutesReturn.then(function (childRoutes) {
    return callback(null, RouteUtils_createRoutes(childRoutes));
  }, callback);
...
function getIndexRoute(route, location, paramNames, paramValues, callback) {
  if (route.indexRoute) {
    ...
    var indexRoutesReturn = route.getIndexRoute(partialNextState, function (error, indexRoute) {
      callback(error, !error && RouteUtils_createRoutes(indexRoute)[0]);
    });

    if (isPromise(indexRoutesReturn)) indexRoutesReturn.then(function (indexRoute) {
      return callback(null, RouteUtils_createRoutes(indexRoute)[0]);
    }, callback);
...
var InternalPropTypes_history = (0,prop_types.shape)({
...
var component = prop_types.elementType;
var components = (0,prop_types.oneOfType)([component, prop_types.object]);
var route = (0,prop_types.oneOfType)([prop_types.object, prop_types.element]);
var routes = (0,prop_types.oneOfType)([route, (0,prop_types.arrayOf)(route)]);
// EXTERNAL MODULE: ../../../node_modules/react-is/index.js
var react_is = __webpack_require__(2594);
...
var contextProviderShape = prop_types_default().shape({
  subscribe: (prop_types_default()).func.isRequired,
  eventIndex: (prop_types_default()).number.isRequired
});
...
var prefixUnsafeLifecycleMethods = typeof (external_React_default()).forwardRef !== 'undefined';
...
function ContextUtils_ContextSubscriber(name) {
 ...
 */
var RouterContext_RouterContext = create_react_class_default()({
  ...
  render: function render() {
    ...
    if (components) {
      element = components.reduceRight(function (element, components, index) {
        ...
        if ((typeof components === 'undefined' ? 'undefined' : RouterContext_typeof(components)) === 'object' && !(0,react_is.isValidElementType)(components)) {
          var elements = {};
    ...
    !(element === null || element === false || external_React_default().isValidElement(element)) ?  false ? 0 : browser_default()(false) : void 0;

    return element;
  }
});

/* harmony default export */ var es_RouterContext = (RouterContext_RouterContext);
...
var Router_prefixUnsafeLifecycleMethods = typeof (external_React_default()).forwardRef !== 'undefined';
...
var Router = create_react_class_default()({
  ...
  getDefaultProps: function getDefaultProps() {
    return {
      render: function render(props) {
        return external_React_default().createElement(es_RouterContext, props);
      }
    };
  },
  getInitialState: function getInitialState() {
  ...
  createTransitionManager: function createTransitionManager() {
    ...
    !history.getCurrentLocation ?  false ? 0 : browser_default()(false) : void 0;

    return createTransitionManager_createTransitionManager(history, RouteUtils_createRoutes(routes || children));
  },
...
if (Router_prefixUnsafeLifecycleMethods) {
...
/* harmony default export */ var es_Router = ((/* unused pure expression or super */ null && (Router)));
;// CONCATENATED MODULE: ../../../node_modules/react-router/es/PropTypes.js


var PropTypes_routerShape = (0,prop_types.shape)({
  push: prop_types.func.isRequired,
  replace: prop_types.func.isRequired,
  go: prop_types.func.isRequired,
  goBack: prop_types.func.isRequired,
...
var locationShape = (0,prop_types.shape)({
...
var Link = create_react_class_default()({
  ...
  mixins: [ContextUtils_ContextSubscriber('router')],

  contextTypes: {
    router: PropTypes_routerShape
  },

  propTypes: {
    to: (0,prop_types.oneOfType)([prop_types.string, prop_types.object, prop_types.func]),
    ...
    innerRef: (0,prop_types.oneOfType)([prop_types.string, prop_types.func, (0,prop_types.shape)({ current: prop_types.elementType })])
  },
  ...
  handleClick: function handleClick(event) {
    ...
    !router ?  false ? 0 : browser_default()(false) : void 0;
  ...
  render: function render() {
    var _props = this.props,
        ...
        props = Link_objectWithoutProperties(_props, ['to', 'activeClassName', 'activeStyle', 'onlyActiveOnIndex', 'innerRef']);
    ...
    if (router) {
      ...
      if (!to) {
        return external_React_default().createElement('a', Link_extends({}, props, { ref: innerRef }));
      }
    ...
    return external_React_default().createElement('a', Link_extends({}, props, { onClick: this.handleClick, ref: innerRef }));
  }
});
...
var IndexLink = create_react_class_default()({
  ...
  render: function render() {
    return external_React_default().createElement(es_Link, IndexLink_extends({}, this.props, { onlyActiveOnIndex: true }));
  }
});

/* harmony default export */ var es_IndexLink = ((/* unused pure expression or super */ null && (IndexLink)));
...
function withRouter(WrappedComponent, options) {
  ...
  var WithRouter = createReactClass({
    ...
    getWrappedInstance: function getWrappedInstance() {
      !withRef ?  false ? 0 : invariant(false) : void 0;
...
var Redirect = create_react_class_default()({
  ...
  /* istanbul ignore next: sanity check */
  render: function render() {
     true ?  false ? 0 : browser_default()(false) : 0;
  }
});
...
/* harmony default export */ var es_IndexRedirect = ((/* unused pure expression or super */ null && (IndexRedirect)));
...
/* harmony default export */ var es_IndexRoute = ((/* unused pure expression or super */ null && (IndexRoute)));
...
/* harmony default export */ var es_Route = ((/* unused pure expression or super */ null && (Route)));
// EXTERNAL MODULE: ../../../node_modules/history/lib/Actions.js
var Actions = __webpack_require__(9119);
// EXTERNAL MODULE: ../../../node_modules/history/lib/useQueries.js
var lib_useQueries = __webpack_require__(927);
// EXTERNAL MODULE: ../../../node_modules/history/lib/useBasename.js
var lib_useBasename = __webpack_require__(583);
// EXTERNAL MODULE: ../../../node_modules/history/lib/createMemoryHistory.js
var lib_createMemoryHistory = __webpack_require__(6878);
...
function match(_ref, callback) {
  ...
  !(history || location) ?  false ? 0 : invariant(false) : void 0;
...
/* harmony default export */ var es_match = ((/* unused pure expression or super */ null && (match)));
...
function useRouterHistory(createHistory) {
  return function (options) {
    var history = (0,lib_useQueries/* default */.Z)((0,lib_useBasename/* default */.Z)(createHistory))(options);
    return history;
  };
}
...
/* harmony default export */ var applyRouterMiddleware = (function () {
  ...
  return function (renderProps) {
    ...
    }, React.createElement(RouterContext, applyRouterMiddleware_extends({}, renderProps, {
      createElement: makeCreateElement(renderProps.createElement)
    })));
  };
});
// EXTERNAL MODULE: ../../../node_modules/history/lib/createBrowserHistory.js
var createBrowserHistory = __webpack_require__(8851);
...
/* harmony default export */ var browserHistory = (createRouterHistory(createBrowserHistory/* default */.Z));
// EXTERNAL MODULE: ../../../node_modules/history/lib/createHashHistory.js
var createHashHistory = __webpack_require__(6975);
;// CONCATENATED MODULE: ../../../node_modules/react-router/es/hashHistory.js


/* harmony default export */ var hashHistory = (createRouterHistory(createHashHistory/* default */.Z));
...
var construct = __webpack_require__(3994);
var construct_default = /*#__PURE__*/__webpack_require__.n(construct);
// EXTERNAL MODULE: ../../../node_modules/lodash/set.js
var set = __webpack_require__(3040);
var set_default = /*#__PURE__*/__webpack_require__.n(set);
// EXTERNAL MODULE: ../../../node_modules/lodash/unset.js
var unset = __webpack_require__(6236);
var unset_default = /*#__PURE__*/__webpack_require__.n(unset);
// EXTERNAL MODULE: ../../../node_modules/lodash/forEach.js
var forEach = __webpack_require__(7709);
var forEach_default = /*#__PURE__*/__webpack_require__.n(forEach);
// EXTERNAL MODULE: ../../../node_modules/lodash/uniqueId.js
var uniqueId = __webpack_require__(556);
var uniqueId_default = /*#__PURE__*/__webpack_require__.n(uniqueId);
// EXTERNAL MODULE: ../../../node_modules/@babel/runtime/helpers/assertThisInitialized.js
var assertThisInitialized = __webpack_require__(6121);
var assertThisInitialized_default = /*#__PURE__*/__webpack_require__.n(assertThisInitialized);
// EXTERNAL MODULE: ../../../node_modules/@babel/runtime/helpers/inheritsLoose.js
var inheritsLoose = __webpack_require__(2323);
var inheritsLoose_default = /*#__PURE__*/__webpack_require__.n(inheritsLoose);
// EXTERNAL MODULE: ../../../node_modules/@babel/runtime/helpers/wrapNativeSuper.js
var wrapNativeSuper = __webpack_require__(7164);
var wrapNativeSuper_default = /*#__PURE__*/__webpack_require__.n(wrapNativeSuper);
;// CONCATENATED MODULE: ./ReactModuleContainerErrors.js



var ReactModuleContainerError = /*#__PURE__*/function (_Error) {
  inheritsLoose_default()(ReactModuleContainerError, _Error);
...
var UnregisteredMethodInvokedError = /*#__PURE__*/function (_ReactModuleContainer) {
  inheritsLoose_default()(UnregisteredMethodInvokedError, _ReactModuleContainer);
...
var UnregisteredComponentUsedError = /*#__PURE__*/function (_ReactModuleContainer2) {
  inheritsLoose_default()(UnregisteredComponentUsedError, _ReactModuleContainer2);
...
var ListenerCallbackError = /*#__PURE__*/function (_ReactModuleContainer3) {
  inheritsLoose_default()(ListenerCallbackError, _ReactModuleContainer3);
...
var LazyComponentLoadingError = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_ReactModuleContainer4) {
...
var FileAppenderLoadError = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_ReactModuleContainer5) {
...
var ModuleAlreadyRegisteredError = /*#__PURE__*/function (_ReactModuleContainer6) {
  inheritsLoose_default()(ModuleAlreadyRegisteredError, _ReactModuleContainer6);
  function ModuleAlreadyRegisteredError(moduleId) {
    var _this7;
    _this7 = _ReactModuleContainer6.call(this, "A module with id \"" + moduleId + "\" is already registered") || this;
    _this7.name = 'ModuleAlreadyRegisteredError';
    return _this7;
  }
  return ModuleAlreadyRegisteredError;
}(ReactModuleContainerError);
;// CONCATENATED MODULE: ./module-registry.js
...
var ModuleRegistry = /*#__PURE__*/function () {
  ...
  _proto.registerModule = function registerModule(globalID, ModuleFactory, args) {
    ...
    this.modules[globalID] = construct_default()(ModuleFactory, args);
  };
  ...
  _proto.addListener = function addListener(globalID, callback) {
    var _this2 = this;
    var callbackKey = uniqueId_default()('eventListener');
    set_default()(this.eventListeners, [globalID, callbackKey], callback);
    return {
      remove: function remove() {
        return unset_default()(_this2.eventListeners[globalID], callbackKey);
      }
    };
  };
  _proto.notifyListeners = function notifyListeners(globalID) {
    ...
    forEach_default()(listenerCallbacks, function (callback) {
...
/* harmony default export */ var module_registry = (singleton);
...
;// CONCATENATED MODULE: ./lazy/react-module.js



var RealReactComp = function RealReactComp(props) {
  return /*#__PURE__*/external_React_default().createElement("div", null, /*#__PURE__*/external_React_default().createElement("div", null, props.value), /*#__PURE__*/external_React_default().createElement("div", {
    id: "value-of-resolved-experiments"
  }, JSON.stringify(props.experiments)), /*#__PURE__*/external_React_default().createElement("div", {
    id: "value-of-resolved-custom-data"
  }, JSON.stringify(props.customData)), /*#__PURE__*/external_React_default().createElement("div", null, /*#__PURE__*/external_React_default().createElement(es_Link, {
    className: "react-link",
    to: "/ng-router-app/a"
  }, "ng-route-app"), "\xA0", /*#__PURE__*/external_React_default().createElement(es_Link, {
    className: "react-link",
    to: "/ui-router-app/"
  }, "ui-route-app"), "\xA0"));
};
module_registry.registerComponent('MyApp3.RealReactComp', function () {
...
module_registry.registerComponent('MyApp6.RealReactCompCrossOrigin', function () {
...
var DemoReactComp = function DemoReactComp() {
  return /*#__PURE__*/external_React_default().createElement("div", {
    ...
    className: "demo-4"
  }, "demo-4"), /*#__PURE__*/external_React_default().createElement("div", {
    className: "demo-5"
  }, "demo-5"));
};
module_registry.registerComponent('MyApp7.RealReactComp', function () {

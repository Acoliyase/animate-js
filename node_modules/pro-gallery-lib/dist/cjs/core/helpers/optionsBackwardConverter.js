...
function reverseMigrateOptions(flatOptionsObject) {
    let oldOptions = Object.assign({}, flatOptionsObject);
    ///----------- LAYOUT -------------///
    oldOptions = (0, migratorStore_js_1.changeNames)(oldOptions, [...migratorStore_js_1.nameChangedLayoutParams].map((ele) => [...ele].reverse()));
    oldOptions = (0, migratorStore_js_1.reverseBooleans)(oldOptions, [...migratorStore_js_1.reversedLayoutParams].map((ele) => [...ele].reverse()));
    ...
    ///----------- BEHAVIOUR -------------///
    oldOptions = (0, migratorStore_js_1.changeNames)(oldOptions, [...migratorStore_js_1.nameChangedBehaviourParams].map((ele) => [...ele].reverse()));
    oldOptions = (0, migratorStore_js_1.reverseBooleans)(oldOptions, [...migratorStore_js_1.reversedBehaviourParams].map((ele) => [...ele].reverse()));
    ...
    ///----------- STYLING -------------///
    oldOptions = (0, migratorStore_js_1.changeNames)(oldOptions, [...migratorStore_js_1.nameChangedStylingParams].map((ele) => [...ele].reverse()));
    return oldOptions;
}
...
function process_new_to_old_ThumbnailAlignment(obj) {
    ...
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.thumbnails.alignment, 'galleryThumbnailsAlignment');
...
function process_new_to_old_targetItemSizeUnit(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.targetItemSize.unit, 'gallerySizeType');
...
function process_new_to_old_targetItemSizeValue(obj) {
    let _obj = obj;
    let value = _obj[optionsMap_js_1.default.layoutParams.targetItemSize.value];
    ...
    delete _obj[optionsMap_js_1.default.layoutParams.targetItemSize.value];
    return _obj;
}
function process_new_to_old_slideshowInfoSize(obj) {
    ...
    const isSlideshow = (0, layoutParams_structure_galleryLayout_js_1.isLayout)('SLIDESHOW')({
        galleryLayout: obj.galleryLayout >= -3 ? obj.galleryLayout : (_b = (_a = obj.layoutParams) === null || _a === void 0 ? void 0 : _a.structure) === null || _b === void 0 ? void 0 : _b.galleryLayout,
    });
    if (isSlideshow) {
        _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.height, 'slideshowInfoSize');
        _obj['textBoxHeight'] = _obj['slideshowInfoSize'];
    }
    else {
        _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.height, 'textBoxHeight');
...
function process_new_to_old_textBoxSizeMode(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.sizeUnits, 'calculateTextBoxWidthMode');
    switch (_obj['calculateTextBoxWidthMode']) {
        case 'PERCENT':
            _obj['calculateTextBoxWidthMode'] = 'PERCENT';
            _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.width, 'textBoxWidthPercent');
            _obj['textBoxWidth'] = _obj['textBoxWidth'] || 200;
            break;
        case 'PIXEL':
            _obj['calculateTextBoxWidthMode'] = 'MANUAL';
            _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.width, 'textBoxWidth');
...
function process_new_to_old_arrowsPosition(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.navigationArrows.position, 'arrowsPosition');
...
function process_new_to_old_responsiveMode(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.structure.responsiveMode, 'gridStyle');
...
function process_new_to_old_columnRatios(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.structure.columnRatios, 'columnWidths');
...
function process_new_to_old_cropMethod(obj) {
    var _a;
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.crop.method, 'cubeType');
    _obj['cubeType'] = (_a = _obj['cubeType']) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    return _obj;
}
function process_new_to_old_VideoPlayTrigger(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.item.video.playTrigger, 'videoPlay');
...
function process_new_to_old_VideoVolume(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.item.video.volume, 'videoSound');
    _obj['videoSound'] = typeof _obj['videoSound'] === 'undefined' ? undefined : !!_obj['videoSound'];
    return _obj;
}
function process_new_to_old_VideoSpeed(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.item.video.speed, 'videoSpeed');
...
function process_new_to_old_ScrollDirection(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.structure.scrollDirection, 'scrollDirection');
...
function process_new_to_old_layoutDirection(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.gallery.layoutDirection, 'isRTL');
    switch (_obj['isRTL']) {
        case 'RIGHT_TO_LEFT':
            _obj['isRTL'] = true;
            break;
...
function process_new_to_old_LayoutOrientation(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.structure.layoutOrientation, 'isVertical');
...
function process_new_to_old_groupsOrder(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.structure.groupsOrder, 'placeGroupsLtr');
...
function process_new_to_old_galleryTextAlign(obj) {
    var _a;
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.gallery.horizontal.slideshowInfo.buttonsAlignment, 'galleryTextAlign');
...
function process_new_to_old_LoadMoreAmount(obj) {
    var _a;
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.gallery.vertical.loadMore.amount, 'loadMoreAmount');
...
function process_new_to_old_CroppedAlignment(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.crop.alignment, 'cubeFitPosition');
...
function process_new_to_old_OverlayHoveringBehaviour(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.item.overlay.hoveringBehaviour, 'hoveringBehaviour');
...
function process_new_to_old_InfoPlacement(obj) {
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.layoutParams.info.placement, 'titlePlacement');
...
function process_new_to_old_ClickAction(obj) {
    var _a;
    let _obj = obj;
    _obj = (0, migratorStore_js_1.namingChange)(_obj, optionsMap_js_1.default.behaviourParams.item.clickAction, 'itemClick');
...
function process_new_to_old_AutoSlideBehaviour(obj) {
    let _obj = obj;
    let val = _obj[optionsMap_js_1.default.behaviourParams.gallery.horizontal.autoSlide.behaviour];
    switch (val) {
        case 'OFF':
    ...
    delete _obj[optionsMap_js_1.default.behaviourParams.gallery.horizontal.autoSlide.behaviour];
    return _obj;
}
function process_new_to_old_CropRatio(obj) {
    let _obj = obj;
    let rotatingCropRatioVal;
    const val = _obj[optionsMap_js_1.default.layoutParams.crop.ratios] && [..._obj[optionsMap_js_1.default.layoutParams.crop.ratios]];
    let newVal = val || [];
    if (newVal.length > 1) {
    ...
    delete _obj[optionsMap_js_1.default.layoutParams.crop.ratios];
    return _obj;
}
function process_new_to_old_AllowedGroupTypes(obj) {
    let _obj = obj;
    _obj['groupTypes'] = _obj[optionsMap_js_1.default.layoutParams.groups.allowedGroupTypes]
        ? _obj[optionsMap_js_1.default.layoutParams.groups.allowedGroupTypes].join
            ? _obj[optionsMap_js_1.default.layoutParams.groups.allowedGroupTypes].join(',')
            : ''
        : undefined;
    delete _obj[optionsMap_js_1.default.layoutParams.groups.allowedGroupTypes];
    return _obj;
}
function process_new_to_old_GroupTypes(obj) {
    let _obj = obj;
    let repeatingVal = _obj[optionsMap_js_1.default.layoutParams.groups.repeatingGroupTypes] &&
        _obj[optionsMap_js_1.default.layoutParams.groups.repeatingGroupTypes].join(',');
    _obj['layoutParams_repeatingGroupTypes'] = _obj['rotatingGroupTypes'] = repeatingVal;
    delete _obj[optionsMap_js_1.default.layoutParams.groups.repeatingGroupTypes];
    return _obj;
}
function process_new_to_old_NumberOfColumns(obj) {
    let _obj = obj;
    _obj.numberOfImagesPerRow = _obj[optionsMap_js_1.default.layoutParams.structure.numberOfColumns];
    delete _obj[optionsMap_js_1.default.layoutParams.structure.numberOfColumns];
    return _obj;
}

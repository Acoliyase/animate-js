...
export interface Gallery {
    ...
    scrollAnimation?: 'NO_EFFECT' | 'FADE_IN' | 'GRAYSCALE' | 'SLIDE_UP' | 'EXPAND' | 'SHRINK' | 'ZOOM_OUT' | 'ONE_COLOR' | 'MAIN_COLOR' | 'BLUR';
...
export interface Content {
    hoverAnimation?: 'NO_EFFECT' | 'ZOOM_IN' | 'TILT' | 'BLUR' | 'GRAYSCALE' | 'SHRINK' | 'INVERT' | 'COLOR_IN' | 'DARKENED';
...
export interface AutoSlide {
    behaviour?: 'OFF' | 'CONTINUOUS' | 'INTERVAL';
    interval?: number;
...
//# sourceMappingURL=behaviourParams.d.ts.map
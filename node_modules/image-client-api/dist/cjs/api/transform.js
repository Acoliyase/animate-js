...
function getTransform(fittingType, src, target, options) {
    var fileType = imageServiceUtils.getFileType(src.id);
    var fileName = imageServiceUtils.getFileName(src.id, src.name);
    var fileExtension = imageServiceUtils.getFileExtension(src.id);
    var isWEBPSupport = imageServiceUtils.isWEBPBrowserSupport(fileType);

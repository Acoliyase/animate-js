...
var imageServiceUtils = require('./imageServiceUtils');
...
function getFitPart(transformsObj, target) {
    ...
    var transformedData = imageServiceUtils.getTransformData(transformsObj.src.width, transformsObj.src.height, target, constants.transformTypes.FIT, transformsObj.upscaleMethod);
    var transformType = constants.transformTypes.FILL;
...
function getFillPart(transformsObj, target) {
    // calculate the transformed image size needed
    var transformedData = imageServiceUtils.getTransformData(transformsObj.src.width, transformsObj.src.height, target, constants.transformTypes.FILL, transformsObj.upscaleMethod);
    var focalPoint = imageServiceUtils.getFocalPoint(transformsObj.focalPoint);
    var transformType = focalPoint ? constants.transformTypes.FILL_FOCAL : constants.transformTypes.FILL;

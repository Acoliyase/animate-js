...
function getQuality(transformsObj, options) {
    ...
    var quality = options.quality && options.quality >= 5 && options.quality <= 90 ? options.quality : defaultQuality;
...
function isUSMValid(usm) {
    ...
    var threshold = !isNaN(usm.threshold) && typeof usm.threshold === 'number' && usm.threshold >= 0 && usm.threshold <= 255;

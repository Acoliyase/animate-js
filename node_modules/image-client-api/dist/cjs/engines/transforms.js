...
var legacyFillTemplate = utils.template('fill/w_${width},h_${height},al_${alignment}');

// upscale template
var upscaleTemplate = utils.template(',lg_${upscaleMethodValue}');
...
var filterTemplatesMap = (_filterTemplatesMap = {}, _filterTemplatesMap[constants.imageFilters.CONTRAST] = utils.template(',con_${contrast}'), _filterTemplatesMap[constants.imageFilters.BRIGHTNESS] = utils.template(',br_${brightness}'), _filterTemplatesMap[constants.imageFilters.SATURATION] = utils.template(',sat_${saturation}'), _filterTemplatesMap[constants.imageFilters.HUE] = utils.template(',hue_${hue}'), _filterTemplatesMap[constants.imageFilters.BLUR] = utils.template(',blur_${blur}'), _filterTemplatesMap);
...
function getImageURI(transformsObj) {
    ...
    // quality
    if (transformsObj.fileType === constants.fileType.PNG && transformsObj.isWEBPSupport || transformsObj.fileType === constants.fileType.JPG) {
